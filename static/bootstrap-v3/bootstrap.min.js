            ...
            (s.prototype.backdrop = function(t) {
                ...
                if (this.isShown && this.options.backdrop) {
                    ...
                    if (
                        ...
                        return;
                    o
                        ? this.$backdrop.one('bsTransitionEnd', t).emulateTransitionEnd(s.BACKDROP_TRANSITION_DURATION)
                        : t();
                    ...
                    a.support.transition && this.$element.hasClass('fade')
                        ? this.$backdrop.one('bsTransitionEnd', n).emulateTransitionEnd(s.BACKDROP_TRANSITION_DURATION)
                        : n();
                } else t && t();
            }),
        ...
        (m.VERSION = '3.4.1'),
            ...
            (m.prototype.setContent = function() {
                var t = this.tip(),
                    e = this.getTitle();
                this.options.html
                    ? (this.options.sanitize && (e = n(e, this.options.whiteList, this.options.sanitizeFn)),
