...
!(function(o) {
    'function' == typeof define && define.amd
        ...
        ? (module.exports = function(t, n) {
              return (
                  void 0 === n && (n = 'undefined' != typeof window ? require('jquery') : require('jquery')(t)), o(n), n
              );
          })
        : o(jQuery);
})(function(j) {
        ...
        return this.each(function() {
            ...
            function x() {
                ...
                var t = s,
                    n = v();
                (s += n),
                    null !== i.max && s > i.max && ((s = i.max), c.trigger('touchspin.on.max'), _()),
                    o.input.val(i.callback_after_calculation(Number(s).toFixed(i.decimals))),
            ...
            function g() {
                ...
                var t = s,
                    n = v();
                (s -= n),
                    null !== i.min && s < i.min && ((s = i.min), c.trigger('touchspin.on.min'), _()),
                    o.input.val(i.callback_after_calculation(Number(s).toFixed(i.decimals))),
                    t !== s && c.trigger('change');
            }
            function m() {
            ...
            !(function() {
                ...
                if ((c.data('alreadyinitialized', !0), (D += 1), c.data('spinnerid', D), !c.is('input')))
                ...
                (i = j.extend(
                    ...
                    o.down.on('mousedown.touchspin', function(t) {
                        o.down.off('touchstart.touchspin'),
                            c.is(':disabled') || (g(), m(), t.preventDefault(), t.stopPropagation());
                    }),
                    ...
                    o.up.on('mousedown.touchspin', function(t) {
                        o.up.off('touchstart.touchspin'),
                            c.is(':disabled') || (x(), w(), t.preventDefault(), t.stopPropagation());
                    }),
                    ...
                    c.on('touchspin.updatesettings', function(t, n) {
                        !(function(t) {
                            ...
                            '' !== n &&
                                ...
                                o.input.val(i.callback_after_calculation(Number(n).toFixed(i.decimals))));
                        })(n);
                    });
                var s;
            })();
