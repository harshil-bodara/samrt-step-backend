    ...
    return (
        ...
        (function(a, b, c) {
            ...
            function k(a, b, c, e, f, g, h, i) {
                return (
                    d('C', { x1: +a, y1: +b, x2: +c, y2: +e, x: +f, y: +g }, this.pathElements, this.pos++, h, i), this
                );
            }
                                        ...
                                        if (
                                            ...
                                            (r = a.horizontalBars
                                                ? {
                                                      x:
                                                          o.x1 +
                                                          j.projectValue(g && g.x ? g.x : 0, k, b.normalized.series[e]),
                                                      y:
                                                          o.y1 -
                                                          l.projectValue(g && g.y ? g.y : 0, u, b.normalized.series[e]),
                                                  }
                                                : {
                                                      x:
                                                          o.x1 +
                                                          l.projectValue(g && g.x ? g.x : 0, u, b.normalized.series[e]),
                                                      y:
                                                          o.y1 -
                                                          j.projectValue(g && g.y ? g.y : 0, k, b.normalized.series[e]),
                                                  }),
                    ...
                    j.raw.series.forEach(
                        function(e, g) {
                            if (0 !== j.normalized.series[g] || !a.ignoreEmptyValues) {
                                ...
                                a.donut &&
                                    ((x = a.classNames.sliceDonut), a.donutSolid && (x = a.classNames.sliceDonutSolid));
