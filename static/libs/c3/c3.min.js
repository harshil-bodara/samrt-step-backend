...
!(function(t, e) {
    ...
    (i.prototype.axisX = function(t, e, i) {
        ...
        (i.prototype.splitTickText = function(t, e) {
            ...
            return (
                (!c || c <= 0) && (c = s.isVertical() ? 95 : s.params.isCategory ? Math.ceil(e(1) - e(0)) - 12 : 110),
                (function t(e, i) {
                    a = void 0;
        ...
        (i.prototype.tspanDy = function(t, e) {
            ...
            return (
                0 === e && (i = this.isVertical() ? -((t.length - 1) * (this.tickTextCharSize.h / 2) - 3) : '.71em'), i
            );
        }),
            ...
            return (
                ...
                (A.orient = function(t) {
                    return arguments.length
                        ? ((w.orient = t in { top: 1, right: 1, bottom: 1, left: 1 } ? t + '' : 'bottom'), A)
                        : w.orient;
                }),
    ...
    var Y = {
        ...
        u = function(t) {
            return null == t || (c(t) && 0 === t.length) || ('object' === s(t) && 0 === Object.keys(t).length);
        },
        h = function(t) {
    ...
    (d.prototype.init = function() {
        ...
        (d.prototype.getXAxis = function(t, e, i, n, r, a, o) {
            ...
            return (
                ...
                s.isCategorized() &&
                    (l.tickCentered(c.axis_x_tick_centered), u(c.axis_x_tick_culling) && (c.axis_x_tick_culling = !1)),
                l
            );
        }),
        (d.prototype.updateXAxisTickValues = function(t, e) {
            ...
            return (
                (r.axis_x_tick_fit || r.axis_x_tick_count) &&
                    (i = this.generateTickValues(n.mapTargetsToUniqueXs(t), r.axis_x_tick_count, n.isTimeSeries())),
        ...
        (d.prototype.getYAxis = function(t, e, i, n, r, a, o) {
            var s = this.owner,
                c = s.config,
                d = { withOuterTick: r, withoutTransition: a, tickTextRotate: o ? 0 : c.axis_y_tick_rotate },
                l = new this.internal(this, d).axis
                    .scale(t)
                    .orient(e)
                    .tickFormat(i);
            return (
                s.isTimeSeriesY() ? l.ticks(c.axis_y_tick_time_type, c.axis_y_tick_time_interval) : l.tickValues(n), l
            );
        }),
                    ...
                    (o.svg &&
                        ...
                        'y' === t
                            ? ((n = o.y.copy().domain(o.getYDomain(i, 'y'))),
                              (r = this.getYAxis(n, o.yOrient, s.axis_y_tick_format, o.yAxisTickValues, !1, !0, !0)))
                            : 'y2' === t
                            ? ((n = o.y2.copy().domain(o.getYDomain(i, 'y2'))),
                              (r = this.getYAxis(n, o.y2Orient, s.axis_y2_tick_format, o.y2AxisTickValues, !1, !0, !0)))
        ...
        (d.prototype.generateTickValues = function(t, e, i) {
            ...
            if (e)
                if (1 === (n = h(e) ? e() : e)) l = [t[0]];
                    ...
                    for (o = n - 2, r = t[0], s = ((a = t[t.length - 1]) - r) / (o + 1), l = [r], c = 0; c < o; c++)
    ...
    var t = {
        ...
        chart: {
            fn: n.prototype,
            internal: { fn: l.prototype, axis: { fn: d.prototype, internal: { fn: i.prototype } } },
        },
        generate: function(t) {
            return new n(t);
        },
    ...
    return (
        ...
        (l.prototype.initWithData = function(t) {
            ...
            (n.axis = new d(n)),
                ...
                n.selectChart.empty() &&
                    ((n.selectChart = r.select(document.createElement('div')).style('opacity', 0)),
                ...
                a.legend_hide &&
                    n.addHiddenLegendIds(!0 === a.legend_hide ? n.mapToIds(n.data.targets) : a.legend_hide),
                n.updateSizes(),
                n.updateScales(),
            ...
            'grid' === e &&
                t.each(function() {
                    var t = a.d3.select(this),
                        ...
                        n = t.attr('y1'),
                        r = t.attr('y2');
                    t.attr({ x1: Math.ceil(e), x2: Math.ceil(i), y1: Math.ceil(n), y2: Math.ceil(r) });
                });
        }),
        ...
        (l.prototype.redraw = function(t, e) {
            ...
            if (
                ...
                u && D.legend_show ? O.updateLegend(O.mapToIds(O.data.targets), t, e) : g && O.updateDimension(!0),
                O.isCategorized() && 0 === H.length && O.x.domain([0, O.axes.x.selectAll('.tick').size()]),
                H.length
                    ? (O.updateXDomain(H, c, d, l), D.axis_x_tick_values || (L = O.axis.updateXAxisTickValues(H)))
                ...
                !D.axis_y_tick_values &&
                    D.axis_y_tick_count &&
                    O.yAxis.tickValues(O.axis.generateTickValues(O.y.domain(), D.axis_y_tick_count)),
                !D.axis_y2_tick_values &&
                    D.axis_y2_tick_count &&
                    O.y2Axis.tickValues(O.axis.generateTickValues(O.y2.domain(), D.axis_y2_tick_count)),
                O.axis.redraw(v, z),
                O.axis.updateLabels(r),
                (c || p) && H.length)
            )
                if (D.axis_x_tick_culling && L) {
                    for (C = 1; C < L.length; C++)
                        if (L.length / C < D.axis_x_tick_culling_max) {
                            V = C;
                            break;
                        }
            ...
            (f = O.generateDrawArea ? O.generateDrawArea(F, !1) : void 0),
                ...
                i && (O.subY.domain(O.getYDomain(H, 'y')), O.subY2.domain(O.getYDomain(H, 'y2'))),
                O.updateXgridFocus(),
        ...
        (l.prototype.updateAndRedraw = function(t) {
            ...
            ((t = t || {}).withTransition = N(t, 'withTransition', !0)),
                ...
                (t.withTransitionForTransform = N(t, 'withTransitionForTransform', t.withTransition)),
                i.updateSizes(),
                (t.withLegend && n.legend_show) ||
                    ((e = i.axis.generateTransitions(t.withTransitionForAxis ? n.transition_duration : 0)),
                    i.updateScales(),
                    i.updateSvgSize(),
        ...
        (l.prototype.getTranslate = function(t) {
            ...
            return (
                'main' === t
                    ...
                    : 'arc' === t && ((e = n.arcWidth / 2), (i = n.arcHeight / 2 - (n.hasType('gauge') ? 6 : 0))),
                'translate(' + e + ',' + i + ')'
            );
        }),
        ...
        (l.prototype.transformMain = function(t, e) {
            var i,
                ...
                r,
                a = this;
            e && e.axisX ? (i = e.axisX) : ((i = a.main.select('.' + Y.axisX)), t && (i = i.transition())),
                e && e.axisY ? (n = e.axisY) : ((n = a.main.select('.' + Y.axisY)), t && (n = n.transition())),
                e && e.axisY2 ? (r = e.axisY2) : ((r = a.main.select('.' + Y.axisY2)), t && (r = r.transition())),
        ...
        (l.prototype.observeInserted = function(e) {
            ...
            'undefined' != typeof MutationObserver
                ? (i = new MutationObserver(function(t) {
                  ...
                  })).observe(e.node(), { attributes: !0, childList: !0, characterData: !0 })
        ...
        'SVGPathSegList' in window ||
            ...
            Object.defineProperty(window.SVGPathElement.prototype, 'pathSegList', {
                get: function() {
                    return (
                        this._pathSegList || (this._pathSegList = new window.SVGPathSegList(this)), this._pathSegList
                    );
                },
                enumerable: !0,
            }),
                ...
                (i.prototype._isCurrentSpace = function() {
                    ...
                    (i.prototype._parseNumber = function() {
                        ...
                        if (
                            ...
                            var l = e + n;
                            if (((l *= r), t && (l *= Math.pow(10, a * t)), o != this._currentIndex))
        ...
        String.prototype.padEnd ||
            (String.prototype.padEnd = function(t, e) {
                return (
                    ...
                    this.length > t
                        ? String(this)
                        : ((t -= this.length) > e.length && (e += e.repeat(t / e.length)), String(this) + e.slice(0, t))
                );
            }),
        ...
        (n.prototype.axis.max = function(t) {
            ...
            'object' === s(t)
                ? (P(t.x) && (i.axis_x_max = t.x), P(t.y) && (i.axis_y_max = t.y), P(t.y2) && (i.axis_y2_max = t.y2))
        ...
        (n.prototype.axis.min = function(t) {
            ...
            'object' === s(t)
                ? (P(t.x) && (i.axis_x_min = t.x), P(t.y) && (i.axis_y_min = t.y), P(t.y2) && (i.axis_y2_min = t.y2))
                    ...
                    for (e = 0; e < r.length; e++)
                        if (t.id === r[e].id) {
                            for (
                                ...
                                (r[e].values[i].index = h + i), c.isTimeSeries() || (r[e].values[i].x = h + i);
        ...
        (l.prototype.generateFlow = function(G) {
            ...
            return function() {
                var t,
                    ...
                    A = E.getValueOnIndex(E.data.targets[0].values, w + v),
                    T = E.x.domain(),
                    P = u.duration || S,
                    L = u.done || function() {},
                    C = E.generateWait();
                    ...
                    (t =
                        ...
                        (u.orgDataCount
                            ...
                            ? ((b = E.getValueOnIndex(E.data.targets[0].values, 0)),
                              (A = E.getValueOnIndex(E.data.targets[0].values, E.data.targets[0].values.length - 1)),
                              E.x(b.x) - E.x(A.x))
                            : R(e) / 2) +
                        ',0) scale(' +
                        R(T) / R(e) +
                ...
                var V = O.transition()
                    .ease(O.easeLinear)
                    .duration(P);
                C.add(E.xAxis(E.axes.x, V)),
                    C.add(s.transition(V).attr('transform', t)),
                    C.add(c.transition(V).attr('transform', t)),
                    C.add(d.transition(V).attr('transform', t)),
                    C.add(l.transition(V).attr('transform', t)),
                    C.add(o.transition(V).attr('transform', t)),
                    C.add(
                        a
                    ...
                    C.add(n.transition(V).attr('transform', t)),
                    C.add(r.transition(V).attr('transform', t)),
                    C(function() {
                        var t,
                            e = [],
                            i = [];
                        if (v) {
                            for (t = 0; t < v; t++)
                                e.push('.' + Y.shape + '-' + (w + t)), i.push('.' + Y.text + '-' + (w + t));
                            E.svg
                                .selectAll('.' + Y.shapes)
                                .selectAll(e)
                                .remove(),
        ...
        (n.prototype.load = function(e) {
            ...
            e.xs && t.addXs(e.xs),
                ...
                'cacheIds' in e && t.hasCaches(e.cacheIds)
                    ...
                    : 'unload' in e
                    ? t.unload(
                          t.mapToTargetIds('boolean' == typeof e.unload && e.unload ? null : e.unload),
                          function() {
                              t.loadFromArgs(e);
                          }
                      )
        ...
        (n.prototype.unload = function(t) {
            var e = this.internal;
            (t = t || {}) instanceof Array ? (t = { ids: t }) : 'string' == typeof t && (t = { ids: [t] }),
                ...
                u.main
                    ...
                    .each(function(t, e) {
                        ...
                        i.classed(Y.line) ||
                            i.classed(Y.area) ||
                            (a && o
                                ? g.data_selection_isselectable(t) && !s && r(!0, i.classed(Y.SELECTED, !0), t, e)
            ...
            h.data_selection_enabled &&
                l.main
                    ...
                    .each(function(t, e) {
                        ...
                        i.classed(Y.line) ||
                            i.classed(Y.area) ||
                            (a && o && h.data_selection_isselectable(t) && s && r(!1, i.classed(Y.SELECTED, !1), t, e));
                    });
        }),
        (n.prototype.show = function(t, e) {
            ...
            (t = n.mapToTargetIds(t)),
                ...
                n.redraw({ withUpdateOrgXDomain: !0, withUpdateXDomain: !0, withLegend: !0 });
        }),
        ...
        (n.prototype.x = function(t) {
            ...
            return (
                arguments.length &&
                    (e.updateTargetX(e.data.targets, t), e.redraw({ withUpdateOrgXDomain: !0, withUpdateXDomain: !0 })),
                e.data.xs
            );
        }),
        ...
        (l.prototype.updateRadius = function() {
            ...
            (t.radiusExpanded = (Math.min(t.arcWidth, t.arcHeight) / 2) * (t.hasType('gauge') ? 0.85 : 1)),
                ...
                (t.gaugeArcWidth =
                    i || (n <= t.radius - t.innerRadius ? t.radius - t.innerRadius : n <= t.radius ? n : t.radius));
        }),
                            ...
                            (a =
                                o.hasType('donut') && s.donut_label_ratio
                                    ...
                                    ? h(s.pie_label_ratio)
                                        ...
                                        : s.pie_label_ratio
                                    : o.radius && r
                                    ? ((0.375 < 36 / o.radius ? 1.175 - 36 / o.radius : 0.8) * o.radius) / r
                                    : 0) +
                        ',' +
                        n * a +
                        ')');
            ...
            if (
                ...
                d &&
                    ...
                    1 === l.filterTargetsToShow(l.data.targets).length
                        ...
                        : o
                              .style('fill', function(t) {
                                  return l.levelColor ? l.levelColor(t.data.values[0].value) : l.color(t.data);
                              })
                              ...
                              .each(function(t) {
                                  ...
                                  if (l.hiddenTargetIds.indexOf(t.data.id) < 0) {
                                      var a = l.updateAngle(t),
                                          o =
                                              (l.gaugeArcWidth / l.filterTargetsToShow(l.data.targets).length) *
                                              (a.index + 1),
                ...
                c
                    ...
                    .style('font-size', function(t) {
                        return l.isGaugeType(t.data) && 1 === l.filterTargetsToShow(l.data.targets).length
                ...
                g
                    ...
                    l.arcs
                        ...
                        .attr(
                            'dx',
                            -1 * (l.innerRadius + (l.radius - l.innerRadius) / (s.gauge_fullCircle ? 1 : 2)) + 'px'
                        )
                        .attr('dy', '1.2em')
                        .text(s.gauge_label_show ? l.textForGaugeMinMax(s.gauge_min, !1) : ''),
                    l.arcs
                        .select('.' + Y.chartArcsGaugeMax)
                        .attr('dx', l.innerRadius + (l.radius - l.innerRadius) / (s.gauge_fullCircle ? 1 : 2) + 'px')
                        .attr('dy', '1.2em')
                        .text(s.gauge_label_show ? l.textForGaugeMinMax(s.gauge_max, !0) : '');
            }
        }),
        ...
        (l.prototype.getClipPath = function(t) {
            return (
                'url(' +
                (0 <= window.navigator.appVersion.toLowerCase().indexOf('msie 9.') ? '' : document.URL.split('#')[0]) +
                '#' +
                t +
                ')'
            );
            ...
            return function(t) {
                ...
                return (
                    n[i] instanceof Function
                        ...
                        : n[i]
                        ? (e = n[i])
                        : (o.indexOf(i) < 0 && o.push(i), (e = r[o.indexOf(i) % r.length]), (n[i] = e)),
        ...
        (l.prototype.loadConfig = function(e) {
            ...
            Object.keys(a).forEach(function(t) {
                (i = e),
                    ...
                    (r = (function t() {
                        var e = n.shift();
                        return e && i && 'object' === s(i) && e in i ? ((i = i[e]), t()) : e ? void 0 : i;
                    })()),
                    k(r) && (a[t] = r);
            });
        }),
        ...
        (l.prototype.convertJsonToData = function(e, t) {
            var r,
                ...
                o = [];
            return t
                ? (t.x ? ((r = t.value.concat(t.x)), (a.config.data_x = t.x)) : (r = t.value),
                  o.push(r),
        ...
        (l.prototype.findValueInJson = function(t, e) {
            for (
                var i = (e = (e = e.replace(/\[(\w+)\]/g, '.$1')).replace(/^\./, '')).split('.'), n = 0;
                n < i.length;
                ++n
            ) {
                var r = i[n];
                ...
                i.forEach(function(i) {
                    ...
                    c.isCustomX() || c.isTimeSeries()
                        ? 0 <= r.indexOf(e)
                            ...
                            : L(d.data_xs) && (c.data.xs[i] = c.getXValuesOfXKey(e, c.data.targets))
                                    ...
                                    c.isCustomX() && c.isCategorized() && !v(n)
                                        ? (0 === o && 0 === e && (d.axis_x_categories = []),
                                          -1 === (i = d.axis_x_categories.indexOf(n)) &&
                                              ((i = d.axis_x_categories.length), d.axis_x_categories.push(n)))
        ...
        (l.prototype.checkValueInTargets = function(t, e) {
            ...
            for (i = 0; i < a.length; i++)
                for (r = t[a[i]].values, n = 0; n < r.length; n++) if (e(r[n].value)) return !0;
            return !1;
        }),
        ...
        (l.prototype.findClosest = function(t, i) {
            ...
            return (
                t
                    ...
                    .forEach(function(t) {
                        var e = r.main
                            .select('.' + Y.bars + r.getTargetSelectorSuffix(t.id) + ' .' + Y.bar + '-' + t.index)
                            .node();
        ...
        (l.prototype.convertValuesToStep = function(t) {
            ...
            return (
                ...
                (i[t.length + 1] = { x: i[t.length].x + 1, value: i[t.length].value, id: i[t.length].id }),
                i
            );
        }),
        ...
        (l.prototype.loadFromArgs = function(e) {
            ...
            e.data
                ...
                : e.url
                ? i.convertUrlToData(e.url, e.mimeType, e.headers, e.keys, function(t) {
                ...
                (t = t.filter(function(t) {
                    ...
                    ? (i.svg
                      ...
                      t.forEach(function(e) {
                          (i.withoutFadeIn[e] = !1),
                              i.legend &&
                                  i.legend.selectAll('.' + Y.legendItem + i.getTargetSelectorSuffix(e)).remove(),
            ...
            return (
                ...
                0 === _.length
                    ...
                    : (isNaN(m) && (m = 0),
                      ...
                      void 0 !== w && ((S = w + (s = Math.max(Math.abs(m), Math.abs(S)))), (m = w - s)),
                      A
        ...
        (l.prototype.getXDomainPadding = function(t) {
            ...
            return (
                ...
                'object' === s(a.axis_x_padding) && L(a.axis_x_padding)
                    ...
                    : (n = r = 'number' == typeof a.axis_x_padding ? a.axis_x_padding : i),
                { left: n, right: r }
            );
        }),
        ...
        (l.prototype.updateXGrid = function(t) {
            ...
            (e.xgridAttr = i.axis_rotated
                ...
                (e.xgridAttr.opacity = function() {
                    return +n.select(this).attr(i.axis_rotated ? 'y1' : 'x1') === (i.axis_rotated ? e.height : 0)
                        ? 0
                        : 1;
                });
            var o = e.main
        ...
        (l.prototype.updateGrid = function(t) {
            ...
            a.grid.style('visibility', a.hasArcType() ? 'hidden' : 'visible'),
                ...
                a.ygridLines
                    ...
                    .transition()
                    .duration(t)
                    .attr('x', s.axis_rotated ? a.xGridTextX.bind(a) : a.yGridTextX.bind(a))
                    .attr('y', d)
                    .text(function(t) {
                        return t.text;
                    })
        ...
        (l.prototype.redrawGrid = function(t, e) {
            ...
            return [
                (t ? a.transition(e) : a)
                    ...
                    .style('opacity', 1),
                (t ? o.transition(e) : o)
                    .attr('x', n.axis_rotated ? i.yGridTextX.bind(i) : i.xGridTextX.bind(i))
                    .attr('y', r)
                    .text(function(t) {
                        return t.text;
                    })
        ...
        (l.prototype.generateGridData = function(t, e) {
            var i,
                ...
                s = this.main
                    ...
                    .size();
            if ('year' === t)
                for (n = (i = this.getXDomain())[0].getFullYear(), r = i[1].getFullYear(), a = n; a <= r; a++)
                ...
                ? function(e) {
                      ...
                      return (
                          [].concat(t).forEach(function(t) {
                              (('value' in t && e.value === t.value) || ('class' in t && e.class === t.class)) &&
                                  (i = !0);
                          }),
                          i
                      );
        ...
        (l.prototype.removeGridLines = function(t, e) {
            ...
            this.main
                ...
                .style('opacity', 0)
                .remove(),
                e ? (i.grid_x_lines = i.grid_x_lines.filter(r)) : (i.grid_y_lines = i.grid_y_lines.filter(r));
        }),
        ...
        (l.prototype.redrawEventRect = function() {
            ...
            (t = r.width),
                ...
                r.main
                    .select('.' + Y.eventRects)
                    .style('cursor', o.zoom_enabled ? (o.axis_rotated ? 'ns-resize' : 'ew-resize') : null),
                r.eventRect
                    .attr('x', 0)
                    .attr('y', 0)
                    .attr('width', t)
                            ...
                            ? function() {
                                  ...
                                  r.dragging ||
                                      ...
                                      !r.mouseover ||
                                          ...
                                          (o.data_onmouseout.call(r.api, r.mouseover), (r.mouseover = void 0)),
                                      i
                                          ? ((n = (r.isScatterType(i) || !o.tooltip_grouped
                                                ? [i]
                                                : r.filterByX(t, i.x)
                                            ).map(function(t) {
                                                return r.addName(t);
                                            ...
                                            r.showXGridFocus(n),
                                            (r.isBarType(i.id) || r.dist(i, e) < o.point_sensitivity) &&
                                                (r.svg.select('.' + Y.eventRect).style('cursor', 'pointer'),
                                                r.mouseover || (o.data_onmouseover.call(r.api, i), (r.mouseover = i))))
                                          : s());
                              }
                            : null
                    )
                                  ...
                                  r.hasArcType(t) ||
                                      ...
                                      (i = r.findClosestFromTargets(t, e)) &&
                                          ...
                                          (r.isScatterType(i) || !o.data_selection_grouped
                                              ...
                                              r.main
                                                  .selectAll('.' + Y.shapes + r.getTargetSelectorSuffix(t.id))
        ...
        (l.prototype.initLegend = function() {
            ...
            if (
                ...
                return t.legend.style('visibility', 'hidden'), void (t.hiddenLegendIds = t.mapToIds(t.data.targets));
            ...
            var i = this,
                ...
                r = {
                    top: i.isLegendTop
                        ...
                        : i.currentHeight - t - i.getCurrentPaddingBottom() - n.legend_inset_y,
                    left: i.isLegendLeft
                        ? i.getCurrentPaddingLeft() + n.legend_inset_x + 0.5
                        : i.currentWidth - e - i.getCurrentPaddingRight() - n.legend_inset_x + 0.5,
                };
            i.margin3 = {
        ...
        (l.prototype.getLegendHeight = function() {
            ...
            return (
                t.config.legend_show &&
                    (e = t.isLegendRight ? t.currentHeight : Math.max(20, t.legendItemHeight) * (t.legendStep + 1)),
                e
            );
        }),
        ...
        (l.prototype.hideLegend = function(t) {
            var e = this,
                i = e.config;
            i.legend_show && u(t) && ((i.legend_show = !1), e.legend.style('visibility', 'hidden')),
        ...
        (l.prototype.updateLegend = function(f, t, e) {
                ...
                var n,
                    ...
                    d =
                        ...
                        m.legendItemTextBox[o] ||
                            (m.legendItemTextBox[o] = m.getTextRect(a.textContent, Y.legendItem, a)),
                        m.legendItemTextBox[o]),
                ...
                s && (A = b = O = L = 0),
                    !S.legend_show || m.isLegendToShow(e)
                        ? ((V[e] = l),
                          ...
                          (!b || b <= l) && (b = l),
                          (!A || A <= u) && (A = u),
                          (r = m.isLegendRight || m.isLegendInset ? A : b),
                          S.legend_equally
            ...
            (f = f.filter(function(t) {
                ...
                m.isLegendInset && ((O = S.legend_inset_step ? S.legend_inset_step : f.length), m.updateLegendStep(O)),
                (a = m.isLegendRight
                    ? ((i = function(t) {
                          return b * I[t];
                      }),
                ...
                (u = m.legend
                    ...
                    .on('click', function(t) {
                        S.legend_item_onclick
                            ...
                            : (m.api.toggle(t), m.isTargetToShow(t) ? m.api.focus(t) : m.api.revert());
                    })
                    ...
                    .on('mouseout', function(t) {
                        S.legend_item_onmouseout
                            ...
                            : (m.d3.select(this).classed(Y.legendItemFocused, !1), m.api.revert());
                    }))
                    .append('text')
                    .text(function(t) {
        ...
        (l.prototype.updateScales = function() {
            ...
            (e.xMin = t.axis_rotated ? 1 : 0),
                ...
                (e.subY = e.getY(e.subYMin, e.subYMax, i ? t.axis_y_default : e.subY.domain())),
                (e.subY2 = e.getY(e.subYMin, e.subYMax, i ? t.axis_y2_default : e.subY2.domain())),
        ...
        (l.prototype.toggleShape = function(t, e, i) {
            ...
            a.data_selection_enabled &&
                ...
                (a.data_selection_multiple ||
                    n.main
                        .selectAll('.' + Y.shapes + (a.data_selection_grouped ? n.getTargetSelectorSuffix(e.id) : ''))
                        .selectAll('.' + Y.shape)
                        .each(function(t, e) {
                            var i = r.select(this);
        ...
        (l.prototype.getBars = function(t, e) {
            return (e ? this.main.selectAll('.' + Y.bars + this.getTargetSelectorSuffix(e)) : this.main).selectAll(
                '.' + Y.bar + (P(t) ? '-' + t : '')
            );
        }),
        ...
        (l.prototype.generateGetBarPoints = function(t, e) {
            ...
            return function(t, e) {
                var i = h.call(o, t.id)(0),
                    ...
                    a = d(t);
                return (
                    o.config.axis_rotated && ((0 < t.value && a < i) || (t.value < 0 && i < a)) && (a = i),
                    [
                        [r + u, n],
                        [r + u, a - (i - n)],
                        [r + s - u, a - (i - n)],
        ...
        (l.prototype.getShapeIndices = function(t) {
            var e,
                ...
                a = 0;
            return (
                this.filterTargetsToShow(this.data.targets.filter(t, this)).forEach(function(t) {
            ...
            return (
                n.isTargetToShow(e.id)
                    ? 'circle' === t.nodeName
                        ...
                        : 'path' === t.nodeName && (i = !r.classed(Y.bar) || n.isWithinBar(n.d3.mouse(t), t))
                    : (i = !1),
                i
            );
        }),
        ...
        (l.prototype.updateTargetsForLine = function(t) {
            ...
            (e = i.main
                ...
                t.forEach(function(e) {
                    i.main
                        .selectAll('.' + Y.selectedCircles + i.getTargetSelectorSuffix(e.id))
        ...
        (l.prototype.generateDrawLine = function(t, o) {
            var s = this,
                ...
                n = function(t, e) {
                    return 0 < c.data_groups.length ? i(t, e)[0][1] : l.call(s, t.id)(t.value);
                };
            return (
                    ...
                    return (
                        (s.isLineType(t)
                            ? c.data_regions[t.id]
                                ...
                                : (s.isStepType(t) && (e = s.convertValuesToStep(e)), d.curve(s.getInterpolate(t))(e))
                            : (e[0] && ((r = i(e[0].x)), (a = n(e[0].value))),
                              c.axis_rotated ? 'M ' + a + ' ' + r : 'M ' + r + ' ' + a)) || 'M 0 0'
                    );
                }
            );
        }),
        (l.prototype.generateGetLinePoints = function(t, e) {
            ...
            return function(t, e) {
                var i = u.call(o, t.id)(0),
                    ...
                    a = d(t);
                return (
                    s.axis_rotated && ((0 < t.value && a < i) || (t.value < 0 && i < a)) && (a = i),
                    [
                        [r, a - (i - n)],
                        [r, a - (i - n)],
                        [r, a - (i - n)],
            ...
            if (k(e))
                for (i = 0; i < e.length; i++)
                    (m[i] = {}),
                        v(e[i].start)
                            ? (m[i].start = t[0].x)
                            : (m[i].start = f.isTimeSeries() ? f.parseDate(e[i].start) : e[i].start),
                        v(e[i].end)
                            ? (m[i].end = t[t.length - 1].x)
                            : (m[i].end = f.isTimeSeries() ? f.parseDate(e[i].end) : e[i].end);
            function w(t) {
        ...
        (l.prototype.generateDrawArea = function(t, e) {
            var r = this,
                ...
                c = function(t, e) {
                    return 0 < a.data_groups.length ? i(t, e)[0][1] : n.call(r, t.id)(r.getAreaBaseValue(t.id));
                },
                d = function(t, e) {
                    return 0 < a.data_groups.length ? i(t, e)[1][1] : n.call(r, t.id)(t.value);
                };
            return (
                (o = a.axis_rotated
                    ? o
                ...
                function(t) {
                    ...
                    return (
                        (r.isAreaType(t)
                            ? (r.isStepType(t) && (e = r.convertValuesToStep(e)), o.curve(r.getInterpolate(t))(e))
                            : (e[0] && ((i = r.x(e[0].x)), (n = r.getYScale(t.id)(e[0].value))),
                              a.axis_rotated ? 'M ' + n + ' ' + i : 'M ' + i + ' ' + n)) || 'M 0 0'
                    );
                }
            );
        }),
        ...
        (l.prototype.updateCircle = function(t, e) {
            var i = this,
                ...
                r = n
                    ...
                    .style('fill', i.color);
            (i.mainCircle = r.merge(n).style('opacity', i.initialOpacityForCircle.bind(i))),
        ...
        (l.prototype.getCircles = function(t, e) {
            return (e ? this.main.selectAll('.' + Y.circles + this.getTargetSelectorSuffix(e)) : this.main).selectAll(
                '.' + Y.circle + (P(t) ? '-' + t : '')
            );
        }),
                        ...
                        ? ('x' === t &&
                              ...
                              (n =
                                  ...
                                  e.axis.getMaxTickWidth(t) *
                                      Math.cos((Math.PI * (90 - Math.abs(i.axis_x_tick_rotate))) / 180)),
                          'y' === t &&
                              i.axis_rotated &&
                              ...
                              (n =
                                  30 +
                                  e.axis.getMaxTickWidth(t) *
                                      Math.cos((Math.PI * (90 - Math.abs(i.axis_y_tick_rotate))) / 180)),
                          n + (e.axis.getLabelPositionById(t).isInner ? 0 : 10) + ('y2' === t ? -10 : 0))
                ...
                (r.brush.selectionAsValue = function(t, e) {
                    ...
                    return t
                        ? (r.context &&
                              ...
                              r.brush.move(n, i)),
                          [])
                        : ((i = r.brush.selection() || [0, 0]), [this.scale.invert(i[0]), this.scale.invert(i[1])]);
                }),
        ...
        (l.prototype.updateTargetsForSubchart = function(t) {
            ...
            s.subchart_show &&
                ...
                o
                    ...
                    .attr(s.axis_rotated ? 'width' : 'height', s.axis_rotated ? a.width2 : a.height2));
        }),
        ...
        (l.prototype.redrawBarForSubchart = function(t, e, i) {
            (e ? this.contextBar.transition(Math.random().toString()).duration(i) : this.contextBar)
                .attr('d', t)
                .style('opacity', 1);
        }),
        ...
        (l.prototype.redrawLineForSubchart = function(t, e, i) {
            (e ? this.contextLine.transition(Math.random().toString()).duration(i) : this.contextLine)
                .attr('d', t)
                .style('opacity', 1);
        }),
        ...
        (l.prototype.redrawAreaForSubchart = function(t, e, i) {
            (e ? this.contextArea.transition(Math.random().toString()).duration(i) : this.contextArea)
                .attr('d', t)
                .style('fill', this.color)
                .style('opacity', this.orgAreaOpacity);
        }),
        ...
        (l.prototype.redrawForBrush = function() {
            ...
            e.redraw({
                ...
                e.main
                    .select('.' + Y.eventRect)
                    .call(e.zoom.transform, n.zoomIdentity.scale(e.width / (t[1] - t[0])).translate(-t[0], 0)),
                e.config.subchart_onbrush.call(e.api, i.orgDomain());
        }),
        (l.prototype.transformContext = function(t, e) {
            var i;
            e && e.axisSubX ? (i = e.axisSubX) : ((i = this.context.select('.' + Y.axisX)), t && (i = i.transition())),
        ...
        (l.prototype.getXForText = function(t, e, i) {
            ...
            return (
                (n = a.config.axis_rotated
                    ...
                    ? (t[2][0] + t[0][0]) / 2
                    : t[0][0]),
                null === e.value && (n > a.width ? (n = a.width - o.width) : n < 0 && (n = 4)),
                n
            );
        }),
                ...
                r.config.axis_rotated
                    ...
                    : ((n = t[2][1]),
                      e.value < 0 || (0 === e.value && !r.hasPositiveValue)
                          ? ((n += a.height),
                            r.isBarType(e) && r.isSafari() ? (n -= 3) : !r.isBarType(e) && r.isChrome() && (n += 3))
                          : (n += r.isBarType(e) ? -3 : -6)),
                null !== e.value ||
                    r.config.axis_rotated ||
                    (n < a.height ? (n = a.height) : n > this.height && (n = this.height - 4)),
                n
            );
        }),
        ...
        (l.prototype.xForTitle = function() {
            ...
            return 0 <= i.indexOf('right')
                ? t.currentWidth -
                      t.getTextRect(t.title.node().textContent, t.CLASS.title, t.title.node()).width -
                      e.title_padding.right
                : 0 <= i.indexOf('center')
                ? (t.currentWidth - t.getTextRect(t.title.node().textContent, t.CLASS.title, t.title.node()).width) / 2
        ...
        (l.prototype.yForTitle = function() {
            ...
            return (
                ...
                t.getTextRect(t.title.node().textContent, t.CLASS.title, t.title.node()).height
            );
        }),
            ...
            if (
                ...
                if (e.isTimeSeries() && c(i.tooltip_init_x)) {
                    for (
                        ...
                        t < e.data.targets[0].values.length && e.data.targets[0].values[t].x - i.tooltip_init_x != 0;
                        t++
                    );
                    i.tooltip_init_x = t;
                }
            ...
            for (f && t.sort(f), a = 0; a < t.length; a++)
                if (
                    ...
                    (c = _(g(t[a].name, t[a].ratio, t[a].id, t[a].index))),
                        ...
                        (r += "<tr class='" + l.CLASS.tooltipName + '-' + l.getTargetSelectorSuffix(t[a].id) + "'>"),
        ...
        (l.prototype.tooltipPosition = function(t, e, i, n) {
            ...
            return (
                h
                    ? ((a = (d.width - (d.isLegendRight ? d.getLegendWidth() : 0)) / 2 + g[0]),
                    ...
                    : ((r = d.getSvgLeft(!0)),
                      (s = l.axis_rotated
                          ? ((o = (a = r + g[0] + 100) + e),
                            ...
                            d.x(t[0].x) + 20)
                          : ((o = (a = r + d.getCurrentPaddingLeft(!0) + d.x(t[0].x) + 20) + e),
        ...
        (l.prototype.showTooltip = function(t, e) {
            ...
            0 !== c.length &&
                o.tooltip_show &&
                (a.tooltip
                    .html(o.tooltip_contents.call(a, t, a.axis.getXAxisTickFormat(), a.getYFormat(s), a.color))
                    .style('display', 'block'),
        ...
        (l.prototype.isLineType = function(t) {
            ...
            return (
                !e.data_types[i] ||
                0 <= ['line', 'spline', 'area', 'area-spline', 'step', 'area-step'].indexOf(e.data_types[i])
            );
        }),
        ...
        (l.prototype.initZoom = function() {
            ...
            return (
                ...
                (i.zoom.updateDomain = function() {
                    return (
                        n.event && n.event.transform && i.x.domain(n.event.transform.rescaleX(i.subX).domain()), this
                    );
                }),
