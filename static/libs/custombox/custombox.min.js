                ...
                _createClass(e, [
                    {
                        key: 'remove',
                        value: function() {
                            document.documentElement.classList.remove(t + '-perspective'),
                    ...
                    },
                    {
                        ...
                        value: function() {
                            for (
                                ...
                                this.element.classList.contains(t + '-' + r[n]) &&
                                    this.element.classList.remove(t + '-' + r[n]);
                            ...
                            if (
                                (u.check(a, this.options.content.effect)
                                    ...
                                    : (e.insertRule(
                                          '.' +
                                              t +
                                              '-overlay { animation: CloseFade ' +
                                              this.options.overlay.speedOut +
                                              'ms; }',
                                          0
                                      ),
                                      e.insertRule(
                            ...
                            return new Promise(function(n, o) {
                                ...
                                if (s && 11 == s[2].length) {
                                    ...
                                    if (
                                        ...
                                        e.options.content.width &&
                                            window.innerWidth > h &&
                                            ((a = Math.round((a * h) / c)), (c = h)),
                                    ...
                                    d.open('GET', e.options.content.target),
                                        (d.onload = function() {
                                            if (200 === d.status) {
                                                ...
                                                e.options.content.width &&
                                                    (t.style.flexBasis = e.options.content.width),
                                                    n();
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            !this.options.content.clone &&
                                ...
                                this.reference.parentNode.insertBefore(
                                    this.element.childNodes[0],
                                    this.reference.nextSibling
                                ),
                    ...
                    [
                                                ...
                                                e.options.overlay.active
                                                    ? (e.dispatchEvent('overlay.onOpen'),
                                                      e.overlay.bind(n).then(function() {
                                                          e.dispatchEvent('overlay.onComplete'),
                                ...
                                this.options.overlay.active &&
                                    t.push(
                                        this.overlay.bind(o).then(function() {
                                            e.scroll && e.scroll.remove(),
                                                e.overlay.remove(),
                                                e.dispatchEvent('overlay.onClose');
                                        })
                                    ),
                                    this.container &&
                                        t.push(
                                    ...
                                    Promise.all(t).then(function() {
                                        e.options.content.close &&
                                            document.removeEventListener('keydown', e.action, !0),
                        ...
                        },
                        {
                            ...
                            value: function() {
                                var e = this,
                                    n = window
                                        .getComputedStyle(this.content.element)
                                        .getPropertyValue('animation-fill-mode');
                                document.addEventListener(
                                    'fullscreenchange',
                                    function() {
                                        window
                                            .getComputedStyle(e.content.element)
                                            .getPropertyValue('animation-fill-mode') === n
