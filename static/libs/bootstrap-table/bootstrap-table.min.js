...
(function(e, t) {
            ...
            function e(e, t) {
                ...
                try {
                    for (
                        ...
                        !(i = (s = l.next()).done) && (o.push(s.value), !(t && o.length === t));
                        i = !0
                    );
                } catch (e) {
                    (a = !0), (n = e);
    ...
    (function(n) {
                ...
                setFieldIndex: function(e) {
                    for (
                        var t = 0,
                            ...
                            n = Array.isArray(a),
                            s = 0,
                            _iterator2 = n ? a : a[Symbol.iterator]();
                        ;
                    ...
                    for (var y = 0; y < e.length; y++)
                        for (var p = e[y], c = Array.isArray(p), h = 0, _iterator3 = c ? p : p[Symbol.iterator](); ; ) {
                            var g;
                            if (c) {
                                if (h >= p.length) break;
                                g = p[h++];
                ...
                calculateObjectValue: function(e, o, i, n) {
                    ...
                    if ('string' == typeof o) {
                        ...
                        if (1 < h.length) {
                            s = window;
                            for (
                                var l = h, r = Array.isArray(l), d = 0, _iterator4 = r ? l : l[Symbol.iterator]();
                                ;
                    ...
                    return null !== s && 'object' === ('undefined' == typeof s ? 'undefined' : a(s))
                        ? s
                        : 'function' == typeof s
                        ? s.apply(e, i || [])
                        : !s && 'string' == typeof o && this.sprintf.apply(this, [o].concat(t(i)))
                        ? this.sprintf.apply(this, [o].concat(t(i)))
                        : n;
                },
                ...
                getRealDataAttr: function(e) {
                    for (
                        var t = (function(e) {
                            ...
                            o = Array.isArray(t),
                            a = 0,
                            _iterator6 = o ? t : t[Symbol.iterator]();
                        ;
                ...
                getItemField: function(e, t, o) {
                    ...
                    for (
                        var a = t.split('.'),
                            ...
                            s = Array.isArray(n),
                            l = 0,
                            _iterator7 = s ? n : n[Symbol.iterator]();
                        ;
                ...
                o(t, [
                    ...
                    },
                    {
                        ...
                        value: function() {
                            if (this.options.locale) {
                                var e = n.fn.bootstrapTable.locales,
                                    t = this.options.locale.split(/-|_/);
                                (t[0] = t[0].toLowerCase()),
                                    t[1] && (t[1] = t[1].toUpperCase()),
                                    e[this.options.locale]
                                        ? n.extend(this.options, e[this.options.locale])
                                        : e[t.join('-')]
                                        ? n.extend(this.options, e[t.join('-')])
                                        : e[t[0]] && n.extend(this.options, e[t[0]]);
                            }
                        },
                    },
                    {
                        ...
                        value: function() {
                            var e =
                                    -1 === ['top', 'both'].indexOf(this.options.paginationVAlign)
                                        ? ''
                                        : '<div class="fixed-table-pagination clearfix"></div>',
                                t =
                                    -1 === ['bottom', 'both'].indexOf(this.options.paginationVAlign)
                                        ? ''
                            ...
                            (this.$container = n(
                                ...
                                (this.$toolbar = this.options.buttonsToolbar
                                    ? n('body').find(this.options.buttonsToolbar)
                                    : this.$container.find('.fixed-table-toolbar')),
                                ...
                                this.options.height &&
                                    ...
                                    -1 !== this.options.classes.split(' ').indexOf('table-bordered') &&
                        ...
                        value: function() {
                            ...
                            if (
                                ...
                                this.$header.length
                                    ...
                                    : (this.$header = n(
                                          '<thead class="' + this.options.theadClasses + '"></thead>'
                                      ).appendTo(this.$el)),
                                this.$header.find('tr').each(function(e, t) {
                                    var a = [];
                                    n(t)
                                        .find('th')
                                        .each(function(e, t) {
                                            'undefined' != typeof n(t).data('field') &&
                                                n(t).data('field', '' + n(t).data('field')),
                                                a.push(
                                                    n.extend(
                                                        {},
                                                        {
                                                            ...
                                                            rowspan: n(t).attr('rowspan')
                                                                ? +n(t).attr('rowspan')
                                                                : void 0,
                                                            colspan: n(t).attr('colspan')
                                                                ? +n(t).attr('colspan')
                                                                : void 0,
                                                        },
                                                        n(t).data()
                                ...
                                (this.options.columns = n.extend(!0, [], o, this.options.columns)),
                                (this.columns = []),
                                (this.fieldsColumnsIndex = []),
                                r.setFieldIndex(this.options.columns),
                                this.options.columns.forEach(function(o, a) {
                                ...
                                this.$el.find('>tbody>tr').each(function(t, o) {
                                    var s = {};
                                    (s._id = n(o).attr('id')),
                                        (s._class = n(o).attr('class')),
                                        (s._data = r.getRealDataAttr(n(o).data())),
                                        n(o)
                                            .find('>td')
                                            .each(function(o, i) {
                                                for (
                                                    var l = +n(i).attr('colspan') || 1,
                                                        d = +n(i).attr('rowspan') || 1,
                                                        p = o;
                                                    a[t] && a[t][p];
                                                    p++
                                                );
                                                for (var h = p; h < p + l; h++)
                                                    for (var g = t; g < t + d; g++) a[g] || (a[g] = []), (a[g][h] = !0);
                                                var c = e.columns[p].field;
                                                (s[c] = n(i)
                                                    .html()
                                                    .trim()),
                                                    (s['_' + c + '_id'] = n(i).attr('id')),
                                                    (s['_' + c + '_class'] = n(i).attr('class')),
                                                    (s['_' + c + '_rowspan'] = n(i).attr('rowspan')),
                                                    (s['_' + c + '_colspan'] = n(i).attr('colspan')),
                                                    (s['_' + c + '_title'] = n(i).attr('title')),
                                                    (s['_' + c + '_data'] = r.getRealDataAttr(n(i).data()));
                                            }),
                                        i.push(s);
                                }),
                                    (this.options.data = i),
                                    i.length && (this.fromHtml = !0);
                            }
                        },
                    },
                    {
                        ...
                        value: function() {
                            ...
                            (this.header = {
                                    ...
                                    o.push('<tr>'),
                                        ...
                                        a.forEach(function(i, a) {
                                            ...
                                            if (
                                                ...
                                                i.width &&
                                                    'string' == typeof i.width &&
                                                    (g = i.width.replace('%', '').replace('px', '')),
                                                (l = r.sprintf('text-align: %s; ', i.halign ? i.halign : i.align)),
                                                (d = r.sprintf('text-align: %s; ', i.align)),
                                                (p = r.sprintf('vertical-align: %s; ', i.valign)),
                                                (p += r.sprintf(
                                                    'width: %s; ',
                                                    (i.checkbox || i.radio) && !g
                                                        ? i.showSelectTitle
                                                            ? void 0
                                                            : '36px'
                                                        : g
                                                ...
                                                'undefined' != typeof i.fieldIndex)
                                            ) {
                                                if (
                                                    ((t.header.fields[i.fieldIndex] = i.field),
                                                    (t.header.styles[i.fieldIndex] = d + p),
                                                    (t.header.classes[i.fieldIndex] = c),
                                            ...
                                            o.push(
                                                '<th' + r.sprintf(' title="%s"', i.titleTooltip),
                                                i.checkbox || i.radio
                                                    ? r.sprintf(' class="bs-checkbox %s"', i['class'] || '')
                                                    : c,
                                                r.sprintf(' style="%s"', l + p),
                                                r.sprintf(' rowspan="%s"', i.rowspan),
                                                r.sprintf(' colspan="%s"', i.colspan),
                                                r.sprintf(' data-field="%s"', i.field),
                                                0 === a && 0 < n ? ' data-not-first-th' : '',
                                                '>'
                                            ),
                                                o.push(
                                                    r.sprintf(
                                                        '<div class="th-inner %s">',
                                                        t.options.sortable && i.sortable ? 'sortable both' : ''
                                                    )
                                                ),
                                                (s = t.options.escape ? r.escapeHTML(i.title) : i.title);
                                            var u = s;
                                            i.checkbox &&
                                                ((s = ''),
                                ...
                                this.$container.off('click', '.th-inner').on('click', '.th-inner', function(o) {
                                    ...
                                    return t.options.detailView &&
                                        !e.parent().hasClass('bs-checkbox') &&
                                        e.closest('.bootstrap-table')[0] !== t.$container[0]
                                        ? !1
                                        : void (t.options.sortable && e.parent().data().sortable && t.onSort(o));
                                }),
                                this.$header
                                    .children()
                                    .children()
                                    .off('keypress')
                                    .on('keypress', function(o) {
                                        if (t.options.sortable && n(o.currentTarget).data().sortable) {
                                            var e = o.keyCode || o.which;
                                            13 === e && t.onSort(o);
                                        }
                                    }),
                                n(window).off('resize.bootstrap-table'),
                                !this.options.showHeader || this.options.cardView
                                    ...
                                    : (this.$header.show(),
                                      ...
                                      this.getCaret(),
                                      n(window).on('resize.bootstrap-table', n.proxy(this.resetWidth, this))),
                        ...
                        value: function() {
                            ...
                            -1 !== i &&
                                ...
                                this.options.customSort
                                    ? r.calculateObjectValue(this.options, this.options.customSort, [
                                    ...
                                    : this.data.sort(function(s, a) {
                                          ...
                                          var l = r.getItemField(s, t, e.options.escape),
                                              d = r.getItemField(a, t, e.options.escape),
                                              p = r.calculateObjectValue(e.header, e.header.sorters[i], [l, d, s, a]);
                                          return void 0 === p
                                              ? ((void 0 === l || null === l) && (l = ''),
                                                (void 0 === d || null === d) && (d = ''),
                                                e.options.sortStable &&
                                                    l === d &&
                                                    ((l = s._position), (d = a._position)),
                                                n.isNumeric(l) && n.isNumeric(d))
                                                  ? ((l = parseFloat(l)),
                                                    (d = parseFloat(d)),
                                                    l < d ? -1 * o : l > d ? o : 0)
                                                  : l === d
                                                  ...
                                                  : ('string' != typeof l && (l = l.toString()),
                                                    -1 === l.localeCompare(d) ? -1 * o : o)
                                              : e.options.sortStable && 0 === p
                                              ? o * (s._position - a._position)
                                              : o * p;
                                      }),
                        ...
                        value: function(e) {
                            ...
                            return (
                                ...
                                this.options.sortName === i.data('field')
                                    ? (this.options.sortOrder = 'asc' === this.options.sortOrder ? 'desc' : 'asc')
                                    : ((this.options.sortName = i.data('field')),
                                      (this.options.sortOrder = this.options.rememberOrder
                                          ? 'asc' === i.data('order')
                                              ? 'desc'
                                              : 'asc'
                                          : this.columns[this.fieldsColumnsIndex[i.data('field')]].order)),
                                this.trigger('sort', this.options.sortName, this.options.sortOrder),
                                i.add(a).data('order', this.options.sortOrder),
                                this.getCaret(),
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            this.$toolbar.find('.bs-bars').children().length &&
                                n('body').append(n(this.options.toolbar)),
                                this.$toolbar.html(''),
                                ('string' == typeof this.options.toolbar || 'object' === a(this.options.toolbar)) &&
                                    n(
                                        r.sprintf(
                                ...
                                'string' == typeof this.options.icons &&
                                    (this.options.icons = r.calculateObjectValue(null, this.options.icons)),
                                this.options.showPaginationSwitch &&
                                    t.push(
                                        r.sprintf(
                                            '<button class="btn' +
                                                r.sprintf(' btn-%s', this.options.buttonsClass) +
                                                r.sprintf(' btn-%s', this.options.iconSize) +
                                ...
                                this.options.showColumns &&
                                    ...
                                    t.push(l.html.toobarDropdow[1], '</div>')),
                                t.push('</div>'),
                                (this.showToolbar || 2 < t.length) && this.$toolbar.append(t.join('')),
                                this.options.showPaginationSwitch &&
                                    this.$toolbar
                                        .find('button[name="paginationSwitch"]')
                                        .off('click')
                                        .on('click', n.proxy(this.togglePagination, this)),
                                this.options.showFullscreen &&
                                    this.$toolbar
                                        .find('button[name="fullscreen"]')
                                        .off('click')
                                        .on('click', n.proxy(this.toggleFullscreen, this)),
                                this.options.showRefresh &&
                                    this.$toolbar
                                        .find('button[name="refresh"]')
                                        .off('click')
                                        .on('click', n.proxy(this.refresh, this)),
                                this.options.showToggle &&
                                    this.$toolbar
                                ...
                                this.options.showColumns &&
                                    ...
                                    d <= this.options.minimumCountColumns && i.find('input').prop('disabled', !0),
                                    i
                                        .find('li')
                                        .off('click')
                                        .on('click', function(t) {
                                    ...
                                    i
                                        ...
                                        .on('click', function(t) {
                                            var o = t.currentTarget,
                                                i = n(o);
                                            e.toggleColumn(i.val(), i.prop('checked'), !1),
                                                e.trigger('column-switch', i.data('field'), i.prop('checked'));
                                        })),
                                this.options.search &&
                                    ((t = []),
                                    t.push(
                                        ...
                                        r.sprintf(
                                            '<input class="form-control' +
                                                r.sprintf(' input-%s', this.options.iconSize) +
                                    ...
                                    (s = this.$toolbar.find('.search input')),
                                    s.off('keyup drop blur').on('keyup drop blur', function(t) {
                                        (e.options.searchOnEnterKey && 13 !== t.keyCode) ||
                                            -1 !== [37, 38, 39, 40].indexOf(t.keyCode) ||
                                            (clearTimeout(o),
                                    ...
                                    r.isIEBrowser() &&
                                        s.off('mouseup').on('mouseup', function(t) {
                                            clearTimeout(o),
                                                (o = setTimeout(function() {
                                                    e.onSearch(t);
                                                }, e.options.searchTimeOut));
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            var t = e.currentTarget,
                                ...
                                i = n.trim(n(t).val());
                            this.options.trimOnSearch && n(t).val() !== i && n(t).val(i),
                                i === this.searchText ||
                                    ((this.searchText = i),
                                    (this.options.searchText = i),
                                    !o && (this.options.pageNumber = 1),
                                    this.initSearch(),
                                    o
                                        ? 'client' === this.options.sidePagination && this.updatePagination()
                        ...
                        value: function() {
                            ...
                            if ('server' !== this.options.sidePagination) {
                                if (this.options.customSearch)
                                    return void (this.data = r.calculateObjectValue(
                                        this.options,
                                ...
                                (this.data = o
                                    ? this.options.data.filter(function(e) {
                                          for (var t in o)
                                              if (
                                                  (Array.isArray(o[t]) && -1 === o[t].indexOf(e[t])) ||
                                                  (!Array.isArray(o[t]) && e[t] !== o[t])
                                              )
                                                  return !1;
                                          return !0;
                                      })
                                        ...
                                        ? this.data.filter(function(o, a) {
                                              for (var c = 0; c < e.header.fields.length; c++)
                                                  if (e.header.searchables[c]) {
                                                      var i = n.isNumeric(e.header.fields[c])
                                                              ? parseInt(e.header.fields[c], 10)
                                                              : e.header.fields[c],
                                                          s = e.columns[e.fieldsColumnsIndex[i]],
                                                          l = void 0;
                                                      if ('string' == typeof i) {
                                                          l = o;
                                                      ...
                                                      if (
                                                          (s &&
                                                              s.searchFormatter &&
                                                              (l = r.calculateObjectValue(
                                                                  s,
                                                                  e.header.formatters[c],
                                                                  [l, o, a],
                                                                  l
                                                              )),
                                                          ...
                                                          } else if (-1 !== ('' + l).toLowerCase().indexOf(t))
                                                              return !0;
                                                  }
                                              return !1;
                                          })
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            if (
                                ('server' !== this.options.sidePagination && (this.options.totalRows = u.length),
                                (this.totalPages = 0),
                                this.options.totalRows)
                            ) {
                                if (this.options.pageSize === this.options.formatAllRows())
                                    (this.options.pageSize = this.options.totalRows), (a = !0);
                            ...
                            if (
                                ...
                                var $ = [
                                    ...
                                    a ? this.options.formatAllRows() : this.options.pageSize,
                                    '</span>',
                                    ' <span class="caret"></span>',
                                    '</button>',
                                ...
                                if ('string' == typeof this.options.pageList) {
                                    ...
                                    for (
                                        var b = P,
                                            m = Array.isArray(b),
                                            y = 0,
                                            _iterator9 = m ? b : b[Symbol.iterator]();
                                        ;
                                        ...
                                        var k = w;
                                        f.push(
                                            k.toUpperCase() === this.options.formatAllRows().toUpperCase() ||
                                                'UNLIMITED' === k.toUpperCase()
                                ...
                                f.forEach(function(e, o) {
                                    if (!t.options.smartDisplay || 0 === o || f[o - 1] < t.options.totalRows) {
                                        var i;
                                        (i = a
                                            ? e === t.options.formatAllRows()
                                                ? 'active'
                                                : ''
                                            : e === t.options.pageSize
                                            ? 'active'
                                            : ''),
                                            $.push(r.sprintf(l.html.pageDropdownItem, i, e));
                                    }
                                }),
                                    $.push(l.html.pageDropdown[1] + '</span>'),
                                    o.push(this.options.formatRecordsPerPage($.join(''))),
                                    o.push('</span>'),
                                    o.push(
                                        '</div>',
                                        r.sprintf(
                                        ...
                                        '<ul class="pagination' +
                                            r.sprintf(' pagination-%s', this.options.iconSize) +
                                            '">',
                                        r.sprintf(
                                    ...
                                    this.totalPages < this.options.paginationSuccessivelySize
                                        ? ((i = 1), (d = this.totalPages))
                                        : ((i = this.options.pageNumber - this.options.paginationPagesBySide),
                                          (d = i + 2 * this.options.paginationPagesBySide)),
                                    this.options.pageNumber < this.options.paginationSuccessivelySize - 1 &&
                                        (d = this.options.paginationSuccessivelySize),
                                    d > this.totalPages && (d = this.totalPages),
                                    this.options.paginationSuccessivelySize > this.totalPages - i &&
                                        (i = i - (this.options.paginationSuccessivelySize - (this.totalPages - i)) + 1),
                                    1 > i && (i = 1),
                                    d > this.totalPages && (d = this.totalPages);
                                var v = e(this.options.paginationPagesBySide / 2),
                                    x = function(e) {
                                        var o = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : '';
                                        return (
                                            '\n          <li class="page-item' +
                                            o +
                                            (e === t.options.pageNumber ? ' active' : '') +
                                ...
                                if (1 < i) {
                                    ...
                                    i - 1 === C + 1
                                        ? ((s = i - 1), o.push(x(s)))
                                        : i - 1 > C &&
                                          (i - 2 * this.options.paginationPagesBySide >
                                              this.options.paginationPagesBySide &&
                                          this.options.paginationUseIntermediate
                                              ? ((s = e((i - v) / 2 + v)), o.push(x(s, ' page-intermediate')))
                                              : o.push(
                                    ...
                                    for (
                                        d >= T && (T = d + 1),
                                            d + 1 === T - 1
                                                ? ((s = d + 1), o.push(x(s)))
                                                : T > d + 1 &&
                                                  (this.totalPages - d > 2 * this.options.paginationPagesBySide &&
                                                  this.options.paginationUseIntermediate
                                                      ? ((s = e((this.totalPages - v - d) / 2 + d)),
                                                        o.push(x(s, ' page-intermediate')))
                                                      : o.push(
                            ...
                            this.$pagination.html(o.join('')),
                                this.options.onlyInfoPagination ||
                                    ((p = this.$pagination.find('.page-list a')),
                                    (c = this.$pagination.find('.page-pre')),
                                    (h = this.$pagination.find('.page-next')),
                                    (g = this.$pagination.find('.page-item').not('.page-next, .page-pre')),
                                    this.options.smartDisplay &&
                                        (1 >= this.totalPages && this.$pagination.find('div.pagination').hide(),
                                        (2 > f.length || this.options.totalRows <= f[0]) &&
                                            this.$pagination.find('span.page-list').hide(),
                                        this.$pagination[this.getData().length ? 'show' : 'hide']()),
                                    !this.options.paginationLoop &&
                                        (1 === this.options.pageNumber && c.addClass('disabled'),
                                        this.options.pageNumber === this.totalPages && h.addClass('disabled')),
                                    a && (this.options.pageSize = this.options.formatAllRows()),
                                    p.off('click').on('click', n.proxy(this.onPageListChange, this)),
                                    c.off('click').on('click', n.proxy(this.onPagePre, this)),
                                    h.off('click').on('click', n.proxy(this.onPageNext, this)),
                                    g.off('click').on('click', n.proxy(this.onPageNumber, this)));
                        },
                    },
                    {
                        key: 'updatePagination',
                        value: function(e) {
                            (e && n(e.currentTarget).hasClass('disabled')) ||
                        ...
                        value: function(e) {
                            ...
                            return (
                                ...
                                (this.options.pageSize =
                                    t.text().toUpperCase() === this.options.formatAllRows().toUpperCase()
                                        ? this.options.formatAllRows()
                                        : +t.text()),
                    ...
                    },
                    {
                        key: 'onPageNumber',
                        value: function(e) {
                            if ((e.preventDefault(), this.options.pageNumber !== +n(e.currentTarget).text()))
                                return (
                                    (this.options.pageNumber = +n(e.currentTarget).text()), this.updatePagination(e), !1
                                );
                        },
                    },
                    {
                        ...
                        value: function(e, t) {
                            ...
                            if (!(-1 < r.findIndex(this.hiddenRows, e))) {
                                if (
                                    ((s = r.calculateObjectValue(this.options, this.options.rowStyle, [e, t], s)),
                                    s && s.css)
                                )
                                    for (
                                        var h = (function(e) {
                                            ...
                                            g = Array.isArray(h),
                                            u = 0,
                                            _iterator10 = g ? h : h[Symbol.iterator]();
                                        ;
                                ...
                                if (
                                    ((p = r.calculateObjectValue(this.options, this.options.rowAttributes, [e, t], p)),
                                    p)
                                )
                                    for (
                                        var x = (function(e) {
                                            ...
                                            S = Array.isArray(x),
                                            $ = 0,
                                            _iterator11 = S ? x : x[Symbol.iterator]();
                                        ;
                                ...
                                if (e._data && !n.isEmptyObject(e._data))
                                    for (
                                        var R = (function(e) {
                                                return Object.keys(e).map(function(t) {
                                                    return [t, e[t]];
                                            ...
                                            I = Array.isArray(R),
                                            _ = 0,
                                            _iterator12 = I ? R : R[Symbol.iterator]();
                                        ;
                                ...
                                return (
                                    a.push(
                                        '<tr',
                                        r.sprintf(' %s', c.length ? c.join(' ') : void 0),
                                        r.sprintf(' id="%s"', Array.isArray(e) ? void 0 : e._id),
                                        r.sprintf(' class="%s"', s.classes || (Array.isArray(e) ? void 0 : e._class)),
                                        ' data-index="' + t + '"',
                                        r.sprintf(' data-uniqueid="%s"', e[this.options.uniqueId]),
                                        r.sprintf('%s', d),
                                        '>'
                                    ),
                                    this.options.cardView &&
                                        a.push(
                                            '<td colspan="' + this.header.fields.length + '"><div class="card-views">'
                                        ),
                                    !this.options.cardView &&
                                        this.options.detailView &&
                                        (a.push('<td>'),
                                        r.calculateObjectValue(null, this.options.detailFilter, [t, e]) &&
                                            a.push(
                                        ...
                                        a.push('</td>')),
                                    this.header.fields.forEach(function(d, p) {
                                        var h = '',
                                            g = r.getItemField(e, d, o.options.escape),
                                            u = '',
                                            f = '',
                                            b = {},
                                            m = '',
                                            ...
                                            $ = o.columns[p];
                                        if (
                                            (!o.fromHtml || 'undefined' != typeof g || $.checkbox || $.radio) &&
                                            $.visible &&
                                            (!o.options.cardView || $.cardVisible)
                                        ) {
                                            if (
                                                ($.escape && (g = r.escapeHTML(g)),
                                                l.concat([o.header.styles[p]]).length &&
                                                    (w = ' style="' + l.concat([o.header.styles[p]]).join('; ') + '"'),
                                                e['_' + d + '_id'] && (m = r.sprintf(' id="%s"', e['_' + d + '_id'])),
                                                e['_' + d + '_class'] &&
                                                    (y = r.sprintf(' class="%s"', e['_' + d + '_class'])),
                                                e['_' + d + '_rowspan'] &&
                                                    (v = r.sprintf(' rowspan="%s"', e['_' + d + '_rowspan'])),
                                                e['_' + d + '_colspan'] &&
                                                    (x = r.sprintf(' colspan="%s"', e['_' + d + '_colspan'])),
                                                e['_' + d + '_title'] &&
                                                    (S = r.sprintf(' title="%s"', e['_' + d + '_title'])),
                                                (b = r.calculateObjectValue(
                                                    o.header,
                                                    o.header.cellStyles[p],
                                                    [g, e, t, d],
                                                    b
                                                )),
                                                b.classes && (y = ' class="' + b.classes + '"'),
                                                b.css)
                                            ) {
                                                for (
                                                    var P = [],
                                                        ...
                                                        T = Array.isArray(C),
                                                        O = 0,
                                                        _iterator13 = T ? C : C[Symbol.iterator]();
                                                    ;
                                            ...
                                            if (
                                                ((u = r.calculateObjectValue(
                                                    $,
                                                    o.header.formatters[p],
                                                    [g, e, t, d],
                                                    g
                                                )),
                                                e['_' + d + '_data'] && !n.isEmptyObject(e['_' + d + '_data']))
                                            )
                                                for (
                                                    var F = (function(e) {
                                                            return Object.keys(e).map(function(t) {
                                                        ...
                                                        B = Array.isArray(F),
                                                        N = 0,
                                                        _iterator14 = B ? F : F[Symbol.iterator]();
                                                    ;
                                            ...
                                            if ($.checkbox || $.radio) {
                                                ...
                                                (h = [
                                                    o.options.cardView
                                                        ? '<div class="card-view ' + z + '">'
                                                        : '<td class="bs-checkbox ' + z + '">',
                                                    '<input\n              data-index="' +
                                                        t +
                                                        '"\n              name="' +
                                                        ...
                                                        ' />',
                                                    o.header.formatters[p] && 'string' == typeof u ? u : '',
                                                    o.options.cardView ? '</div>' : '</td>',
                                                ].join('')),
                                                    (e[o.header.stateField] = !0 === u || !!g || (u && u.checked));
                                            } else if (
                                                ((u =
                                                    'undefined' == typeof u || null === u
                                                        ? o.options.undefinedText
                                                        : u),
                                                o.options.cardView)
                                            ) {
                                                var q = o.options.showHeader
                                                    ? '<span class="title"' +
                                                      s +
                                                      '>' +
                                                      r.getFieldTitle(o.columns, d) +
                                                      '</span>'
                                                    : '';
                                                (h =
                                                    '<div class="card-view">' +
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            this.trigger('pre-body', o),
                                ...
                                this.$body.length || (this.$body = n('<tbody></tbody>').appendTo(this.$el)),
                                (this.options.pagination && 'server' !== this.options.sidePagination) ||
                                    ((this.pageFrom = 1), (this.pageTo = o.length));
                            for (
                                var a = n(document.createDocumentFragment()), s = !1, l = this.pageFrom - 1;
                                l < this.pageTo;
                                l++
                            ) {
                                var d = o[l],
                                    p = this.initRow(d, l, o, a);
                            ...
                            s
                                ...
                                this.$body
                                    ...
                                    .on('click dblclick', function(e) {
                                        var o = e.currentTarget,
                                            ...
                                            s = n(o),
                                            l = s.parent(),
                                            d = t.data[l.data('index')],
                                            p = s[0].cellIndex,
                                            c = t.getVisibleFields(),
                                            h = c[t.options.detailView && !t.options.cardView ? p - 1 : p],
                                            g = t.columns[t.fieldsColumnsIndex[h]],
                                            u = r.getItemField(d, h, t.options.escape);
                                        if (
                                            !s.find('.detail-icon').length &&
                                            (t.trigger('click' === i ? 'click-cell' : 'dbl-click-cell', h, u, d, s),
                                            t.trigger('click' === i ? 'click-row' : 'dbl-click-row', d, l, h),
                                            'click' === i &&
                                                t.options.clickToSelect &&
                                                g.clickToSelect &&
                                                !t.options.ignoreClickToSelectOn(a))
                                        ) {
                                        ...
                                        if (a.next().is('tr.detail-view'))
                                            e
                                                ...
                                                .attr(
                                                    ...
                                                    r.sprintf(
                                                        '%s %s',
                                                        t.options.iconsPrefix,
                                                        t.options.icons.detailOpen
                                                    )
                                                ),
                                                t.trigger('collapse-row', s, l, a.next()),
                                                a.next().remove();
                                        else {
                                            e
                                                .find('i')
                                            ...
                                            var d = a.next().find('td'),
                                                p = r.calculateObjectValue(
                                                    t.options,
                                                    t.options.detailFormatter,
                                                    [s, l, d],
                                                    ''
                                                );
                                ...
                                (this.$selectItem = this.$body.find(
                                    r.sprintf('[name="%s"]', this.options.selectItemName)
                                )),
                                this.$selectItem.off('click').on('click', function(o) {
                                ...
                                this.header.events.forEach(function(e, o) {
                                    ...
                                    if (a) {
                                        ...
                                        var s = t.header.fields[o],
                                            l = t.getVisibleFields().indexOf(s);
                                        if (-1 !== l) {
                                            ...
                                            for (
                                                var d = function() {
                                                        ...
                                                        t.$body.find('>tr:not(.no-records-found)').each(function(e, o) {
                                                            var i = n(o),
                                                                d = i
                                                                    .find(t.options.cardView ? '.card-view' : 'td')
                                                                    .eq(l),
                                                                p = a.indexOf(' '),
                                                                c = a.substring(0, p),
                                                                h = a.substring(p + 1);
                                                    ...
                                                    c = Array.isArray(p),
                                                    h = 0,
                                                    _iterator15 = c ? p : p[Symbol.iterator]();
                                                ;
                    ...
                    },
                    {
                        ...
                        value: function(e, t, o) {
                            ...
                            if (
                                (this.header.sortNames[s] && (l.sortName = this.header.sortNames[s]),
                                ...
                                ('limit' === this.options.queryParamsType &&
                                    ((l = { search: l.searchText, sort: l.sortName, order: l.sortOrder }),
                                    this.options.pagination &&
                                        'server' === this.options.sidePagination &&
                                        ((l.offset =
                                            this.options.pageSize === this.options.formatAllRows()
                                ...
                                n.isEmptyObject(this.filterColumnsPartial) ||
                                    (l.filter = JSON.stringify(this.filterColumnsPartial, null)),
                                (a = r.calculateObjectValue(this.options, this.options.queryParams, [l], a)),
                                n.extend(a, t || {}),
                                !1 !== a)
                            ) {
                                ...
                                var d = n.extend({}, r.calculateObjectValue(null, this.options.ajaxOptions), {
                                    ...
                                    error: function(t) {
                                        ...
                                        'server' === i.options.sidePagination &&
                                            ((o = {}), (o[i.options.totalField] = 0), (o[i.options.dataField] = [])),
                                            i.load(o),
                                            i.trigger('load-error', t.status, t),
                                            e || i.$tableLoading.hide();
                                    },
                                });
                                this.options.ajax
                                    ? r.calculateObjectValue(this, this.options.ajax, [d], null)
                        ...
                        value: function() {
                            if (this.options.search && ((this.searchText = ''), '' !== this.options.searchText)) {
                                ...
                                e.val(this.options.searchText),
                                    this.onSearch({ currentTarget: e, firedByInitSearchText: !0 });
                            }
                        },
                    },
                    {
                        ...
                        value: function() {
                            ...
                            this.$header.find('th').each(function(t, o) {
                                n(o)
                                    ...
                                    .addClass(n(o).data('field') === e.options.sortName ? e.options.sortOrder : 'both');
                            });
                        },
                    },
                    {
                        ...
                        value: function() {
                            ...
                            this.$selectAll.add(this.$selectAll_).prop('checked', e),
                                this.$selectItem.each(function(e, t) {
                                    n(t)
                                        .closest('tr')
                                        [n(t).prop('checked') ? 'addClass' : 'removeClass']('selected');
                                });
                        },
                    },
                    {
                        ...
                        value: function() {
                            for (
                                var e = this.data,
                                    t = Array.isArray(e),
                                    o = 0,
                                    _iterator16 = t ? e : e[Symbol.iterator]();
                                ;
                                ...
                                this.$selectAll.prop('checked', !1),
                                    ...
                                    this.header.stateField && (a[this.header.stateField] = !1);
                            }
                            this.initHiddenRows();
                        },
                    },
                    {
                        ...
                        value: function(e) {
                            for (
                                var o, i = e + '.bs.table', a = arguments.length, s = Array(1 < a ? a - 1 : 0), l = 1;
                                l < a;
                                l++
                            )
                                s[l - 1] = arguments[l];
                            (o = this.options)[t.EVENTS[i]].apply(o, s),
                                this.$el.trigger(n.Event(i), s),
                                this.options.onAll(i, s),
                                this.$el.trigger(n.Event('all.bs.table'), [i, s]);
                        },
                    },
                    {
                        key: 'resetHeader',
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            if (this.$el.is(':hidden'))
                                return void (this.timeoutId_ = setTimeout(n.proxy(this.fitHeader, this), 100));
                            var t = this.$tableBody.get(0),
                                o =
                                    t.scrollWidth > t.clientWidth &&
                                    t.scrollHeight > t.clientHeight + this.$header.outerHeight()
                                        ? r.getScrollBarWidth()
                                        : 0;
                            ...
                            0 < a.length && (a.focus(), this.$header.find('.focus-temp').removeClass('focus-temp')),
                                this.$header.find('th[data-field]').each(function(t, o) {
                                    e.$header_
                                        .find(r.sprintf('th[data-field="%s"]', n(o).data('field')))
                                        .data(n(o).data());
                                });
                            for (
                                var s = this.getVisibleFields(),
                                    l = this.$header_.find('th'),
                                    d = this.$body.find('>tr:first-child:not(.no-records-found)');
                                d.length && d.find('>td[colspan]:not([colspan="1"])').length;
                            ...
                            if (this.options.showFooter && !this.options.cardView) {
                                ...
                                for (
                                    var o = this.columns,
                                        a = Array.isArray(o),
                                        n = 0,
                                        _iterator17 = a ? o : o[Symbol.iterator]();
                                    ;
                                    ...
                                    if (l.visible) {
                                        ...
                                        if (
                                            ((d = r.sprintf('text-align: %s; ', l.falign ? l.falign : l.align)),
                                            (p = r.sprintf('vertical-align: %s; ', l.valign)),
                                            (h = r.calculateObjectValue(null, this.options.footerStyle, [l])),
                                            h && h.css)
                                        )
                                            for (
                                                var u = (function(e) {
                                                    ...
                                                    f = Array.isArray(u),
                                                    b = 0,
                                                    _iterator18 = f ? u : u[Symbol.iterator]();
                                                ;
                                        ...
                                        h &&
                                            ...
                                            t.push(
                                                '<th',
                                                g,
                                                r.sprintf(' style="%s"', d + p + c.concat().join('; ')),
                                                '>'
                                            ),
                        ...
                        value: function() {
                            ...
                            for (
                                var i = this.getVisibleFields(),
                                    a = this.$tableFooter.find('th'),
                                    s = this.$body.find('>tr:first-child:not(.no-records-found)');
                                s.length && s.find('>td[colspan]:not([colspan="1"])').length;
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            this.trigger('scroll-body'),
                                this.$tableBody.off('scroll').on('scroll', function(t) {
                                    var o = t.currentTarget;
                                    e.options.showHeader &&
                                        e.options.height &&
                                        e.$tableHeader.scrollLeft(n(o).scrollLeft()),
                                        e.options.showFooter &&
                                            !e.options.cardView &&
                                            e.$tableFooter.scrollLeft(n(o).scrollLeft());
                                });
                        },
                    },
                    {
                        ...
                        value: function(e, t, o) {
                            if (
                                ...
                                o && i.filter(r.sprintf('[value="%s"]', e)).prop('checked', t),
                                    i.filter(':checked').length <= this.options.minimumCountColumns &&
                    ...
                    },
                    {
                        ...
                        value: function() {
                            for (
                                var e = [],
                                    t = this.header.fields,
                                    o = Array.isArray(t),
                                    i = 0,
                                    _iterator19 = o ? t : t[Symbol.iterator]();
                                ;
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            var t = 0;
                            if (
                                (e && e.height && (this.options.height = e.height),
                                this.$selectAll.prop(
                                    'checked',
                                    0 < this.$selectItem.length &&
                            ...
                            if (
                                ...
                                this.options.showFooter &&
                                    (this.resetFooter(), this.options.height && (t += this.$tableFooter.outerHeight())),
                                this.options.height)
                            ) {
                                ...
                                this.$tableContainer.css('height', a + 'px'),
                                    this.$tableBorder && this.$tableBorder.css('height', a - n - t - 1 + 'px');
                            }
                            this.getCaret(),
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            this.options.pagination &&
                                'server' === this.options.sidePagination &&
                                (this.options.totalRows = o[this.options.totalField]),
                                (t = o.fixedScroll),
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            if (e.hasOwnProperty('field') && e.hasOwnProperty('values')) {
                                for (o = t - 1; 0 <= o; o--)
                                    ((i = this.options.data[o]), !!i.hasOwnProperty(e.field)) &&
                                        -1 !== e.values.indexOf(i[e.field]) &&
                                        (this.options.data.splice(o, 1),
                        ...
                        value: function(e) {
                            for (
                                var t = Array.isArray(e) ? e : [e],
                                    ...
                                    i = Array.isArray(o),
                                    a = 0,
                                    _iterator20 = i ? o : o[Symbol.iterator]();
                                ;
                        ...
                        value: function(e) {
                            if (
                                ...
                                t.find('th[data-field]').each(function(t, o) {
                                    if (n(o).data('field') === e.field)
                                        return n(n(o).find('.th-inner')[0]).text(e.title), !1;
                                });
                            }
                        },
                    },
                    {
                        ...
                        value: function(e) {
                            e.hasOwnProperty('index') &&
                                ...
                                (this.options.data.splice(e.index, 0, e.row),
                                this.initSearch(),
                                this.initPagination(),
                                this.initSort(),
                                this.initBody(!0));
                        ...
                        value: function(e) {
                            for (
                                var t = Array.isArray(e) ? e : [e],
                                    ...
                                    i = Array.isArray(o),
                                    a = 0,
                                    _iterator21 = i ? o : o[Symbol.iterator]();
                                ;
                                ...
                                l.hasOwnProperty('index') &&
                                    ...
                                    n.extend(this.options.data[l.index], l.row);
                            }
                            this.initSearch(), this.initPagination(), this.initSort(), this.initBody(!0);
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            ...
                            if (
                                (e.hasOwnProperty('index')
                                    ? (o = this.getData()[e.index])
                                    : e.hasOwnProperty('uniqueId') && (o = this.getRowByUniqueId(e.uniqueId)),
                                !!o)
                            ) {
                                var i = r.findIndex(this.hiddenRows, o);
                                t || -1 !== i ? t && -1 < i && this.hiddenRows.splice(i, 1) : this.hiddenRows.push(o),
                                    this.initBody(!0);
                            }
                        },
                    },
                        ...
                        value: function(e) {
                            ...
                            for (
                                var t = this.getData(),
                                    ...
                                    a = Array.isArray(i),
                                    n = 0,
                                    _iterator22 = a ? i : i[Symbol.iterator]();
                                ;
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            e.hasOwnProperty('index') &&
                                ...
                                ((this.data[e.index][e.field] = e.value),
                            ...
                            if (e.hasOwnProperty('id') && e.hasOwnProperty('field') && e.hasOwnProperty('value')) {
                                ...
                                o.forEach(function(e) {
                                    var o = e.id,
                                        i = e.field,
                                        a = e.value,
                                        n = t.options.data.indexOf(t.getRowByUniqueId(o));
                                    -1 === n || (t.data[n][i] = a);
                                }),
                                    !1 === e.reinit || (this.initSort(), this.initBody(!0));
                            }
                            ...
                            if (o.is(':radio') || this.options.singleSelect) {
                                for (
                                    var a = this.options.data,
                                        n = Array.isArray(a),
                                        s = 0,
                                        _iterator23 = n ? a : a[Symbol.iterator]();
                                    ;
                            ...
                            if (t.hasOwnProperty('field') && t.hasOwnProperty('values')) {
                                ...
                                this.options.data.forEach(function(n, s) {
                                    ...
                                    if (-1 !== t.values.indexOf(n[t.field])) {
                                        var i = o.$selectItem
                                            .filter(':enabled')
                                            .filter(r.sprintf('[data-index="%s"]', s))
                                            .prop('checked', e);
                    ...
                    },
                    {
                        ...
                        value: function() {
                            this.$el.insertBefore(this.$container),
                                n(this.options.toolbar).insertBefore(this.$el),
                        ...
                        value: function(e) {
                            for (
                                var t = this.columns,
                                    o = Array.isArray(t),
                                    i = 0,
                                    _iterator24 = o ? t : t[Symbol.iterator]();
                                ;
                            ...
                            if (
                                ...
                                s.filter(':checked').length <= this.options.minimumCountColumns &&
                    ...
                    },
                    {
                        key: 'filterBy',
                        value: function(e) {
                            (this.filterColumns = n.isEmptyObject(e) ? {} : e),
                                (this.options.pageNumber = 1),
                                this.initSearch(),
                                this.updatePagination();
                        },
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            this.options.cardView
                                ? (e.removeClass(this.options.icons.toggleOff), e.addClass(this.options.icons.toggleOn))
                                : (e.removeClass(this.options.icons.toggleOn),
                                  e.addClass(this.options.icons.toggleOff)),
                                this.initBody(),
                    ...
                    },
                    {
                        key: 'refreshOptions',
                        value: function(e) {
                            r.compareObjects(this.options, e, !0) ||
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            if (e) {
                                    ...
                                    (o.next().is('tr.detail-view')
                                        ? !o
                                          ...
                                          (o
                                              ...
                                              .click(),
                                          (s = !0))
                                        : (o.find('> td > .detail-icon').click(), (s = !0)),
                                    s)
                                )
                                    try {
                                ...
                                for (var d = this.$body.children(), p = 0; p < d.length; p++)
                                    this.expandRow_(!0, n(d[p]).data('index'));
                        },
                    },
                    {
                        key: 'collapseAllRows',
                        value: function(e) {
                            if (e) this.expandRow_(!1, 0);
                                ...
                                for (var t = this.$body.children(), o = 0; o < t.length; o++)
                                    this.expandRow_(!1, n(t[o]).data('index'));
                        },
                    },
                    {
                        key: 'updateFormatText',
                        value: function(e, t) {
                            this.options[r.sprintf('format%s', e)] &&
                                ('string' == typeof t
                                    ? (this.options[r.sprintf('format%s', e)] = function() {
                                          return t;
                                      })
        ...
        (n.BootstrapTable = c),
            (n.fn.bootstrapTable = function(e) {
            ...
            (n.fn.bootstrapTable.Constructor = c),
            (n.fn.bootstrapTable.defaults = c.DEFAULTS),
            (n.fn.bootstrapTable.columnDefaults = c.COLUMN_DEFAULTS),
            (n.fn.bootstrapTable.locales = c.LOCALES),
            (n.fn.bootstrapTable.methods = h),
            (n.fn.bootstrapTable.utils = r),
            n(function() {
