        ...
        function(t, e, r) {
            ...
            var n = (function() {
                ...
                i = function t(e, r) {
                    ...
                    var l = new Error(a);
                    return (l.name = 'ParseError'), (l.__proto__ = t.prototype), (l.position = n), l;
                };
            ...
            var m = function t(e) {
                ...
                y = [1, 1, 3, 3, 5, 5, 7, 7],
                b = [0, 1, 2, 3, 2, 3, 2, 3],
                w = { DISPLAY: p[0], TEXT: p[2], SCRIPT: p[4], SCRIPTSCRIPT: p[6] },
                k = [
                    {
                        name: 'latin',
                        blocks: [
            ...
            var M = {
                ...
                N = function(t) {
                    ...
                    for (var a in (r && (e += ' style="' + c.escape(r) + '"'), this.attributes))
                ...
                I = (function() {
                    function t(t, e, r, n, a, i, o, s) {
                        ...
                        h && this.classes.push(h + '_fallback'),
                            /[\xee\xef\xed\xec]/.test(this.text) && (this.text = O[this.text]);
                    }
                    var e = t.prototype;
                    return (
                        (e.hasClass = function(t) {
                        ...
                        (e.toNode = function() {
                            ...
                            for (var r in (this.italic > 0 &&
                                ((e = document.createElement('span')).style.marginRight = this.italic + 'em'),
                            this.classes.length > 0 &&
                                ((e = e || document.createElement('span')).className = A(this.classes)),
                            this.style))
                                this.style.hasOwnProperty(r) &&
                                    ((e = e || document.createElement('span')).style[r] = this.style[r]);
                        ...
                        (e.toMarkup = function() {
                            var t = !1,
                                e = '<span';
                            this.classes.length &&
                                ((t = !0), (e += ' class="'), (e += c.escape(A(this.classes))), (e += '"'));
                            var r = '';
                        ...
                        (e.toNode = function() {
                            ...
                            return (
                                this.alternate
                                    ...
                                    : t.setAttribute('d', M.path[this.pathName]),
                                t
                            );
                        }),
                        (e.toMarkup = function() {
            ...
            function V(t, e, r) {
                if (!H[e]) throw new Error('Font metrics not found for font: ' + e + '.');
                var n = t.charCodeAt(0);
                t[0] in F && (n = F[t[0]].charCodeAt(0));
                var a = H[e][n];
                if ((a || 'text' !== r || (z(n) && (a = H[e][77])), a))
            ...
            function W(t, e, r, n, a, i) {
                (Y[t][a] = { font: e, group: r, replace: n }), i && n && (Y[t][n] = Y[t][a]);
            }
            var j = 'main',
                $ = 'ams',
                Z = 'bin',
            ...
            W('math', j, Q, '\u2261', '\\equiv', !0),
                ...
                W('math', j, Q, '\u22c8', '\\bowtie', !0),
                W('math', j, Q, '\u2323', '\\smile', !0),
                W('math', j, Q, '\u2291', '\\sqsubseteq', !0),
                W('math', j, Q, '\u2292', '\\sqsupseteq', !0),
                W('math', j, Q, '\u2250', '\\doteq', !0),
                W('math', j, Q, '\u2322', '\\frown', !0),
                W('math', j, Q, '\u220b', '\\ni', !0),
                W('math', j, Q, '\u221d', '\\propto', !0),
                ...
                W('math', j, Q, '\u22a3', '\\dashv', !0),
                W('math', j, Q, '\u220b', '\\owns'),
                W('math', j, 'punct', '.', '\\ldotp'),
                W('math', j, 'punct', '\u22c5', '\\cdotp'),
                W('math', j, 'textord', '#', '\\#'),
                W('text', j, 'textord', '#', '\\#'),
                W('math', j, 'textord', '&', '\\&'),
                W('text', j, 'textord', '&', '\\&'),
                W('math', j, 'textord', '\u2135', '\\aleph', !0),
                W('math', j, 'textord', '\u2200', '\\forall', !0),
                W('math', j, 'textord', '\u210f', '\\hbar', !0),
                W('math', j, 'textord', '\u2203', '\\exists', !0),
                W('math', j, 'textord', '\u2207', '\\nabla', !0),
                W('math', j, 'textord', '\u266d', '\\flat', !0),
                W('math', j, 'textord', '\u2113', '\\ell', !0),
                W('math', j, 'textord', '\u266e', '\\natural', !0),
                W('math', j, 'textord', '\u2663', '\\clubsuit', !0),
                W('math', j, 'textord', '\u2118', '\\wp', !0),
                W('math', j, 'textord', '\u266f', '\\sharp', !0),
                W('math', j, 'textord', '\u2662', '\\diamondsuit', !0),
                W('math', j, 'textord', '\u211c', '\\Re', !0),
                W('math', j, 'textord', '\u2661', '\\heartsuit', !0),
                W('math', j, 'textord', '\u2111', '\\Im', !0),
                W('math', j, 'textord', '\u2660', '\\spadesuit', !0),
                W('text', j, 'textord', '\xa7', '\\S', !0),
                W('text', j, 'textord', '\xb6', '\\P', !0),
                W('math', j, 'textord', '\u2020', '\\dag'),
                W('text', j, 'textord', '\u2020', '\\dag'),
                W('text', j, 'textord', '\u2020', '\\textdagger'),
                W('math', j, 'textord', '\u2021', '\\ddag'),
                W('text', j, 'textord', '\u2021', '\\ddag'),
                W('text', j, 'textord', '\u2021', '\\textdaggerdbl'),
                W('math', j, 'close', '\u23b1', '\\rmoustache', !0),
                W('math', j, 'open', '\u23b0', '\\lmoustache', !0),
                W('math', j, 'close', '\u27ef', '\\rgroup', !0),
                W('math', j, 'open', '\u27ee', '\\lgroup', !0),
                W('math', j, Z, '\u2213', '\\mp', !0),
                W('math', j, Z, '\u2296', '\\ominus', !0),
                W('math', j, Z, '\u228e', '\\uplus', !0),
                W('math', j, Z, '\u2293', '\\sqcap', !0),
                ...
                W('math', j, Z, '\u2a3f', '\\amalg'),
                W('math', j, Z, '&', '\\And'),
                W('math', j, Q, '\u27f5', '\\longleftarrow', !0),
                W('math', j, Q, '\u21d0', '\\Leftarrow', !0),
                W('math', j, Q, '\u27f8', '\\Longleftarrow', !0),
                W('math', j, Q, '\u27f6', '\\longrightarrow', !0),
                W('math', j, Q, '\u21d2', '\\Rightarrow', !0),
                W('math', j, Q, '\u27f9', '\\Longrightarrow', !0),
                W('math', j, Q, '\u2194', '\\leftrightarrow', !0),
                W('math', j, Q, '\u27f7', '\\longleftrightarrow', !0),
                W('math', j, Q, '\u21d4', '\\Leftrightarrow', !0),
                W('math', j, Q, '\u27fa', '\\Longleftrightarrow', !0),
                W('math', j, Q, '\u21a6', '\\mapsto', !0),
                W('math', j, Q, '\u27fc', '\\longmapsto', !0),
                W('math', j, Q, '\u2197', '\\nearrow', !0),
                W('math', j, Q, '\u21a9', '\\hookleftarrow', !0),
                W('math', j, Q, '\u21aa', '\\hookrightarrow', !0),
                W('math', j, Q, '\u2198', '\\searrow', !0),
                W('math', j, Q, '\u21bc', '\\leftharpoonup', !0),
                W('math', j, Q, '\u21c0', '\\rightharpoonup', !0),
                W('math', j, Q, '\u2199', '\\swarrow', !0),
                W('math', j, Q, '\u21bd', '\\leftharpoondown', !0),
                W('math', j, Q, '\u21c1', '\\rightharpoondown', !0),
                W('math', j, Q, '\u2196', '\\nwarrow', !0),
                W('math', j, Q, '\u21cc', '\\rightleftharpoons', !0),
                W('math', $, Q, '\u226e', '\\nless', !0),
                W('math', $, Q, '\ue010', '\\nleqslant'),
                W('math', $, Q, '\ue011', '\\nleqq'),
                W('math', $, Q, '\u2a87', '\\lneq', !0),
                ...
                W('math', $, Q, '\u22ea', '\\ntriangleleft'),
                W('math', $, Q, '\u22ec', '\\ntrianglelefteq', !0),
                W('math', $, Q, '\u228a', '\\subsetneq', !0),
                W('math', $, Q, '\ue01a', '\\varsubsetneq'),
                W('math', $, Q, '\u2acb', '\\subsetneqq', !0),
                W('math', $, Q, '\ue017', '\\varsubsetneqq'),
                W('math', $, Q, '\u226f', '\\ngtr', !0),
                W('math', $, Q, '\ue00f', '\\ngeqslant'),
                W('math', $, Q, '\ue00e', '\\ngeqq'),
                W('math', $, Q, '\u2a88', '\\gneq', !0),
                ...
                W('math', $, Q, '\u22ed', '\\ntrianglerighteq', !0),
                W('math', $, Q, '\ue018', '\\nsupseteqq'),
                W('math', $, Q, '\u228b', '\\supsetneq', !0),
                W('math', $, Q, '\ue01b', '\\varsupsetneq'),
                W('math', $, Q, '\u2acc', '\\supsetneqq', !0),
                W('math', $, Q, '\ue019', '\\varsupsetneqq'),
                W('math', $, Q, '\u22ae', '\\nVdash', !0),
                W('math', $, Q, '\u2ab5', '\\precneqq', !0),
                W('math', $, Q, '\u2ab6', '\\succneqq', !0),
                W('math', $, Q, '\ue016', '\\nsubseteqq'),
                ...
                W('math', $, Q, '\u21ae', '\\nleftrightarrow', !0),
                W('math', $, Q, '\u21ce', '\\nLeftrightarrow', !0),
                W('math', $, Q, '\u25b3', '\\vartriangle'),
                W('math', $, 'textord', '\u210f', '\\hslash'),
                W('math', $, 'textord', '\u25bd', '\\triangledown'),
                W('math', $, 'textord', '\u25ca', '\\lozenge'),
                W('math', $, 'textord', '\u24c8', '\\circledS'),
                W('math', $, 'textord', '\xae', '\\circledR'),
                W('text', $, 'textord', '\xae', '\\circledR'),
                W('math', $, 'textord', '\u2221', '\\measuredangle', !0),
                W('math', $, 'textord', '\u2204', '\\nexists'),
                W('math', $, 'textord', '\u2127', '\\mho'),
                W('math', $, 'textord', '\u2132', '\\Finv', !0),
                W('math', $, 'textord', '\u2141', '\\Game', !0),
                W('math', $, 'textord', 'k', '\\Bbbk'),
                W('math', $, 'textord', '\u2035', '\\backprime'),
                W('math', $, 'textord', '\u25b2', '\\blacktriangle'),
                W('math', $, 'textord', '\u25bc', '\\blacktriangledown'),
                W('math', $, 'textord', '\u25a0', '\\blacksquare'),
                W('math', $, 'textord', '\u29eb', '\\blacklozenge'),
                W('math', $, 'textord', '\u2605', '\\bigstar'),
                W('math', $, 'textord', '\u2222', '\\sphericalangle', !0),
                W('math', $, 'textord', '\u2201', '\\complement', !0),
                W('math', $, 'textord', '\xf0', '\\eth', !0),
                W('math', $, 'textord', '\u2571', '\\diagup'),
                W('math', $, 'textord', '\u2572', '\\diagdown'),
                W('math', $, 'textord', '\u25a1', '\\square'),
                W('math', $, 'textord', '\u25a1', '\\Box'),
                W('math', $, 'textord', '\u25ca', '\\Diamond'),
                W('math', $, 'textord', '\xa5', '\\yen', !0),
                W('text', $, 'textord', '\xa5', '\\yen', !0),
                W('math', $, 'textord', '\u2713', '\\checkmark', !0),
                W('text', $, 'textord', '\u2713', '\\checkmark'),
                W('math', $, 'textord', '\u2136', '\\beth', !0),
                W('math', $, 'textord', '\u2138', '\\daleth', !0),
                W('math', $, 'textord', '\u2137', '\\gimel', !0),
                W('math', $, 'textord', '\u03dd', '\\digamma'),
                W('math', $, 'textord', '\u03f0', '\\varkappa'),
                W('math', $, 'open', '\u250c', '\\ulcorner', !0),
                W('math', $, 'close', '\u2510', '\\urcorner', !0),
                W('math', $, 'open', '\u2514', '\\llcorner', !0),
                W('math', $, 'close', '\u2518', '\\lrcorner', !0),
                W('math', $, Q, '\u2266', '\\leqq', !0),
                W('math', $, Q, '\u2a7d', '\\leqslant', !0),
                W('math', $, Q, '\u2a95', '\\eqslantless', !0),
                W('math', $, Q, '\u2272', '\\lesssim', !0),
                W('math', $, Q, '\u2a85', '\\lessapprox', !0),
                W('math', $, Q, '\u224a', '\\approxeq', !0),
                W('math', $, Z, '\u22d6', '\\lessdot'),
                W('math', $, Q, '\u22d8', '\\lll', !0),
                W('math', $, Q, '\u2276', '\\lessgtr', !0),
                W('math', $, Q, '\u22da', '\\lesseqgtr', !0),
                W('math', $, Q, '\u2a8b', '\\lesseqqgtr', !0),
                W('math', $, Q, '\u2251', '\\doteqdot'),
                W('math', $, Q, '\u2253', '\\risingdotseq', !0),
                W('math', $, Q, '\u2252', '\\fallingdotseq', !0),
                W('math', $, Q, '\u223d', '\\backsim', !0),
                W('math', $, Q, '\u22cd', '\\backsimeq', !0),
                W('math', $, Q, '\u2ac5', '\\subseteqq', !0),
                W('math', $, Q, '\u22d0', '\\Subset', !0),
                W('math', $, Q, '\u228f', '\\sqsubset', !0),
                W('math', $, Q, '\u227c', '\\preccurlyeq', !0),
                W('math', $, Q, '\u22de', '\\curlyeqprec', !0),
                W('math', $, Q, '\u227e', '\\precsim', !0),
                W('math', $, Q, '\u2ab7', '\\precapprox', !0),
                W('math', $, Q, '\u22b2', '\\vartriangleleft'),
                W('math', $, Q, '\u22b4', '\\trianglelefteq'),
                W('math', $, Q, '\u22a8', '\\vDash', !0),
                W('math', $, Q, '\u22aa', '\\Vvdash', !0),
                W('math', $, Q, '\u2323', '\\smallsmile'),
                W('math', $, Q, '\u2322', '\\smallfrown'),
                ...
                W('math', $, Q, '\u2267', '\\geqq', !0),
                W('math', $, Q, '\u2a7e', '\\geqslant', !0),
                W('math', $, Q, '\u2a96', '\\eqslantgtr', !0),
                W('math', $, Q, '\u2273', '\\gtrsim', !0),
                W('math', $, Q, '\u2a86', '\\gtrapprox', !0),
                W('math', $, Z, '\u22d7', '\\gtrdot'),
                W('math', $, Q, '\u22d9', '\\ggg', !0),
                W('math', $, Q, '\u2277', '\\gtrless', !0),
                W('math', $, Q, '\u22db', '\\gtreqless', !0),
                W('math', $, Q, '\u2a8c', '\\gtreqqless', !0),
                W('math', $, Q, '\u2256', '\\eqcirc', !0),
                W('math', $, Q, '\u2257', '\\circeq', !0),
                W('math', $, Q, '\u225c', '\\triangleq', !0),
                W('math', $, Q, '\u223c', '\\thicksim'),
                W('math', $, Q, '\u2248', '\\thickapprox'),
                W('math', $, Q, '\u2ac6', '\\supseteqq', !0),
                W('math', $, Q, '\u22d1', '\\Supset', !0),
                W('math', $, Q, '\u2290', '\\sqsupset', !0),
                W('math', $, Q, '\u227d', '\\succcurlyeq', !0),
                W('math', $, Q, '\u22df', '\\curlyeqsucc', !0),
                W('math', $, Q, '\u227f', '\\succsim', !0),
                W('math', $, Q, '\u2ab8', '\\succapprox', !0),
                W('math', $, Q, '\u22b3', '\\vartriangleright'),
                W('math', $, Q, '\u22b5', '\\trianglerighteq'),
                W('math', $, Q, '\u22a9', '\\Vdash', !0),
                W('math', $, Q, '\u2223', '\\shortmid'),
                W('math', $, Q, '\u2225', '\\shortparallel'),
                W('math', $, Q, '\u226c', '\\between', !0),
                W('math', $, Q, '\u22d4', '\\pitchfork', !0),
                W('math', $, Q, '\u221d', '\\varpropto'),
                W('math', $, Q, '\u25c0', '\\blacktriangleleft'),
                W('math', $, Q, '\u2234', '\\therefore', !0),
                W('math', $, Q, '\u220d', '\\backepsilon'),
                W('math', $, Q, '\u25b6', '\\blacktriangleright'),
                W('math', $, Q, '\u2235', '\\because', !0),
                W('math', $, Q, '\u22d8', '\\llless'),
                W('math', $, Q, '\u22d9', '\\gggtr'),
                W('math', $, Z, '\u22b2', '\\lhd'),
                ...
                W('math', $, Q, '\u2251', '\\Doteq', !0),
                W('math', $, Z, '\u2214', '\\dotplus', !0),
                W('math', $, Z, '\u2216', '\\smallsetminus'),
                W('math', $, Z, '\u22d2', '\\Cap', !0),
                W('math', $, Z, '\u22d3', '\\Cup', !0),
                W('math', $, Z, '\u2a5e', '\\doublebarwedge', !0),
                W('math', $, Z, '\u229f', '\\boxminus', !0),
                W('math', $, Z, '\u229e', '\\boxplus', !0),
                W('math', $, Z, '\u22c7', '\\divideontimes', !0),
                W('math', $, Z, '\u22c9', '\\ltimes', !0),
                W('math', $, Z, '\u22ca', '\\rtimes', !0),
                W('math', $, Z, '\u22cb', '\\leftthreetimes', !0),
                W('math', $, Z, '\u22cc', '\\rightthreetimes', !0),
                W('math', $, Z, '\u22cf', '\\curlywedge', !0),
                W('math', $, Z, '\u22ce', '\\curlyvee', !0),
                W('math', $, Z, '\u229d', '\\circleddash', !0),
                W('math', $, Z, '\u229b', '\\circledast', !0),
                W('math', $, Z, '\u22c5', '\\centerdot'),
                W('math', $, Z, '\u22ba', '\\intercal', !0),
                W('math', $, Z, '\u22d2', '\\doublecap'),
                W('math', $, Z, '\u22d3', '\\doublecup'),
                W('math', $, Z, '\u22a0', '\\boxtimes', !0),
                W('math', $, Q, '\u21e2', '\\dashrightarrow', !0),
                W('math', $, Q, '\u21e0', '\\dashleftarrow', !0),
                W('math', $, Q, '\u21c7', '\\leftleftarrows', !0),
                W('math', $, Q, '\u21c6', '\\leftrightarrows', !0),
                W('math', $, Q, '\u21da', '\\Lleftarrow', !0),
                W('math', $, Q, '\u219e', '\\twoheadleftarrow', !0),
                W('math', $, Q, '\u21a2', '\\leftarrowtail', !0),
                W('math', $, Q, '\u21ab', '\\looparrowleft', !0),
                W('math', $, Q, '\u21cb', '\\leftrightharpoons', !0),
                W('math', $, Q, '\u21b6', '\\curvearrowleft', !0),
                W('math', $, Q, '\u21ba', '\\circlearrowleft', !0),
                W('math', $, Q, '\u21b0', '\\Lsh', !0),
                W('math', $, Q, '\u21c8', '\\upuparrows', !0),
                W('math', $, Q, '\u21bf', '\\upharpoonleft', !0),
                W('math', $, Q, '\u21c3', '\\downharpoonleft', !0),
                W('math', $, Q, '\u22b8', '\\multimap', !0),
                W('math', $, Q, '\u21ad', '\\leftrightsquigarrow', !0),
                W('math', $, Q, '\u21c9', '\\rightrightarrows', !0),
                W('math', $, Q, '\u21c4', '\\rightleftarrows', !0),
                W('math', $, Q, '\u21a0', '\\twoheadrightarrow', !0),
                W('math', $, Q, '\u21a3', '\\rightarrowtail', !0),
                W('math', $, Q, '\u21ac', '\\looparrowright', !0),
                W('math', $, Q, '\u21b7', '\\curvearrowright', !0),
                W('math', $, Q, '\u21bb', '\\circlearrowright', !0),
                W('math', $, Q, '\u21b1', '\\Rsh', !0),
                W('math', $, Q, '\u21ca', '\\downdownarrows', !0),
                W('math', $, Q, '\u21be', '\\upharpoonright', !0),
                W('math', $, Q, '\u21c2', '\\downharpoonright', !0),
                W('math', $, Q, '\u21dd', '\\rightsquigarrow', !0),
                W('math', $, Q, '\u21dd', '\\leadsto'),
                W('math', $, Q, '\u21db', '\\Rrightarrow', !0),
                W('math', $, Q, '\u21be', '\\restriction'),
                W('math', j, 'textord', '\u2018', '`'),
                W('math', j, 'textord', '$', '\\$'),
                W('text', j, 'textord', '$', '\\$'),
                W('text', j, 'textord', '$', '\\textdollar'),
                W('math', j, 'textord', '%', '\\%'),
                W('text', j, 'textord', '%', '\\%'),
                W('math', j, 'textord', '_', '\\_'),
                W('text', j, 'textord', '_', '\\_'),
                W('text', j, 'textord', '_', '\\textunderscore'),
                W('math', j, 'textord', '\u2220', '\\angle', !0),
                W('math', j, 'textord', '\u221e', '\\infty', !0),
                W('math', j, 'textord', '\u2032', '\\prime'),
                W('math', j, 'textord', '\u25b3', '\\triangle'),
                W('math', j, 'textord', '\u0393', '\\Gamma', !0),
                W('math', j, 'textord', '\u0394', '\\Delta', !0),
                W('math', j, 'textord', '\u0398', '\\Theta', !0),
                W('math', j, 'textord', '\u039b', '\\Lambda', !0),
                W('math', j, 'textord', '\u039e', '\\Xi', !0),
                W('math', j, 'textord', '\u03a0', '\\Pi', !0),
                W('math', j, 'textord', '\u03a3', '\\Sigma', !0),
                W('math', j, 'textord', '\u03a5', '\\Upsilon', !0),
                W('math', j, 'textord', '\u03a6', '\\Phi', !0),
                W('math', j, 'textord', '\u03a8', '\\Psi', !0),
                W('math', j, 'textord', '\u03a9', '\\Omega', !0),
                W('math', j, 'textord', 'A', '\u0391'),
                W('math', j, 'textord', 'B', '\u0392'),
                W('math', j, 'textord', 'E', '\u0395'),
                W('math', j, 'textord', 'Z', '\u0396'),
                W('math', j, 'textord', 'H', '\u0397'),
                W('math', j, 'textord', 'I', '\u0399'),
                W('math', j, 'textord', 'K', '\u039a'),
                W('math', j, 'textord', 'M', '\u039c'),
                W('math', j, 'textord', 'N', '\u039d'),
                W('math', j, 'textord', 'O', '\u039f'),
                W('math', j, 'textord', 'P', '\u03a1'),
                W('math', j, 'textord', 'T', '\u03a4'),
                W('math', j, 'textord', 'X', '\u03a7'),
                W('math', j, 'textord', '\xac', '\\neg', !0),
                W('math', j, 'textord', '\xac', '\\lnot'),
                W('math', j, 'textord', '\u22a4', '\\top'),
                W('math', j, 'textord', '\u22a5', '\\bot'),
                W('math', j, 'textord', '\u2205', '\\emptyset'),
                W('math', $, 'textord', '\u2205', '\\varnothing'),
                W('math', j, K, '\u03b1', '\\alpha', !0),
                W('math', j, K, '\u03b2', '\\beta', !0),
                W('math', j, K, '\u03b3', '\\gamma', !0),
                W('math', j, K, '\u03b4', '\\delta', !0),
                W('math', j, K, '\u03f5', '\\epsilon', !0),
                W('math', j, K, '\u03b6', '\\zeta', !0),
                W('math', j, K, '\u03b7', '\\eta', !0),
                W('math', j, K, '\u03b8', '\\theta', !0),
                W('math', j, K, '\u03b9', '\\iota', !0),
                W('math', j, K, '\u03ba', '\\kappa', !0),
                W('math', j, K, '\u03bb', '\\lambda', !0),
                W('math', j, K, '\u03bc', '\\mu', !0),
                W('math', j, K, '\u03bd', '\\nu', !0),
                W('math', j, K, '\u03be', '\\xi', !0),
                W('math', j, K, '\u03bf', '\\omicron', !0),
                W('math', j, K, '\u03c0', '\\pi', !0),
                W('math', j, K, '\u03c1', '\\rho', !0),
                W('math', j, K, '\u03c3', '\\sigma', !0),
                W('math', j, K, '\u03c4', '\\tau', !0),
                W('math', j, K, '\u03c5', '\\upsilon', !0),
                W('math', j, K, '\u03d5', '\\phi', !0),
                W('math', j, K, '\u03c7', '\\chi', !0),
                W('math', j, K, '\u03c8', '\\psi', !0),
                W('math', j, K, '\u03c9', '\\omega', !0),
                W('math', j, K, '\u03b5', '\\varepsilon', !0),
                W('math', j, K, '\u03d1', '\\vartheta', !0),
                W('math', j, K, '\u03d6', '\\varpi', !0),
                W('math', j, K, '\u03f1', '\\varrho', !0),
                W('math', j, K, '\u03c2', '\\varsigma', !0),
                W('math', j, K, '\u03c6', '\\varphi', !0),
                W('math', j, Z, '\u2217', '*'),
                W('math', j, Z, '+', '+'),
                W('math', j, Z, '\u2212', '-'),
                W('math', j, Z, '\u22c5', '\\cdot', !0),
                W('math', j, Z, '\u2218', '\\circ'),
                W('math', j, Z, '\xf7', '\\div', !0),
                W('math', j, Z, '\xb1', '\\pm', !0),
                W('math', j, Z, '\xd7', '\\times', !0),
                W('math', j, Z, '\u2229', '\\cap', !0),
                W('math', j, Z, '\u222a', '\\cup', !0),
                W('math', j, Z, '\u2216', '\\setminus'),
                W('math', j, Z, '\u2227', '\\land'),
                ...
                W('math', j, Z, '\u2227', '\\wedge', !0),
                W('math', j, Z, '\u2228', '\\vee', !0),
                W('math', j, 'textord', '\u221a', '\\surd'),
                W('math', j, 'open', '(', '('),
                W('math', j, 'open', '[', '['),
                W('math', j, 'open', '\u27e8', '\\langle', !0),
                W('math', j, 'open', '\u2223', '\\lvert'),
                W('math', j, 'open', '\u2225', '\\lVert'),
                W('math', j, 'close', ')', ')'),
                W('math', j, 'close', ']', ']'),
                W('math', j, 'close', '?', '?'),
                W('math', j, 'close', '!', '!'),
                W('math', j, 'close', '\u27e9', '\\rangle', !0),
                W('math', j, 'close', '\u2223', '\\rvert'),
                W('math', j, 'close', '\u2225', '\\rVert'),
                W('math', j, Q, '=', '='),
                W('math', j, Q, '<', '<'),
                W('math', j, Q, '>', '>'),
                ...
                W('math', j, Q, '\u2282', '\\subset', !0),
                W('math', j, Q, '\u2283', '\\supset', !0),
                W('math', j, Q, '\u2286', '\\subseteq', !0),
                W('math', j, Q, '\u2287', '\\supseteq', !0),
                W('math', $, Q, '\u2288', '\\nsubseteq', !0),
                W('math', $, Q, '\u2289', '\\nsupseteq', !0),
                W('math', j, Q, '\u22a8', '\\models'),
                W('math', j, Q, '\u2190', '\\leftarrow', !0),
                ...
                W('math', j, tt, '\xa0', '\\ '),
                W('math', j, tt, '\xa0', '~'),
                W('math', j, tt, '\xa0', '\\space'),
                W('math', j, tt, '\xa0', '\\nobreakspace'),
                W('text', j, tt, '\xa0', '\\ '),
                W('text', j, tt, '\xa0', '~'),
                W('text', j, tt, '\xa0', '\\space'),
                W('text', j, tt, '\xa0', '\\nobreakspace'),
                W('math', j, tt, null, '\\nobreak'),
                W('math', j, tt, null, '\\allowbreak'),
                W('math', j, 'punct', ',', ','),
                W('math', j, 'punct', ';', ';'),
                W('math', $, Z, '\u22bc', '\\barwedge', !0),
                W('math', $, Z, '\u22bb', '\\veebar', !0),
                ...
                W('math', j, Z, '\u2295', '\\oplus', !0),
                W('math', j, Z, '\u2297', '\\otimes', !0),
                W('math', j, 'textord', '\u2202', '\\partial', !0),
                W('math', j, Z, '\u2298', '\\oslash', !0),
                W('math', $, Z, '\u229a', '\\circledcirc', !0),
                W('math', $, Z, '\u22a1', '\\boxdot', !0),
                W('math', j, Z, '\u25b3', '\\bigtriangleup'),
                W('math', j, Z, '\u25bd', '\\bigtriangledown'),
                W('math', j, Z, '\u2020', '\\dagger'),
                W('math', j, Z, '\u22c4', '\\diamond'),
                W('math', j, Z, '\u22c6', '\\star'),
                W('math', j, Z, '\u25c3', '\\triangleleft'),
                W('math', j, Z, '\u25b9', '\\triangleright'),
                W('math', j, 'open', '{', '\\{'),
                W('text', j, 'textord', '{', '\\{'),
                W('text', j, 'textord', '{', '\\textbraceleft'),
                W('math', j, 'close', '}', '\\}'),
                W('text', j, 'textord', '}', '\\}'),
                W('text', j, 'textord', '}', '\\textbraceright'),
                W('math', j, 'open', '{', '\\lbrace'),
                W('math', j, 'close', '}', '\\rbrace'),
                W('math', j, 'open', '[', '\\lbrack'),
                W('text', j, 'textord', '[', '\\lbrack'),
                W('math', j, 'close', ']', '\\rbrack'),
                W('text', j, 'textord', ']', '\\rbrack'),
                W('math', j, 'open', '(', '\\lparen'),
                W('math', j, 'close', ')', '\\rparen'),
                W('text', j, 'textord', '<', '\\textless'),
                W('text', j, 'textord', '>', '\\textgreater'),
                W('math', j, 'open', '\u230a', '\\lfloor', !0),
                W('math', j, 'close', '\u230b', '\\rfloor', !0),
                W('math', j, 'open', '\u2308', '\\lceil', !0),
                W('math', j, 'close', '\u2309', '\\rceil', !0),
                W('math', j, 'textord', '\\', '\\backslash'),
                W('math', j, 'textord', '\u2223', '|'),
                W('math', j, 'textord', '\u2223', '\\vert'),
                W('text', j, 'textord', '|', '\\textbar'),
                W('math', j, 'textord', '\u2225', '\\|'),
                W('math', j, 'textord', '\u2225', '\\Vert'),
                W('text', j, 'textord', '\u2225', '\\textbardbl'),
                W('text', j, 'textord', '~', '\\textasciitilde'),
                W('text', j, 'textord', '\\', '\\textbackslash'),
                W('text', j, 'textord', '^', '\\textasciicircum'),
                W('math', j, Q, '\u2191', '\\uparrow', !0),
                W('math', j, Q, '\u21d1', '\\Uparrow', !0),
                W('math', j, Q, '\u2193', '\\downarrow', !0),
                W('math', j, Q, '\u21d3', '\\Downarrow', !0),
                W('math', j, Q, '\u2195', '\\updownarrow', !0),
                W('math', j, Q, '\u21d5', '\\Updownarrow', !0),
                W('math', j, J, '\u2210', '\\coprod'),
                W('math', j, J, '\u22c1', '\\bigvee'),
                W('math', j, J, '\u22c0', '\\bigwedge'),
                ...
                W('math', j, J, '\u2a06', '\\bigsqcup'),
                W('math', j, J, '\u222b', '\\smallint'),
                W('text', j, 'inner', '\u2026', '\\textellipsis'),
                W('math', j, 'inner', '\u2026', '\\mathellipsis'),
                W('text', j, 'inner', '\u2026', '\\ldots', !0),
                W('math', j, 'inner', '\u2026', '\\ldots', !0),
                W('math', j, 'inner', '\u22ef', '\\@cdots', !0),
                W('math', j, 'inner', '\u22f1', '\\ddots', !0),
                W('math', j, 'textord', '\u22ee', '\\varvdots'),
                W('math', j, 'accent-token', '\u02ca', '\\acute'),
                W('math', j, 'accent-token', '\u02cb', '\\grave'),
                W('math', j, 'accent-token', '\xa8', '\\ddot'),
                W('math', j, 'accent-token', '~', '\\tilde'),
                W('math', j, 'accent-token', '\u02c9', '\\bar'),
                W('math', j, 'accent-token', '\u02d8', '\\breve'),
                W('math', j, 'accent-token', '\u02c7', '\\check'),
                W('math', j, 'accent-token', '^', '\\hat'),
                W('math', j, 'accent-token', '\u20d7', '\\vec'),
                W('math', j, 'accent-token', '\u02d9', '\\dot'),
                W('math', j, 'accent-token', '\u02da', '\\mathring'),
                W('math', j, K, '\u0131', '\\imath', !0),
                W('math', j, K, '\u0237', '\\jmath', !0),
                W('text', j, 'textord', '\u0131', '\\i', !0),
                W('text', j, 'textord', '\u0237', '\\j', !0),
                W('text', j, 'textord', '\xdf', '\\ss', !0),
                W('text', j, 'textord', '\xe6', '\\ae', !0),
                W('text', j, 'textord', '\xe6', '\\ae', !0),
                W('text', j, 'textord', '\u0153', '\\oe', !0),
                W('text', j, 'textord', '\xf8', '\\o', !0),
                W('text', j, 'textord', '\xc6', '\\AE', !0),
                W('text', j, 'textord', '\u0152', '\\OE', !0),
                W('text', j, 'textord', '\xd8', '\\O', !0),
                W('text', j, 'accent-token', '\u02ca', "\\'"),
                W('text', j, 'accent-token', '\u02cb', '\\`'),
                W('text', j, 'accent-token', '\u02c6', '\\^'),
                W('text', j, 'accent-token', '\u02dc', '\\~'),
                W('text', j, 'accent-token', '\u02c9', '\\='),
                W('text', j, 'accent-token', '\u02d8', '\\u'),
                W('text', j, 'accent-token', '\u02d9', '\\.'),
                W('text', j, 'accent-token', '\u02da', '\\r'),
                W('text', j, 'accent-token', '\u02c7', '\\v'),
                W('text', j, 'accent-token', '\xa8', '\\"'),
                W('text', j, 'accent-token', '\u02dd', '\\H'),
                W('text', j, 'accent-token', '\u25ef', '\\textcircled');
            var et = { '--': !0, '---': !0, '``': !0, "''": !0 };
            W('text', j, 'textord', '\u2013', '--'),
                W('text', j, 'textord', '\u2013', '\\textendash'),
                W('text', j, 'textord', '\u2014', '---'),
                W('text', j, 'textord', '\u2014', '\\textemdash'),
                W('text', j, 'textord', '\u2018', '`'),
                W('text', j, 'textord', '\u2018', '\\textquoteleft'),
                W('text', j, 'textord', '\u2019', "'"),
                W('text', j, 'textord', '\u2019', '\\textquoteright'),
                W('text', j, 'textord', '\u201c', '``'),
                W('text', j, 'textord', '\u201c', '\\textquotedblleft'),
                W('text', j, 'textord', '\u201d', "''"),
                W('text', j, 'textord', '\u201d', '\\textquotedblright'),
                W('math', j, 'textord', '\xb0', '\\degree', !0),
                W('text', j, 'textord', '\xb0', '\\degree'),
                W('text', j, 'textord', '\xb0', '\\textdegree', !0),
                W('math', j, K, '\xa3', '\\pounds'),
                W('math', j, K, '\xa3', '\\mathsterling', !0),
                W('text', j, K, '\xa3', '\\pounds'),
                W('text', j, K, '\xa3', '\\textsterling', !0),
                W('math', $, 'textord', '\u2720', '\\maltese'),
                W('text', $, 'textord', '\u2720', '\\maltese'),
                W('text', j, tt, '\xa0', '\\ '),
                W('text', j, tt, '\xa0', ' '),
                W('text', j, tt, '\xa0', '~');
            for (var rt = 0; rt < '0123456789/@."'.length; rt++) {
                var nt = '0123456789/@."'.charAt(rt);
                W('math', j, 'textord', nt, nt);
            }
            for (var at = 0; at < '0123456789!@*()-=+[]<>|";:?/.,'.length; at++) {
                var it = '0123456789!@*()-=+[]<>|";:?/.,'.charAt(at);
                W('text', j, 'textord', it, it);
            }
            for (var ot = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz', st = 0; st < ot.length; st++) {
                var ht = ot.charAt(st);
                W('math', j, K, ht, ht), W('text', j, 'textord', ht, ht);
            }
            W('math', $, 'textord', 'C', '\u2102'),
                W('text', $, 'textord', 'C', '\u2102'),
                W('math', $, 'textord', 'H', '\u210d'),
            ...
            for (var lt = '', mt = 0; mt < ot.length; mt++) {
                var ct = ot.charAt(mt);
                W('math', j, K, ct, (lt = String.fromCharCode(55349, 56320 + mt))),
                    W('text', j, 'textord', ct, lt),
                    W('math', j, K, ct, (lt = String.fromCharCode(55349, 56372 + mt))),
                    W('text', j, 'textord', ct, lt),
                    W('math', j, K, ct, (lt = String.fromCharCode(55349, 56424 + mt))),
                    W('text', j, 'textord', ct, lt),
                    W('math', j, K, ct, (lt = String.fromCharCode(55349, 56580 + mt))),
                    W('text', j, 'textord', ct, lt),
                    W('math', j, K, ct, (lt = String.fromCharCode(55349, 56736 + mt))),
                    W('text', j, 'textord', ct, lt),
                    W('math', j, K, ct, (lt = String.fromCharCode(55349, 56788 + mt))),
                    W('text', j, 'textord', ct, lt),
                    W('math', j, K, ct, (lt = String.fromCharCode(55349, 56840 + mt))),
                    W('text', j, 'textord', ct, lt),
                    W('math', j, K, ct, (lt = String.fromCharCode(55349, 56944 + mt))),
                    W('text', j, 'textord', ct, lt),
                    mt < 26 &&
                        (W('math', j, K, ct, (lt = String.fromCharCode(55349, 56632 + mt))),
                        W('text', j, 'textord', ct, lt),
                        W('math', j, K, ct, (lt = String.fromCharCode(55349, 56476 + mt))),
                        W('text', j, 'textord', ct, lt));
            }
            W('math', j, K, 'k', (lt = String.fromCharCode(55349, 56668))), W('text', j, 'textord', 'k', lt);
            for (var ut = 0; ut < 10; ut++) {
                var dt = ut.toString();
                W('math', j, K, dt, (lt = String.fromCharCode(55349, 57294 + ut))),
                    W('text', j, 'textord', dt, lt),
                    W('math', j, K, dt, (lt = String.fromCharCode(55349, 57314 + ut))),
                    W('text', j, 'textord', dt, lt),
                    W('math', j, K, dt, (lt = String.fromCharCode(55349, 57324 + ut))),
                    W('text', j, 'textord', dt, lt),
                    W('math', j, K, dt, (lt = String.fromCharCode(55349, 57334 + ut))),
                    W('text', j, 'textord', dt, lt);
            }
            for (var pt = 0; pt < '\xc7\xd0\xde\xe7\xfe'.length; pt++) {
                var ft = '\xc7\xd0\xde\xe7\xfe'.charAt(pt);
                W('math', j, K, ft, ft), W('text', j, 'textord', ft, ft);
            }
            W('text', j, 'textord', '\xf0', '\xf0'),
                W('text', j, 'textord', '\u2013', '\u2013'),
                W('text', j, 'textord', '\u2014', '\u2014'),
                W('text', j, 'textord', '\u2018', '\u2018'),
                W('text', j, 'textord', '\u2019', '\u2019'),
                ...
                wt = (function() {
                    ...
                    return (
                        ...
                        (e.havingStyle = function(t) {
                            return this.style === t ? this : this.extend({ style: t, size: bt(this.textSize, t) });
                        }),
                        ...
                        (e.havingBaseStyle = function(e) {
                            ...
                            return this.size === r && this.textSize === t.BASESIZE && this.style === e
                                ? this
                                ...
                                this._fontMetrics ||
                                    (this._fontMetrics = (function(t) {
                                        ...
                                        if (!U[(e = t >= 5 ? 0 : t >= 3 ? 1 : 2)]) {
                                            var r = (U[e] = { cssEmPerMu: P.quad[e] / 18 });
                                            for (var n in P) P.hasOwnProperty(n) && (r[n] = P[n][e]);
                                        }
                                        return U[e];
                                    })(this.size)),
                                this._fontMetrics
                        ...
                        (e.getColor = function() {
                            return this.phantom
                                ? 'transparent'
                                : null != this.color && t.colorMap.hasOwnProperty(this.color)
            ...
            var kt = wt,
                ...
                Mt = function(t, e) {
                    var r;
                    if (t.unit in St) r = St[t.unit] / e.fontMetrics().ptPerEm / e.sizeMultiplier;
                    else if ('mu' === t.unit) r = e.fontMetrics().cssEmPerMu;
                    else {
                        var n;
                        if (((n = e.style.isTight() ? e.havingStyle(e.style.text()) : e), 'ex' === t.unit))
                ...
                Tt = ['\\imath', '\u0131', '\\jmath', '\u0237', '\\pounds', '\\mathsterling', '\\textsterling', '\xa3'],
                At = function(t, e, r) {
                    return _[r][t] && _[r][t].replace && (t = _[r][t].replace), { value: t, metrics: V(t, e, r) };
                },
                Bt = function(t, e, r, n, a) {
                    ...
                    if (((t = o.value), s)) {
                        ...
                        'undefined' != typeof console &&
                            console.warn("No character metrics for '" + t + "' in style '" + e + "'"),
                ...
                Dt = {
                    ...
                    mathsym: function(t, e, r, n) {
                        return (
                            void 0 === n && (n = []),
                            r && r.font && 'boldsymbol' === r.font && At(t, 'Main-Bold', e).metrics
                    ...
                    makeVList: function(t, e) {
                            ...
                            var r = (function(t) {
                                    if ('individualShift' === t.positionType) {
                                        for (
                                            ...
                                            (a += o), r.push({ type: 'kern', size: s }), r.push(e[i]);
                                        }
                        ...
                        var l = qt(['pstrut'], []);
                        l.style.height = i + 'em';
                        for (var m = [], c = a, u = a, d = a, p = 0; p < n.length; p++) {
                            var f = n[p];
                        ...
                        if (((w.style.height = u + 'em'), c < 0)) {
                            var k = qt([], []),
                                S = qt(['vlist'], [k]);
                            S.style.height = -c + 'em';
                            var z = qt(['vlist-s'], [new I('\u200b')]);
                            b = [qt(['vlist-r'], [w, z]), qt(['vlist-r'], [S])];
                        } else b = [qt(['vlist-r'], [w])];
                        var M = qt(['vlist-t'], b);
                        return 2 === b.length && M.classes.push('vlist-t2'), (M.height = u), (M.depth = -c), M;
                    },
                    makeOrd: function(t, e, r) {
                        ...
                        if (55349 === i.charCodeAt(0)) {
                            var m = (function(t, e) {
                                    ...
                                    if (120485 === r || 120486 === r) return [gt[0][2], gt[0][n]];
                        ...
                        if (l) {
                            ...
                            if ('boldsymbol' === l || 'mathnormal' === l) {
                                ...
                                c.contains(Tt, i)
                                    ...
                                    : h
                                    ? ((p = Rt[l].fontName), (f = [l]))
                                    : ((p = It(l, e.fontWeight, e.fontShape)), (f = [l, e.fontWeight, e.fontShape]));
                            if (At(i, p, a).metrics) return Bt(i, p, a, e, s.concat(f));
                            if (et.hasOwnProperty(i) && 'Typewriter' === p.substr(0, 10)) {
                                for (var x = [], v = 0; v < i.length; v++) x.push(Bt(i[v], p, a, e, s.concat(f)));
                                return Ot(x);
                            }
                        }
                        if ('mathord' === r) {
                        ...
                        if ('textord' === r) {
                            var b = _[a][i] && _[a][i].font;
                            if ('ams' === b) {
                                var w = It('amsrm', e.fontWeight, e.fontShape);
                                return Bt(i, w, a, e, s.concat('amsrm', e.fontWeight, e.fontShape));
                            }
                            if ('main' !== b && b) {
                                var k = It(b, e.fontWeight, e.fontShape);
                                return Bt(i, k, a, e, s.concat(k, e.fontWeight, e.fontShape));
                            }
                    ...
                    staticSvg: function(t, e) {
                        var r = Lt[t],
                            ...
                            h = Et(['overlay'], [s], e);
                        return (h.height = i), (h.style.height = i + 'em'), (h.style.width = a + 'em'), h;
                    },
                    svgData: Lt,
            ...
            var Ut = { number: 3, unit: 'mu' },
                ...
                Xt = { number: 5, unit: 'mu' },
                Yt = {
                    mord: { mop: Ut, mbin: Gt, mrel: Xt, minner: Ut },
                    mop: { mord: Ut, mop: Ut, mrel: Xt, minner: Ut },
                    mbin: { mord: Gt, mop: Gt, mopen: Gt, minner: Gt },
                    mrel: { mord: Xt, mop: Xt, mopen: Xt, minner: Xt },
                    mopen: {},
                    mclose: { mop: Ut, mbin: Gt, mrel: Xt, minner: Ut },
                    mpunct: { mord: Ut, mop: Ut, mrel: Xt, mopen: Ut, mclose: Ut, mpunct: Ut, minner: Ut },
                    minner: { mord: Ut, mop: Ut, mbin: Gt, mrel: Xt, mopen: Ut, mpunct: Ut, minner: Ut },
                },
                _t = {
                    mord: { mop: Ut },
                    mop: { mord: Ut, mop: Ut },
            ...
            var Jt = function(t) {
                ...
                re = { display: w.DISPLAY, text: w.TEXT, script: w.SCRIPT, scriptscript: w.SCRIPTSCRIPT },
                ne = {
                    mord: 'mord',
                    mop: 'mop',
                    mbin: 'mbin',
                ...
                ae = function(t, e, r, n) {
                    ...
                    var h = e;
                    if (1 === t.length) {
                        var l = Pt(t[0], 'sizing') || Pt(t[0], 'styling');
                        l &&
                            ('sizing' === l.type
                                ? (h = e.havingSize(l.size))
                                : 'styling' === l.type && (h = e.havingStyle(re[l.style])));
                    }
                    ...
                    return (
                        ie(
                            ...
                            function(t, e) {
                                ...
                                'mbin' === r && c.contains(ee, n)
                                    ? (e.classes[0] = 'mord')
                                    : 'mbin' === n && c.contains(te, r) && (t.classes[0] = 'mord');
                            },
                            { node: m },
                            u
                        ),
                        ie(
                            ...
                            function(t, e) {
                                var r = se(e),
                                    n = se(t),
                                    a = r && n ? (t.hasClass('mtight') ? _t[r][n] : Yt[r][n]) : null;
                                if (a) return Dt.makeGlue(a, h);
                            },
                            { node: m },
                            u
                        ),
                ...
                ie = function t(e, r, n, a) {
                    ...
                    for (var i = 0; i < e.length; i++) {
                        ...
                        if (s) t(s.children, r, n);
                            ...
                            var h = r(o, n.node);
                            h && (n.insertAfter ? n.insertAfter(h) : (e.unshift(h), i++)),
                                (n.node = o),
                ...
                oe = function(t) {
                    return t instanceof T || t instanceof E ? t : null;
                },
                se = function(t, e) {
                    return t
                        ? (e &&
                              (t = (function t(e, r) {
                                  ...
                                  if (n) {
                                      var a = n.children;
                                      if (a.length) {
                                          if ('right' === r) return t(a[a.length - 1], 'right');
            ...
            function ce(t, e) {
                ...
                for (var n, a = ae(t, e, !0), i = [], o = [], s = 0; s < a.length; s++)
                    if ((o.push(a[s]), a[s].hasClass('mbin') || a[s].hasClass('mrel') || a[s].hasClass('allowbreak'))) {
                        for (
                            var h = !1;
                            s < a.length - 1 && a[s + 1].hasClass('mspace') && !a[s + 1].hasClass('newline');
                        ...
                        a[s].hasClass('newline') &&
                            (o.pop(), o.length > 0 && (i.push(me(o, e)), (o = [])), i.push(a[s]));
                o.length > 0 && i.push(me(o, e)), r && (((n = me(ae(r, e, !0))).classes = ['tag']), i.push(n));
            ...
            var de = (function() {
                ...
                ve = function(t, e) {
                    ...
                    return c.contains(['\\imath', '\\jmath'], a)
                        ? null
                        : (_[n][a] && _[n][a].replace && (a = _[n][a].replace),
                          V(a, Dt.fontMap[r].fontName, n) ? Dt.fontMap[r].variant : null);
                },
                ye = function(t, e) {
                    for (var r, n = [], a = 0; a < t.length; a++) {
                        ...
                        if (i instanceof de && r instanceof de) {
                            if (
                                'mtext' === i.type &&
                                'mtext' === r.type &&
                                i.getAttribute('mathvariant') === r.getAttribute('mathvariant')
                            ) {
                                var o;
            ...
            var ke = function(t) {
                    return new kt({ style: t.displayMode ? w.DISPLAY : w.TEXT, maxSize: t.maxSize });
                },
                Se = function(t, e) {
                    if (e.displayMode) {
                        var r = ['katex-display'];
                    ...
                    var n = ke(r),
                        a = (function(t, e, r) {
                            var n,
                                a = ye(t, r);
                            n =
                                1 === a.length && a[0] instanceof de && c.contains(['mrow', 'mtable'], a[0].type)
                                    ? a[0]
                            ...
                            return Dt.makeSpan(['katex-mathml'], [s]);
                        })(t, e, n),
                        i = ce(t, n),
                        o = Dt.makeSpan(['katex'], [a, i]);
                    return Se(o, r);
                },
                Me = {
                    widehat: '^',
                ...
                Be = function(t, e, r, n) {
                    ...
                    if (/fbox|color/.test(e)) {
                        if (((a = Dt.makeSpan(['stretchy', e], [], n)), 'fbox' === e)) {
                        ...
                        var s = [];
                        /^[bx]cancel$/.test(e) &&
                            s.push(new D({ x1: '0', y1: '0', x2: '100%', y2: '100%', 'stroke-width': '0.046em' })),
                            /^x?cancel$/.test(e) &&
                                s.push(new D({ x1: '0', y1: '100%', x2: '100%', y2: '0', 'stroke-width': '0.046em' }));
                        var h = new R(s, { width: '100%', height: i + 'em' });
                        a = Dt.makeSvgSpan([], [h], n);
                    }
                    return (a.height = i), (a.style.height = i + 'em'), a;
                },
                Ce = function(t) {
                    var e = new fe.MathNode('mo', [new fe.TextNode(Me[t.substr(1)])]);
                ...
                Ne = function(t, e) {
                    var r = (function() {
                            ...
                            if (1 === b) (u = ['hide-tail']), (d = [f[3]]);
                                ...
                                (u = ['halfarrow-left', 'halfarrow-right']), (d = ['xMinYMin', 'xMaxYMin']);
                            else {
                                if (3 !== b)
                                    throw new Error(
                            ...
                            for (var w = 0; w < b; w++) {
                                var k = new L(g[w]),
                                    ...
                                    z = Dt.makeSvgSpan([u[w]], [S], e);
                                if (1 === b) return { span: z, minWidth: x, height: y };
                                (z.style.height = y + 'em'), p.push(z);
                            }
                            return { span: Dt.makeSpan(['stretchy'], p, e), minWidth: x, height: y };
                        })(),
                        n = r.span,
                        a = r.minWidth,
                        i = r.height;
                ...
                qe = function(t, e) {
                    ...
                    if (n.isStretchy)
                        ...
                        var u, d;
                        '\\vec' === n.label
                            ? ((u = Dt.staticSvg('vec', e)), (d = Dt.svgData.vec[1]))
                            : (((u = Dt.makeSymbol(n.label, 'Main-Regular', n.mode, e)).italic = 0), (d = u.width)),
                    ...
                    return a
                        ? ((a.children[0] = g), (a.height = Math.max(g.height, a.height)), (a.classes[0] = 'mord'), a)
                        : g;
                },
                Ee = function(t, e) {
                    var r = t.isStretchy ? Ce(t.label) : new fe.MathNode('mo', [ge(t.label, t.mode)]),
            ...
            Zt({
                ...
                Zt({
                    ...
                    htmlBuilder: function(t, e) {
                        var r,
                            ...
                            i = Dt.wrapFragment(le(t.body, a, e), e);
                        i.classes.push('x-arrow-pad'),
                            t.below &&
                                ((a = e.havingStyle(n.sub())),
                                (r = Dt.wrapFragment(le(t.below, a, e), e)).classes.push('x-arrow-pad'));
                        var o,
                            s = Ne(t, e),
                    ...
                    mathmlBuilder: function(t, e) {
                        ...
                        if (t.body) {
                            var i = we(t.body, e);
                            t.below
                                ? ((n = we(t.below, e)), (r = new fe.MathNode('munderover', [a, n, i])))
                                : (r = new fe.MathNode('mover', [a, i]));
                        } else
                            t.below
                                ? ((n = we(t.below, e)), (r = new fe.MathNode('munder', [a, n])))
                ...
                Zt({
                    ...
                    handler: function(t, e) {
                        for (var r = t.parser, n = Ht(e[0], 'ordgroup').body, a = '', i = 0; i < n.length; i++) {
                            a += Ht(n[i], 'textord').text;
                        }
                        var s = parseInt(a);
                ...
                Zt({
                    ...
                    handler: function(t, e) {
                        var r = t.parser,
                            n = t.funcName,
                            a = e[0];
                        return { type: 'color', mode: r.mode, color: 'katex-' + n.slice(1), body: Jt(a) };
                    },
                    htmlBuilder: Ie,
                    mathmlBuilder: Re,
                }),
                ...
                Zt({
                    ...
                    handler: function(t, e, r) {
                        ...
                        return (
                            ...
                            { type: 'cr', mode: n.mode, newLine: s, newRow: o, size: i && Ht(i, 'size').value }
                        );
                    },
                    htmlBuilder: function(t, e) {
                        ...
                        return (
                            t.newLine &&
                                (r.classes.push('newline'), t.size && (r.style.marginTop = Mt(t.size, e) + 'em')),
                            r
                        );
                    },
                    mathmlBuilder: function(t, e) {
                        ...
                        return (
                            t.newLine &&
                                ...
                                t.size && r.setAttribute('height', Mt(t.size, e) + 'em')),
                            r
                        );
                    },
                });
            var Le = function(t, e, r) {
                    var n = V((_.math[t] && _.math[t].replace) || t, e, r);
                ...
                He = function(t, e, r) {
                    ...
                    t.classes.push('delimcenter'), (t.style.top = a + 'em'), (t.height -= a), (t.depth += a);
                },
                Pe = function(t, e, r, n, a, i) {
                    var o = (function(t, e, r, n) {
                            return Dt.makeSymbol(t, 'Size' + e + '-Regular', r, n);
                        })(t, e, a, n),
                        s = De(Dt.makeSpan(['delimsizing', 'size' + e], [o], n), w.TEXT, n, i);
                    return r && He(s, n, w.TEXT), s;
                },
                Fe = function(t, e, r) {
                    var n;
                    return (
                ...
                Ve = function(t, e, r, n, a, i) {
                    ...
                    var M = S / 2 - z,
                        T = [];
                    if ((T.push(Fe(l, m, a)), null === s)) for (var A = 0; A < k; A++) T.push(Fe(h, m, a));
                    else {
                    ...
                    var N = n.havingBaseStyle(w.TEXT),
                        q = Dt.makeVList({ positionType: 'bottom', positionData: M, children: T }, N);
                    return De(Dt.makeSpan(['delimsizing', 'mult'], [q], N), w.TEXT, n, i);
                },
                Ue = function(t, e, r, n) {
                    var a;
                    'sqrtTall' === t &&
                    ...
                    return Dt.makeSvgSpan(['hide-tail'], [o], n);
                },
                Ge = [
                    '(',
                    '\\lparen',
                ...
                Ye = ['<', '>', '\\langle', '\\rangle', '/', '\\backslash', '\\lt', '\\gt'],
                _e = [0, 1.2, 1.8, 2.4, 3],
                We = [
                ...
                Ke = function(t, e, r, n) {
                    for (var a = Math.min(2, 3 - n.style.size); a < r.length && 'stack' !== r[a].type; a++) {
                        var i = Le(t, Ze(r[a]), 'math'),
                            o = i.height + i.depth;
                        if (('small' === r[a].type && (o *= n.havingBaseStyle(r[a].style).sizeMultiplier), o > e))
                            return r[a];
                    }
                    return r[r.length - 1];
                },
                Je = function(t, e, r, n, a, i) {
                    ...
                    '<' === t || '\\lt' === t || '\u27e8' === t
                        ? (t = '\\langle')
                        : ('>' !== t && '\\gt' !== t && '\u27e9' !== t) || (t = '\\rangle'),
                        (o = c.contains(Ye, t) ? We : c.contains(Ge, t) ? $e : je);
                    var s = Ke(t, e, o, n);
                    return 'small' === s.type
                ...
                Qe = function(t, e) {
                    var r,
                        ...
                        i = Ke('\\surd', t * a.sizeMultiplier, $e, a),
                        o = a.sizeMultiplier,
                        s = 0,
                        h = 0,
                        l = 0;
                    return (
                        'small' === i.type
                            ? (t < 1 ? (o = 1) : t < 1.4 && (o = 0.7),
                              (h = 1 / o),
                              ((r = Ue('sqrtMain', (s = 1.08 / o), (l = 1080), e)).style.minWidth = '0.853em'),
                              (n = 0.833 / o))
                            : 'large' === i.type
                            ? ((l = 1080 * _e[i.size]),
                              (h = _e[i.size] / o),
                              (s = (_e[i.size] + 0.08) / o),
                              ((r = Ue('sqrtSize' + i.size, s, l, e)).style.minWidth = '1.02em'),
                              (n = 1 / o))
                            : ((s = t + 0.08),
                              (h = t),
                              (l = Math.floor(1e3 * t) + 80),
                              ((r = Ue('sqrtTall', s, l, e)).style.minWidth = '0.742em'),
                              (n = 1.056)),
                        (r.height = h),
                        (r.style.height = s + 'em'),
                        { span: r, advanceWidth: n, ruleWidth: e.fontMetrics().sqrtRuleThickness * o }
                    );
                },
                tr = function(t, e, r, n, a) {
                    if (
                        ('<' === t || '\\lt' === t || '\u27e8' === t
                            ? (t = '\\langle')
                            : ('>' !== t && '\\gt' !== t && '\u27e9' !== t) || (t = '\\rangle'),
                        c.contains(Ge, t) || c.contains(Ye, t))
                    )
                        return Pe(t, e, !1, r, n, a);
                    if (c.contains(Xe, t)) return Ve(t, _e[e], !1, r, n, a);
            ...
            function ir(t, e) {
                ...
                throw new o(
                    "Invalid delimiter: '" + (r ? r.text : JSON.stringify(t)) + "' after '" + e.funcName + "'",
                    t
                );
            }
            function or(t) {
            ...
            Zt({
                ...
                htmlBuilder: function(t, e) {
                    return '.' === t.delim ? Dt.makeSpan([t.mclass]) : tr(t.delim, t.size, e, t.mode, [t.mclass]);
                },
                ...
                Zt({
                    ...
                    handler: function(t, e) {
                        ...
                        return { type: 'leftright', mode: n.mode, body: a, left: r.text, right: i.delim };
                    },
                    htmlBuilder: function(t, e) {
                        or(t);
                        for (
                            var r, n, a = ae(t.body, e, !0, ['mopen', 'mclose']), i = 0, o = 0, s = !1, h = 0;
                            h < a.length;
                            h++
                        )
                            a[h].isMiddle ? (s = !0) : ((i = Math.max(a[h].height, i)), (o = Math.max(a[h].depth, o)));
                        if (
                            ((i *= e.sizeMultiplier),
                            (o *= e.sizeMultiplier),
                            (r = '.' === t.left ? he(e, ['mopen']) : rr(t.left, i, o, e, t.mode, ['mopen'])),
                            a.unshift(r),
                            s)
                        )
                        ...
                        return (
                            (n = '.' === t.right ? he(e, ['mclose']) : rr(t.right, i, o, e, t.mode, ['mclose'])),
                            a.push(n),
            ...
            var sr = function(t, e) {
                    var r,
                        n,
                        a = Dt.wrapFragment(le(t.body, e), e),
                        i = t.label.substr(1),
                        o = e.sizeMultiplier,
                        s = 0,
                    ...
                    if ('sout' === i)
                        ...
                        /cancel/.test(i) ? h || a.classes.push('cancel-pad') : a.classes.push('boxpad');
                        var l = 0;
                        (l = /box/.test(i) ? ('colorbox' === i ? 0.3 : 0.34) : h ? 0.2 : 0),
                            (r = Be(a, i, l, e)),
                            (s = a.depth + l),
                            t.backgroundColor &&
                    ...
                    return (
                        ...
                        /cancel/.test(i) && ((n.height = a.height), (n.depth = a.depth)),
                        /cancel/.test(i) && !h
                            ? Dt.makeSpan(['mord', 'cancel-lap'], [n], e)
            ...
            function cr(t) {
                var e = [];
                t.consumeSpaces();
                for (var r = t.nextToken.text; '\\hline' === r || '\\hdashline' === r; )
                    t.consume(), e.push('\\hdashline' === r), t.consumeSpaces(), (r = t.nextToken.text);
                return e;
            }
            function ur(t, e, r) {
                ...
                for (u.push(cr(t)); ; ) {
                    ...
                    if ('&' === p) t.consume();
                        ...
                        if ('\\end' === p) {
                            1 === l.length && 'styling' === d.type && 0 === d.body[0].body.length && m.pop(),
                                u.length < m.length + 1 && u.push([]);
                            break;
                        }
                        if ('\\cr' !== p) throw new o('Expected & or \\\\ or \\cr or \\end', t.nextToken);
                        var f = Ht(t.parseFunction(), 'cr');
            ...
            var pr = function(t, e) {
                    var r,
                        ...
                        v = 0;
                    function y(t) {
                        for (var e = 0; e < t.length; ++e) e > 0 && (v += 0.25), l.push({ pos: v, isDashed: t[e] });
                    }
                    for (y(i[0]), r = 0; r < t.body.length; ++r) {
                        ...
                        for (n = 0; n < b.length; ++n) {
                            var z = le(b[n], e);
                            k < z.depth && (k = z.depth), w < z.height && (w = z.height), (S[n] = z);
                        }
                        var M = t.rowGaps[r],
                            T = 0;
                        M && (T = Mt(M, e)) > 0 && (k < (T += x) && (k = T), (T = 0)),
                            t.addJot && (k += p),
                            (S.height = w),
                            (S.depth = k),
                            (v += w),
                    ...
                    for (n = 0, B = 0; n < s || B < N.length; ++n, ++B) {
                        for (var E = N[B] || {}, O = !0; 'separator' === E.type; ) {
                            if (
                                (O ||
                                    (((A = Dt.makeSpan(['arraycolsep'], [])).style.width =
                                        e.fontMetrics().doubleRuleSep + 'em'),
                                    q.push(A)),
                                '|' === E.separator)
                            ) {
                                var I = Dt.makeSpan(['vertical-separator'], [], e);
                                (I.style.height = v + 'em'), (I.style.verticalAlign = -(v - C) + 'em'), q.push(I);
                            } else {
                                if (':' !== E.separator) throw new o('Invalid separator type: ' + E.separator);
                                var R = Dt.makeSpan(['vertical-separator', 'vs-dashed'], [], e);
                                (R.style.height = v + 'em'), (R.style.verticalAlign = -(v - C) + 'em'), q.push(R);
                            }
                            (E = N[++B] || {}), (O = !1);
                        }
                        if (!(n >= s)) {
                            ...
                            (n > 0 || t.hskipBeforeAndAfter) &&
                                0 !== (L = c.deflt(E.pregap, u)) &&
                                (((A = Dt.makeSpan(['arraycolsep'], [])).style.width = L + 'em'), q.push(A));
                            var D = [];
                            for (r = 0; r < a; ++r) {
                                var H = h[r],
                                    P = H[n];
                                if (P) {
                                    ...
                                    (P.depth = H.depth),
                                        (P.height = H.height),
                                        D.push({ type: 'elem', elem: P, shift: F });
                                }
                            }
                            (D = Dt.makeVList({ positionType: 'individualShift', children: D }, e)),
                                (D = Dt.makeSpan(['col-align-' + (E.align || 'c')], [D])),
                                q.push(D),
                                (n < s - 1 || t.hskipBeforeAndAfter) &&
                                    0 !== (L = c.deflt(E.postgap, u)) &&
                                    (((A = Dt.makeSpan(['arraycolsep'], [])).style.width = L + 'em'), q.push(A));
                        }
                    }
                    if (((h = Dt.makeSpan(['mtable'], q)), l.length > 0)) {
                        for (
                            var V = Dt.makeLineSpan('hline', e, 0.05),
                                U = Dt.makeLineSpan('hdashline', e, 0.05),
                            ...
                            var X = l.pop(),
                                Y = X.pos - C;
                            X.isDashed
                                ? G.push({ type: 'elem', elem: U, shift: Y })
                                : G.push({ type: 'elem', elem: V, shift: Y });
                        }
                        h = Dt.makeVList({ positionType: 'individualShift', children: G }, e);
                    }
                ...
                gr = function(t, e) {
                    ...
                    a.body.forEach(function(t) {
                        for (var e = 1; e < t.length; e += 2) {
                            var n = Ht(t[e], 'styling');
                            Ht(n.body[0], 'ordgroup').body.unshift(s);
                        }
                        if (c) i < t.length && (i = t.length);
                        else {
                            var a = t.length / 2;
                            if (r < a) throw new o('Too many math in a row: expected ' + r + ', but got ' + a, t[0]);
                        }
                    });
                    for (var u = 0; u < i; ++u) {
                        var d = 'r',
            ...
            mr({
                ...
                handler: function(t, e) {
                    var r = {
                        cols: (Vt(e[0]) ? [e[0]] : Ht(e[0], 'ordgroup').body).map(function(t) {
                            var e = (function(t) {
                                var e = Vt(t);
                                if (!e)
                                    throw new Error(
                ...
                mr({
                    ...
                    props: { numArgs: 0 },
                    handler: function(t) {
                        return ur(t.parser, { cols: [{ type: 'align', align: 'c' }], addJot: !0 }, 'display');
                    },
                    htmlBuilder: pr,
                    mathmlBuilder: fr,
                }),
            ...
            Zt({
                ...
                handler: function(t, e) {
                    ...
                    if ('\\begin' === n) {
                        if (!xr.hasOwnProperty(i)) throw new o('No such environment: ' + i, a);
                        var h = xr[i],
                        ...
                        if (f.name !== i)
                            throw new o('Mismatch: \\begin{' + i + '} matched by \\end{' + f.name + '}', p);
                        return d;
                    }
            ...
            Zt({
                ...
                handler: function(t, e) {
                    var r = t.parser,
                        n = t.funcName,
                        a = e[0];
                    return { type: 'mclass', mode: r.mode, mclass: 'm' + n.substr(5), body: Jt(a) };
                },
                htmlBuilder: yr,
                mathmlBuilder: br,
            });
            ...
            Zt({
                ...
                props: { numArgs: 2 },
                handler: function(t, e) {
                    return { type: 'mclass', mode: t.parser.mode, mclass: wr(e[0]), body: [e[1]] };
                },
            }),
                Zt({
                    type: 'mclass',
            ...
            Zt({
                ...
                handler: function(t, e) {
                    var r = t.parser,
                        ...
                        a = e[0],
                        i = n;
                    return i in zr && (i = zr[i]), { type: 'font', mode: r.mode, font: i.slice(1), body: a };
                },
                htmlBuilder: kr,
                mathmlBuilder: Sr,
            }),
            ...
            var Mr = function(t, e) {
                    ...
                    if (
                        (t.hasBarLine
                            ? (t.barSize
                                  ? ((m = Mt(t.barSize, e)), (l = Dt.makeLineSpan('frac-line', e, m)))
                                  : (l = Dt.makeLineSpan('frac-line', e)),
                              (m = l.height),
                              (c = l.height))
                            : ((l = null), (m = 0), (c = e.fontMetrics().defaultRuleThickness)),
                        r.size === w.DISPLAY.size
                            ? ((u = e.fontMetrics().num1), (d = m > 0 ? 3 * c : 7 * c), (p = e.fontMetrics().denom1))
                            : (m > 0
                        ...
                        u - o.depth - (b + 0.5 * m) < d && (u += d - (u - o.depth - (b + 0.5 * m))),
                            b - 0.5 * m - (y.height - p) < d && (p += d - (b - 0.5 * m - (y.height - p)));
                        var k = -(b - 0.5 * m);
                        f = Dt.makeVList(
                            {
                                positionType: 'individualShift',
                    ...
                    return (
                        ...
                        (g = r.size === w.DISPLAY.size ? e.fontMetrics().delim1 : e.fontMetrics().delim2),
                        (x =
                            null == t.leftDelim
                                ? he(e, ['mopen'])
                                : er(t.leftDelim, g, !0, e.havingStyle(r), t.mode, ['mopen'])),
                        (v = t.continued
                            ? Dt.makeSpan([])
                            : null == t.rightDelim
                            ? he(e, ['mclose'])
                            : er(t.rightDelim, g, !0, e.havingStyle(r), t.mode, ['mclose'])),
                        Dt.makeSpan(['mord'].concat(n.sizingClasses(e)), [x, Dt.makeSpan(['mfrac'], [f]), v], e)
                    );
                },
                Tr = function(t, e) {
                    var r = new fe.MathNode('mfrac', [we(t.numer, e), we(t.denom, e)]);
                    if (t.hasBarLine) {
                        if (t.barSize) {
                    ...
                    if (null != t.leftDelim || null != t.rightDelim) {
                        var a = [];
                        if (null != t.leftDelim) {
                            var i = new fe.MathNode('mo', [new fe.TextNode(t.leftDelim)]);
                            i.setAttribute('fence', 'true'), a.push(i);
                        }
                        if ((a.push(r), null != t.rightDelim)) {
                            var o = new fe.MathNode('mo', [new fe.TextNode(t.rightDelim)]);
            ...
            Zt({
                ...
                Zt({
                    ...
                    handler: function(t) {
                        ...
                        return { type: 'infix', mode: r.mode, replaceWith: e, token: a };
                    },
                });
            ...
            Zt({
                ...
                handler: function(t, e) {
                    ...
                    if (d) {
                        if (d.body.length > 0) {
                            var p = Ht(d.body[0], 'textord');
                            u = Ar[Number(p.text)];
                        }
                    } else (d = Ht(e[3], 'textord')), (u = Ar[Number(d.text)]);
                    return {
                        type: 'genfrac',
                        mode: r.mode,
                        numer: n,
            ...
            var Cr = function(t, e) {
                var r,
                    ...
                    i = Pt(t, 'supsub');
                i
                    ? ((r = i.sup ? le(i.sup, e.havingStyle(a.sup()), e) : le(i.sub, e.havingStyle(a.sub()), e)),
                      (n = Ht(i.base, 'horizBrace')))
                    : (n = Ht(t, 'horizBrace'));
                var o,
                ...
                if (
                    ...
                    var l = Dt.makeSpan(['mord', n.isOver ? 'mover' : 'munder'], [o], e);
                    o = n.isOver
                        ? Dt.makeVList(
                              {
                                  positionType: 'firstBaseline',
                ...
                return Dt.makeSpan(['mord', n.isOver ? 'mover' : 'munder'], [o], e);
            };
            Zt({
                type: 'horizBrace',
                ...
                mathmlBuilder: function(t, e) {
                    var r = Ce(t.label);
                    return new fe.MathNode(t.isOver ? 'mover' : 'munder', [we(t.base, e), r]);
                },
            }),
                Zt({
                    type: 'href',
                    ...
                    mathmlBuilder: function(t, e) {
                        var r = be(t.body, e);
                        return r instanceof de || (r = new de('mrow', [r])), r.setAttribute('href', t.href), r;
                    },
                }),
                Zt({
                    type: 'href',
                    ...
                    handler: function(t, e) {
                        for (var r = t.parser, n = Ht(e[0], 'url').url, a = [], i = 0; i < n.length; i++) {
                            var o = n[i];
                ...
                Zt({
                    ...
                    handler: function(t, e) {
                        return { type: 'htmlmathml', mode: t.parser.mode, html: Jt(e[0]), mathml: Jt(e[1]) };
                    },
                    htmlBuilder: function(t, e) {
                        var r = ae(t.html, e, !1);
                        return Dt.makeFragment(r);
                ...
                Zt({
                    ...
                    htmlBuilder: function(t, e) {
                        var r;
                        'clap' === t.alignment
                            ? ((r = Dt.makeSpan([], [le(t.body, e)])), (r = Dt.makeSpan(['inner'], [r], e)))
                            : (r = Dt.makeSpan(['inner'], [le(t.body, e)]));
                        ...
                        return (
                            ...
                            (a = Dt.makeVList(
                                { positionType: 'firstBaseline', children: [{ type: 'elem', elem: a }] },
                                e
                            )),
            ...
            var qr = function(t, e) {
                    var r,
                        ...
                        i = !1,
                        o = Pt(t, 'supsub');
                    o ? ((r = o.sup), (n = o.sub), (a = Ht(o.base, 'op')), (i = !0)) : (a = Ht(t, 'op'));
                    var s,
                        h = e.style,
                        l = !1;
                    if (
                        (h.size === w.DISPLAY.size && a.symbol && !c.contains(['\\smallint'], a.name) && (l = !0),
                        a.symbol)
                    ) {
                        ...
                        if (
                            (('\\oiint' !== a.name && '\\oiiint' !== a.name) ||
                                ((u = a.name.substr(1)), (a.name = 'oiint' === u ? '\\iint' : '\\iiint')),
                            (s = Dt.makeSymbol(a.name, m, 'math', e, [
                                'mop',
                                'op-symbol',
                                l ? 'large-op' : 'small-op',
                            ])),
                        ...
                        for (var g = [], x = 1; x < a.name.length; x++) g.push(Dt.mathsym(a.name[x], a.mode));
                        s = Dt.makeSpan(['mop'], g, e);
                    }
                    var v = 0,
                        y = 0;
                    if (
                        ((s instanceof I || '\\oiint' === a.name || '\\oiiint' === a.name) &&
                            !a.suppressBaseShift &&
                            ((v = (s.height - s.depth) / 2 - e.fontMetrics().axisHeight), (y = s.italic)),
                        i)
                    ) {
                        var b, k, S;
                        if (((s = Dt.makeSpan([], [s])), r)) {
                            var z = le(r, e.havingStyle(h.sup()), e);
                            k = {
                                elem: z,
                                kern: Math.max(e.fontMetrics().bigOpSpacing1, e.fontMetrics().bigOpSpacing3 - z.depth),
                            };
                        }
                        if (n) {
                            var M = le(n, e.havingStyle(h.sub()), e);
                            b = {
                                elem: M,
                                kern: Math.max(e.fontMetrics().bigOpSpacing2, e.fontMetrics().bigOpSpacing4 - M.height),
                            };
                        }
                        if (k && b) {
                            var T = e.fontMetrics().bigOpSpacing5 + b.elem.height + b.elem.depth + b.kern + s.depth + v;
                            S = Dt.makeVList(
                                {
                                    positionType: 'bottom',
                                    positionData: T,
                        ...
                        return Dt.makeSpan(['mop', 'op-limits'], [S], e);
                    }
            ...
            Zt({
                ...
                handler: function(t, e) {
                    var r = t.parser,
                        n = t.funcName;
                    return 1 === n.length && (n = Or[n]), { type: 'op', mode: r.mode, limits: !0, symbol: !0, name: n };
                },
                htmlBuilder: qr,
                mathmlBuilder: Er,
            }),
                Zt({
                    ...
                    handler: function(t, e) {
                        var r = t.parser,
                            n = e[0];
                        return { type: 'op', mode: r.mode, limits: !1, symbol: !1, body: Jt(n) };
                    },
                    htmlBuilder: qr,
                    mathmlBuilder: Er,
                });
            ...
            function Rr(t, e, r) {
                for (var n = ae(t, e, !1), a = e.sizeMultiplier / r.sizeMultiplier, i = 0; i < n.length; i++) {
            ...
            Zt({
                ...
                Zt({
                    ...
                    handler: function(t) {
                        var e = t.parser,
                            r = t.funcName;
                        return (
                            1 === r.length && (r = Ir[r]), { type: 'op', mode: e.mode, limits: !1, symbol: !0, name: r }
                        );
                    },
                    htmlBuilder: qr,
                    mathmlBuilder: Er,
                    ...
                    htmlBuilder: function(t, e) {
                        if (t.body.length > 0) {
                            for (
                                ...
                                var i = n[a];
                                i instanceof I && (i.text = i.text.replace(/\u2212/, '-').replace(/\u2217/, '*'));
                            }
                            return Dt.makeSpan(['mop'], n, e);
                        }
                        return Dt.makeSpan(['mop'], [], e);
                    },
                    mathmlBuilder: function(t, e) {
                        for (var r = ye(t.body, e.withFont('mathrm')), n = !0, a = 0; a < r.length; a++) {
                            var i = r[a];
                ...
                Kt({
                    ...
                    htmlBuilder: function(t, e) {
                        return t.semisimple
                            ? Dt.makeFragment(ae(t.body, e, !1))
                            : Dt.makeSpan(['mord'], ae(t.body, e, !0), e);
                    },
                    mathmlBuilder: function(t, e) {
                        return be(t.body, e);
                    },
                ...
                Zt({
                    ...
                    htmlBuilder: function(t, e) {
                        ...
                        return Dt.makeSpan(['mord', 'overline'], [a], e);
                    },
                    mathmlBuilder: function(t, e) {
                ...
                Zt({
                    ...
                    htmlBuilder: function(t, e) {
                        var r = Dt.makeSpan([], [le(t.body, e.withPhantom())]);
                ...
                Zt({
                    ...
                    htmlBuilder: function(t, e) {
                        var r = Dt.makeSpan(['inner'], [le(t.body, e.withPhantom())]),
                            n = Dt.makeSpan(['fix'], []);
            ...
            Zt({
                ...
                handler: function(t, e) {
                    ...
                    return { type: 'sizing', mode: a.mode, size: Lr.indexOf(n) + 1, body: i };
                },
                htmlBuilder: Dr,
                mathmlBuilder: function(t, e) {
                    var r = e.havingSize(t.size),
                ...
                Zt({
                    ...
                    htmlBuilder: function(t, e) {
                        var r = { type: 'text', mode: t.mode, body: Jt(t.body), font: 'mathrm' },
                            n = { type: 'sizing', mode: t.mode, body: [r], size: 6 },
                            a = Dr(n, e),
                            i = Mt(t.dy, e);
                        return Dt.makeVList(
                            { positionType: 'shift', positionData: -i, children: [{ type: 'elem', elem: a }] },
                            e
                        );
                    },
                    mathmlBuilder: function(t, e) {
                ...
                Zt({
                    ...
                    handler: function(t, e, r) {
                        ...
                        var l = e[0];
                        return { type: 'smash', mode: n.mode, body: l, smashHeight: a, smashDepth: i };
                    },
                    htmlBuilder: function(t, e) {
                        var r = Dt.makeSpan([], [le(t.body, e)]);
                ...
                Zt({
                    ...
                    htmlBuilder: function(t, e) {
                        ...
                        if (t.index) {
                            ...
                            return Dt.makeSpan(['mord', 'sqrt'], [v, d], e);
                        }
                        return Dt.makeSpan(['mord', 'sqrt'], [d], e);
                    },
                    mathmlBuilder: function(t, e) {
                        var r = t.body,
                            n = t.index;
            ...
            Kt({
                ...
                htmlBuilder: function(t, e) {
                    ...
                    if (s) {
                        ...
                        (n = le(s, f, e)),
                            p || (u = l.height - (f.fontMetrics().supDrop * f.sizeMultiplier) / e.sizeMultiplier);
                    }
                    if (h) {
                        var g = e.havingStyle(e.style.sub());
                        (a = le(h, g, e)),
                            p || (d = l.depth + (g.fontMetrics().subDrop * g.sizeMultiplier) / e.sizeMultiplier);
                    }
                    ...
                    if (n && a) {
                        (u = Math.max(u, i, n.depth + 0.25 * m.xHeight)), (d = Math.max(d, m.sub2));
                        var S = 4 * m.defaultRuleThickness;
                        if (u - n.depth - (a.height - d) < S) {
                            d = S - (u - n.depth) + a.height;
                            var z = 0.8 * m.xHeight - (u - n.depth);
                            z > 0 && ((u += z), (d -= z));
                        }
                        var M = [
                            { type: 'elem', elem: a, shift: d, marginRight: y, marginLeft: b },
                            { type: 'elem', elem: n, shift: -u, marginRight: y },
                        ];
                        x = Dt.makeVList({ positionType: 'individualShift', children: M }, e);
                    } else if (a) {
                        d = Math.max(d, m.sub1, a.height - 0.8 * m.xHeight);
                        var T = [{ type: 'elem', elem: a, marginLeft: b, marginRight: y }];
                        x = Dt.makeVList({ positionType: 'shift', positionData: d, children: T }, e);
                    } else {
                    ...
                    return Dt.makeSpan([A], [l, Dt.makeSpan(['msupsub'], [x])], e);
                },
                mathmlBuilder: function(t, e) {
                    var r,
                        n = !1,
                        a = Pt(t.base, 'horizBrace');
                    a && !!t.sup === a.isOver && ((n = !0), (r = a.isOver));
                    var i,
                        o = [we(t.base, e)];
                    if ((t.sub && o.push(we(t.sub, e)), t.sup && o.push(we(t.sup, e)), n)) i = r ? 'mover' : 'munder';
                    else if (t.sub)
                        if (t.sup) {
                            var s = t.base;
                            ...
                            var h = t.base;
                            i = h && 'op' === h.type && h.limits && e.style === w.DISPLAY ? 'munder' : 'msub';
                        }
                    else {
                        var l = t.base;
                        i = l && 'op' === l.type && l.limits && e.style === w.DISPLAY ? 'mover' : 'msup';
                    }
            ...
            var Pr = { mi: 'italic', mn: 'normal', mtext: 'normal' };
            Kt({
                type: 'mathord',
                htmlBuilder: function(t, e) {
                ...
                mathmlBuilder: function(t, e) {
                    var r = new fe.MathNode('mi', [ge(t.text, t.mode, e)]),
                        n = ve(t, e) || 'italic';
                    return n !== Pr[r.type] && r.setAttribute('mathvariant', n), r;
                },
            }),
                Kt({
                    type: 'textord',
                    ...
                    mathmlBuilder: function(t, e) {
                        ...
                        return (
                            ...
                            a !== Pr[r.type] && r.setAttribute('mathvariant', a),
                            r
                        );
                    },
                });
            ...
            Kt({
                ...
                htmlBuilder: function(t, e) {
                    ...
                    if (Fr.hasOwnProperty(t.text)) return Dt.makeSpan(['mspace', Fr[t.text]], [], e);
                    throw new o('Unknown type of space "' + t.text + '"');
                },
                mathmlBuilder: function(t, e) {
                    if (!Vr.hasOwnProperty(t.text)) {
                        if (Fr.hasOwnProperty(t.text)) return new fe.MathNode('mspace');
                        throw new o('Unknown type of space "' + t.text + '"');
                    }
                    return new fe.MathNode('mtext', [new fe.TextNode('\xa0')]);
                },
            }),
                Kt({
                    type: 'tag',
            ...
            Zt({
                ...
                Zt({
                    ...
                    htmlBuilder: function(t, e) {
                        ...
                        return Dt.makeSpan(['mord', 'underline'], [a], e);
                    },
                    mathmlBuilder: function(t, e) {
                        var r = new fe.MathNode('mo', [new fe.TextNode('\u203e')]);
                        r.setAttribute('stretchy', 'true');
                ...
                Zt({
                    ...
                    htmlBuilder: function(t, e) {
                        for (var r = _r(t), n = [], a = e.havingStyle(e.style.text()), i = 0; i < r.length; i++) {
                            var o = r[i];
                            '~' === o && (o = '\\textasciitilde'),
                ...
                Kr = (function() {
                    ...
                    return (
                        ...
                        (e.lex = function() {
                            ...
                            var h = i.match(jr);
                            return h && (i = h[1]), new a(i, new n(this, e, this.tokenRegex.lastIndex));
                        }),
                        t
                    );
                })(),
                Jr = (function() {
                    ...
                    return (
                        ...
                        (e.endGroup = function() {
                            ...
                            for (var e in t)
                                t.hasOwnProperty(e) &&
                                    (void 0 === t[e] ? delete this.current[e] : (this.current[e] = t[e]));
                        }),
                        (e.has = function(t) {
            ...
            en('\\char', function(t) {
                ...
                if (e) {
                    if (null == (n = rn[r.text]) || n >= e) throw new o('Invalid base-' + e + ' digit ' + r.text);
                    for (var a; null != (a = rn[t.future().text]) && a < e; ) (n *= e), (n += a), t.popToken();
                }
                return '\\@char{' + n + '}';
            });
            var nn = function(t, e) {
            ...
            var an = function(t, e, r) {
                ...
                if (1 === (n = t.consumeArgs(1)[0]).length && '[' === n[0].text) {
                    for (var h = '', l = t.expandNextToken(); ']' !== l.text && 'EOF' !== l.text; )
            ...
            en('\\newcommand', function(t) {
                ...
                en('\\aa', '\\r a'),
                en('\\AA', '\\r A'),
                en('\\textcopyright', '\\html@mathml{\\textcircled{c}}{\\char`\xa9}'),
                en('\\copyright', '\\TextOrMath{\\textcopyright}{\\text{\\textcopyright}}'),
                en('\\textregistered', '\\html@mathml{\\textcircled{\\scriptsize R}}{\\char`\xae}'),
                en('\u212c', '\\mathscr{B}'),
                en('\u2130', '\\mathscr{E}'),
                en('\u2131', '\\mathscr{F}'),
                en('\u210b', '\\mathscr{H}'),
                ...
                en('\u2259', '\\html@mathml{\\stackrel{\\tiny\\wedge}{=}}{\\mathrel{\\char`\u2258}}'),
                en('\u225a', '\\html@mathml{\\stackrel{\\tiny\\vee}{=}}{\\mathrel{\\char`\u225a}}'),
                en('\u225b', '\\html@mathml{\\stackrel{\\scriptsize\\star}{=}}{\\mathrel{\\char`\u225b}}'),
                en('\u225d', '\\html@mathml{\\stackrel{\\tiny\\mathrm{def}}{=}}{\\mathrel{\\char`\u225d}}'),
                en('\u225e', '\\html@mathml{\\stackrel{\\tiny\\mathrm{m}}{=}}{\\mathrel{\\char`\u225e}}'),
                en('\u225f', '\\html@mathml{\\stackrel{\\tiny?}{=}}{\\mathrel{\\char`\u225f}}'),
                en('\u27c2', '\\perp'),
            ...
            en('\\dots', function(t) {
                ...
                return (
                    r in on
                        ...
                        : '\\not' === r.substr(0, 4)
                        ? (e = '\\dotsb')
                        : r in _.math && c.contains(['bin', 'rel'], _.math[r].group) && (e = '\\dotsb'),
                    e
                );
            });
            var sn = {
            ...
            en('\\dotso', function(t) {
                ...
                en('\\pod', '\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern8mu}{\\mkern8mu}{\\mkern8mu}(#1)'),
                ...
                en('\\\\', '\\newline'),
                en('\\TeX', '\\textrm{\\html@mathml{T\\kern-.1667em\\raisebox{-.5ex}{E}\\kern-.125emX}{TeX}}');
            var hn = H['Main-Regular']['T'.charCodeAt(0)][1] - 0.7 * H['Main-Regular']['A'.charCodeAt(0)][1] + 'em';
            en(
                '\\LaTeX',
                '\\textrm{\\html@mathml{L\\kern-.36em\\raisebox{' + hn + '}{\\scriptsize A}\\kern-.15em\\TeX}{LaTeX}}'
            ),
                en(
                    '\\KaTeX',
                ...
                en('\\dblcolon', '\\mathrel{\\vcentcolon\\mathrel{\\mkern-.9mu}\\vcentcolon}'),
                en('\\coloneqq', '\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}=}'),
                en('\\Coloneqq', '\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}=}'),
                en('\\coloneq', '\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}\\mathrel{-}}'),
                en('\\Coloneq', '\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}\\mathrel{-}}'),
                en('\\eqqcolon', '\\mathrel{=\\mathrel{\\mkern-1.2mu}\\vcentcolon}'),
                en('\\Eqqcolon', '\\mathrel{=\\mathrel{\\mkern-1.2mu}\\dblcolon}'),
                en('\\eqcolon', '\\mathrel{\\mathrel{-}\\mathrel{\\mkern-1.2mu}\\vcentcolon}'),
                en('\\Eqcolon', '\\mathrel{\\mathrel{-}\\mathrel{\\mkern-1.2mu}\\dblcolon}'),
                en('\\colonapprox', '\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}\\approx}'),
                en('\\Colonapprox', '\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}\\approx}'),
                en('\\colonsim', '\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}\\sim}'),
                en('\\Colonsim', '\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}\\sim}'),
                en('\u2254', '\\coloneqq'),
                en('\u2255', '\\eqqcolon'),
                en('\u2a74', '\\Coloneqq'),
                en('\\ratio', '\\vcentcolon'),
                ...
                en('\\simcolon', '\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\vcentcolon}'),
                en('\\simcoloncolon', '\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\dblcolon}'),
                en('\\approxcolon', '\\mathrel{\\approx\\mathrel{\\mkern-1.2mu}\\vcentcolon}'),
                en('\\approxcoloncolon', '\\mathrel{\\approx\\mathrel{\\mkern-1.2mu}\\dblcolon}'),
                en('\\notni', '\\html@mathml{\\not\\ni}{\\mathrel{\\char`\u220c}}'),
                en('\\limsup', '\\DOTSB\\mathop{\\operatorname{lim\\,sup}}\\limits'),
                en('\\liminf', '\\DOTSB\\mathop{\\operatorname{lim\\,inf}}\\limits'),
                ...
                en('\\weierp', '\\wp'),
                en('\\Zeta', '\\mathrm{Z}'),
                en('\\argmin', '\\DOTSB\\mathop{\\operatorname{arg\\,min}}\\limits'),
                en('\\argmax', '\\DOTSB\\mathop{\\operatorname{arg\\,max}}\\limits');
            var ln = { '\\relax': !0, '^': !0, _: !0, '\\limits': !0, '\\nolimits': !0 },
                mn = (function() {
                    function t(t, e, r) {
                        (this.settings = void 0),
                    ...
                    return (
                        ...
                        (e.expandOnce = function() {
                            ...
                            var n = r.tokens;
                            if (r.numArgs)
                                for (var a = this.consumeArgs(r.numArgs), i = (n = n.slice()).length - 1; i >= 0; --i) {
                                    var s = n[i];
                                    if ('#' === s.text) {
                                        ...
                                        if ('#' === (s = n[--i]).text) n.splice(i + 1, 1);
                                            ...
                                            var h;
                                            (h = n).splice.apply(h, [i, 2].concat(a[+s.text - 1]));
                                        }
                                    }
                                }
                        ...
                        (e.expandMacro = function(t) {
                            if (this.macros.get(t)) {
                                ...
                                for (this.pushToken(new a(t)); this.stack.length > r; ) {
                                    this.expandOnce() instanceof a && e.push(this.stack.pop());
                                }
                                return e;
                            }
                        }),
                        ...
                        (e._getExpansion = function(t) {
                            ...
                            if ('string' == typeof r) {
                                ...
                                for (var i = new Kr(r, this.settings), o = [], s = i.lex(); 'EOF' !== s.text; )
                                    o.push(s), (s = i.lex());
                        ...
                        (e.isDefined = function(t) {
                            return (
                                this.macros.has(t) ||
                                Wr.hasOwnProperty(t) ||
                                _.math.hasOwnProperty(t) ||
                                _.text.hasOwnProperty(t) ||
                                ln.hasOwnProperty(t)
                            );
                        }),
                        t
                    ...
                    return (
                        (e.expect = function(t, e) {
                            if ((void 0 === e && (e = !0), this.nextToken.text !== t))
                                throw new o("Expected '" + t + "', got '" + this.nextToken.text + "'", this.nextToken);
                            e && this.consume();
                        }),
                        (e.consume = function() {
                        ...
                        (e.parseExpression = function(e, r) {
                            for (var n = []; ; ) {
                                ...
                                if (r && a.text === r) break;
                                if (e && Wr[a.text] && Wr[a.text].infix) break;
                        ...
                        (e.handleInfixNodes = function(t) {
                            for (var e, r = -1, n = 0; n < t.length; n++) {
                                var a = Pt(t[n], 'infix');
                                if (a) {
                                    if (-1 !== r) throw new o('only one infix operator per group', a.token);
                                    (r = n), (e = a.replaceWith);
                                }
                            }
                            if (-1 !== r && e) {
                        ...
                        (e.handleUnsupportedCmd = function() {
                            for (var t = this.nextToken.text, e = [], r = 0; r < t.length; r++)
                                e.push({ type: 'textord', mode: 'text', text: t[r] });
                            var n = { type: 'text', mode: this.mode, body: e },
                                a = { type: 'color', mode: this.mode, color: this.settings.errorColor, body: [n] };
                        ...
                        (e.parseAtom = function(t) {
                            ...
                            for (;;) {
                                ...
                                if ('\\limits' === a.text || '\\nolimits' === a.text) {
                                    var i = Pt(n, 'op');
                                    if (!i) throw new o('Limit controls must follow a math operator', a);
                                    var s = '\\limits' === a.text;
                                    ...
                                    var h = { type: 'textord', mode: this.mode, text: '\\prime' },
                                        l = [h];
                                    for (this.consume(); "'" === this.nextToken.text; ) l.push(h), this.consume();
                                    '^' === this.nextToken.text && l.push(this.handleSupSubscript('superscript')),
                        ...
                        (e.parseFunction = function(t, e, r) {
                            ...
                            if (
                                (i.argTypes && 'url' === i.argTypes[0] && this.gullet.lexer.setCatcode('%', 13),
                                i.consumeMode)
                            ) {
                                var s = this.mode;
                        ...
                        (e.callFunction = function(t, e, r, n, a) {
                            var i = { funcName: t, parser: this, token: n, breakOnTokenText: a },
                                s = Wr[t];
                        ...
                        (e.parseArguments = function(t, e) {
                            ...
                            for (var n = e.greediness, a = [], i = [], s = 0; s < r; s++) {
                                ...
                                s > 0 && !l && this.consumeSpaces(),
                                    0 !== s || l || 'math' !== this.mode || this.consumeSpaces();
                                var m = this.nextToken,
                                    c = this.parseGroupOfType("argument to '" + t + "'", h, l, n);
                                if (!c) {
                                    if (l) {
                                        i.push(null);
                                        continue;
                        ...
                        (e.parseGroupOfType = function(t, e, r, n) {
                            switch (e) {
                                ...
                                case 'raw':
                                    ...
                                    if (a) return { type: 'raw', mode: 'text', string: a.text };
                                ...
                                default:
                                    throw new o('Unknown group type as ' + t, this.nextToken);
                            }
                        }),
                        (e.consumeSpaces = function() {
                        ...
                        (e.parseStringGroup = function(t, e, r) {
                            ...
                            if (i.text !== n) {
                                ...
                                if (r && 'EOF' !== i.text && /[^{}[\]]/.test(i.text))
                                    return this.gullet.lexer.setCatcode('%', 14), this.consume(), i;
                            }
                            var s = this.mode;
                            ...
                            for (
                                ...
                                switch (this.nextToken.text) {
                                    case 'EOF':
                                        throw new o('Unexpected end of input in ' + t, l.range(c, h));
                                    case n:
                                        m++;
                                        break;
                                    case a:
                            ...
                            return (
                                (this.mode = s), this.gullet.lexer.setCatcode('%', 14), this.expect(a), l.range(c, h)
                            );
                        }),
                        (e.parseRegexGroup = function(t, e) {
                            ...
                            for (
                                ...
                                'EOF' !== this.nextToken.text && t.test(i + this.nextToken.text);

                            )
                                (i += (a = this.nextToken).text), this.consume();
                            if ('' === i) throw new o('Invalid ' + e + ": '" + n.text + "'", n);
                        ...
                        (e.parseSizeGroup = function(t) {
                            ...
                            if (('string' != typeof (a = i) && (a = a.unit), !(a in St || a in zt || 'ex' === a)))
                        ...
                        (e.parseGroup = function(e, r, a, i, s) {
                            var h,
                                ...
                                c = this.nextToken,
                                u = c.text;
                            if ((s && this.switchMode(s), r ? '[' === u : '{' === u || '\\begingroup' === u)) {
                                (h = t.endOfGroup[u]), this.gullet.beginGroup(), this.consume();
                                ...
                                null == (l = this.parseFunction(i, e, a) || this.parseSymbol()) &&
                                '\\' === u[0] &&
                                !ln.hasOwnProperty(u)
                            ) {
                                ...
                                this.settings.strict &&
                                    (z(e.charCodeAt(0))
                                        ? 'math' === this.mode &&
                                          this.settings.reportNonstrict(
                                              'unicodeTextInMathMode',
                                              'Unicode text character "' + e[0] + '" used in math mode',
                                              t
                                          )
                                        : this.settings.reportNonstrict(
                                              'unknownSymbol',
                                    ...
                                    (i = { type: 'textord', mode: this.mode, loc: n.range(t), text: e });
                            }
                            if ((this.consume(), s))
                                for (var u = 0; u < s[0].length; u++) {
                                    var d = s[0][u];
                                    if (!cn[d]) throw new o("Unknown accent ' " + d + "'", t);
                                    var p = cn[d][this.mode];
                                    if (!p) throw new o('Accent ' + d + ' unsupported in ' + this.mode + ' mode', t);
                                    i = {
                                        type: 'accent',
                                        mode: this.mode,
                                        loc: n.range(t),
            ...
            (dn.endOfExpression = ['}', '\\endgroup', '\\end', '\\right', '&']),
                (dn.endOfGroup = { '[': ']', '{': '}', '\\begingroup': '\\endgroup' }),
            ...
            var gn = function(t, e, r) {
                    ...
                    var n = Dt.makeSpan(['katex-error'], [new I(e)]);
                ...
                vn = {
                    ...
                    __defineSymbol: W,
                    __defineMacro: en,
                    __domTree: { Span: q, Anchor: E, SymbolNode: I, SvgNode: R, PathNode: L, LineNode: D },
                };
            e.default = vn;
        },
    ]).default;
