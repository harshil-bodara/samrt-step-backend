...
!(function(e, t) {
        ...
        _extends(this, {
            ...
            install: function() {
                if (!i.inputEventPatched) {
                    ...
                    for (
                        var n = ['select', 'input[type="checkbox"]', 'input[type="radio"]', 'input[type="file"]'],
                            r = 0;
                        r < n.length;
                        r++
                    ) {
    ...
    h.prototype = {
        validate: function(e, t) {
            ...
            if (this.validateNumber)
                return (
                    !isNaN(e) && ((arguments[0] = parseFloat(arguments[0])), this.validateNumber.apply(this, arguments))
                );
    ...
    p.prototype = {
        ...
        updateValidator: function(e, t, i) {
            return this.validators[e]
                ...
                : (a.warn('Validator "' + e + '" is not already defined.'), this.addValidator.apply(this, arguments));
        },
        removeValidator: function(e) {
            return (
                this.validators[e] || a.warn('Validator "' + e + '" is not defined.'), delete this.validators[e], this
            );
        },
        ...
        (y.Field = {
            ...
            getErrorsMessages: function() {
                ...
                for (var e = [], t = 0; t < this.validationResult.length; t++)
                    e.push(
                        this.validationResult[t].errorMessage || this._getErrorMessage(this.validationResult[t].assert)
                    );
                return e;
            },
            addError: function(e) {
            ...
            _insertErrorWrapper: function() {
                ...
                if ('string' == typeof t) {
                    ...
                    'function' == typeof window[t]
                        ? (t = window[t])
                        : a.warn('The errors container `' + t + '` does not exist in DOM nor as a global JS function');
                }
                return (
    ...
    var F = function(e, t, i, n, r) {
            ...
            (n = n || e.options[t + 'Priority'] || a.priority),
                (r = !0 === r),
                _extends(this, { validator: a, name: t, requirements: i, priority: n, isDomConstraint: r }),
            ...
            return (
                ...
                a.all([r]).fail(function(e) {
                    n.validationResult instanceof Array || (n.validationResult = []),
                        n.validationResult.push({ assert: i, errorMessage: 'string' == typeof e && e });
                })
            );
        },
        getValue: function() {
    ...
    var P = function(t, i, n) {
        ...
        if (r)
            return (
                'undefined' != typeof n && r.parent === window.Parsley && ((r.parent = n), r._resetOptions(r.options)),
    ...
    P.prototype = {
        ...
        handleMultiple: function() {
            ...
            if (
                ...
                return (
                    (this.options.multiple = this.options.multiple || this.__id__), this.bind('parsleyFieldMultiple')
                );
        ...
        bind: function(t, i) {
            ...
            switch (t) {
                case 'parsleyForm':
                    n = e
                        .extend(new w(this.element, this.domOptions, this.options), new l(), window.ParsleyExtend)
                        ._bindFields();
                    break;
                case 'parsleyField':
                    n = e.extend(
    ...
    (window.ParsleyValidator = {}),
        ...
        (window.ParsleyUI = {
            ...
            getErrorsMessages: function(e) {
                return (
                    a.warnOnce("Accessing UI is deprecated. Call 'getErrorsMessages' on the instance directly."),
                    e.getErrorsMessages()
                );
            },
        }),
