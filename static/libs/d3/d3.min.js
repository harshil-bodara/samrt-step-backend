...
!(function(t, n) {
    ...
    function A(t, n) {
        ...
        if (null == n) {
            for (; ++o < i; )
                if (null != (e = t[o]) && e >= e) for (r = e; ++o < i; ) null != (e = t[o]) && e > r && (r = e);
    ...
    function S(t, n) {
        ...
        if (null == n) {
            for (; ++o < i; )
                if (null != (e = t[o]) && e >= e) for (r = e; ++o < i; ) null != (e = t[o]) && r > e && (r = e);
    ...
    function zn(t) {
        ...
        var e,
            ...
            o = On(t.g),
            a = On(t.b),
            u = qn((0.2225045 * i + 0.7168786 * o + 0.0606169 * a) / Tn);
        return (
            i === o && o === a
                ? (e = r = u)
                : ((e = qn((0.4360747 * i + 0.3850649 * o + 0.1430804 * a) / An)),
                  (r = qn((0.0139322 * i + 0.0971045 * o + 0.7141733 * a) / Sn))),
    ...
    Zt(
        ...
        Qt(Jt, {
            ...
            rgb: function() {
                ...
                return new yn(
                    Un(3.1338561 * (n = An * Ln(n)) - 1.6168667 * (t = Tn * Ln(t)) - 0.4906146 * (e = Sn * Ln(e))),
    ...
    Zt(
        ...
        Qt(Jt, {
            brighter: function(t) {
                return (
                    (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new Qn(this.h, this.s, this.l * t, this.opacity)
                );
            },
            darker: function(t) {
                ...
                for (
                    var i =
                            n < e.duration
                                ...
                                : (e.timer.restart(u), (e.state = yr), 1),
                        o = -1,
                        a = r.length;
                    ++o < a;
        ...
        function l() {
            ...
            if (i.apply(this, arguments)) {
                ...
                'overlay' === m
                    ...
                    : ((r = T[0][0]), (a = T[0][1]), (s = T[1][0]), (h = T[1][1])),
                    (o = r),
                    (u = a),
                    (l = s),
                    (d = h);
            ...
            function B() {
                ...
                switch (((p = R[0] - z[0]), (v = R[1] - z[1]), x)) {
                    case vi:
                    case pi:
                        w && ((p = Math.max(S - r, Math.min(E - s, p))), (o = r + p), (l = s + p)),
                            M && ((v = Math.max(k - a, Math.min(C - h, v))), (u = a + v), (d = h + v));
                        break;
                    case gi:
                        w < 0
                            ? ((p = Math.max(S - r, Math.min(E - r, p))), (o = r + p), (l = s))
                            : w > 0 && ((p = Math.max(S - s, Math.min(E - s, p))), (o = r), (l = s + p)),
                            M < 0
                                ? ((v = Math.max(k - a, Math.min(C - a, v))), (u = a + v), (d = h))
                                : M > 0 && ((v = Math.max(k - h, Math.min(C - h, v))), (u = a), (d = h + v));
                        break;
                    case yi:
                        w && ((o = Math.max(S, Math.min(E, r - p * w))), (l = Math.max(S, Math.min(E, s + p * w)))),
                            M && ((u = Math.max(k, Math.min(C, a - v * M))), (d = Math.max(k, Math.min(C, h + v * M))));
                }
                l < o &&
                    ((w *= -1),
                    (t = r),
                    ...
                    y && ((o = T[0][0]), (l = T[1][0])),
                    _ && ((u = T[0][1]), (d = T[1][1])),
                    (T[0][0] === o && T[0][1] === u && T[1][0] === l && T[1][1] === d) ||
                        ((N.selection = [
                            [o, u],
                            [l, d],
                        ]),
    ...
    function po() {
        ...
        function o(e, i) {
            ...
            return (
                (function(e, r, i) {
                    ...
                    for (; ++u < n - 1; ) {
                        for (
                            o = -1, f = e[u * t + t] >= r, s = e[u * t] >= r, ho[(f << 1) | (s << 2)].forEach(p);
                            ++o < t - 1;
        ...
        return (
            ...
            (i.thresholds = function(t) {
                return arguments.length
                    ? ((e = 'function' == typeof t ? t : Array.isArray(t) ? uo(oo.call(t)) : uo(t)), i)
                    : e;
            }),
            (i.smooth = function(t) {
    ...
    function ko(t) {
        ...
        return isNaN(t)
            ? 'Invalid Date'
            : ((n = t.getUTCFullYear()) < 0 ? '-' + So(-n, 6) : n > 9999 ? '+' + So(n, 6) : So(n, 4)) +
                  '-' +
                  So(t.getUTCMonth() + 1, 2) +
                  '-' +
                  So(t.getUTCDate(), 2) +
                  (o
                      ? 'T' + So(e, 2) + ':' + So(r, 2) + ':' + So(i, 2) + '.' + So(o, 3) + 'Z'
                      : i
                      ? 'T' + So(e, 2) + ':' + So(r, 2) + ':' + So(i, 2) + 'Z'
                      : r || e
                      ? 'T' + So(e, 2) + ':' + So(r, 2) + 'Z'
                      : '');
    }
    ...
    (fa.copy = function() {
        ...
        for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop()); )
            for (var i = 0; i < 4; ++i)
                (n = r.source[i]) &&
                    (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = ca(n)));
        return e;
    }),
        (fa.add = function(t) {
    ...
    var Aa = {
        ...
        s: function(t, n) {
            ...
            return o === a
                ...
                : '0.' + new Array(1 - o).join('0') + _a(t, Math.max(0, n + o - 1))[0];
        },
        X: function(t) {
            return Math.round(t)
                .toString(16)
    ...
    var Sa,
        ka = ['y', 'z', 'a', 'f', 'p', 'n', 'µ', 'm', '', 'k', 'M', 'G', 'T', 'P', 'E', 'Z', 'Y'];
    function Ea(t) {
        var n,
            e,
            r =
        ...
        function c(t) {
            var n = (t = wa(t)).fill,
                ...
                p = t.trim,
                v = t.type;
            'n' === v ? ((h = !0), (v = 'g')) : Aa[v] || (null == d && (d = 12), (p = !0), (v = 'g')),
                (s || ('0' === n && '=' === e)) && ((s = !0), (n = '0'), (e = '='));
        ...
        ac = {
            ...
            polygonEnd: function() {
                xu.polygonEnd(),
                    ...
                    (ac.lineStart = fc),
                    (ac.lineEnd = sc),
                    bu < 0 ? ((Ru = -(qu = 180)), (Du = -(Lu = 90))) : oc > Oa ? (Lu = 90) : oc < -Oa && (Du = -90),
                    (Iu[0] = Ru),
                    (Iu[1] = qu);
            },
        };
    ...
    function wc(t, n) {
        ...
        var e = Wa((n *= Xa)),
            ...
            o = tu(n),
            a = $a(
                eu((a = rc * o - ic * i) * a + (a = ic * r - ec * o) * a + (a = ec * i - rc * r) * a),
                ec * r + rc * i + ic * o
            );
        (Hu += a),
            ($u += a * (ec + (ec = r))),
    ...
    function Lc(t, n, e, r, i, o) {
        if (e) {
            ...
            null == i
                ? ((i = n + r * ja), (o = n - c / 2))
                : ((i = Uc(a, i)), (o = Uc(a, o)), (r > 0 ? i < o : i > o) && (i += r * ja));
    ...
    function Hc(t, n) {
        ...
        for (var c = 0, f = t.length; c < f; ++c)
            if ((l = (s = t[c]).length))
                for (
                    var s, l, h = s[l - 1], d = h[0], p = h[1] / 2 + Ia, v = tu(p), g = Wa(p), y = 0;
                    y < l;
                    ++y, d = b, v = x, g = w, h = _
                ) {
                    var _ = s[y],
                        ...
                        : i !== u &&
                          ...
                          (r = (function(t, n, e, r) {
                              var i,
                                  ...
                                  a = tu(t - e);
                              return Ga(a) > Oa
                                  ? Va((tu(n) * (o = Wa(r)) * tu(e) - tu(r) * (i = Wa(n)) * tu(t)) / (i * o * a))
                                  : (n + r) / 2;
                          })(e, r, o, a)),
                          t.point(i, r),
                          t.lineEnd(),
    ...
    function wf() {
        ...
        function b() {
            return g(Za(r / p) * p, e, p)
                .map(s)
                .concat(g(Za(u / v) * v, a, v).map(l))
                .concat(
                    g(Za(n / h) * h, t, h)
                        .filter(function(t) {
                            return Ga(t % p) > Oa;
        ...
        return (
            ...
            (_.precision = function(h) {
                return arguments.length
                    ? ((y = +h), (c = mf(o, i, 90)), (f = xf(n, t, y)), (s = mf(u, a, 90)), (l = xf(r, e, y)), _)
                    : y;
            }),
            _.extentMajor([
                [-180, -90 + Oa],
                  ...
                  function e(r, i, o, a, u, c, f, s, l, h, d, p, v, g) {
                      ...
                      if (b > 4 * n && v--) {
                          var m = a + h,
                              ...
                              C = k - i,
                              P = _ * E - y * C;
                          ((P * P) / b > n || Ga((y * E + _ * C) / b - 0.5) > 0.3 || a * h + u * d + c * p < Es) &&
            ...
            (A.clipExtent = function(t) {
                return arguments.length
                    ? ((M =
                          null == t
                              ? ((w = r = i = o = null), Mf)
                              : Jc((w = +t[0][0]), (r = +t[0][1]), (i = +t[1][0]), (o = +t[1][1]))),
                      k())
                    : null == w
                    ? null
                    : [
    ...
    function tl(t, n) {
        var e = ou(Ks * tu(n)),
            ...
            i = r * r * r;
        return [
            (t * Wa(e)) / (Ks * (Ws + 3 * Zs * r + i * (7 * Qs + 9 * Js * r))),
            e * (Ws + Zs * r + i * (Qs + Js * r)),
        ];
    }
    function nl(t, n) {
        ...
        for (null == n && (n = hl); (e = f.pop()); )
            if ((c && (e.value = +e.data.value), (i = n(e.data)) && (a = i.length)))
                for (e.children = new Array(a), o = a - 1; o >= 0; --o)
                    f.push((r = e.children[o] = new vl(i[o]))), (r.parent = e), (r.depth = e.depth + 1);
    ...
    (tl.invert = function(t, n) {
        for (
            ...
            ((o =
                (i =
                    (r -= e =
                        (r * (Ws + Zs * i + o * (Qs + Js * i)) - n) / (Ws + 3 * Zs * i + o * (7 * Qs + 9 * Js * i))) *
                    r) *
                i *
                i),
            !(Ga(e) < Ba));
    ...
    function _l(t, n) {
        ...
        for (e = 0; e < t.length - 1; ++e)
            for (r = e + 1; r < t.length; ++r)
                if (bl(Ml(t[e], t[r]), n) && bl(Ml(t[e], n), t[r]) && bl(Ml(t[r], n), t[e]) && xl(Nl(t[e], t[r], n), t))
                    return [t[e], t[r], n];
        throw new Error();
    }
    function bl(t, n) {
    ...
    function El(t) {
        ...
        t: for (u = 3; u < i; ++u) {
            ...
            for (r.previous = n, r.next = e, n.next = e.previous = e = r, o = Sl(n); (r = r.next) !== e; )
                (a = Sl(r)) < o && ((n = r), (o = a));
            e = n.next;
        }
    ...
    function Jl(t, n, e, r, i, o) {
        for (
            ...
            for (
                l = h = s, g = s * s * (v = Math.max(f / c, c / f) / (w * t)), p = Math.max(h / g, g / l);
                m < x;
                ++m
            ) {
                if (
            ...
            y.push((a = { value: s, dice: c < f, children: _.slice(b, m) })),
                a.dice ? Ol(a, e, r, i, w ? (r += (f * s) / w) : o) : Zl(a, e, r, w ? (e += (c * s) / w) : i, o),
                (w -= s),
                (b = m);
        }
        return y;
    ...
    function Mh(t, n, e) {
        var r = t[0],
            ...
            a = n[1];
        return (
            i < r ? ((r = xh(i, r)), (o = e(a, o))) : ((r = xh(r, i)), (o = e(o, a))),
            function(t) {
                return o(r(t));
            }
        );
    ...
    function kh(n, e, r, i) {
        ...
        switch ((i = wa(null == i ? ',f' : i)).type) {
            ...
            case 'r':
                null != i.precision ||
                    isNaN((o = Ra(a, Math.max(Math.abs(n), Math.abs(e))))) ||
    ...
    function Uh(n) {
        ...
        function u() {
            return (
                ...
                o()[0] < 0 ? ((e = Lh(e)), (r = Lh(r)), n(Rh, Dh)) : n(Ph, zh),
                i
            );
        }
        return (
        ...
        function w(t, n) {
            return function(e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++u < f; )
                    37 === t.charCodeAt(u) &&
                        (a.push(t.slice(c, u)),
                        null != (i = ep[(r = t.charAt(++u))]) ? (r = t.charAt(++u)) : (i = 'e' === r ? ' ' : '0'),
                        (o = n[r]) && (r = o(e, i)),
                        a.push(r),
                        (c = u + 1));
                    ...
                    'w' in o || (o.w = 1),
                        'Z' in o
                            ? ((i = (r = Jd(Kd(o.y))).getUTCDay()),
                              ...
                              (r = Cd.offset(r, 7 * (o.V - 1))),
                              (o.y = r.getUTCFullYear()),
                              (o.m = r.getUTCMonth()),
                              (o.d = r.getUTCDate() + ((o.w + 6) % 7)))
                            : ((i = (r = n(Kd(o.y))).getDay()),
                              (r = i > 4 || 0 === i ? fd.ceil(r) : fd(r)),
    ...
    function hv(n) {
        return (
            (np = tp(n)),
            (t.timeFormat = np.format),
            (t.timeParse = np.parse),
            (t.utcFormat = np.utcFormat),
            (t.utcParse = np.utcParse),
            np
        );
    }
    hv({
    ...
    var pv = +new Date('2000-01-01T00:00:00.000Z')
            ? function(t) {
                  var n = new Date(t);
    ...
    var Fv = new Array(3)
        ...
        Bg = new Array(3)
            ...
            .map(Cv),
        Yg = Yv(Bg),
        Fg = je(Zn(300, 0.5, 0), Zn(-240, 0.5, 1)),
        Ig = je(Zn(-100, 0.75, 0.35), Zn(80, 1.5, 0.8)),
        jg = je(Zn(260, 0.75, 0.35), Zn(80, 1.5, 0.8)),
        Hg = Zn();
    var Xg = gn(),
        Gg = Math.PI / 3,
        Vg = (2 * Math.PI) / 3;
        ...
        n_ = {
            draw: function(t, n) {
                ...
                t.moveTo(r, i),
                    ...
                    t.lineTo(-0.5 * o - Jy * a, Jy * o + -0.5 * a),
                    t.lineTo(-0.5 * u - Jy * c, Jy * u + -0.5 * c),
    ...
    function T_(t, n, e) {
        var r = t._x1 - t._x0,
            ...
            a = (e - t._y1) / (i || (r < 0 && -0)),
            u = (o * i + a * r) / (r + i);
        return (A_(o) + A_(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) || 0;
    }
    function S_(t, n) {
        var e = t._x1 - t._x0;
    ...
    function Z_(t, n, e, r) {
        ...
        return (
            ...
            e && J_(i, t, n, e),
            r && J_(i, n, t, r),
            _b[t.index].halfedges.push(o),
            _b[n.index].halfedges.push(o),
            i
        );
    }
    function Q_(t, n, e) {
            ...
            lineEnd: function() {
                ...
                if (e)
                    if ((this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e))
                        ...
                        for (var r = R_(t), i = R_(n), o = 0, a = 1; a < e; ++o, ++a)
        ...
        (X_.prototype = {
            ...
            insert: function(t, n) {
                ...
                if (t) {
                    ...
                    this._
                        ? ((t = W_(this._)), (n.P = null), (n.N = t), (t.P = t.L = n), (e = t))
                        : ((n.P = n.N = null), (this._ = n), (e = null));
                for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
                    e === (r = e.U).L
                        ? (i = r.R) && i.C
                            ? ((e.C = i.C = !1), (r.C = !0), (t = r))
                            : (t === e.R && (V_(this, e), (e = (t = e).U)), (e.C = !1), (r.C = !0), $_(this, r))
                        : (i = r.L) && i.C
                        ? ((e.C = i.C = !1), (r.C = !0), (t = r))
                        : (t === e.L && ($_(this, e), (e = (t = e).U)), (e.C = !1), (r.C = !0), V_(this, r)),
                        (e = t.U);
                this._.C = !1;
            },
            remove: function(t) {
                ...
                if (
                    ...
                    if (t && t.C) t.C = !1;
                        ...
                        do {
                            ...
                            if (t === i.L) {
                                if (
                                    ((n = i.R).C && ((n.C = !1), (i.C = !0), V_(this, i), (n = i.R)),
                                    (n.L && n.L.C) || (n.R && n.R.C))
                                ) {
                                    (n.R && n.R.C) || ((n.L.C = !1), (n.C = !0), $_(this, n), (n = i.R)),
                                        (n.C = i.C),
                                        (i.C = n.R.C = !1),
                                        V_(this, i),
                                        (t = this._);
                                ...
                                ((n = i.L).C && ((n.C = !1), (i.C = !0), $_(this, i), (n = i.L)),
                                (n.L && n.L.C) || (n.R && n.R.C))
                            ) {
                                (n.L && n.L.C) || ((n.R.C = !1), (n.C = !0), V_(this, n), (n = i.L)),
                                    (n.C = i.C),
                                    (i.C = n.L.C = !1),
                                    $_(this, i),
                                    (t = this._);
    ...
    function db(t) {
        var n = t.circle,
            ...
            u = [t];
        hb(t);
        for (var c = o; c.circle && Math.abs(e - c.circle.x) < xb && Math.abs(r - c.circle.cy) < xb; )
            (o = c.P), u.unshift(c), hb(c), (c = o);
        u.unshift(c), cb(c);
        for (var f = a; f.circle && Math.abs(e - f.circle.x) < xb && Math.abs(r - f.circle.cy) < xb; )
    ...
    function pb(t) {
        ...
        if ((yb.insert(n, c), n || e)) {
            if (n === e)
                return (
                    cb(n), (e = lb(n.site)), yb.insert(c, e), (c.edge = e.edge = Z_(n.site, c.site)), ub(n), void ub(e)
                );
            if (e) {
                cb(n), cb(e);
                var f = n.site,
    ...
    function Nb(t, n) {
        ...
        for (mb = [], _b = new Array(t.length), yb = new X_(), bb = new X_(); ; )
            if (((i = ib), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
                (o[0] === e && o[1] === r) || (pb(o), (e = o[0]), (r = o[1])), (o = t.pop());
            else {
                if (!i) break;
                db(i.arc);
            }
        if (
            ...
            !(function(t, n, e, r) {
                for (var i, o = mb.length; o--; )
                    (tb((i = mb[o]), t, n, e, r) &&
                        K_(i, t, n, e, r) &&
                        (Math.abs(i[0][0] - i[1][0]) > xb || Math.abs(i[0][1] - i[1][1]) > xb)) ||
                        delete mb[o];
            })(a, u, c, f),
                (function(t, n, e, r) {
                    var i,
                        ...
                        if ((o = _b[i])) {
                            ...
                            for (u = 0, f = c.length; u < f; )
                                (p = (d = rb(o, mb[c[u]]))[0]),
                                    ...
                                    (l = (s = eb(o, mb[c[++u % f]]))[0]),
                                    (h = s[1]),
                                    (Math.abs(p - l) > xb || Math.abs(v - h) > xb) &&
                                        (c.splice(
                                            u,
                                            0,
                                            mb.push(
                                                Q_(
                                                    a,
                                                    d,
                                                    Math.abs(p - t) < xb && r - v > xb
                                                        ? [t, Math.abs(l - t) < xb ? h : r]
                                                        : Math.abs(v - r) < xb && e - p > xb
                                                        ? [Math.abs(h - r) < xb ? l : e, r]
                                                        : Math.abs(p - e) < xb && v - n > xb
                                                        ? [e, Math.abs(l - e) < xb ? h : n]
                                                        : Math.abs(v - n) < xb && p - t > xb
                                                        ? [Math.abs(h - n) < xb ? l : t, n]
                                                        : null
                                                )
                                            ) - 1
                                        ),
                        ...
                        for (
                            ...
                            (a = d),
                                ...
                                a &&
                                    ...
                                    ((c = a),
                                    (f = d),
                                    ((u = s)[0] - f[0]) * (c[1] - u[1]) - (u[0] - c[0]) * (f[1] - u[1]) < 0) &&
    ...
    (Eb.prototype = Sb.prototype),
        ...
        (t.histogram = function() {
            ...
            return (
                ...
                (r.thresholds = function(t) {
                    return arguments.length
                        ? ((e = 'function' == typeof t ? t : Array.isArray(t) ? p(h.call(t)) : p(t)), r)
                        : e;
                }),
                r
            );
        ...
        (t.thresholdFreedmanDiaconis = function(t, e, r) {
            return (
                (t = d.call(t, u).sort(n)),
                Math.ceil((r - e) / (2 * (N(t, 0.75) - N(t, 0.25)) * Math.pow(t.length, -1 / 3)))
            );
        }),
                ...
                for (f = -1; ++f < l; )
                    for (s = f - 1; ++s < l; ) {
                        var N = _[s * l + f],
                            A = _[f * l + s];
                        (N.value || A.value) &&
                            v.push(N.value < A.value ? { source: A, target: N } : { source: N, target: A });
                    }
                return r ? v.sort(r) : v;
            }
            return (
        ...
        (t.drag = function() {
            ...
            function m(n, e, r, i, o) {
                var a,
                    ...
                    v = s.copy();
                if (
                    St(new Xt(d, 'beforestart', a, n, l, p[0], p[1], 0, 0, v), function() {
                        return (
                    ...
                    return function t(u) {
                        ...
                        St(new Xt(d, u, a, n, s, p[0] + c, p[1] + h, p[0] - g[0], p[1] - g[1], v), v.apply, v, [
                            u,
                            i,
                            o,
                        ]);
        ...
        (t.formatDefaultLocale = Ca),
        (t.formatLocale = Ea),
        (t.formatSpecifier = wa),
        (t.precisionFixed = Pa),
        ...
        (t.geoCentroid = function(t) {
            ...
            return i < Ba &&
                ...
                (e = Wu),
                (r = Zu),
                Hu < Oa && ((n = Xu), (e = Gu), (r = Vu)),
                (i = n * n + e * e + r * r) < Ba)
                ? [NaN, NaN]
                : [$a(e, n) * Ha, ou(r / eu(i)) * Ha];
        }),
        ...
        (t.geoPath = function(t, n) {
            ...
            function o(t) {
                return (
                    t && ('function' == typeof i && r.pointRadius(+i.apply(this, arguments)), du(t, e(r))), r.result()
                );
            }
            return (
                (o.area = function(t) {
                ...
                (o.context = function(t) {
                    return arguments.length
                        ? ((r = null == t ? ((n = null), new bs()) : new fs((n = t))),
                ...
                (s.translate = function(t) {
                    ...
                    return (
                        ...
                        (r = u
                            ...
                            .clipExtent([
                                [o - 0.425 * n + Oa, s + 0.12 * n + Oa],
                                [o - 0.214 * n - Oa, s + 0.234 * n - Oa],
                            ])
                            .stream(f)),
                        (i = c
                            .translate([o - 0.205 * n, s + 0.212 * n])
                            .clipExtent([
                                [o - 0.214 * n + Oa, s + 0.166 * n + Oa],
                                [o - 0.115 * n - Oa, s + 0.234 * n - Oa],
                            ])
                            .stream(f)),
                        l()
                    );
        ...
        (t.geoAzimuthalEqualAreaRaw = Fs),
        (t.geoAzimuthalEquidistant = function() {
            return Rs(Is)
                .scale(79.4188)
                .clipAngle(179.999);
        }),
        (t.geoAzimuthalEquidistantRaw = Is),
        (t.geoConicConformal = function() {
            return qs(Gs)
                .scale(109.5)
                .parallels([30, 30]);
        }),
        (t.geoConicConformalRaw = Gs),
        (t.geoConicEqualArea = Us),
        (t.geoConicEqualAreaRaw = Ls),
        (t.geoConicEquidistant = function() {
            return qs($s)
                .scale(131.154)
                .center([0, 13.9389]);
        }),
        (t.geoConicEquidistantRaw = $s),
        (t.geoEqualEarth = function() {
            return Rs(tl).scale(177.158);
        }),
        (t.geoEqualEarthRaw = tl),
                ...
                clipExtent: function(r) {
                    return arguments.length
                        ? ((d =
                              null == r
                                  ? ((h = t = n = e = null), Mf)
                                  : Jc((h = +r[0][0]), (t = +r[0][1]), (n = +r[1][0]), (e = +r[1][1]))),
                          p())
                        : null == h
                        ? null
                        : [
        ...
        (t.geoNaturalEarth1Raw = rl),
        (t.geoOrthographic = function() {
            return Rs(il)
                .scale(249.5)
                .clipAngle(90 + Oa);
        }),
        (t.geoOrthographicRaw = il),
        (t.geoStereographic = function() {
            return Rs(ol)
                .scale(250)
                .clipAngle(142);
        }),
        (t.geoStereographicRaw = ol),
                ...
                return (
                    ...
                    t
                        ...
                        : i
                              .eachBefore(Dl(Rl))
                              .eachAfter(ql(Pl, 1))
                              .eachAfter(ql(r, i.r / Math.min(n, e)))
                              .eachBefore(Ll(Math.min(n, e) / (2 * i.r))),
                    i
                );
            }
            return (
        ...
        (t.stratify = function() {
            ...
            function e(e) {
                ...
                for (i = 0; i < s; ++i)
                    (r = e[i]),
                        (u = l[i] = new vl(r)),
                        null != (c = t(r, i, e)) && (c += '') && (h[(f = Bl + (u.id = c))] = f in h ? Fl : u);
                for (i = 0; i < s; ++i)
        ...
        (t.treemapSquarify = Kl),
        (t.treemapResquarify = th),
        (t.interpolate = ye),
        ...
        (t.interpolateTransformCss = Se),
        (t.interpolateTransformSvg = ke),
        ...
        (t.randomUniform = ih),
        (t.randomNormal = oh),
        (t.randomLogNormal = ah),
        (t.randomBates = ch),
        (t.randomIrwinHall = uh),
        (t.randomExponential = fh),
        (t.scaleBand = yh),
        ...
        (t.scaleIdentity = function t(n) {
            ...
            return (
                ...
                (n = arguments.length ? dh.call(n, _h) : [0, 1]),
                Eh(r)
            );
        }),
        ...
        (t.scaleTime = function() {
            return sh.apply(
                Nv(Nd, wd, cd, od, rd, nd, Kh, Wh, t.timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
                arguments
            );
        }),
        (t.scaleUtc = function() {
            return sh.apply(
                Nv(Wd, Vd, Rd, Cd, kd, Td, Kh, Wh, t.utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]),
                arguments
            );
        }),
        ...
        (t.schemeSet2 = Ov),
        (t.schemeSet3 = Bv),
        (t.interpolateBrBG = Iv),
        (t.schemeBrBG = Fv),
        (t.interpolatePRGn = Hv),
        (t.schemePRGn = jv),
        (t.interpolatePiYG = Gv),
        (t.schemePiYG = Xv),
        (t.interpolatePuOr = $v),
        (t.schemePuOr = Vv),
        (t.interpolateRdBu = Zv),
        (t.schemeRdBu = Wv),
        (t.interpolateRdGy = Jv),
        (t.schemeRdGy = Qv),
        (t.interpolateRdYlBu = tg),
        (t.schemeRdYlBu = Kv),
        (t.interpolateRdYlGn = eg),
        (t.schemeRdYlGn = ng),
        (t.interpolateSpectral = ig),
        (t.schemeSpectral = rg),
        (t.interpolateBuGn = ag),
        (t.schemeBuGn = og),
        (t.interpolateBuPu = cg),
        (t.schemeBuPu = ug),
        (t.interpolateGnBu = sg),
        (t.schemeGnBu = fg),
        (t.interpolateOrRd = hg),
        (t.schemeOrRd = lg),
        (t.interpolatePuBuGn = pg),
        (t.schemePuBuGn = dg),
        (t.interpolatePuBu = gg),
        (t.schemePuBu = vg),
        (t.interpolatePuRd = _g),
        (t.schemePuRd = yg),
        (t.interpolateRdPu = mg),
        (t.schemeRdPu = bg),
        (t.interpolateYlGnBu = wg),
        (t.schemeYlGnBu = xg),
        (t.interpolateYlGn = Ng),
        (t.schemeYlGn = Mg),
        (t.interpolateYlOrBr = Tg),
        (t.schemeYlOrBr = Ag),
        (t.interpolateYlOrRd = kg),
        (t.schemeYlOrRd = Sg),
        (t.interpolateBlues = Cg),
        (t.schemeBlues = Eg),
        (t.interpolateGreens = zg),
        (t.schemeGreens = Pg),
        (t.interpolateGreys = Dg),
        (t.schemeGreys = Rg),
        (t.interpolatePurples = Lg),
        (t.schemePurples = qg),
        (t.interpolateReds = Og),
        (t.schemeReds = Ug),
        (t.interpolateOranges = Yg),
        (t.schemeOranges = Bg),
        (t.interpolateCubehelixDefault = Fg),
        (t.interpolateRainbow = function(t) {
            (t < 0 || t > 1) && (t -= Math.floor(t));
            var n = Math.abs(t - 0.5);
            return (Hg.h = 360 * t - 100), (Hg.s = 1.5 - 1.5 * n), (Hg.l = 0.8 - 0.9 * n), Hg + '';
        }),
        (t.interpolateWarm = Ig),
        (t.interpolateCool = jg),
        (t.interpolateSinebow = function(t) {
            var n;
            return (
                (t = (0.5 - t) * Math.PI),
                (Xg.r = 255 * (n = Math.sin(t)) * n),
                (Xg.g = 255 * (n = Math.sin(t + Gg)) * n),
                (Xg.b = 255 * (n = Math.sin(t + Vg)) * n),
                Xg + ''
            );
        }),
        (t.interpolateViridis = Wg),
        (t.interpolateMagma = Zg),
        (t.interpolateInferno = Qg),
                ...
                if ((u || (u = c = Hi()), h < l && ((f = h), (h = l), (l = f)), h > uy))
                    if (v > sy - uy)
                        u.moveTo(h * ey(d), h * oy(d)),
                            u.arc(0, 0, h, d, p, !g),
                            l > uy && (u.moveTo(l * ey(p), l * oy(p)), u.arc(0, 0, l, p, d, g));
                    else {
                        var y,
                            _,
                            b = d,
                        ...
                        if (T > uy) {
                            var C = ly((T / l) * oy(A)),
                                P = ly((T / h) * oy(A));
                            (M -= 2 * C) > uy ? ((x += C *= g ? 1 : -1), (w -= C)) : ((M = 0), (x = w = (d + p) / 2)),
                                (N -= 2 * P) > uy
                                    ? ((b += P *= g ? 1 : -1), (m -= P))
                                    : ((N = 0), (b = m = (d + p) / 2));
                        }
                            ...
                            if (
                                ...
                                var F = z - L[0],
                                    ...
                                    X =
                                        1 /
                                        oy(
                                            ((s = (F * j + I * H) / (ay(F * F + I * I) * ay(j * j + H * H))) > 1
                                                ? 0
                                                : s < -1
                                                ? cy
                                                : Math.acos(s)) / 2
                        ...
                        N > uy
                            ? E > uy
                                ? ((y = yy(B, Y, z, R, h, E, g)),
                                  ...
                                  E < S
                                      ? u.arc(y.cx, y.cy, E, ny(y.y01, y.x01), ny(_.y01, _.x01), !g)
                                      : (u.arc(y.cx, y.cy, E, ny(y.y01, y.x01), ny(y.y11, y.x11), !g),
                                        u.arc(
                                            0,
                                            0,
                                            h,
                                            ny(y.cy + y.y11, y.cx + y.x11),
                                            ny(_.cy + _.y11, _.cx + _.x11),
                                            !g
                                        ),
                                        u.arc(_.cx, _.cy, E, ny(_.y11, _.x11), ny(_.y01, _.x01), !g)))
                            ...
                            l > uy && M > uy
                                ? k > uy
                                    ? ((y = yy(D, q, U, O, l, -k, g)),
                                      ...
                                      k < S
                                          ? u.arc(y.cx, y.cy, k, ny(y.y01, y.x01), ny(_.y01, _.x01), !g)
                                          : (u.arc(y.cx, y.cy, k, ny(y.y01, y.x01), ny(y.y11, y.x11), !g),
                                            u.arc(
                                                0,
                                                0,
                                                l,
                                            ...
                                            u.arc(_.cx, _.cy, k, ny(_.y11, _.x11), ny(_.y01, _.x01), !g)))
                                    : u.arc(0, 0, l, w, x, g)
                                : u.lineTo(D, q);
                    }
                else u.moveTo(0, 0);
        ...
        (t.curveBundle = f_),
        (t.curveCardinalClosed = p_),
        (t.curveCardinalOpen = g_),
        (t.curveCardinal = h_),
        (t.curveCatmullRomClosed = x_),
        (t.curveCatmullRomOpen = M_),
        (t.curveCatmullRom = b_),
        ...
        (t.stack = function() {
            ...
            return (
                ...
                (i.order = function(t) {
                    return arguments.length
                        ? ((n = null == t ? L_ : 'function' == typeof t ? t : Kg(Ry.call(t))), i)
                        : n;
                }),
                (i.offset = function(t) {
        ...
        (t.timeInterval = $h),
        (t.timeMillisecond = Wh),
        (t.timeMilliseconds = Zh),
        (t.utcMillisecond = Wh),
        (t.utcMilliseconds = Zh),
        (t.timeSecond = Kh),
        (t.timeSeconds = td),
        (t.utcSecond = Kh),
        (t.utcSeconds = td),
        ...
        (t.utcYear = Wd),
        (t.utcYears = Zd),
        (t.timeFormatDefaultLocale = hv),
        (t.timeFormatLocale = tp),
        (t.isoFormat = dv),
        (t.isoParse = pv),
        (t.now = nr),
        (t.timer = ir),
                        ...
                        i = zt(t.event.view)
                            .on(
                                ...
                                function() {
                                    ...
                                    n.zoom(
                                        'mouse',
                                        o(b(n.that.__zoom, (n.mouse[0] = Ot(n.that)), n.mouse[1]), n.extent, f)
                                    );
                                },
                                !0
                            )
            ...
            return (
                ...
                (M.prototype = {
                    ...
                    zoom: function(t, n) {
                        ...
                        return (
                            0 == --this.active && (h.splice(this.index, 1), (this.index = -1), this.emit('end')), this
                        );
                    },
                    emit: function(t) {
