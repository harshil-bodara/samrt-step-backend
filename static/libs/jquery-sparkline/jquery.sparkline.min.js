    ...
    (function(factory) {
        ...
        $.fn.sparkline = function(userValues, userOptions) {
            return this.each(function() {
                ...
                if (
                    ($(this).html() && !options.get('disableHiddenCheck') && $(this).is(':hidden')) ||
        ...
        $.fn.sparkline.line = line = createClass($.fn.sparkline._base, {
            ...
            drawNormalRange: function(canvasLeft, canvasTop, canvasHeight, canvasWidth, rangey) {
                var normalRangeMin = this.options.get('normalRangeMin'),
                    ...
                    ytop =
                        canvasTop + Math.round(canvasHeight - canvasHeight * ((normalRangeMax - this.miny) / rangey)),
        ...
        $.fn.sparkline.bullet = bullet = createClass($.fn.sparkline._base, {
            ...
            renderTarget: function(highlight) {
                var targetval = this.values[0],
                    x = Math.round(
                        this.canvasWidth * ((targetval - this.min) / this.range) - this.options.get('targetWidth') / 2
                    ),
