    ...
    })(
        {
                ...
                function(En, jn, t) {
                    ...
                    (e = this),
                        (n = function() {
                            ...
                            function P(t) {
                                return (
                                    t instanceof Function || '[object Function]' === Object.prototype.toString.call(t)
                                );
                            }
                            function T(t, e) {
                                var n,
                                          ...
                                          k(r)
                                              ...
                                              : (h(r)
                                                    ...
                                                    ? (function(t) {
                                                          var e, n, i, a, r;
                                                          if (0 === t._f.length)
                                                              return (v(t).invalidFormat = !0), (t._d = new Date(NaN));
                                                      ...
                                                      null === (a = be.exec(i._i))
                                                          ? (ye(i),
                                                            !1 === i._isValid &&
                                                                ...
                                                                we(i),
                                                                !1 === i._isValid &&
                                                                    (delete i._isValid, c.createFromInputFallback(i))))
                                                          : (i._d = new Date(+a[1])))
                                                    : s(n)
                                ...
                                (hn.months = function(t, e) {
                                    return t
                                        ? s(this._months)
                                            ...
                                            : this._months[
                                                  (this._months.isFormat || It).test(e) ? 'format' : 'standalone'
                                              ][t.month()]
                                        : s(this._months)
                                        ? this._months
                            ...
                            return (
                                ...
                                (c.relativeTimeThreshold = function(t, e) {
                                    return (
                                        void 0 !== Nn[t] &&
                                        (void 0 === e ? Nn[t] : ((Nn[t] = e), 's' === t && (Nn.ss = e - 1), !0))
                                    );
                                }),
                        ...
                        legendCallback: function(t) {
                            ...
                            if (i.length)
                                for (var r = 0; r < i[0].data.length; ++r)
                                    e.push(
                                        '<li><span style="background-color:' + i[0].backgroundColor[r] + '"></span>'
                                    ),
                                        a[r] && e.push(a[r]),
                                        e.push('</li>');
                        ...
                        (e.exports = function(t) {
                            ...
                            t.controllers.line = t.DatasetController.extend({
                                ...
                                update: function(t) {
                                    ...
                                    for (
                                        c && 0 !== o._model.tension && a.updateBezierControlPoints(),
                                            e = 0,
                                            n = s.length;
                                        e < n;
                                        ++e
                                ...
                                setHoverStyle: function(t) {
                                    ...
                                    (t.$previousStyle = {
                                        ...
                                        (a.borderWidth =
                                            i.hoverBorderWidth ||
                                            g.valueAtIndexOrDefault(e.pointHoverBorderWidth, n, a.borderWidth)),
                                        (a.radius =
                                            i.hoverRadius ||
                                            g.valueAtIndexOrDefault(
                                                e.pointHoverRadius,
                            ...
                            t.controllers.polarArea = t.DatasetController.extend({
                                ...
                                update: function(n) {
                                    var t,
                                        ...
                                        u = (a._angles = []);
                                    for (
                                        a._updateRadius(), o.count = a.countVisibleElements(), t = 0, e = r.data.length;
                                        t < e;
                                        t++
                                    )
                                    ...
                                    void 0 !== r.radius && void 0 === r.pointRadius && (r.pointRadius = r.radius),
                                        ...
                                        u.extend(t, {
                                            ...
                                            _model: {
                                                ...
                                                rotation: a.rotation
                                                    ? a.rotation
                                                    : u.valueAtIndexOrDefault(r.pointRotation, e, s.rotation),
                                    ...
                                    t.scales &&
                                        ...
                                        c.each(e, function(t) {
                                            ...
                                            if (n in s && s[n].type === i)
                                                ((a = s[n]).options = e), (a.ctx = o.ctx), (a.chart = o);
                                            else {
                                                var r = m.getScaleConstructor(i);
                                                if (!r) return;
                                                (a = new r({ id: n, type: i, options: e, ctx: o.ctx, chart: o })),
                                                    (s[a.id] = a);
                                            }
                                        ...
                                        c.each(
                                            ...
                                            function(t, e) {
                                                ...
                                                if (
                                                    (n.type &&
                                                        n.type !== i &&
                                                        (r.destroyDatasetMeta(e), (n = r.getDatasetMeta(e))),
                                                    (n.type = i),
                                                    o.push(n.type),
                                                    n.controller)
                                                )
                    ...
                    e.exports = function() {
                        ...
                        (g.configMerge = function() {
                            ...
                            (g.longestText = function(e, t, n, i) {
                                ...
                                i.font !== t && ((a = i.data = {}), (r = i.garbageCollect = []), (i.font = t)),
                                    (e.font = t);
                                var o = 0;
                                g.each(n, function(t) {
            ...
            33: [
                function(t, e, n) {
                    ...
                    function E(t, e, n) {
                        ...
                        return (
                            n && (i -= 0 === e ? (t.getPixelForTick(1) - i) / 2 : (i - t.getPixelForTick(e - 1)) / 2), i
                        );
                    }
                    function k(t, e, n) {
                            ...
                            if (S.length) {
                                ...
                                k.filter &&
                                    ...
                                    'right' === c
                                        ? (s -= a.width)
                                        : 'center' === c &&
                                          ((s -= a.width / 2) + a.width > o.width && (s = o.width - a.width),
                                          s < 0 && (s = 0)),
            ...
            37: [
                function(t, e, n) {
                    ...
                    i._set('global', {
                        elements: {
                            arc: { backgroundColor: i.global.defaultColor, borderColor: '#fff', borderWidth: 2 },
                        },
                    }),
                        (e.exports = a.extend({
                    ...
                    u._set('global', {
                        ...
                        (e.exports = i.extend({
                            inRange: function(t, e) {
                                ...
                                return (
                                    !!n &&
                                    Math.pow(t - n.x, 2) + Math.pow(e - n.y, 2) < Math.pow(n.hitRadius + n.radius, 2)
                                );
                            },
                            inLabelRange: a,
                            inXRange: a,
                        ...
                        (e.exports = a.extend({
                            ...
                            getCenterPoint: function() {
                                var t,
                                    ...
                                    n = this._view;
                                return (
                                    (e = l(this) ? ((t = n.x), (n.y + n.base) / 2) : ((t = (n.x + n.base) / 2), n.y)),
                                    { x: t, y: e }
                                );
                            },
                            getArea: function() {
                    ...
                    n = e.exports = {
                        ...
                        drawPoint: function(t, e, n, i, a, r) {
                            ...
                            if (
                                ...
                                if (!(isNaN(n) || n <= 0)) {
                                    switch (
                                        (t.save(), t.translate(i, a), t.rotate((r * Math.PI) / 180), t.beginPath(), e)
                                    ) {
                                        default:
                        ...
                        draw: function() {
                            ...
                            if (c.display) {
                                ...
                                C.each(h.legendItems, function(t, e) {
                                    ...
                                    M
                                        ? p <= u + l &&
                                          ((d = b.y += S), b.line++, (u = b.x = h.left + (p - v[b.line]) / 2))
                                        : d + S > h.bottom &&
                            ...
                            e = i.extend({
                                ...
                                handleTickRangeOptions: function() {
                                    ...
                                    (t.min = n(e.min, t.min)),
                                        ...
                                        null === t.max &&
                                            (t.max = 0 !== t.min ? Math.pow(10, Math.floor(c.log10(t.min)) + 1) : 10),
                                        null === t.minNotZero &&
                                            (0 < t.min
                                                ? (t.minNotZero = t.min)
                                                : t.max < 1
                    ...
                    e.exports = function() {
                        var t = i.extend({
                            ...
                            determineDataLimits: function() {
                                ...
                                g.length &&
                                    ((g = k(g).sort(b)), (d = Math.min(d, g[0])), (h = Math.max(h, g[g.length - 1]))),
                                    c.length &&
                                        ((c = k(c).sort(b)),
                                        (d = Math.min(d, c[0])),
                            ...
                            getValueForPixel: function(t) {
                                var e = this,
                                    ...
                                    i = e._horizontal ? e.left : e.top,
                                    a =
                                        (n ? (t - i) / n : 0) * (e._offsets.left + 1 + e._offsets.left) -
                                        e._offsets.right,
