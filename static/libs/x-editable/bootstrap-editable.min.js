...
!(function(a) {
    ...
    (b.prototype = {
        ...
        submit: function(b) {
            ...
            if ('object' === a.type(d) && void 0 !== d.newValue) {
                if (((c = d.newValue), this.input.value2input(c), 'string' == typeof d.msg))
                    return this.error(d.msg), this.showForm(), void 0;
            } else if (d) return this.error(d), this.showForm(), void 0;
            if (!this.options.savenochange && this.input.value2str(c) == this.input.value2str(this.value))
                    ...
                    .done(
                        a.proxy(function(a) {
                            ...
                            return b === !1
                                ...
                                : (b && 'object' == typeof b && b.hasOwnProperty('newValue') && (c = b.newValue),
                                  this.error(!1),
                                  (this.value = c),
                                  this.$div.triggerHandler('save', { newValue: c, submitValue: e, response: a }),
                                  void 0);
                        }, this)
                    )
                    .fail(
            ...
            return e
                ? (this.showLoading(),
                  ...
                  'function' == typeof this.options.params
                      ...
                      : ((this.options.params = a.fn.editableutils.tryParseJson(this.options.params, !0)),
                        a.extend(c, this.options.params)),
                  'function' == typeof this.options.url
                      ? this.options.url.call(this.options.scope, c)
                      : a.ajax(a.extend({ url: this.options.url, data: c, type: 'POST' }, this.options.ajaxOptions)))
                : void 0;
        },
        validate: function(a) {
            return (
            ...
            getConfigData: function(b) {
                ...
                return (
                    a.each(b.data(), function(a, b) {
                        ('object' != typeof b ||
                            (b && 'object' == typeof b && (b.constructor === Object || b.constructor === Array))) &&
                            (c[a] = b);
                    }),
                    c
                );
    ...
    (function(a) {
        ...
        (b.prototype = {
            ...
            container: function() {
                var a;
                return this.containerDataName && (a = this.$element.data(this.containerDataName))
                    ? a
            ...
            option: function(a, b) {
                (this.options[a] = b),
                    a in this.containerOptions
                        ...
                        : ((this.formOptions[a] = b), this.$form && this.$form.editableform('option', a, b));
            },
                ...
                if (
                    ...
                    switch (
                        (void 0 === this.options.value || null === this.options.value
                            ? ((this.value = this.input.html2value(a.trim(this.$element.html()))), (c = !0))
                            : ((this.options.value = a.fn.editableutils.tryParseJson(this.options.value, !0)),
                              (this.value =
                        ...
                        'function' == typeof this.options.display && (this.options.autotext = 'always'),
                ...
                (this.options.selector = !1),
                    ...
                    this.$element.on(
                        ...
                        a.proxy(function(b) {
                            var c = a(b.target);
                            c.data('editable') ||
                                (c.hasClass(this.options.emptyclass) && c.empty(), c.editable(this.options).trigger(b));
                        }, this)
                    );
            },
            render: function(a) {
                return this.options.display !== !1
                    ? this.input.value2htmlFinal
                        ? this.input.value2html(this.value, this.$element[0], this.options.display, a)
                    ...
                    (c = c || 'function' == typeof this.options.url),
                        ...
                        (c =
                            ...
                            (this.options.savenochange &&
                                this.input.value2str(this.value) !== this.input.value2str(b.newValue))),
                        c
                        ...
                        if (a.isEmptyObject(i)) {
                            ...
                            if (1 === h.length) {
                                ...
                                'function' == typeof k.options.params
                                    ...
                                    : ((k.options.params = a.fn.editableutils.tryParseJson(k.options.params, !0)),
                ...
                return this.each(function() {
                    ...
                    return h && h.selector
                        ...
                        : (g || d.data(f, (g = new b(this, h))),
                          'string' == typeof c && g[c].apply(g, Array.prototype.slice.call(e, 1)),
                          void 0);
                });
            }),
            (a.fn.editable.defaults = {
    ...
    (function(a) {
        ...
        (b.prototype = {
            ...
            (b.defaults = { tpl: '', inputclass: null, escape: !0, scope: null, showbuttons: !0 }),
                ...
                onSourceReady: function(b, c) {
                    ...
                    if (
                        (a.isFunction(this.options.source)
                            ? ((d = this.options.source.call(this.options.scope)), (this.sourceData = null))
            ...
            a.extend(b.prototype, {
                ...
                activate: function() {
                    this.$input.is(':visible') &&
                        (this.$input.focus(),
                        a.fn.editableutils.setCursorPosition(this.$input.get(0), this.$input.val().length),
                    ...
                    var b = function(c, d) {
                        ...
                        if (a.isArray(d))
                            for (var f = 0; f < d.length; f++)
                                (e = {}),
                                    d[f].children
                                        ? ((e.label = d[f].text), c.append(b(a('<optgroup>', e), d[f].children)))
                                        : ((e.value = d[f].value),
                ...
                renderList: function() {
                    ...
                    if ((this.$tpl.empty(), a.isArray(this.sourceData))) {
                        for (var c = 0; c < this.sourceData.length; c++)
                            (b = a('<label>')
                                .append(a('<input>', { type: 'checkbox', value: this.sourceData[c].value }))
                ...
                str2value: function(b) {
                    ...
                    return (
                        'string' == typeof b && b.length
                            ? ((c = new RegExp('\\s*' + a.trim(this.options.separator) + '\\s*')), (d = b.split(c)))
                            : (d = a.isArray(b) ? b : [b]),
                        d
                    );
                },
    ...
    (function(a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.text),
            ...
            (b.defaults = a.extend({}, a.fn.editabletypes.text.defaults, { tpl: '<input type="password">' })),
    ...
    (function(a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
            ...
            (b.defaults = a.extend({}, a.fn.editabletypes.abstractinput.defaults, { tpl: '<input type="time">' })),
            ...
            if (
                ...
                a.isFunction(c.source) && (d = c.source.call(c.scope)),
                    'string' == typeof d
                        ...
                        : ((this.sourceData = this.convertSource(d)), (c.select2.data = this.sourceData));
            }
            if (
            ...
            a.extend(b.prototype, {
                ...
                value2html: function(c, d) {
                    ...
                    this.options.select2.tags
                        ? (e = c)
                        : this.sourceData && (e = a.fn.editableutils.itemsByValue(c, this.sourceData, this.idFunc)),
                        a.isArray(e)
                            ? ((f = []),
                ...
                value2input: function(b) {
                    if (
                        ...
                        this.isRemote && !this.isMultiple && !this.options.select2.initSelection)
                    ) {
        ...
        var b = function(b, c) {
            return (
                ...
                this.$element.is('input')
                    ? ((this.options = a.extend({}, a.fn.combodate.defaults, c, this.$element.data())),
                      this.init(),
                      void 0)
                        ...
                        : (this.$ampm &&
                              (d.hour =
                                  12 === d.hour
                                      ...
                                      ? d.hour
                                      : d.hour + 12),
                          (c = moment([d.year, d.month, d.day, d.hour, d.minute, d.second])),
                          this.highlight(c),
                          (b = void 0 === b ? this.options.format : b),
                          null === b ? (c.isValid() ? c : null) : c.isValid() ? c.format(b) : '')
                );
            },
            setValue: function(b) {
                function c(b, c) {
                    ...
                    'getValue' === c && this.length && (d = this.eq(0).data('combodate'))
                        ...
                        : this.each(function() {
                              ...
                              f || d.data('combodate', (f = new b(this, g))),
                                  'string' == typeof c && 'function' == typeof f[c] && f[c].apply(f, e);
                          })
                );
            }),
        ...
        a.extend(a.fn.editableform.Constructor.prototype, {
            ...
            initInput: function() {
                ...
                ~a.inArray(this.input.type, e) &&
                    ...
                    c && ((this.input.options.inputclass = d), this.input.$input.addClass(d)));
                for (
        ...
        a.extend(a.fn.editableContainer.Popup.prototype, {
            ...
            initContainer: function() {
                ...
                this.$element.data('template') &&
                    ((b = this.$element.data('template')), this.$element.removeData('template')),
                    this.call(this.containerOptions),
        ...
        e.prototype = {
            ...
            _process_options: function(b) {
                ...
                c.startDate !== -1 / 0 && (c.startDate = l.parseDate(c.startDate, e, c.language)),
                    1 / 0 !== c.endDate && (c.endDate = l.parseDate(c.endDate, e, c.language)),
            ...
            getClassNames: function(b) {
                ...
                return (
                    b.getUTCFullYear() < d || (b.getUTCFullYear() == d && b.getUTCMonth() < e)
                        ? c.push('old')
                        : (b.getUTCFullYear() > d || (b.getUTCFullYear() == d && b.getUTCMonth() > e)) && c.push('new'),
                            ...
                            if (!d.is('.disabled')) {
                                if ((this.viewDate.setUTCDate(1), d.is('.month'))) {
                                    ...
                                    this.viewDate.setUTCMonth(j),
                                        ...
                                        1 === this.o.minViewMode && this._setDate(b(k, j, i, 0, 0, 0, 0));
                                } else {
                                    ...
                                    this.viewDate.setUTCFullYear(k),
                                        ...
                                        2 === this.o.minViewMode && this._setDate(b(k, j, i, 0, 0, 0, 0));
                                }
            ...
            keydown: function(a) {
                ...
                switch (a.keyCode) {
                    ...
                    case 39:
                        ...
                        (b = 37 == a.keyCode ? -1 : 1),
                            a.ctrlKey
                                ? ((c = this.moveYear(this.date, b)), (d = this.moveYear(this.viewDate, b)))
                                : a.shiftKey
                                ? ((c = this.moveMonth(this.date, b)), (d = this.moveMonth(this.viewDate, b)))
                ...
                parseDate: function(a, b) {
                    ...
                    return (
                        a &&
                            ...
                            'string' == typeof a &&
                                ((c = this.dpg.formatDate(d, b, this.options.datepicker.language)),
                                a !== c && (d = null))),
                        d
                    );
                },
    ...
    (function(a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.date),
            a.extend(b.prototype, {
                ...
                value2input: function(a) {
                    this.$input.val(
                        a ? this.dpg.formatDate(a, this.parsedViewFormat, this.options.datepicker.language) : ''
                    ),
