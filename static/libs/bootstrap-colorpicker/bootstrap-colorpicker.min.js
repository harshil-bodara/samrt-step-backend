    ...
    return (function(e) {
                            ...
                            [
                                {
                                    key: 'api',
                                    value: function(t) {
                                        for (var o = arguments.length, r = Array(o > 1 ? o - 1 : 0), n = 1; n < o; n++)
                                            r[n - 1] = arguments[n];
                            ...
                            [
                                {
                                    ...
                                    value: function(t) {
                                        ...
                                        if (
                                            ...
                                            return (
                                                (this._color = (0, a.default)(null)), void (this._original.valid = !1)
                                            );
                                    ...
                                    value: function(t) {
                                        ...
                                        if (Array.isArray(t)) o = t;
                                            ...
                                            if (!e.colorFormulas.hasOwnProperty(t))
                                                throw new Error("No color formula found with the name '" + t + "'.");
                                            o = e.colorFormulas[t];
                                        }
                                        var r = [],
                                            n = this._color,
        ...
        function(e, t, o) {
            ...
            t.default = {
                ...
                sliders: {
                    ...
                    hue: { selector: '.colorpicker-hue', maxLeft: 0, maxTop: n, callLeft: !1, callTop: 'setHueRatio' },
                    alpha: {
                ...
                slidersHorz: {
                    ...
                    hue: { selector: '.colorpicker-hue', maxLeft: n, maxTop: 0, callLeft: 'setHueRatio', callTop: !1 },
                    alpha: {
                        selector: '.colorpicker-alpha',
                        childSelector: '.colorpicker-alpha-color',
                        maxLeft: n,
            ...
            var l =
                ...
                d = (function(e) {
                    function t(e) {
                        ...
                        var r = i(
                            this,
                            (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, p.default.extend(!0, {}, f, o))
                        );
                        return (
                                    ...
                                    return (
                                        ...
                                        (Array.isArray(this.options.colors)
                                            ? this.options.colors.indexOf(e) >= 0
                                                ...
                                                ? e.toUpperCase()
                                                : this.options.colors.indexOf(e.toLowerCase()) >= 0 && e.toLowerCase()
                                            : 'object' === l(this.options.colors) &&
        ...
        function(e, t, o) {
            ...
            (l.rgb.hsl = function(e) {
                    ...
                    return (
                        0 === u
                            ...
                            : ((i = u / c),
                              ...
                              (o = h(l)),
                              (r = h(s)),
                              a === c ? (n = r - o) : l === c ? (n = 1 / 3 + t - r) : s === c && (n = 2 / 3 + o - t),
                              n < 0 ? (n += 1) : n > 1 && (n -= 1)),
                        [360 * n, 100 * i, 100 * c]
                    );
                }),
                ...
                (l.hsl.rgb = function(e) {
                    ...
                    (o = s < 0.5 ? s * (1 + l) : s + l - s * l), (t = 2 * s - o), (n = [0, 0, 0]);
                    for (var c = 0; c < 3; c++)
                        (r = a + (1 / 3) * -(c - 1)),
                            r < 0 && r++,
                            r > 1 && r--,
                ...
                (l.rgb.hcg = function(e) {
                    ...
                    return (
                        (t = s < 1 ? l / (1 - s) : 0),
                        (o =
                            s <= 0 ? 0 : a === r ? ((n - i) / s) % 6 : a === n ? 2 + (i - r) / s : 4 + (r - n) / s + 4),
                        (o /= 6),
                        (o %= 1),
                        [360 * o, 100 * s, 100 * t]
                    );
                ...
                (l.hcg.hsl = function(e) {
                    var t = e[1] / 100,
                        ...
                        n = 0;
                    return (
                        r > 0 && r < 0.5 ? (n = t / (2 * r)) : r >= 0.5 && r < 1 && (n = t / (2 * (1 - r))),
                        [e[0], 100 * n, 100 * r]
                    );
                }),
                ...
                E = (function() {
                    function e(t, o) {
                        n(this, e),
                            ...
                            (this.options = f.default.extend(!0, {}, c.default, o, this.element.data())),
                            (this.disabled = !1),
                            (this.extensions = []),
                            (this.container =
                            ...
                            (this.container = !1 !== this.container && (0, f.default)(this.container)),
                    ...
                    return (
                        ...
                        i(e, [
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    var t = this;
                                    Array.isArray(this.options.extensions) || (this.options.extensions = []),
                                        this.options.debug && this.options.extensions.push({ name: 'debugger' }),
                                ...
                                value: function(e) {
                                    if (!this.isDisabled()) {
                                        ...
                                        (t.hasColor() && e && t.color.equals(e)) ||
                                            (!t.hasColor() && !e) ||
                                            ((t.color = e ? t.createColor(e, this.options.autoInputFallback) : null),
        ...
        function(e, t, o) {
            ...
            (t.Debugger = i.default),
                ...
                (t.Palette = h.default),
                (t.default = { debugger: i.default, preview: l.default, swatches: c.default, palette: h.default });
        },
        function(e, t, o) {
            'use strict';
            function r(e) {
                        ...
                        l(t, [
                            {
                                key: 'log',
                                value: function(e) {
                                    for (var t, o = arguments.length, r = Array(o > 1 ? o - 1 : 0), n = 1; n < o; n++)
                                        r[n - 1] = arguments[n];
                                    this.eventCounter += 1;
                                    var i =
                                        '#' +
                                    ...
                                    (t = console).debug.apply(t, [i].concat(r)),
                                        this.colorpicker.element.trigger({
                                            ...
                                            color: this.color,
                                            value: null,
                                            debug: { debugger: this, eventName: e, logArgs: r, logMessage: i },
                                        });
                                },
                            },
                            {
                                ...
                                value: function(e) {
                                    if (
                                        ...
                                        return void this.elementInner
                                            ...
                                            .css('color', null)
                                            .html('');
                                    this.elementInner.css('backgroundColor', e.color.toRgbString()),
                                        this.options.showText &&
                                            (this.elementInner.html(
                                                e.color.string(this.options.format || this.colorpicker.format)
                                            ),
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    s(
                                        ...
                                        this.isEnabled() &&
                                            ((this.element = (0, p.default)(this.options.barTemplate)),
                                            this.load(),
                                            this.colorpicker.picker.append(this.element));
                                },
                            },
                                ...
                                value: function() {
                                    ...
                                    o.empty(),
                                        p.default.each(this.colors, function(n, i) {
                                            ...
                                            a.find('.colorpicker-swatch--inner').css('background-color', i),
                                                o.append(a);
                                        }),
                                        ...
                                        if (!o.is('.colorpicker')) {
                                            ...
                                            for (var n in r)
                                                if (r.hasOwnProperty(n)) {
                                                    var i = r[n];
                                                    if (o.is(i.selector)) {
                                                        this.currentSlider = a.default.extend({}, i, { name: n });
                                                        break;
                                                    }
                        ...
                        i(e, [
                            {
                                ...
                                value: function() {
                                    ...
                                    if (e.options.inline)
                                        return void e.picker.addClass('colorpicker-inline colorpicker-visible');
                                    e.picker.addClass('colorpicker-popup colorpicker-hidden'),
                                        (this.hasInput || this.hasAddon) &&
                                            (e.options.popover && this.createPopover(),
                                            this.hasAddon &&
                                                (this.addon.attr('tabindex') || this.addon.attr('tabindex', 0),
                                                this.addon.on({
                                                    'mousedown.colorpicker touchstart.colorpicker': l.default.proxy(
                                                        this.toggle,
                                                        this
                                                    ),
                                                }),
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    this.hasInput &&
                                        ...
                                        this.input.off({ 'focusout.colorpicker': l.default.proxy(this.hide, this) })),
                                        this.hasAddon &&
                                            (this.addon.off({
                                                'mousedown.colorpicker touchstart.colorpicker': l.default.proxy(
                                                    this.toggle,
                                            ...
                                            this.addon.off({ 'focus.colorpicker': l.default.proxy(this.show, this) }),
                                            this.addon.off({
                                                'focusout.colorpicker': l.default.proxy(this.hide, this),
                                            })),
                                ...
                                value: function() {
                                    ...
                                    (this.popoverTarget = this.hasAddon ? this.addon : this.input),
                                        ...
                                        this.popoverTarget.popover(
                                            l.default.extend(!0, {}, c.default.popover, e.options.popover, {
                                                trigger: 'manual',
                                                content: e.picker,
                                                html: !0,
                                            })
                                        ...
                                        this.popoverTarget.on('shown.bs.popover', l.default.proxy(this.fireShow, this)),
                                ...
                                value: function(e) {
                                    if (!(this.isVisible() || this.showing || this.hidding)) {
                                        ...
                                        (t.lastEvent.alias = 'show'),
                                            ...
                                            t.picker.addClass('colorpicker-visible').removeClass('colorpicker-hidden'),
                                            this.popoverTarget ? this.popoverTarget.popover('show') : this.fireShow();
                                    }
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    var e = this.colorpicker;
                                    e.picker.addClass('colorpicker-hidden').removeClass('colorpicker-visible'),
                                        (0, l.default)(this.root).off(
                                            'resize.colorpicker',
                                            l.default.proxy(this.reposition, this)
                                        ),
                        ...
                        i(e, [
                            {
                                ...
                                value: function() {
                                    this.hasInput() &&
                                        (this.input.on({ 'keyup.colorpicker': l.default.proxy(this.onkeyup, this) }),
                                        this.input.on({ 'change.colorpicker': l.default.proxy(this.onchange, this) }));
                                },
                            },
                            {
                                key: 'unbind',
                                    ...
                                    if (this.hasInput()) {
                                        ...
                                        [this.input.val(), this.input.data('color'), this.input.attr('data-color')].map(
                                            ...
                                            e instanceof c.default
                                                ? (e = this.getFormattedColor(e.string(this.colorpicker.format)))
                                                : 'string' == typeof e || e instanceof String || (e = ''),
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;
                                    return (e = e || this.colorpicker.colorHandler.getColorString())
                                        ? ((e = this.colorpicker.colorHandler.resolveColorDelegate(e, !1)),
                                          !1 === this.colorpicker.options.useHashPrefix && (e = e.replace(/^#/g, '')),
                                          e)
                                        : '';
                                },
                            },
        ...
        function(e, t, o) {
            ...
            function r(e, t) {
                ...
                if (e)
                    if (e instanceof r)
                        ...
                        var l = Object.keys(e);
                        'alpha' in e &&
                            (l.splice(l.indexOf('alpha'), 1), (this.valpha = 'number' == typeof e.alpha ? e.alpha : 0));
                        var s = l.sort().join('');
            ...
            (r.prototype = {
                ...
                object: function() {
                    for (var e = {}, t = h[this.model].channels, o = h[this.model].labels, r = 0; r < t; r++)
                        e[o[r]] = this.color[r];
                ...
                luminosity: function() {
                    for (var e = this.rgb().color, t = [], o = 0; o < e.length; o++) {
                        var r = e[o] / 255;
                        t[o] = r <= 0.03928 ? r / 12.92 : Math.pow((r + 0.055) / 1.055, 2.4);
                    }
        ...
        function(e, t, o) {
            ...
            e.exports = function(e) {
                return (
                    !!e && (e instanceof Array || Array.isArray(e) || (e.length >= 0 && e.splice instanceof Function))
                );
            };
        },
        function(e, t, o) {
            function r(e) {
                var t = function(t) {
                    return void 0 === t || null === t
                        ? t
                        : (arguments.length > 1 && (t = Array.prototype.slice.call(arguments)), e(t));
                };
            ...
            function n(e) {
                var t = function(t) {
                    ...
                    var o = e(t);
                    if ('object' == typeof o) for (var r = o.length, n = 0; n < r; n++) o[n] = Math.round(o[n]);
                    return o;
                };
                return 'conversion' in e && (t.conversion = e.conversion), t;
            }
        ...
        function(e, t, o) {
            ...
            function n(e) {
                ...
                for (t[e].distance = 0; o.length; )
                    for (var n = o.pop(), i = Object.keys(l[n]), a = i.length, s = 0; s < a; s++) {
                        var c = i[s],
                            u = t[c];
                        -1 === u.distance && ((u.distance = t[n].distance + 1), (u.parent = n), o.unshift(c));
                    }
                return t;
            }
            function i(e, t) {
            ...
            function a(e, t) {
                for (var o = [t[e].parent, e], r = l[t[e].parent][e], n = t[e].parent; t[n].parent; )
                    o.unshift(t[n].parent), (r = i(l[t[n].parent][n], r)), (n = t[n].parent);
                        ...
                        i(e, [
                            {
                                ...
                                value: function() {
                                    if (this.colorpicker.options.color)
                                        return void (this.color = this.createColor(this.colorpicker.options.color));
                                    !this.color &&
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                                        o = !1;
                                    return (
                                        l.default.each(this.colorpicker.extensions, function(r, n) {
                        ...
                        n(e, [
                            {
                                ...
                                value: function() {
                                    ...
                                    this.options.customClass && e.addClass(this.options.customClass),
                                        this.options.horizontal && e.addClass('colorpicker-horizontal'),
                                        this._supportsAlphaBar()
                                            ? ((this.options.useAlpha = !0), e.addClass('colorpicker-with-alpha'))
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    if (this.colorpicker.colorHandler.hasColor()) {
                                        ...
                                        r.length &&
                                            r.css(e ? 'top' : 'left', (e ? t.hue.maxTop : t.hue.maxLeft) * (1 - i.h)),
                                            n.length &&
                                                n.css(
                                                    e ? 'top' : 'left',
                                        ...
                                        (l = this.options.horizontal
                                            ? 'linear-gradient(to right, ' + a + ' 0%, transparent 100%)'
                                            : 'linear-gradient(to bottom, ' + a + ' 0%, transparent 100%)'),
                                            this.picker.find('.colorpicker-alpha-color').css('background', l);
                                    }
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    (this.addon = this.colorpicker.options.addon
                                        ...
                                        : null),
                                        this.addon && 0 === this.addon.length && (this.addon = null);
                                },
                            },
                            {
                                key: 'unbind',
