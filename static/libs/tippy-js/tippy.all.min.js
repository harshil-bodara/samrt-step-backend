(function(t, e) {
    ...
    function l(t, e, a, i) {
        ...
        return (
            i.target
                ? (Ft.supportsTouch && i.touchHold && (d('touchstart', n), d('touchend', s)),
                  'mouseenter' === t && (d('mouseover', n), d('mouseout', s)),
                  'focus' === t && (d('focusin', n), d('focusout', s)),
                  'click' === t && d('click', n))
                : (d(t, o),
                  Ft.supportsTouch && i.touchHold && (d('touchstart', o), d('touchend', r)),
                  'mouseenter' === t && d('mouseleave', r),
                  'focus' === t && d(zt ? 'focusout' : 'blur', p)),
            l
        );
    }
    function d(t, e) {
    ...
    function w(t) {
        ...
        return i && 'BODY' !== i && 'HTML' !== i
            ? -1 !== ['TD', 'TABLE'].indexOf(a.nodeName) && 'static' === b(a, 'position')
                ? w(a)
                : a
            : t
    ...
    function I(t, e, a, i) {
        ...
        if ('viewport' === i) r = P(p, o);
            ...
            var n;
            'scrollParent' === i
                ? ((n = y(u(e))), 'BODY' === n.nodeName && (n = t.ownerDocument.documentElement))
                : 'window' === i
        ...
        return (
            (r.left += m ? a : a.left || 0),
            (r.top += m ? a : a.top || 0),
            (r.right -= m ? a : a.right || 0),
            (r.bottom -= m ? a : a.bottom || 0),
            r
        );
    }
    function R(t) {
    ...
    function j(t) {
        for (
            var e = [!1, 'ms', 'Webkit', 'Moz', 'O'], a = t.charAt(0).toUpperCase() + t.slice(1), o = 0;
            o < e.length;
            o++
        ) {
            var i = e[o],
    ...
    function J() {
        this.state.eventsEnabled &&
            (cancelAnimationFrame(this.scheduleUpdate), (this.state = $(this.reference, this.state)));
    }
    function tt(t) {
    ...
    function pt(t, e, a, i) {
        ...
        if ('vh' === p || 'vw' === p) {
            ...
            return (
                (l =
                    'vh' === p
                        ? Bt(document.documentElement.clientHeight, window.innerHeight || 0)
                        : Bt(document.documentElement.clientWidth, window.innerWidth || 0)),
                (l / 100) * r
            );
        }
        return r;
    ...
    function bt(t, e, a) {
        var i = ct(t),
            ...
            c = a
                .replace(
                    l.translate,
                    'translate' + ht(d.translate.axis, o) + '(' + ft('translate', d.translate.numbers, o, r) + ')'
                )
                .replace(l.scale, 'scale' + ht(d.scale.axis, o) + '(' + ft('scale', d.scale.numbers, o, r) + ')');
    ...
    function Tt(t) {
        ...
        if ((St.call(this), !this.state.visible)) {
            ...
            if (((this._(he).isPreparingToShow = !0), a.wait))
            ...
            var r = gt(a.delay, 0);
            r
                ? (this._(he).showTimeout = setTimeout(function() {
                      e.show();
                  }, r))
                : this.show();
        }
    ...
    function Lt() {
        ...
        if ((St.call(this), !!this.state.visible)) {
            ...
            e
                ? (this._(he).hideTimeout = setTimeout(function() {
    ...
    function Ot() {
        ...
        return {
            onTrigger: function(e) {
                if (t.state.enabled) {
                    var a =
                        Ft.supportsTouch && Ft.usingTouch && -1 < ['mouseenter', 'mouseover', 'focus'].indexOf(e.type);
                    (a && t.options.touchHold) ||
                        ((t._(he).lastTriggerEvent = e),
                        'click' === e.type && 'persistent' !== t.options.hideOnClick && t.state.visible
                            ? Lt.call(t)
                            : Tt.call(t, e));
                }
            },
        ...
        var t = this,
            ...
            l = Qt({ placement: i.placement }, p || {}, {
                modifiers: Qt({}, p ? p.modifiers : {}, {
                    ...
                    flip: Qt(
                        { enabled: i.flip, padding: i.distance + 5, behavior: i.flipBehavior },
        ...
        if (
            (this.popperInstance
                ? (this.popperInstance.scheduleUpdate(),
                  e.livePlacement && !kt.call(this) && this.popperInstance.enableEventListeners())
                : ((this.popperInstance = At.call(this)),
    ...
    function Dt(t, a) {
        ...
        var e = m(this.popper),
            ...
            o = function(t, e) {
                e &&
                    i[t + 'EventListener'](
                        'transition' in document.body.style ? 'transitionend' : 'webkitTransitionEnd',
                        e
                    );
            },
            r = function t(r) {
    ...
    function Ht(t) {
        var i = function() {
                Ft.usingTouch ||
                    ((Ft.usingTouch = !0),
                    Ft.iOS && document.body.classList.add('tippy-touch'),
                    Ft.dynamicInputDetection && window.performance && document.addEventListener('mousemove', o),
                    Ft.onUserInputChange('touch'));
            },
            o = (function() {
                var t;
                return function() {
                    ...
                    20 > e - t &&
                        ...
                        !Ft.iOS && document.body.classList.remove('tippy-touch'),
                        Ft.onUserInputChange('mouse')),
                        (t = e);
                };
            })();
        document.addEventListener(
            ...
            function(t) {
                ...
                var e = yt(t.target, qt.REFERENCE),
                    a = yt(t.target, qt.POPPER);
    ...
    var Nt = Math.min,
        ...
        Ft = {};
    Ut &&
        ((Ft.supported = 'requestAnimationFrame' in window),
        (Ft.supportsTouch = 'ontouchstart' in window),
        (Ft.usingTouch = !1),
        (Ft.dynamicInputDetection = !0),
        (Ft.iOS = /iPhone|iPad|iPod/.test(navigator.platform) && !window.MSStream),
        (Ft.onUserInputChange = function() {}));
    for (
        var qt = {
                POPPER: '.tippy-popper',
            ...
            Kt = Ft.supported && Object.keys(jt),
            Vt = function(t, e) {
        ...
        ce = (function() {
            function t(e, a) {
                ...
                oe(this, t),
                    ...
                    Object.keys(ne({}, t.Defaults.modifiers, o.modifiers)).forEach(function(e) {
            ...
            modifiers: {
                                ...
                                secondary: function(t) {
                                    ...
                                    return (
                                        d[t] > s[t] &&
                                            ...
                                            (i = Nt(d[a], s[t] - ('right' === t ? d.width : d.height))),
                                        pe({}, a, i)
                                    );
                                },
                            };
                ...
                arrow: {
                    ...
                    fn: function(t, e) {
                        ...
                        return (
                            (x = Bt(Nt(p[l] - h, x), 0)),
                            (t.arrowElement = i),
                            (t.offsets.arrow = ((a = {}), pe(a, c, Mt(x)), pe(a, m, ''), a)),
                            t
                        );
                    },
                    element: '[x-arrow]',
                ...
                inner: {
                    ...
                    fn: function(t) {
                        ...
                        return (
                            (o[p ? 'left' : 'top'] = r[a] - (n ? o[p ? 'width' : 'height'] : 0)),
                            (t.placement = M(e)),
                    ...
                    fn: function(t, e) {
                        ...
                        if (
                            ((b =
                                'bottom' == c
                                    ? 'HTML' === n.nodeName
                                        ? -n.clientHeight + d.bottom
                                        : -s.height + d.bottom
                                    : d.top),
                            (h =
                                'right' == m
                                    ? 'HTML' === n.nodeName
                                        ? -n.clientWidth + d.right
                                        : -s.width + d.right
                                    : d.left),
                            p && f)
                        )
                        ...
                        return (
                            (t.attributes = ne({}, g, t.attributes)),
                            (t.styles = ne({}, l, t.styles)),
                            (t.arrowStyles = ne({}, t.offsets.arrow, t.arrowStyles)),
                            t
                        );
                    },
                    gpuAcceleration: !0,
    ...
    if (Ut) {
        ...
        me =
            ...
            function(t) {
                for (
                    var e = (this.document || this.ownerDocument).querySelectorAll(t), a = e.length;
                    0 <= --a && e.item(a) !== this;
                                      ...
                                      Ct.call(this, function() {
                                          if (e.state.visible) {
                                              if ((kt.call(e) || e.popperInstance.scheduleUpdate(), kt.call(e))) {
                                                  ...
                                                  var r = gt(o.delay, 0),
                                                      d = e._(he).lastTriggerEvent;
                                                  d &&
                                                      e
                                                          ._(he)
                                                          .followCursorListener(
                                                              r && e._(he).lastMouseMoveEvent
                        ...
                        value: function(t) {
                            ...
                            if (!this.state.destroyed && this.state.enabled) {
                                ...
                                o.onHide.call(a, this),
                                    ...
                                    xt([p, n, n ? s : null], t),
                                    wt([p, n], 'hidden'),
                                    o.interactive && -1 < o.trigger.indexOf('click') && vt(i),
                                    Dt.call(this, t, function() {
                                        e.state.visible ||
                                            !o.appendTo.contains(a) ||
                                            (!e._(he).isPreparingToShow &&
                                                (document.removeEventListener(
                                                    'mousemove',
                                                    e._(he).followCursorListener
                                                ),
                                                (e._(he).lastMouseMoveEvent = null)),
                        ...
                        value: function() {
                            ...
                            if (!this.state.destroyed) {
                                ...
                                ['data-original-title', 'data-tippy', 'data-tippy-delegate'].forEach(function(e) {
                                    ...
                                    this.options.target &&
                                        e &&
                                        a(this.reference.querySelectorAll(this.options.target)).forEach(function(t) {
                                            return t._tippy && t._tippy.destroy();
                                        }),
                                    this.popperInstance && this.popperInstance.destroy(),
                                    this._(he).mutationObservers.forEach(function(t) {
                                        t.disconnect();
                                    }),
