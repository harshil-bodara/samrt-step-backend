                        ...
                        (this.prototype.Emitter = Emitter),
                            ...
                            (this.prototype.defaultOptions = {
                                ...
                                fallback: function() {
                                    ...
                                    a ||
                                        ((a = b.createElement('<div class="dz-message"><span></span></div>')),
                                ...
                                addedfile: function(a) {
                                    ...
                                    if (
                                        ...
                                        for (
                                            var d = a.previewElement.querySelectorAll('[data-dz-name]'), e = 0, d = d;
                                            ;
                                        ...
                                        for (
                                            var h = a.previewElement.querySelectorAll('[data-dz-size]'), i = 0, h = h;
                                            !(i >= h.length);
                ...
                [
                        ...
                        value: function() {
                            ...
                            if (
                                ...
                                !(function c() {
                                    return (
                                        a.hiddenFileInput &&
                                            a.hiddenFileInput.parentNode.removeChild(a.hiddenFileInput),
                                        ...
                                        null !== a.options.capture &&
                                            a.hiddenFileInput.setAttribute('capture', a.options.capture),
                            ...
                            return (
                                (a.upload = {
                                    ...
                                    chunked:
                                        ...
                                        (this.options.forceChunking || a.size > this.options.chunkSize),
                    ...
                    },
                    {
                        ...
                        value: function(a) {
                            ...
                            return (
                                this.options.uploadMultiple && this.emit('processingmultiple', a), this.uploadFiles(a)
                            );
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function(a, b) {
                            for (var c = 0; c < a.upload.totalChunkCount; c++)
                                if (void 0 !== a.upload.chunks[c] && a.upload.chunks[c].xhr === b)
                                ...
                                for (
                                    ...
                                    if ((g && (g = g.toLowerCase()), void 0 !== f && null !== f))
                                        if ('SELECT' === e.tagName && e.hasAttribute('multiple'))
                                            ...
                                            (!g || ('checkbox' !== g && 'radio' !== g) || e.checked) &&
                                                a.append(f, e.value);
                                }
                        },
                    },
                            ...
                            if (a[0].status !== b.CANCELED) {
                                ...
                                for (var f = a, g = 0, f = f; ; ) {
                                    ...
                                    this._errorProcessing(
                                        a,
                                        d || this.options.dictResponseError.replace('{{statusCode}}', c.status),
                                        c
                                    );
                                }
                            }
                    ...
                    },
                    {
                        ...
                        value: function(a, c, d) {
                            ...
                            if (
                                (this.options.uploadMultiple &&
                                    (this.emit('errormultiple', a, c, d), this.emit('completemultiple', a)),
                                this.options.autoProcessQueue)
                            )
                                return this.processQueue();
                        },
    ...
    var c = !1,
        ...
        j = function d(f) {
            if ('readystatechange' !== f.type || 'complete' === e.readyState)
                return (
                    ('load' === f.type ? a : e)[h](i + f.type, d, !1), !c && (c = !0) ? b.call(a, f.type || f) : void 0
                );
        };
