...
!(function(t, i) {
    ...
    function rt(t, i) {
        i &&
            (K(t.length)
                ...
                : 0 <= t.className.indexOf(i) && (t.className = t.className.replace(i, '')));
    }
    function st(t, i, e) {
        i &&
            (K(t.length)
    ...
    var Ot = {
            ...
            initContainer: function() {
                ...
                ot(a, { width: (this.containerData = n).width, height: n.height }), ht(t, S), rt(a, S);
            },
            initCanvas: function() {
                ...
                t.height * h > t.width
                    ...
                    ? (s = t.width / h)
                    : (r = t.height * h);
                var c = { aspectRatio: h, naturalWidth: n, naturalHeight: o, width: r, height: s };
                (c.left = (t.width - r) / 2),
                    (c.top = (t.height - s) / 2),
                    (c.oldLeft = c.left),
                    (c.oldTop = c.top),
                    ...
                    1 < h
                        ...
                        : 0 < h &&
                          (c
                              ...
                              : s && ((c = o.width) < (d = o.height) * r ? (c = d * r) : (d = c / r)));
                    ...
                    if (h) {
                        ...
                        (n.minLeft = Math.min(0, p)),
                            ...
                            s &&
                                ...
                                (n.maxTop = o.top),
                                2 === h &&
                                    (n.width >= a.width && ((n.minLeft = Math.min(0, p)), (n.maxLeft = Math.max(0, p))),
                                    n.height >= a.height &&
                                        ((n.minTop = Math.min(0, m)), (n.maxTop = Math.max(0, m)))));
            ...
            renderCanvas: function(t, i) {
                ...
                (e.width > e.maxWidth || e.width < e.minWidth) && (e.left = e.oldLeft),
                    ...
                    ot(
                        this.canvas,
                        et({ width: e.width, height: e.height }, kt({ translateX: e.left, translateY: e.top }))
                    ),
                    this.renderImage(t),
            ...
            renderImage: function(t) {
                ...
                et(e, { width: a, height: n, left: (i.width - a) / 2, top: (i.height - n) / 2 }),
                    ot(
                        this.image,
                        et({ width: e.width, height: e.height }, kt(et({ translateX: e.left, translateY: e.top }, e)))
                    ),
                    t && this.output();
            },
            ...
            limitCropBox: function(t, i) {
                ...
                if (t) {
                    ...
                    (s = Math.min(s, a.width)),
                        ...
                        r &&
                            (s && c ? (s < c * r ? (c = s / r) : (s = c * r)) : s ? (c = s / r) : c && (s = c * r),
                            d < l * r ? (l = d / r) : (d = l * r)),
            ...
            renderCropBox: function() {
                ...
                (e.width > e.maxWidth || e.width < e.minWidth) && (e.left = e.oldLeft),
                    ...
                    t.movable &&
                        t.cropBoxMovable &&
                        pt(this.face, u, e.width >= i.width && e.height >= i.height ? W : k),
                    ot(
                        this.cropBox,
                        et({ width: e.width, height: e.height }, kt({ translateX: e.left, translateY: e.top }))
                    ),
        ...
        zt = {
                ...
                if ((e && (i.crossOrigin = e), (i.src = a), this.viewBox.appendChild(i), (this.viewBoxImage = i), t)) {
                    ...
                    'string' == typeof t
                        ...
                        it((this.previews = n), function(t) {
                            ...
                            pt(t, g, { width: t.offsetWidth, height: t.offsetHeight, html: t.innerHTML }),
                                e && (i.crossOrigin = e),
                                (i.src = a),
                                (i.style.cssText =
            ...
            resetPreview: function() {
                it(this.previews, function(t) {
                    var i = lt(t, g);
                    ot(t, { width: i.width, height: i.height }), (t.innerHTML = i.html), mt(t, g);
                });
            },
            preview: function() {
                ...
                this.cropped &&
                    !this.disabled &&
                    (ot(this.viewBoxImage, et({ width: d, height: l }, kt(et({ translateX: -p, translateY: -m }, r)))),
                    it(this.previews, function(t) {
                        var i = lt(t, g),
                            e = i.width,
                            a = i.height,
            ...
            resize: function() {
                ...
                if (!(this.disabled || e.width <= a || e.height <= n)) {
                    ...
                    if (1 !== o || i.offsetHeight !== e.height) {
                        var h = void 0,
                            r = void 0;
                        t.restore && ((h = this.getCanvasData()), (r = this.getCropBoxData())),
                            this.render(),
                            t.restore &&
                                (this.setCanvasData(
                                    it(h, function(t, i) {
                ...
                if (!this.disabled) {
                    ...
                    t.changedTouches
                        ...
                        i &&
                            ...
                            this.cropping &&
                                ((this.cropping = !1), st(this.dragBox, o, this.cropped && this.options.modal)),
                ...
                switch (h) {
                    ...
                    case z:
                        if (r) {
                            ...
                            B(O),
                                ...
                                D.y <= 0 ? g < c && ((l -= D.y), (c += D.y)) : ((l -= D.y), (c += D.y));
                        d < 0 && l < 0
                            ? ((h = R), (d = l = 0))
                            : d < 0
                            ? ((h = Y), (d = 0))
                    ...
                    case T:
                        ...
                        (b = yt(this.cropper)),
                            ...
                            (d = n.minWidth),
                            (l = n.minHeight),
                            0 < D.x ? (h = 0 < D.y ? X : z) : D.x < 0 && ((s -= d), (h = 0 < D.y ? R : Y)),
                            D.y < 0 && (c -= l),
                            this.cropped ||
                                (rt(this.cropBox, S), (this.cropped = !0), this.limited && this.limitCropBox(!0, !0));
                }
                w &&
                    ((n.width = d), (n.height = l), (n.left = s), (n.top = c), (this.action = h), this.renderCropBox()),
                    it(o, function(t) {
        ...
        St = {
            ...
            destroy: function() {
                var t = this.element;
                return (
                    lt(t, l) && (this.isImg && this.replaced && (t.src = this.originalUrl), this.uncreate(), mt(t, l)),
                    this
                );
            },
            move: function(t) {
            ...
            moveTo: function(t) {
                ...
                return (
                    ...
                    this.ready &&
                        ...
                        (K(t) && ((e.left = t), (a = !0)), K(i) && ((e.top = i), (a = !0)), a && this.renderCanvas(!0)),
                    this
                );
            },
            zoom: function(t, i) {
            ...
            zoomTo: function(t, i, e) {
                ...
                if (0 <= (t = Number(t)) && this.ready && !this.disabled && h.zoomable) {
                    var p = d * t,
                        m = l * t;
                    if (!1 === wt(this.element, j, { originalEvent: e, oldRatio: s / d, ratio: p / d })) return this;
                    if (e) {
                        var u = this.pointers,
                            g = yt(this.cropper),
                            f =
                        ...
                        _(i) && K(i.x) && K(i.y)
                            ? ((r.left -= (p - s) * ((i.x - r.left) / s)), (r.top -= (m - c) * ((i.y - r.top) / c)))
            ...
            getData: function() {
                ...
                if (this.ready && this.cropped) {
                    o = { x: n.left - a.left, y: n.top - a.top, width: n.width, height: n.height };
                ...
                return (
                    ...
                    t.scalable && ((o.scaleX = i.scaleX || 1), (o.scaleY = i.scaleY || 1)),
                    o
                );
            },
            setData: function(t) {
                ...
                if (this.ready && !this.disabled && _(t)) {
                    var o = !1;
                    i.rotatable && K(t.rotate) && t.rotate !== e.rotate && ((e.rotate = t.rotate), (o = !0)),
                        i.scalable &&
                            (K(t.scaleX) && t.scaleX !== e.scaleX && ((e.scaleX = t.scaleX), (o = !0)),
                            K(t.scaleY) && t.scaleY !== e.scaleY && ((e.scaleY = t.scaleY), (o = !0))),
            ...
            getCanvasData: function() {
                ...
                return (
                    this.ready &&
                        it(['left', 'top', 'width', 'height', 'naturalWidth', 'naturalHeight'], function(t) {
                            e[t] = i[t];
                        }),
                    e
                );
                ...
                return (
                    this.ready &&
                        ...
                        K(t.width)
                            ...
                            : K(t.height) && ((i.height = t.height), (i.width = t.height * e)),
                        this.renderCanvas(!0)),
                    this
                );
            },
            ...
            setCropBoxData: function(t) {
                ...
                return (
                    this.ready &&
                        ...
                        (K(t.left) && (i.left = t.left),
                        K(t.top) && (i.top = t.top),
                        K(t.width) && t.width !== i.width && ((a = !0), (i.width = t.width)),
                        K(t.height) && t.height !== i.height && ((n = !0), (i.height = t.height)),
            ...
            getCroppedCanvas: function() {
                ...
                1 !== K && (($ *= K), (Q *= K), (F *= K), (Z *= K));
                var V = F / Z,
                    G = Et({ aspectRatio: V, width: t.maxWidth || 1 / 0, height: t.maxHeight || 1 / 0 }),
                    J = Et({ aspectRatio: V, width: t.minWidth || 0, height: t.minHeight || 0 }, 'cover'),
                    _ = Et({
                        aspectRatio: V,
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                this.options.checkCrossOrigin &&
                                    Dt(i) &&
                                    ((e = t.crossOrigin) ? (a = i) : ((e = 'anonymous'), (a = Bt(i)))),
                                    (this.crossOrigin = e),
                        ...
                        },
                        {
                            ...
                            value: function(t) {
                                ...
                                var a =
                                        r.navigator &&
                                        /(Macintosh|iPhone|iPod|iPad).*AppleWebKit/i.test(r.navigator.userAgent),
                                    n = function(t, i) {
                                        et(e.imageData, { naturalWidth: t, naturalHeight: i, aspectRatio: t / i }),
                                            (e.sizing = !1),
                                            (e.sized = !0),
                                            e.build();
                                    };
