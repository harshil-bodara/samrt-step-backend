...
!(function(a, b, c) {
    ...
    (d.prototype = {
        ...
        _createHeaderRow: function() {
            ...
            return (
                this._eachField(function(c, d) {
                    var e = this._prepareCell('<th>', c, 'headercss', this.headerCellClass)
        ...
        _refreshContent: function() {
            ...
            for (
                var b = this._loadStrategy.firstDisplayIndex(), c = this._loadStrategy.lastDisplayIndex(), d = b;
                c > d;
                d++
            ) {
                var e = this.data[d];
        ...
        _createRow: function(a, c) {
            ...
            return (
                b.isFunction(this.rowRenderer)
                    ? (d = this.renderTemplate(this.rowRenderer, this, { item: a, itemIndex: c }))
        ...
        _setSortingCss: function() {
            ...
            this._headerRow
                .find('th')
                .eq(a)
                .addClass(this._sortOrder === i ? this.sortAscClass : this.sortDescClass);
        },
        ...
        _createPager: function() {
            ...
            return (
                (a = b.isFunction(this.pagerRenderer)
                    ? b(this.pagerRenderer({ pageIndex: this.pageIndex, pageCount: this._pagesCount() }))
                ...
                b.proxy(function(e) {
                    ...
                    return (
                        e === l
                            ...
                            : e === m
                            ? (f = this._createPagerNavButton(this.pagePrevText, a - 1, a > 1))
                            : e === n
                            ? (f = this._createPagerNavButton(this.pageNextText, a + 1, c > a))
                            : e === o
        ...
        _createPages: function() {
            ...
            return (
                a > c + b - 1 && d.push(this._createPagerPageNavButton(this.pageNavigatorNextText, this.showNextPages)),
                d
            );
        },
        _createPagerNavButton: function(a, c, d) {
            return this._createPagerButton(
                a,
                this.pagerNavButtonClass + (d ? '' : ' ' + this.pagerNavButtonInactiveClass),
                d
                    ? function() {
                          this.openPage(c);
                      }
        ...
        loadData: function(a) {
            ...
            return this._controllerCall('loadData', a, c.cancel, function(a) {
                a && (this._loadStrategy.finishLoad(a), this._callEventHandler(this.onDataLoaded, { data: a }));
            });
        },
        getFilter: function() {
            var a = {};
            ...
            return (
                this._eachField(function(b) {
                    ...
                    this._prepareCell('<td>', b, 'editcss')
                        .append(this.renderTemplate(b.editTemplate || '', b, { value: d, item: a }))
                        .appendTo(c);
                }),
                c
            );
        ...
        _deleteRow: function(a) {
            ...
            return this._controllerCall('deleteItem', b, d.cancel, function() {
                this._loadStrategy.finishDelete(b, c),
                    this._callEventHandler(this.onItemDeleted, { row: a, item: b, itemIndex: c });
            });
        },
    }),
        ...
        (c.prototype = {
            ...
            _initShader: function() {
                this.shading &&
                    (this._shader = b('<div>')
                        ...
                        .hide()
                        .css({ position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, zIndex: this.zIndex })
            ...
            _initLoadPanel: function() {
                this._loadPanel = b('<div>')
                    ...
                    .text(this.message)
                    .hide()
                    .css({ position: 'absolute', top: '50%', left: '50%', zIndex: this.zIndex })
                    .appendTo(this._container);
            },
            show: function() {
    ...
    (function(a, b) {
        ...
        (c.prototype = {
            ...
            (d.prototype = {
                ...
                loadParams: function() {
                    var a = this._grid;
                    return { pageIndex: a.option('pageIndex'), pageSize: a.option('pageSize') };
                },
                reset: function() {
                ...
                return (
                    ...
                    c.on('click', function() {
                        ...
                        a.prop('readOnly')
                            ...
                            : a.prop('checked') || a.prop({ readOnly: !0, indeterminate: !0 });
                    }),
                    this.autosearch &&
                        c.on('click', function() {
                            a.search();
    ...
    (function(a, b) {
        ...
        (c.prototype = new d({
            ...
            _createModeSwitchButton: function() {
                var a = !1,
                    c = b.proxy(function() {
                        d.attr('title', a ? this.searchModeButtonTooltip : this.insertModeButtonTooltip)
