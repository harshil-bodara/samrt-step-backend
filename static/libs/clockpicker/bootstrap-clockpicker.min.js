...
!(function() {
    ...
    function s(s, r) {
        ...
        if (
            ...
            n('<button type="button" class="btn btn-sm btn-default clockpicker-button am-button">AM</button>')
                .on('click', function() {
                    (x.amOrPm = 'AM'),
                ...
                n('<button type="button" class="btn btn-sm btn-default clockpicker-button pm-button">PM</button>')
                    .on('click', function() {
                        (x.amOrPm = 'PM'),
                            n('.clockpicker-span-am-pm')
                                .empty()
        ...
        if (r.twelvehour)
            for (E = 1; 13 > E; E += 1)
                (D = z.clone()),
                    ...
                    (B = g),
                    D.css('font-size', '120%'),
                    D.css({ left: b + Math.sin(I) * B - y, top: b - Math.cos(I) * B - y }),
                    D.html(0 === E ? '00' : E),
                    v.append(D),
                    D.on(k, p);
        else
    ...
    (s.DEFAULTS = {
        ...
        (s.prototype.show = function() {
            if (!this.isShown) {
                ...
                (this.hours = +e[0] || 0),
                    ...
                    this.locate(),
                    (this.isShown = !0),
                    a.on('click.clockpicker.' + this.id + ' focusin.clockpicker.' + this.id, function(i) {
                        var e = n(i.target);
            ...
            if (
                ...
                u.twelvehour
                    ? a
                        ...
                        : (s && (c *= 5), 60 === c && (c = 0))
                    : a
                    ? (12 === c && (c = 0), (c = k ? (0 === c ? 12 : c) : 0 === c ? 0 : c + 12))
                    : (s && (c *= 5), 60 === c && (c = 0)),
        ...
        (s.prototype.remove = function() {
            this.element.removeData('clockpicker'),
                ...
                this.isAppended && (r.off('resize.clockpicker' + this.id), this.popover.remove());
        }),
