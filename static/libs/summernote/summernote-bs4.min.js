...
!(function(t, e) {
    ...
    var i = (function() {
                ...
                ? i.items
                      .map(function(t) {
                          ...
                          return (
                              ...
                              ('data-value="' + e + '"' + (void 0 !== n ? ' data-option="' + n + '"' : '')) +
        ...
        p = o('<div class="note-color-palette"/>', function(t, e) {
            for (var o = [], n = 0, i = e.colors.length; n < i; n++) {
                for (
                    var r = e.eventName, s = e.colors[n], a = e.colorsName[n], l = [], c = 0, d = s.length;
                    c < d;
                    c++
                ) {
                    var u = s[c],
            ...
            t.html(o.join('')),
                e.tooltip &&
                    t
                        .find('.note-color-btn')
                        .tooltip({ container: e.container, trigger: 'hover', placement: 'bottom' });
        }),
        ...
        g = o('<div class="form-check"></div>', function(t, e) {
            t.html(
                [
                    '<label class="form-check-label"' + (e.id ? ' for="' + e.id + '"' : '') + '>',
        ...
        b = {
            ...
            createLayout: function(t, e) {
                var o = (e.airMode
                    ...
                    : b.editor([b.toolbar(), b.editingArea([b.codable(), b.editable()]), b.statusbar()])
                ).render();
                return (
                    o.insertAfter(t),
                    {
    ...
    if (!H && E)
        if ('function' == typeof __webpack_require__)
            ...
            else void 0 !== require.specified && (H = require.specified('codemirror'));
        ...
        return e.length
            ? 1 === e.length
                ...
                : e.reduce(function(t, e) {
                      return t === o.node && (t = wt(o, n)), wt({ node: e, offset: t ? vt(t) : it(e) }, n);
                  })
            : null;
    }
    function St(t) {
    ...
    var Nt = {
        ...
        commonAncestor: function(t, e) {
            for (var o = lt(t), n = e; n; n = n.parentNode) if (-1 < k.inArray(n, o)) return n;
            return null;
        },
        wrap: function(t, e) {
            var o = t.parentNode,
        ...
        replace: function(t, e) {
            ...
            var o = St(e);
            return (
                t.style.cssText && (o.style.cssText = t.style.cssText), ut(o, N.from(t.childNodes)), dt(o, t), Tt(t), o
            );
        },
        html: function(t, e) {
            var o = $t(t);
            e &&
                ((o = o.replace(/<(\/?)(\b(?!!)[^>\s]*)(.*?)(\s*\/?>)/g, function(t, e, o) {
                    o = o.toUpperCase();
    ...
    var Rt = (function() {
            ...
            return (
                (r.prototype.nativeRange = function() {
                    ...
                    return e.setEndPoint('EndToEnd', At({ node: this.ec, offset: this.eo })), e;
                }),
                ...
                (r.prototype.normalize = function() {
                    var t = function(t, e) {
                            if (
                                ...
                                (Nt.isVisiblePoint(t) && Nt.isBlock(t.node) && Nt.isEmpty(t.node))
                            )
                                return t;
                            var o = Nt.ancestor(t.node, Nt.isBlock);
                            if (
                                ((Nt.isLeftEdgePointOf(t, o) || Nt.isVoid(Nt.prevPoint(t).node)) && !e) ||
                                ((Nt.isRightEdgePointOf(t, o) || Nt.isVoid(Nt.nextPoint(t).node)) && e)
                            ) {
                                ...
                                Nt.isEditable(t.node) ||
                                    (i
                                        ? (Nt.isLeftEdgePoint(t) && a.push(t.node),
                                          Nt.isRightEdgePoint(t) && N.contains(a, t.node) && (e = t.node))
                ...
                (r.prototype.splitText = function() {
                    var t = this.sc === this.ec,
                        e = this.getPoints();
                    return (
                        Nt.isText(this.ec) && !Nt.isEdgePoint(this.getEndPoint()) && this.ec.splitText(this.eo),
                        Nt.isText(this.sc) &&
                ...
                (r.prototype.wrapBodyInlineWithPara = function() {
                    if (Nt.isBodyContainer(this.sc) && Nt.isEmpty(this.sc))
                        return (this.sc.innerHTML = Nt.emptyPara), new r(this.sc.firstChild, 0, this.sc.firstChild, 0);
                    var t,
                        e = this.normalize();
                ...
                (r.prototype.insertNode = function(t) {
                    ...
                    return (
                        o.rightNode ? o.rightNode.parentNode.insertBefore(t, o.rightNode) : o.container.appendChild(t),
                        t
                    );
                }),
                ...
                (r.prototype.paraBookmark = function(t) {
                    return {
                        s: { path: N.tail(Nt.makeOffsetPath(N.head(t), this.sc)), offset: this.so },
                        e: { path: N.tail(Nt.makeOffsetPath(N.last(t), this.ec)), offset: this.eo },
                    };
                }),
    ...
    var Ht = (function() {
            ...
            return (
                ...
                (t.prototype.toggleList = function(o, t) {
                    ...
                    if (N.find(i, Nt.isPurePara)) {
                        ...
                        var l = e.nodes(Nt.isList, { includeAncestor: !0 }).filter(function(t) {
                            ...
                            if ('LI' === i.parentNode.nodeName)
                                e.map(function(t) {
                                    ...
                                    r.nextSibling
                                        ...
                                        e.length && (d.wrapList(e, i.nodeName), t.appendChild(e[0].parentNode));
                                }),
                ...
                (t.prototype.insertParagraph = function(t, e) {
                    ...
                    if (n) {
                        ...
                        if (
                            ...
                            var r = Nt.splitTree(i, e.getStartPoint(), { isDiscardEmptySplits: !0 });
        ...
        Mt = function(t, h, p, i) {
            ...
            function v(t, e, o, n, i, r, s) {
                var a = { baseRow: o, baseCell: n, isRowSpan: i, isColSpan: r, isVirtual: s };
                m[t] || (m[t] = []), (m[t][e] = a);
            }
            function b(t, e) {
                if (!m[t]) return e;
            ...
            (this.getActionList = function() {
                for (
                    ...
                    g.push(
                        ...
                        (e = a),
                        (o = l),
                        { baseCell: d.baseCell, action: t, virtualTable: { rowIndex: e, cellIndex: o } })
                    ),
                        r++;
                }
                return g;
            }),
                t && t.tagName && ('td' === t.tagName.toLowerCase() || 'th' === t.tagName.toLowerCase())
                    ? ((f.colPos = t.cellIndex),
                      t.parentElement && t.parentElement.tagName && 'tr' === t.parentElement.tagName.toLowerCase()
    ...
    (Mt.where = { Row: 0, Column: 1 }),
        ...
        (Mt.resultAction = { Ignore: 0, SubtractSpanCount: 1, RemoveCell: 2, AddCell: 3, SumSpanCount: 4 });
    var Ot,
        Ut = (function() {
            function t() {}
            return (
                ...
                (t.prototype.addRow = function(t, e) {
                    for (
                        var o = Nt.ancestor(t.commonAncestor(), Nt.isCell),
                            ...
                            r = k('<tr' + i + '></tr>'),
                            s = new Mt(o, Mt.where.Row, Mt.requestAction.Add, k(n).closest('table')[0]).getActionList(),
                            a = 0;
                        a < s.length;
                        a++
                    ) {
                            ...
                            case Mt.resultAction.SumSpanCount:
                                if ('top' === e)
                                    if ((l.baseCell.parent ? l.baseCell.closest('tr').rowIndex : 0) <= n[0].rowIndex) {
                                        var d = k('<div></div>')
                                            .append(k('<td' + c + '>' + Nt.blank + '</td>').removeAttr('rowspan'))
                                            .html();
                                        r.append(d);
                                        break;
                                    }
                                ...
                                case Mt.resultAction.SubtractSpanCount:
                                    ...
                                    if (s.colSpan && 1 < s.colSpan) {
                                        ...
                                        2 < a
                                            ...
                                            : 2 === a &&
                                              (s.removeAttribute('colSpan'), s.cellIndex === n && (s.innerHTML = ''));
                                    }
                                    continue;
                                case Mt.resultAction.RemoveCell:
        ...
        jt = (function() {
                ...
                (this.insertParagraph = this.wrapCommand(function() {
                    ...
                    (this.insertNode = this.wrapCommand(function(t) {
                        u.isLimited(k(t).text().length) ||
                            (u.createRange().insertNode(t), Ft.createFromNodeAfter(t).select());
                    })),
                        ...
                        if (!(0 < r && u.isLimited(r))) {
                            ...
                            'string' == typeof o && (o = o.trim()),
                                u.options.onCreateLink
                                    ...
                                    : /^\.?\/(.*)/.test(o) ||
                                      (o = /^[A-Za-z][A-Za-z0-9+-.]*\:[\/\/]?/.test(o) ? o : 'http://' + o);
                            var a = [];
                            if (s) {
            ...
            return (
                (t.prototype.initialize = function() {
                    ...
                    this.$editable
                        .on('keydown', function(t) {
                            if (
                                (t.keyCode === Lt.code.ENTER && e.context.triggerEvent('enter', t),
                                e.context.triggerEvent('keydown', t),
                                t.isDefaultPrevented() ||
                                    (e.options.shortcuts ? e.handleKeyMap(t) : e.preventDefaultEditableShortCuts(t)),
                                e.isLimited(1, t))
                            )
                                return !1;
                        })
                ...
                (t.prototype.tab = function() {
                    ...
                    if (t.isCollapsed() && t.isOnCell()) this.table.tab(t);
                        ...
                        this.isLimited(this.options.tabSize) ||
                            (this.beforeCommand(), this.typing.insertTab(t, this.options.tabSize), this.afterCommand());
                    }
                }),
                ...
                (t.prototype.onFormatBlock = function(t, e) {
                    if (
                        ((t = z.isMSIE ? '<' + t + '>' : t), document.execCommand('FormatBlock', !1, t), e && e.length)
                    ) {
                        var o = e[0].className || '';
                        if (o) {
    ...
    var Vt = (function() {
            ...
            return (
                ...
                (t.prototype.activate = function() {
                    var e = this;
                    if (
                        (this.$codable.val(Nt.html(this.$editable, this.options.prettifyHtml)),
            ...
            return (
                ...
                (t.prototype.update = function(t) {
                    ...
                    if ((this.context.invoke('imagePopover.update', t), e)) {
                        ...
                        o.css({ display: 'block', left: r.left, top: r.top, width: s.w, height: s.h }).data(
                            'target',
                            n
                        );
                        var a = new Image();
                        a.src = n.attr('src');
                        var l =
                            s.w + 'x' + s.h + ' (' + this.lang.image.original + ': ' + a.width + 'x' + a.height + ')';
            ...
            return (
                    ...
                    return (
                        this.fontInstalledMap.hasOwnProperty(t) ||
                            (this.fontInstalledMap[t] =
                                z.isFontInstalled(t) || N.contains(this.options.fontNamesIgnoreCheck, t)),
                        this.fontInstalledMap[t]
                    );
                }),
                (t.prototype.isFontDeservedToAdd = function(t) {
                    return (
                        ...
                        -1 === k.inArray(t, ['sans-serif', 'serif', 'monospace', 'cursive', 'fantasy'])
                    );
                }),
                                ...
                                this.button({
                                    ...
                                    click: function(t) {
                                        ...
                                        o && n
                                            ...
                                            : o
                                            ? p.context.invoke('editor.color', { backColor: e.attr('data-backColor') })
                                            : n &&
                                              p.context.invoke('editor.color', { foreColor: e.attr('data-foreColor') });
                                    },
                                    callback: function(t) {
                        ...
                        this.context.memo('button.paragraph', function() {
                            return n.ui
                                .buttonGroup([
                                    ...
                                    n.ui.dropdown([
                                        n.ui.buttonGroup({ className: 'note-align', children: [r, s, a, l] }),
                                        n.ui.buttonGroup({ className: 'note-list', children: [c, d] }),
                                    ]),
                                ])
                                .render();
                        }),
                                    ...
                                    ],
                                    {
                                        callback: function(t) {
                                            t.find('.note-dimension-picker-mousecatcher')
                                                ...
                                                .mousedown(n.context.createInvokeHandler('editor.insertTable'))
                ...
                (t.prototype.tableMoveHandler = function(t) {
                    ...
                    r.css({ width: l + 'em', height: c + 'em' }),
                        i.data('value', l + 'x' + c),
                        3 < l && l < this.options.insertTableMaxSize.col && s.css({ width: l + 1 + 'em' }),
                        3 < c && c < this.options.insertTableMaxSize.row && s.css({ height: c + 1 + 'em' }),
                        n.html(l + ' x ' + c);
                }),
                t
            );
                ...
                (t.prototype.initialize = function() {
                    ...
                    if (this.options.maximumImageFileSize) {
                        var o = Math.floor(Math.log(this.options.maximumImageFileSize) / Math.log(1024)),
                            n =
                                1 * (this.options.maximumImageFileSize / Math.pow(1024, o)).toFixed(2) +
                                ' ' +
                                ' KMGTP'[o] +
                                'B';
                    ...
                    var i = [
                        ...
                        r =
                            ...
                            '" disabled>';
                    this.$dialog = this.ui
                        .dialog({ title: this.lang.image.insert, fade: this.options.dialogsFade, body: i, footer: r })
                        .render()
                        .appendTo(t);
                }),
                (t.prototype.destroy = function() {
            ...
            return (
                (t.prototype.initialize = function() {
                    var t = this.options.dialogsInBody ? this.$body : this.$editor,
                        ...
                        o =
                            ...
                            '" disabled>';
                    this.$dialog = this.ui
                        .dialog({ title: this.lang.video.insert, fade: this.options.dialogsFade, body: e, footer: o })
                        .render()
                        .appendTo(t);
                }),
                (t.prototype.destroy = function() {
                ...
                (t.prototype.createVideoNode = function(t) {
                    ...
                    if (o && 11 === o[1].length) {
                        ...
                        e = k('<iframe>')
                            .attr('frameborder', 0)
                            .attr('src', '//www.youtube.com/embed/' + p + (0 < f ? '?start=' + f : ''))
                            .attr('width', '640')
                            .attr('height', '360');
                        ...
                        e = k('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
                            .attr('frameborder', 0)
                        ...
                        e = k('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
                            ...
                            .attr('height', '310')
                            .attr('width', '500')
                            .attr('src', 'http://v.qq.com/iframe/player.html?vid=' + y + '&amp;auto=0');
                    } else {
                        if (!(d || u || h)) return !1;
                        e = k('<video controls>')
                            .attr('src', t)
                    ...
                    return Object.keys(i)
                        .map(function(t) {
                            ...
                            return (
                                o
                                    .append(
                                        k('<label><kbd>' + t + '</kdb></label>').css({ width: 180, 'margin-right': 10 })
                                    )
                ...
                (this.context = t),
                    ...
                    (this.events = {
                        ...
                        'summernote.focusout': function(t, e) {
                            z.isFF ||
                                (e.relatedTarget && Nt.ancestor(e.relatedTarget, C.eq(o.$popover[0]))) ||
                                o.hide();
                        },
                    });
            }
            ...
            return (
                ...
                (t.prototype.createItemTemplates = function(n, t) {
                    ...
                    return t.map(function(t, e) {
                        ...
                        return o.append(i.template ? i.template(t) : t + ''), o.data({ index: n, item: t }), o;
                    });
                }),
                (t.prototype.handleKeydown = function(t) {
                    this.$popover.is(':visible') &&
                        (t.keyCode === Lt.code.ENTER
                            ...
                            : t.keyCode === Lt.code.DOWN && (t.preventDefault(), this.moveDown()));
                }),
                    ...
                    if (!N.contains([Lt.code.ENTER, Lt.code.UP, Lt.code.DOWN], t.keyCode)) {
                        ...
                        if (this.hints.length && n) {
                            ...
                            i &&
                                ...
                                'top' === this.direction
                                    ? this.$popover.css({ left: i.left, top: i.top - this.$popover.outerHeight() - 5 })
            ...
            return (
                ...
                (t.prototype.initializeModule = function(t) {
                    ...
                    (e.shouldInitialize = e.shouldInitialize || C.ok),
                        e.shouldInitialize() &&
                            (e.initialize && e.initialize(), e.events && Nt.attachEvents(this.$note, e.events));
                }),
                ...
                (t.prototype.removeModule = function(t) {
                    var e = this.modules[t];
                    e.shouldInitialize() &&
                        (e.events && Nt.detachEvents(this.$note, e.events), e.destroy && e.destroy()),
