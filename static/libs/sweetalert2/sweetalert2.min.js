            ...
            if (o) {
                ...
                var i = function() {
                    M()
                        ...
                        : (new Promise(function(e) {
                              ...
                              (le.restoreFocusTimeout = setTimeout(function() {
                                  le.previousActiveElement && le.previousActiveElement.focus
                                      ? (le.previousActiveElement.focus(), (le.previousActiveElement = null))
                        ...
                        W(
                            [document.documentElement, document.body],
                            [_.shown, _['height-auto'], _['no-backdrop'], _['toast-shown'], _['toast-column']]
                        ),
                        T() &&
                            (null !== b.previousBodyPadding &&
        ...
        Me = {
            email: function(e, t) {
                return /^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(e)
                    ? Promise.resolve()
                    : Promise.reject(t && t.validationMessage ? t.validationMessage : 'Invalid email address');
            },
            url: function(e, t) {
                return /^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{2,256}\.[a-z]{2,63}\b([-a-zA-Z0-9@:%_+.~#?&//=]*)$/.test(
                    ...
                    ? Promise.resolve()
                    : Promise.reject(t && t.validationMessage ? t.validationMessage : 'Invalid URL');
            },
        };
    var je = function(e) {
        var t = w(),
                ...
                !(function(t) {
                    ...
                    t.inputValidator ||
                        Object.keys(Me).forEach(function(e) {
                            t.input === e &&
                                (t.inputValidator = t.expectRejections ? Me[e] : De.adaptInputValidator(Me[e]));
                        }),
                        t.validationMessage &&
                    ...
                    if (
                        ...
                        'string' == typeof t.backdrop
                            ...
                            : t.backdrop || z([document.documentElement, document.body], _['no-backdrop']),
                        !t.backdrop &&
                            t.allowOutsideClick &&
                            R('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
                        t.position in _
                            ? z(s, _[t.position])
                            : (R('The "position" parameter is not valid, defaulting to "center"'), z(s, _.center)),
                    ...
                    t.showCloseButton ? (c.setAttribute('aria-label', t.closeButtonAriaLabel), K(c)) : F(c),
                        (e.className = _.popup),
                        t.toast
                            ? (z([document.documentElement, document.body], _['toast-shown']), z(e, _.toast))
                            : z(e, _.modal),
                    ...
                    if (
                        ...
                        (j.popup.onmousedown = function() {
                            ...
                            (j.container.onclick = function(e) {
                                a
                                    ? (a = !1)
                                    : e.target === j.container && H(M.allowOutsideClick) && c(V.DismissReason.backdrop);
                            });
                    }
                    M.reverseButtons
                        ? j.confirmButton.parentNode.insertBefore(j.cancelButton, j.confirmButton)
                        : j.confirmButton.parentNode.insertBefore(j.confirmButton, j.cancelButton);
                    var s = function(e, t) {
