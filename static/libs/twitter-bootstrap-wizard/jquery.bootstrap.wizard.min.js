...
(function(e) {
    var n = function(d, k) {
        ...
        this.fixNavigationButtons = function() {
            ...
            if (c.onTabShow && 'function' === typeof c.onTabShow && !1 === c.onTabShow(f, b, a.currentIndex()))
                return !1;
        };
        this.next = function(h) {
            if (
                d.hasClass('last') ||
                (c.onNext && 'function' === typeof c.onNext && !1 === c.onNext(f, b, a.nextIndex()))
            )
                return !1;
            h = a.currentIndex();
            $index = a.nextIndex();
            $index > a.navigationLength() ||
                (g.push(h), b.find('li:has([data-toggle="tab"]):eq(' + $index + ') a').tab('show'));
        };
        this.previous = function(h) {
            if (
                d.hasClass('first') ||
                (c.onPrevious && 'function' === typeof c.onPrevious && !1 === c.onPrevious(f, b, a.previousIndex()))
            )
                return !1;
            h = a.currentIndex();
        ...
        this.first = function(h) {
            if (
                (c.onFirst && 'function' === typeof c.onFirst && !1 === c.onFirst(f, b, a.firstIndex())) ||
                d.hasClass('disabled')
            )
                return !1;
        ...
        this.last = function(h) {
            if (
                (c.onLast && 'function' === typeof c.onLast && !1 === c.onLast(f, b, a.lastIndex())) ||
                d.hasClass('disabled')
            )
                return !1;
            g.push(a.currentIndex());
        ...
        this.previousTab = function() {
            return 0 >= a.currentIndex()
                ? null
                : b.find('li:has([data-toggle="tab"]):eq(' + parseInt(a.currentIndex() - 1) + ')');
        };
