            ...
            maxlength: function(b, c) {
                ...
                function l(a, c, d, e) {
                    e &&
                        ...
                        a > 0
                            ? g(c, b.threshold, d)
                                ? i(c, e.removeClass(b.limitReachedClass).addClass(b.warningClass))
                                : j(c, e)
                            : i(c, e.removeClass(b.warningClass).addClass(b.limitReachedClass))),
                        b.allowOverMax && (0 > a ? c.addClass('overmax') : c.removeClass('overmax'));
                }
                function m(b) {
                    var c = b[0];
                    return a.extend(
                ...
                function n(c, d) {
                    ...
                    var f = c.outerWidth(),
                        ...
                        i = d.height();
                    switch (
                        (b.appendToParent && ((e.top -= c.parent().offset().top), (e.left -= c.parent().offset().left)),
                        b.placement)
                    ) {
                        case 'bottom':
                    ...
                    this.each(function() {
                        function c() {
                            ...
                            (d = p(g)),
                                ...
                                b.appendToParent
                                    ? (g.parent().append(f), g.parent().css('position', 'relative'))
                                    : q.append(f);
                            var e = h(g, p(g));
                            l(e, g, d, f), n(g, f);
                        }
                        ...
                        a(window).resize(function() {
                            ...
                            g.on('input', function() {
                                ...
                                return (
                                    ...
                                    ('bottom-right-inside' === b.placement || 'top-right-inside' === b.placement) &&
                                        n(g, f),
                                    i
                                );
                            });
