            ...
            if (j.isPlainObject(c)) {
                ...
                if (s) {
                    ...
                    for (w = i.length; g < w; g++)
                        (f = c.createAttribute(i[g].name.replace(':', '_dt_b_namespace_token_'))),
                            (f.value = i[g].value),
        ...
        var y = h.document.createElementNS('http://www.w3.org/1999/xhtml', 'a'),
            ...
            F = function(a, b, d) {
                ...
                var c = this,
                    ...
                    g = function() {
                        for (
                            var a = ['writestart', 'progress', 'write', 'writeend'], a = [].concat(a), b = a.length;
                            b--;
    ...
    q.ext.buttons.excelHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            var e = this,
                ...
                m = function(a) {
                    ...
                    for (var b = 0, d = a.length; b < d; b++) {
                        ...
                        f ||
                            ('number' === typeof a[b] ||
                            (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                                ...
                                : ((h = !h.replace ? h : h.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, '')),
                                  (f = n(i, 'c', {
                                      ...
                                      children: {
                                          row: n(i, 'is', {
                                              children: {
                                                  row: n(i, 't', { text: h, attr: { 'xml:space': 'preserve' } }),
                                              },
                                          }),
                                      },
                                  }))));
            ...
            for (s = k.header.length; p < s; p++)
                m.appendChild(n(i, 'col', { attr: { min: p + 1, max: p + 1, width: L(k, p), customWidth: 1 } }));
            j('mergeCells', i).before(
                n(i, 'autoFilter', { attr: { ref: 'A' + d + ':' + x(k.header.length - 1) + h } })
            );
            m = a.xl['workbook.xml'];
