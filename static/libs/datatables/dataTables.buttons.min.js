...
(function(e) {
    ...
    e.extend(l.prototype, {
        ...
        add: function(a, b) {
            ...
            if ('string' === typeof b) {
                for (var d = b.split('-'), c = this.s, e = 0, h = d.length - 1; e < h; e++) c = c.buttons[1 * d[e]];
                c = c.buttons;
                b = 1 * d[d.length - 1];
            }
        ...
        disable: function(a) {
            ...
            e(a.node).addClass(this.c.dom.button.disabled);
            return this;
        },
        destroy: function() {
        ...
        enable: function(a, b) {
            ...
            var c = this._nodeToButton(a);
            e(c.node).removeClass(this.c.dom.button.disabled);
            return this;
        },
        name: function() {
            return this.c.name;
        ...
        processing: function(a, b) {
            var c = this._nodeToButton(a);
            if (b === m) return e(c.node).hasClass('processing');
            e(c.node).toggleClass('processing', b);
            return this;
        },
        remove: function(a) {
        ...
        text: function(a, b) {
            ...
            c.conf.text = b;
            d ? h.children(d).html(f(b)) : h.html(f(b));
            return this;
        },
        _constructor: function() {
            ...
            for (var g = 0, h = d.length; g < h; g++) this.add(d[g]);
        ...
        _expandButton: function(a, b, c, d) {
            for (var g = this.s.dt, h = 0, b = !e.isArray(b) ? [b] : b, f = 0, q = b.length; f < q; f++) {
                var j = this._resolveExtends(b[f]);
                if (j)
                    if (e.isArray(j)) this._expandButton(a, j, c, d);
                    else {
                        var p = this._buildButton(j, c);
                        if (p) {
                            d !== m ? (a.splice(d, 0, p), d++) : a.push(p);
                            if (p.conf.buttons) {
                                var u = this.c.dom.collection;
                                p.collection = e('<' + u.tag + '/>')
                                    .addClass(u.className)
                                    .attr('role', 'menu');
                                p.conf._collection = p.collection;
                                this._expandButton(p.buttons, p.conf.buttons, !0, d);
                            }
                            j.init && j.init.call(g.button(p.node), g, e(p.node), j);
                            h++;
                        }
                    }
            }
                ...
                var c = function(d) {
                    for (var g = 0, h = d.length; g < h; g++) {
                        var f = d[g].conf,
                            q = d[g].node;
                        if (f.key)
                            if (f.key === a) (b._buttonsHandled = !0), e(q).click();
                            else if (e.isPlainObject(f.key) && f.key.key === a && (!f.key.shiftKey || b.shiftKey))
                                if (!f.key.altKey || b.altKey)
                                    if (!f.key.ctrlKey || b.ctrlKey)
                                        if (!f.key.metaKey || b.metaKey) (b._buttonsHandled = !0), e(q).click();
        ...
        _resolveExtends: function(a) {
            for (
                ...
                if (f) {
                    a.buttons || (a.buttons = []);
                    c = 0;
                    for (d = f.length; c < d; c++) a.buttons.push(f[c]);
                    a.postfixButtons = null;
                }
                if ((f = a.prefixButtons)) {
                    a.buttons || (a.buttons = []);
                    c = 0;
                    for (d = f.length; c < d; c++) a.buttons.splice(c, 0, f[c]);
    ...
    l.instanceSelector = function(a, b) {
        ...
        var c = [],
            ...
            g = function(a) {
                if (e.isArray(a)) for (var f = 0, q = a.length; f < q; f++) g(a[f]);
                else
                    'string' === typeof a
                        ? -1 !== a.indexOf(',')
                            ? g(a.split(','))
                            : ((a = e.inArray(e.trim(a), d)), -1 !== a && c.push(b[a].inst))
            ...
            var c = [],
                ...
                g = function(a, b) {
                    ...
                    if (e.isArray(a) || a instanceof e) {
                        ...
                        'object' === typeof a &&
                            a.nodeName &&
                            ((i = e.inArray(a, f)), -1 !== i && c.push({ inst: b, node: f[i] }));
                },
                h = 0,
                f = a.length;
            h < f;
    ...
    l.defaults = {
        ...
        dom: {
            ...
            button: {
                tag: 'ActiveXObject' in n ? 'a' : 'button',
                className: 'dt-button',
                active: 'active',
                disabled: 'disabled',
            },
    ...
    e.extend(k, {
        collection: {
            ...
            action: function(a, b, c, d) {
                var g = e(c).parents('div.dt-button-collection'),
                    a = c.position(),
                    h = e(b.table().container()),
                    f = !1,
                    i = c;
                g.length &&
                    ((f = e('.dt-button-collection').position()), (i = g), e('body').trigger('click.dtb-collection'));
                i.parents('body')[0] !== o.body && (i = o.body.lastChild);
                d._collection.find('.dt-button-collection-title').remove();
                d._collection.prepend('<div class="dt-button-collection-title">' + d.collectionTitle + '</div>');
                d._collection
                    .addClass(d.collectionLayout)
                    .css('display', 'none')
                    .insertAfter(i)
                    .fadeIn(d.fade);
                g = d._collection.css('position');
                f && 'absolute' === g
                    ? d._collection.css({ top: f.top, left: f.left })
                    : 'absolute' === g
                    ? (d._collection.css({ top: a.top + c.outerHeight(), left: a.left }),
                      (f = h.offset().top + h.height()),
                      (f = a.top + c.outerHeight() + d._collection.outerHeight() - f),
                      (g = a.top - d._collection.outerHeight()),
                      (g = h.offset().top - g),
                      (f > g || d.dropup) && d._collection.css('top', a.top - d._collection.outerHeight() - 5),
                      d._collection.hasClass(d.rightAlignClassName) &&
                          d._collection.css('left', a.left + c.outerWidth() - d._collection.outerWidth()),
                      (f = a.left + d._collection.outerWidth()),
                      (h = h.offset().left + h.width()),
                      f > h && d._collection.css('left', a.left - (f - h)),
                      (c = c.offset().left + d._collection.outerWidth()),
                      c > e(n).width() && d._collection.css('left', a.left - (c - e(n).width())))
                    : ((c = d._collection.height() / 2),
                      c > e(n).height() / 2 && (c = e(n).height() / 2),
                      d._collection.css('marginTop', -1 * c));
                d.background && l.background(!0, d.backgroundClassName, d.fade, i);
                var j = function() {
                    d._collection.fadeOut(d.fade, function() {
                        d._collection.detach();
                    });
                    e('div.dt-button-background').off('click.dtb-collection');
                    l.background(false, d.backgroundClassName, d.fade, i);
                ...
                setTimeout(function() {
                    ...
                    e('body')
                        .on('click.dtb-collection', function(a) {
                            var b = e.fn.addBack ? 'addBack' : 'andSelf';
                            e(a.target)
                                .parents()
                                [b]()
                                .filter(d._collection).length || j();
                        })
    ...
    i.Api.registerPlural('buttons().containers()', 'buttons().container()', function() {
        ...
        this.iterator(!0, 'table', function(c) {
            if (c._buttons)
                for (var c = l.instanceSelector(b, c._buttons), d = 0, e = c.length; d < e; d++)
    ...
    i.Api.register('buttons.info()', function(a, b, c) {
        ...
        if (!1 === a)
            return (
                e('#datatables_buttons_info').fadeOut(function() {
                    e(this).remove();
                }),
                clearTimeout(r),
                (r = null),
    ...
    i.Api.register('buttons.exportData()', function(a) {
        if (this.context.length) {
            ...
            b.select &&
                ...
                h.selected === m &&
                b.rows(c.rows, e.extend({ selected: !0 }, h)).any() &&
    ...
    i.Api.register('buttons.exportInfo()', function(a) {
        ...
        var c = a;
        b =
            '*' === c.filename && '*' !== c.title && c.title !== m && null !== c.title && '' !== c.title
                ? c.title
                : c.filename;
        'function' === typeof b && (b = b());
        b === m || null === b
            ? (b = null)
            : (-1 !== b.indexOf('*') && (b = e.trim(b.replace('*', e('head > title').text()))),
