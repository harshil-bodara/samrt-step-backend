...
(function(e) {
    ...
    function x(a) {
        ...
        e('body').on('click.dtSelect' + a.table().node().id, function(c) {
            b._select.blurable &&
                !e(c.target)
                    .parents()
                    .filter(a.table().container()).length &&
                0 !== e(c.target).parents('html').length && !e(c.target).parents('div.DTE').length &&
                o(b, !0);
        });
    }
    function j(a, c, b, d) {
        if (!d || a.flatten().length)
            'string' === typeof c && (c += '.dt'), b.unshift(a), e(a.table().node()).trigger(c, b);
    }
    function y(a) {
        var c = a.settings()[0];
    ...
    function r(a, c, b, d, f) {
        ...
        'os' === e
            ? a.ctrlKey || a.metaKey
                ...
                : ((a = c[d + 's']({ selected: !0 })),
                  g && 1 === a.flatten().length ? c[d](f).deselect() : (a.deselect(), c[d](f).select()))
            : 'multi+shift' == e
            ? a.shiftKey
                ? 'cell' === d
                    ? u(c, f, b._select_lastCell || null)
        ...
        function(a, c) {
            g.ext.selector[c.type].push(function(b, a, f) {
                ...
                for (var h = 0, i = f.length; h < i; h++)
                    (e = b[c.prop][f[h]]),
                        ((!0 === a && !0 === e._select_selected) || (!1 === a && !e._select_selected)) && g.push(f[h]);
                return g;
            });
        }
    );
    g.ext.selector.cell.push(function(a, c, b) {
        ...
        for (var e = 0, g = b.length; e < g; e++)
            (d = a.aoData[b[e].row]),
                ((!0 === c && d._selected_cells && !0 === d._selected_cells[b[e].column]) ||
                    (!1 === c && (!d._selected_cells || !d._selected_cells[b[e].column]))) &&
                    f.push(b[e]);
        return f;
    });
                      ...
                      c.aoRowCreatedCallback.push({
                          fn: function(b, a, d) {
                              ...
                              for (d = c.aoColumns.length; b < d; b++)
                                  (c.aoColumns[b]._select_selected || (a._selected_cells && a._selected_cells[b])) &&
    ...
    e.extend(g.ext.buttons, {
        selected: {
            ...
            init: function(a, c, b) {
                ...
                a.on(s(b), function() {
                    d.enable(
                        (-1 !== e.inArray('rows', b.limitTo) && a.rows({ selected: !0 }).any()) ||
                            (-1 !== e.inArray('columns', b.limitTo) && a.columns({ selected: !0 }).any()) ||
                            (-1 !== e.inArray('cells', b.limitTo) && a.cells({ selected: !0 }).any())
                            ? !0
                            : !1
                    );
                });
