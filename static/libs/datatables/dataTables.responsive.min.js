...
(function(d) {
    ...
    function r(a, b, d) {
        ...
        if (n[e]) {
            for (
                var a = a.cell(b, d).node(), d = n[e][0].parentNode.childNodes, b = [], f = 0, g = d.length;
                f < g;
                f++
            )
                b.push(d[f]);
        ...
        _columnsVisiblity: function(a) {
            ...
            for (f = g.length; e < f; e++) {
                ...
                '-' === h[k] &&
                    ...
                    (s || 0 > m - c[k].minWidth ? ((s = !0), (h[k] = !1)) : (h[k] = !0), (m -= c[k].minWidth));
            }
            g = !1;
            e = 0;
                        ...
                        g = d('<div class="dtr-modal"/>')
                            .append(
                                d('<div class="dtr-modal-display"/>')
                                    ...
                                    .append(
                                        d('<div class="dtr-modal-close">&times;</div>').click(function() {
                                            f();
                                        })
                                    )
                            )
                ...
                d.each(c, function(b, c) {
                    c.hidden &&
                        (d(
                            ...
                            .append(d('<span class="dtr-data"/>').append(t(a, c.rowIndex, c.columnIndex)))
                            .appendTo(e),
                        (f = !0));
                });
                return f ? e : !1;
