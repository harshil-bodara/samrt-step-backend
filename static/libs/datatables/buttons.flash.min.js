            ...
            if (g.isPlainObject(d)) x(d);
                ...
                if (r) {
                    ...
                    for (f = h.length; e < f; e++)
                        (i = d.createAttribute(h[e].name.replace(':', '_dt_b_namespace_token_'))),
                            (i.value = h[e].value),
    ...
    j.ext.buttons.excelFlash = g.extend({}, u, {
        ...
        action: function(a, b, d, c) {
                            ...
                            (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                                ...
                                : ((n = !a[b].replace
                                  ...
                                  (i = o(f, 'c', {
                                      ...
                                      children: { row: o(f, 'is', { children: { row: o(f, 't', { text: n }) } }) },
                                  }))));
                        l.appendChild(i);
                    }
                    h.appendChild(l);
            ...
            for (s = i.header.length; m < s; m++)
                j.appendChild(o(f, 'col', { attr: { min: m + 1, max: m + 1, width: C(i, m), customWidth: 1 } }));
