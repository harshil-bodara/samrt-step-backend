        ...
        _constructor: function() {
            ...
            if (this.c.blurable)
                f(h).on('mousedown.keyTable', function(c) {
                    ...
                    f(c.target)
                        .parents()
                        .filter(b.table().container()).length ||
            ...
            if (this.c.editor) {
                ...
                if (this.c.editOnFocus)
                    b.on('key-focus.keyTable key-refocus.keyTable', function(b, c, d, e) {
                        a._editor(null, e, !0);
                    });
                ...
                if (!a.s.focusDraw) {
                    ...
                    if (d && d.node && f(d.node).closest('body') === h.body) {
                        var d = a.s.lastFocus.relative,
                            ...
                            m = d.row + e.start;
                        0 !== e.recordsDisplay &&
                            (m >= e.recordsDisplay && (m = e.recordsDisplay - 1), a._focus(m, d.column, !0, c));
                    }
                }
            });
        ...
        _clipboard: function() {
            ...
            k.getSelection &&
                (f(h).on('copy.keyTable', function(a) {
                    ...
                    !d &&
                        e &&
                        (a.clipboardData.setData('text/plain', e.cell.render(b.c.clipboardOrthogonal)),
                        a.preventDefault());
                }),
        ...
        _tabInput: function() {
            ...
            if (-1 != c)
                f('<div><input type="text" tabindex="' + c + '"/></div>')
                    .css({ position: 'absolute', height: 1, width: 0, overflow: 'hidden' })
                    .insertBefore(b.table().node())
                    .children()
                    .on('focus', function(c) {
                        b.cell(':eq(0)', { page: 'current' }).any() &&
                            a._focus(b.cell(':eq(0)', '0:visible', { page: 'current' }), null, !0, c);
                    });
        },
