    ...
    !(function(G) {
                    ...
                    if (s.defineProperty) {
                        ...
                        try {
                            ...
                            (void 0 !== e.number && -2146823252 !== e.number) ||
                                ((l.enumerable = !1), s.defineProperty(n, t, l));
                        }
        ...
        (i = null),
            String.prototype.startsWith ||
                ...
                e
                    ? e(String.prototype, 'startsWith', { value: t, configurable: !0, writable: !0 })
        ...
        G.fn.triggerNative = function(e) {
            var t,
                i = this[0];
            i.dispatchEvent
                ? (o ? (t = new Event(e, { bubbles: !0 })) : (t = document.createEvent('Event')).initEvent(e, !0, !1),
                  i.dispatchEvent(t))
                : i.fireEvent
                ...
                if (e.is('select')) {
                    ...
                    if (t) {
                        ...
                        (s.template = G.extend(
                            {},
                            u.DEFAULTS.template,
                            G.fn.selectpicker.defaults ? G.fn.selectpicker.defaults.template : {},
                            e.data().template,
                            i.template
                        )),
        ...
        (u.VERSION = '1.13.5'),
            ...
            '4' === K.major &&
                ((u.DEFAULTS.style = 'btn-light'), (u.DEFAULTS.iconBase = ''), (u.DEFAULTS.tickIcon = 'bs-ok-default')),
            (u.prototype = {
                constructor: u,
                init: function() {
                    var i = this,
                ...
                createView: function(C, e) {
                    ...
                    function i(e, t) {
                        var i,
                            ...
                            d,
                            h,
                            p = O.selectpicker.current.elements.length,
                            u = [],
                            f = !0,
                            m = O.isVirtual();
                        ...
                        for (var v = 0; v < n; v++) {
                            ...
                            void 0 === l &&
                                e <= O.selectpicker.current.data[g - 1].position - O.sizeInfo.menuInnerHeight &&
                                (l = v);
                        }
                        if (
                            (void 0 === l && (l = 0),
                            ...
                            !0 === m &&
                                ((b =
                                    0 === O.selectpicker.view.position0
                                        ? 0
                                        : O.selectpicker.current.data[O.selectpicker.view.position0 - 1].position),
                                (w =
                                    O.selectpicker.view.position1 > p - 1
                                        ? 0
                                        : O.selectpicker.current.data[p - 1].position -
                        ...
                        if (((O.prevActiveIndex = O.activeIndex), O.options.liveSearch)) {
                            if (C && t) {
                                ...
                                O.selectpicker.view.canHighlight[y] ||
                                    (y = 1 + O.selectpicker.view.canHighlight.slice(1).indexOf(!0)),
                                    (S = O.selectpicker.view.visibleElements[y]),
                                    O.selectpicker.view.currentActive &&
                                        (O.selectpicker.view.currentActive.classList.remove('active'),
                                        O.selectpicker.view.currentActive.firstChild &&
                                            O.selectpicker.view.currentActive.firstChild.classList.remove('active')),
                                    S &&
                ...
                createLi: function() {
                    ...
                    (H.options.showTick || H.multiple) &&
                        (((e = M.span.cloneNode(!1)).className =
                            H.options.iconBase + ' ' + H.options.tickIcon + ' check-mark'),
                        M.a.appendChild(e)),
                    ...
                    var V = function(e, t, i) {
                            ...
                            return (
                                e && (1 === e.nodeType || 11 === e.nodeType ? n.appendChild(e) : (n.innerHTML = e)),
                        ...
                        _ = function(e) {
                            ...
                            if (e.optionContent) n.innerHTML = e.optionContent;
                                ...
                                e.optionSubtext &&
                                    (((t = M.subtext.cloneNode(!1)).innerHTML = e.optionSubtext), n.appendChild(t));
                            }
                    ...
                    if (this.options.title && !this.multiple) {
                        ...
                        if (n)
                            (this.selectpicker.view.titleOption.className = 'bs-title-option'),
                                ...
                                (i =
                                    void 0 === G(t.options[t.selectedIndex]).attr('selected') &&
                        ...
                        if ((B++, !t.hasClass('bs-title-option'))) {
                            ...
                            if (!0 === l.hidden || this.hidden || (H.options.hideDisabled && (b || g)))
                                return (
                                    ...
                                    B--,
                                    (L[e] = { type: 'hidden', data: l }),
                                    w ||
                                        (void 0 !== i &&
                                            (o = F[i].previousElementSibling) &&
                                            'OPTGROUP' === o.tagName &&
                                            !o.disabled &&
                                            (w = !0)),
                                    void (
                                        w &&
                                        'divider' !== P[P.length - 1].type &&
                                        (B++,
                                        D.push(V(!1, Y.DIVIDER, R + 'div')),
                                        P.push({ type: 'divider', optID: R }))
                                    )
                                );
                            if (v && !0 !== l.divider) {
                                    ...
                                    0 !== e &&
                                        ...
                                        (s = (function(e) {
                                            ...
                                            if (((n.innerHTML = e.labelEscaped), e.labelIcon)) {
                                                var s = M.whitespace.cloneNode(!1);
                                                ((i = M.span.cloneNode(!1)).className =
                                                    H.options.iconBase + ' ' + e.labelIcon),
                                                    U.appendChild(i),
                                                    U.appendChild(s);
                                            }
                                            return (
                                                e.labelSubtext &&
                                                    (((t = M.subtext.cloneNode(!1)).textContent = e.labelSubtext),
                                                    n.appendChild(t)),
                                                U.appendChild(n),
                                                U
                                            );
                                        })({ labelEscaped: S, labelSubtext: y, labelIcon: C })),
                                        D.push(V(s, 'dropdown-header' + k, R)),
                                        P.push({ content: S, subtext: y, type: 'optgroup-label', optID: R }),
                                        (W = B - 1);
                                }
                                (n = _({ text: d, optionContent: c, optionSubtext: p, optionIcon: u })),
                                ...
                                !0 === l.divider
                                    ? (D.push(V(!1, Y.DIVIDER)), P.push({ type: 'divider', originalIndex: e, data: l }))
                                    : (!w &&
                                          H.options.hideDisabled &&
                                          void 0 !== (i = l.prevHiddenIndex) &&
                                          (o = F[i].previousElementSibling) &&
                                          'OPTGROUP' === o.tagName &&
                                          !o.disabled &&
                                          (w = !0),
                ...
                render: function() {
                    ...
                    for (var s = 0, o = t.length; s < o; s++) {
                        ...
                        if (
                            ...
                            r.selected &&
                            a &&
                            (i.push(r), (n.length < 100 && 'count' !== e.options.selectedTextFormat) || 1 === i.length)
                        ) {
                            var c,
                                d,
                                h = a.data,
                                p =
                                    h.icon && e.options.showIcon
                                        ? '<i class="' + e.options.iconBase + ' ' + h.icon + '"></i> '
                                        : '';
                            (c =
                                e.options.showSubtext && h.subtext && !e.multiple
                                    ? ' <small class="text-muted">' + h.subtext + '</small>'
                                    : ''),
                                (d = r.title
                                    ? r.title
                                    : h.content && e.options.showContent
                                    ? h.content.toString()
                                    : p + r.innerHTML.trim() + c),
                                n.push(d);
                        }
                    }
                    ...
                    if (
                        ...
                        if ((1 < f.length && i.length > f[1]) || (1 === f.length && 2 <= i.length)) {
                            ...
                            u = ('function' == typeof this.options.countSelectedText
                                ? this.options.countSelectedText(i.length, m)
                ...
                setStyle: function(e, t) {
                    ...
                    'add' == t
                        ...
                        : (this.$button.removeClass(this.options.style), this.$button.addClass(i));
                },
                liHeight: function(e) {
                    if (e || (!1 !== this.options.size && !this.sizeInfo)) {
                        ...
                        var t = document.createElement('div'),
                            ...
                            d =
                                this.options.header && 0 < this.$menu.find('.' + Y.POPOVERHEADER).length
                        ...
                        if (
                            ...
                            this.selectpicker.view.widestOption &&
                                s.appendChild(this.selectpicker.view.widestOption.cloneNode(!0)),
                            s.appendChild(r),
                            s.appendChild(o),
                            s.appendChild(l),
                            d && i.appendChild(d),
                        ...
                        var v,
                            ...
                            C = {
                                vert:
                                    z(E ? E.paddingTop : y.css('paddingTop')) +
                                    z(E ? E.paddingBottom : y.css('paddingBottom')) +
                                    z(E ? E.borderTopWidth : y.css('borderTopWidth')) +
                                    z(E ? E.borderBottomWidth : y.css('borderBottomWidth')),
                                horiz:
                                    z(E ? E.paddingLeft : y.css('paddingLeft')) +
                                    z(E ? E.paddingRight : y.css('paddingRight')) +
                                    z(E ? E.borderLeftWidth : y.css('borderLeftWidth')) +
                                    z(E ? E.borderRightWidth : y.css('borderRightWidth')),
                            },
                            O = {
                                vert:
                                    C.vert +
                                    z(E ? E.marginTop : y.css('marginTop')) +
                                    z(E ? E.marginBottom : y.css('marginBottom')) +
                                    2,
                                horiz:
                                    C.horiz +
                                    z(E ? E.marginLeft : y.css('marginLeft')) +
                                    z(E ? E.marginRight : y.css('marginRight')) +
                                    2,
                            };
                ...
                getSelectPosition: function() {
                    ...
                    (this.sizeInfo.selectOffsetTop = i.top - e.top - t.scrollTop()),
                        (this.sizeInfo.selectOffsetBot =
                            t.height() - this.sizeInfo.selectOffsetTop - this.sizeInfo.selectHeight - e.top - s[2]),
                        (this.sizeInfo.selectOffsetLeft = i.left - e.left - t.scrollLeft()),
                        (this.sizeInfo.selectOffsetRight =
                            t.width() - this.sizeInfo.selectOffsetLeft - this.sizeInfo.selectWidth - e.left - s[1]),
                    ...
                    if (
                        ...
                        this.setMenuSize(),
                            ...
                            e
                                ...
                                : i.multiple ||
                                  ('number' ==
                                      typeof (t = i.selectpicker.main.map.newIndex[i.$element[0].selectedIndex]) &&
                                      !1 !== i.options.size &&
                                      (s =
                    ...
                    var n,
                        ...
                        e = function(e) {
                            var t = {},
                                i =
                                    l.options.display ||
                                    (!!G.fn.dropdown.Constructor.Default && G.fn.dropdown.Constructor.Default.display);
                            l.$bsContainer
                                .addClass(e.attr('class').replace(/form-control|fit-width/gi, ''))
                                .toggleClass(Y.DROPUP, e.hasClass(Y.DROPUP)),
                                (n = e.offset()),
                                r.is('body')
                                    ? (s = { top: 0, left: 0 })
                                ...
                                (K.major < 4 || 'static' === i) &&
                                    ((t.top = n.top - s.top + o), (t.left = n.left - s.left)),
                    ...
                    this.$button.on('click.bs.dropdown.data-api', function() {
                        l.isDisabled() ||
                            ...
                            l.$bsContainer
                                ...
                                .toggleClass(Y.SHOW, !l.$button.hasClass(Y.SHOW))
                                .append(l.$menu));
                    }),
                        G(window)
                    ...
                    if (
                        ...
                        for (var i = 0; i < e.selectpicker.view.visibleElements.length; i++) {
                            ...
                            if (s) {
                                ...
                                e.setDisabled(
                                    n,
                                    s.disabled || ('OPTGROUP' === s.parentNode.tagName && s.parentNode.disabled),
                                    o,
                                    l
                                ),
                ...
                setDisabled: function(e, t, i, n) {
                    ...
                    i || (i = this.selectpicker.main.map.newIndex[e]),
                        ...
                        s &&
                            ('4' === K.major && s.classList.toggle(Y.DISABLED, t),
                ...
                clickListener: function() {
                    ...
                    function i() {
                        E.dropdown && E.dropdown._popper && E.dropdown._popper.state.isCreated
                            ? e()
                    ...
                    t.data('spaceSelect', !1),
                        ...
                        this.$newElement.on('show.bs.dropdown', function() {
                            3 < K.major &&
                                !E.dropdown &&
                                ((E.dropdown = E.$button.data('bs.dropdown')), (E.dropdown._menu = E.$menu[0]));
                        }),
                        this.$button.on('click.bs.dropdown.data-api', function() {
                        ...
                        this.$menuInner.on('click', 'li a', function(e, t) {
                            var i = G(this),
                                ...
                                r = !0;
                            if (
                                (E.multiple && 1 !== E.options.maxOptions && e.stopPropagation(),
                                e.preventDefault(),
                                ...
                                if (
                                    (s === E.activeIndex && (t = !0),
                                    t || ((E.prevActiveIndex = E.activeIndex), (E.activeIndex = void 0)),
                                    E.multiple)
                                ) {
                                    if (
                                        (c.prop('selected', !d), E.setSelected(s, !d), i.blur(), !1 !== u || !1 !== f)
                                    ) {
                                            ...
                                            if (u && 1 == u) {
                                                ...
                                                var w =
                                                        'string' == typeof E.options.maxOptionsText
                                                            ? [E.options.maxOptionsText, E.options.maxOptionsText]
                                ...
                                !E.multiple || (E.multiple && 1 === E.options.maxOptions)
                                    ...
                                    r &&
                                        ...
                                        ((y = [s, c.prop('selected'), o]), E.$element.triggerNative('change'));
                            }
                        }),
                        this.$menu.on(
                            'click',
                            'li.' + Y.DISABLED + ' a, .' + Y.POPOVERHEADER + ', .' + Y.POPOVERHEADER + ' :not(.close)',
                            function(e) {
                                e.currentTarget == this &&
                                    (e.preventDefault(),
                                    e.stopPropagation(),
                                    E.options.liveSearch && !G(e.target).hasClass('close')
                                        ? E.$searchbox.focus()
                                        : E.$button.focus());
                            }
                        ),
                                ...
                                for (var r = 0; r < u.selectpicker.main.data.length; r++) {
                                    ...
                                    n[r] || (n[r] = $(a, i, o, l)),
                                        n[r] &&
                                            ...
                                            (0 < a.headerIndex &&
                                                ((n[a.headerIndex - 1] = !0), s.push(a.headerIndex - 1)),
                                            (n[a.headerIndex] = !0),
                    ...
                    if (this.multiple) {
                        ...
                        for (var o = 0; o < this.selectpicker.current.elements.length; o++) {
                            ...
                            r &&
                                !r.disabled &&
                                'divider' !== l.type &&
                                (r.selected && i++, (r.selected = e), r.selected && n++);
                        }
                        this.$element.removeClass('bs-select-hidden'),
                            i !== n &&
                ...
                keydown: function(e) {
                    ...
                    if (
                        (!(i = a.$newElement.hasClass(Y.SHOW)) &&
                            (p ||
                        ...
                        e.which === C &&
                            i &&
                            (e.preventDefault(), a.$button.trigger('click.bs.dropdown.data-api').focus()),
                        p)
                    ) {
                        if (!c.length) return;
                        void 0 ===
                            (t =
                                !0 === f
                                    ...
                                    : a.selectpicker.current.map.newIndex[a.activeIndex]) && (t = -1),
                            -1 !== t &&
                                ((n = a.selectpicker.current.elements[t + m]).classList.remove('active'),
                            ...
                            e.which === D
                                ? (-1 !== t && t--,
                                  ...
                                  a.selectpicker.view.canHighlight[t + m] ||
                                      (-1 ===
                                          (t = a.selectpicker.view.canHighlight.slice(0, t + m).lastIndexOf(!0) - m) &&
                                          (t = c.length - 1)))
                                : (e.which === L || h) &&
                            ...
                            : (e.which === L || h) &&
                              (0 === t
                                  ...
                                  : (d =
                                        u <
                                        (o =
                                            (s = a.selectpicker.current.data[v]).position -
                                            a.sizeInfo.menuInnerHeight))),
                            (n = a.selectpicker.current.elements[v]) &&
                                (n.classList.add('active'), n.firstChild && n.firstChild.classList.add('active')),
                        ...
                        if (w.length) {
                            ...
                            c
                                ...
                                .removeClass('active'),
                                1 === b.length &&
                                    (-1 === (k = w.indexOf(a.activeIndex)) || k === w.length - 1 ? (k = 0) : k++),
                                (g = a.selectpicker.current.map.newIndex[w[k]]),
                                0 < u - (s = a.selectpicker.current.data[g]).position
                                    ? ((o = s.position - s.height), (d = !0))
                    ...
                    i &&
                        ...
                        (a.options.liveSearch && e.which === T) ||
                            ...
                            l.focus(),
                            a.options.liveSearch || (e.preventDefault(), G(document).data('spaceSelect', !0))));
                },
                mobile: function() {
