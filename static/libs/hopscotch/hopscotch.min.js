                ...
                (g = 'center' !== a.arrowOffset ? h.getPixelValue(a.arrowOffset) : a.arrowOffset),
                    g
                        ? 'top' === a.placement || 'bottom' === a.placement
                            ? ((l.style.top = ''),
                              'center' === g
                                  ? (l.style[m] = Math.floor(c / 2 - l.offsetWidth / 2) + 'px')
                                  : (l.style[m] = g + 'px'))
                            : ('left' === a.placement || 'right' === a.placement) &&
                              ((l.style[m] = ''),
                              'center' === g
                                  ? (l.style.top = Math.floor(b / 2 - l.offsetHeight / 2) + 'px')
                                  : (l.style.top = g + 'px'))
                        : ((l.style.top = ''), (l.style[m] = '')),
                    'center' === a.xOffset
                        ? (f = d.left + j.offsetWidth / 2 - c / 2)
                        : (f += h.getPixelValue(a.xOffset)),
                    'center' === a.yOffset
                        ? (e = d.top + j.offsetHeight / 2 - b / 2)
            ...
            (this.getCalloutManager = function() {
                ...
                (this.removeCallbacks = function(a, b) {
                    ...
                    for (f in i)
                        if (!a || a === f)
                            if (b)
                                for (c = i[f], d = 0, e = c.length; e > d; ++d)
                                    c[d].fromTour && (c.splice(d--, 1), --e);
                            else i[f] = [];
                    return this;
                }),
