        ...
        (b.prototype = {
            initialize: function() {
                ...
                d.element.setAttribute('autocomplete', 'off'),
                    (d.noSuggestionsContainer = a('<div class="autocomplete-no-suggestion"></div>')
            ...
            onValueChange: function() {
                ...
                return (
                    b.selection &&
                        b.currentValue !== e &&
                        ((b.selection = null), (c.onInvalidateSelection || a.noop).call(b.element)),
                    clearTimeout(b.onChangeTimeout),
                    (b.currentValue = d),
                    (b.selectedIndex = -1),
            ...
            validateOrientation: function(b, c) {
                return (
                    (b = a.trim(b || '').toLowerCase()), a.inArray(b, ['auto', 'bottom', 'top']) === -1 && (b = c), b
                );
            },
                ...
                if (d) {
                    ...
                    (e = d.offsetTop),
                        ...
                        e < f
                            ...
                            : e > g && a(c.suggestionsContainer).scrollTop(e - c.options.maxHeight + h),
                        c.options.preserveInput ||
                            ((c.ignoreValueChange = !0), c.el.val(c.getValue(c.suggestions[b].value))),
                        c.signalHint(null);
                }
            },
            onSelect: function(b) {
            ...
            getValue: function(a) {
                ...
                return e
                    ? ((b = d.currentValue),
                      (c = b.split(e)),
                      1 === c.length ? a : b.substr(0, b.length - c[c.length - 1].length) + a)
                    : a;
            },
            dispose: function() {
                var b = this;
            ...
            return arguments.length
                ? this.each(function() {
                      ...
                      'string' == typeof c
                          ...
                          : (g && g.dispose && g.dispose(), (g = new b(this, c)), f.data(e, g));
                  })
                : this.first().data(e);
        }),
