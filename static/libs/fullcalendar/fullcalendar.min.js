                    ...
                    return (
                        (t.invertRanges = function(e, n) {
                            ...
                            for (e.sort(r), i = 0; i < e.length; i++)
                                (o = e[i]), o.startMs > a && s.push(new t(a, o.startMs)), o.endMs > a && (a = o.endMs);
                        ...
                        (t.prototype.containsDate = function(t) {
                            var e = t.valueOf();
                            return (
                                (null == this.startMs || e >= this.startMs) && (null == this.endMs || e < this.endMs)
                            );
                        }),
                ...
                l = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.parseEventDef = function(t) {
                            ...
                            return (
                                e && (t = e(t, this.calendar)), n && (t = n(t, this.calendar)), a.default.parse(t, this)
                            );
                        }),
        ...
        function(t, e, n) {
            ...
            (e.default = h),
                ...
                (d.stripZone = function() {
                    ...
                    return (
                        this._ambigZone ||
                            ((t = this._ambigTime), this.utc(!0), (this._ambigTime = t || !1), (this._ambigZone = !0)),
                        this
                    );
                }),
                (d.hasZone = function() {
                ...
                (d.local = function(t) {
                    return (
                        c.local.call(this, this._ambigZone || t), (this._ambigTime = !1), (this._ambigZone = !1), this
                    );
                }),
                (d.utc = function(t) {
                ...
                i = (function() {
                    ...
                    return (
                        ...
                        (t.prototype.getCustomButtonIconClass = function(t) {
                            var e;
                            return this.iconOverrideCustomButtonOption && (e = t[this.iconOverrideCustomButtonOption])
                        ...
                        (e.prototype.stopNowIndicator = function() {
                            this.isNowIndicatorRendered &&
                                ...
                                this.nowIndicatorIntervalID &&
                                    (clearInterval(this.nowIndicatorIntervalID), (this.nowIndicatorIntervalID = null)),
                                this.unrenderNowIndicator(),
                    ...
                    return (
                        ...
                        (t.prototype.rangeUpdated = function() {
                            ...
                            (this.eventTimeFormat =
                                this.opt('eventTimeFormat') || this.opt('timeFormat') || this.computeEventTimeFormat()),
                            ...
                            return s || this.cellWeekNumbersVisible
                                ? ((e = this.getDayClasses(t)),
                                  ...
                                  this.cellWeekNumbersVisible &&
                                      (n = 'ISO' === t._locale._fullCalendar_weekCalc ? 1 : t._locale.firstDayOfWeek()),
                                  (i +=
                                      '<td class="' +
                                      e.join(' ') +
                                      '"' +
                        ...
                        return (
                            ...
                            r.opt('weekNumbers') &&
                                (r.opt('weekNumbersWithinDays')
                                    ? ((r.dayGrid.cellWeekNumbersVisible = !0), (r.dayGrid.colWeekNumbersVisible = !1))
                    ...
                    return (
                        ...
                        (e.prototype.updateSize = function(e, n, r) {
                            ...
                            if (!this.dayGrid.rowEls)
                                return void (n || ((i = this.computeScrollerHeight(e)), this.scroller.setHeight(i)));
                ...
                p = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.eventFootprintToSegs = function(t) {
                            ...
                            for (e = this.componentFootprintToSegs(t.componentFootprint), n = 0; n < e.length; n++)
                                (r = e[n]), i.isStart || (r.isStart = !1), i.isEnd || (r.isEnd = !1), (r.footprint = t);
                            return e;
                        }),
                        (e.prototype.componentFootprintToSegs = function(t) {
                            return [];
                    ...
                    return (
                        ...
                        (t.prototype.updateToolbarButtons = function(t) {
                            ...
                            this.toolbarsManager.proxyCall(
                                r.isValid && !t.currentUnzonedRange.containsDate(e) ? 'enableButton' : 'disableButton',
                                'today'
                            ),
                    ...
                    return (
                        ...
                        (e.prototype.renderContentSkeleton = function() {
                            ...
                            (e = this.contentSkeletonEl = i(
                                '<div class="fc-content-skeleton"><table><tr>' + n + '</tr></table></div>'
                            )),
                        ...
                        (t.prototype.render = function() {
                            ...
                            t
                                ? (e
                                      ? e.empty()
                                      : (e = this.el = r(
                                            "<div class='fc-toolbar " + this.toolbarOptions.extraClasses + "'/>"
                                        )),
                                  e
