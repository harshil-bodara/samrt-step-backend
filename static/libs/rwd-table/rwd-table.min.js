    ...
    (a.DEFAULTS = {
        ...
        (a.prototype.createButtonToolbar = function() {
            ...
            (this.$btnToolbar = d('[data-responsive-table-toolbar="' + this.id + '"]').addClass('btn-toolbar')),
                ...
                this.options.addFocusBtn &&
                    ...
                    (this.$focusBtn = d(
                        '<button type="button" class="btn btn-default">' + this.options.i18n.focus + '</button>'
                    )),
                ...
                this.options.addDisplayAllBtn &&
                    ((this.$displayAllBtn = d(
                        '<button type="button" class="btn btn-default">' + this.options.i18n.displayAll + '</button>'
                    )),
        ...
        (a.prototype.buildHeaderCellIndices = function() {
            ...
            if (
                (this.$thead
                    ...
                    .find('th')
                    .each(function(t) {
                        for (var i = d(this), e = i.prop('colSpan'), o = i.prop('rowSpan'), a = 0; a < e; a++)
                            (s.headerColIndices[l + t + a] = t), 0 <= l + t + a && (n[l + t + a - r] = r);
                        1 < o && r++, (l += e - 1);
                    }),
        ...
        (a.prototype.updateSpanningCells = function() {
            this.$table.find('.spn-cell').each(function() {
                for (var t = d(this), i = t.attr('data-columns').split(' '), e = i.length, o = 0, a = 0; a < e; a++)
    ...
    (d.fn.responsiveTable = function(o) {
        ...
        d(document).ready(function() {
            d('html')
                .removeClass('no-js')
                .addClass('js'),
                void 0 !== window.matchMedia || void 0 !== window.msMatchMedia || void 0 !== window.styleMedia
                    ? d('html').addClass('mq')
