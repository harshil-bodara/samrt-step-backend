...
JustGage = function(config) {
    ...
    if (obj.config.pointer) {
        ...
        obj.needle = obj.canvas.path().attr({
            stroke:
                obj.config.pointerOptions.stroke !== null && obj.config.pointerOptions.stroke !== undefined
                    ? obj.config.pointerOptions.stroke
                    : 'none',
            'stroke-width':
                obj.config.pointerOptions.stroke_width !== null && obj.config.pointerOptions.stroke_width !== undefined
            ...
            'stroke-linecap':
                ...
                obj.config.pointerOptions.stroke_linecap !== undefined
                    ...
                    : 'square',
            fill:
                obj.config.pointerOptions.color !== null && obj.config.pointerOptions.color !== undefined
    ...
    if (obj.config.counter === true) {
        ...
        eve.on('raphael.anim.frame.' + obj.level.id, function() {
            ...
            if (obj.config.textRenderer) {
                ...
                obj.txtValue.attr(
                    'text',
                    humanFriendlyNumber(Math.floor(currentValue), obj.config.humanFriendlyDecimal) + obj.config.symbol
                );
            } else if (obj.config.formatNumber) {
