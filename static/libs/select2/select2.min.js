/*! Select2 4.0.6-rc.1 | https://github.com/select2/select2/blob/master/LICENSE.md */ !(function(a) {
    'function' == typeof define && define.amd
        ...
        ? (module.exports = function(b, c) {
              return (
                  void 0 === c && (c = 'undefined' != typeof window ? require('jquery') : require('jquery')(b)), a(c), c
              );
          })
        : a(jQuery);
})(function(a) {
                            ...
                            (p = function(a, b) {
                                ...
                                (n = function(a, c, d, f) {
                                    ...
                                    if (((f = f || a), (t = l(f)), 'undefined' === x || 'function' === x)) {
                                        for (
                                            c = !c.length && d.length ? ['require', 'exports', 'module'] : c, o = 0;
                                            o < c.length;
                                            o += 1
                                        )
                                ...
                                this.$results.on('scroll', function() {
                                    ...
                                    if (!e.loading && b) {
                                        e.$results.offset().top + e.$results.outerHeight(!1) + 50 >=
                                            e.$loadingMore.offset().top + e.$loadingMore.outerHeight(!1) &&
                                            e.loadMore();
                                    }
                                });
                        }),
