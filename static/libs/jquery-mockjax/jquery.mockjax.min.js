!(function(a, b) {
    ...
    function d(b, c) {
        ...
        return (
            a.each(b, function(e) {
                ...
                'object' == typeof c[e] && null !== c[e]
                    ? (f && a.isArray(c[e]) && (f = a.isArray(b[e]) && c[e].length === b[e].length),
                      (f = f && d(b[e], c[e])))
                    : (f = b[e] && a.isFunction(b[e].test) ? f && b[e].test(c[e]) : f && b[e] === c[e]);
            }),
            f
        );
    }
    function e(a) {
        ...
        for (b = 0, c = g.length; b < c; ++b) {
            ...
            f[d[0]]
                ? (f[d[0]].splice || ((e = f[d[0]]), (f[d[0]] = []), f[d[0]].push(e)), f[d[0]].push(d[1]))
                : (f[d[0]] = d[1]);
        }
    ...
    function g(b, c) {
        ...
        if (a.isFunction(b.url.test)) {
            ...
            if (
                (e !== c.url && -1 === g) ||
                !new RegExp(e.replace(/[-[\]{}()+?.,\\^$|#\s]/g, '\\$&').replace(/\*/g, '.+')).test(c.url)
            )
                return null;
        }
        if (b.requestHeaders) {
    ...
    function j(b, d, e) {
            ...
            return function() {
                return function() {
                    ...
                    var g = function() {
                        ...
                        if (
                            ('json' === d.dataType && 'object' == typeof b.responseText
                                ...
                                ? 'string' == typeof b.responseXML
                                    ? ((this.responseXML = c(b.responseXML)), (this.responseText = b.responseXML))
                        ...
                        'string' == typeof b.statusText && (this.statusText = b.statusText),
                            (e = this.onload || this.onreadystatechange),
                            a.isFunction(e)
                                ? (b.isTimeout && (this.status = -1), e.call(this, b.isTimeout ? 'timeout' : void 0))
                                : b.isTimeout && (this.status = -1);
                    };
                    if (a.isFunction(b.response)) {
                        if (2 === b.response.length)
                            return void b.response(e, function() {
                                g.call(f);
                            });
                        b.response(e);
                    }
        ...
        b.proxy
            ? (C.info(b, ['Retrieving proxy file: ' + b.proxy, b]),
              v({
                  global: !1,
                  url: b.proxy,
                  type: b.proxyType,
                  ...
                  complete: function(a) {
                      (b.responseXML = b.responseText = a.responseText),
                          f(b, 'status') && (b.status = a.status),
                          f(b, 'statusText') && (b.statusText = a.statusText),
                          !1 === d.async ? g() : (this.responseTimer = setTimeout(g, i(b.responseTime)));
                  },
              }))
            : !1 === d.async
            ? g()
            : (this.responseTimer = setTimeout(g, i(b.responseTime)));
    }
    function k(b, c, d, e) {
        return (
            C.debug(b, ['Creating new mock XHR object', b, c, d, e]),
            (b = a.extend(!0, {}, a.mockjaxSettings, b)),
            void 0 === b.headers && (b.headers = {}),
            void 0 === c.headers && (c.headers = {}),
    ...
    function m(a) {
        'GET' === a.type.toUpperCase()
            ? z.test(a.url) || (a.url += (/\?/.test(a.url) ? '&' : '?') + (a.jsonp || 'callback') + '=?')
            : (a.data && z.test(a.data)) || (a.data = (a.data ? a.data + '&' : '') + (a.jsonp || 'callback') + '=?');
    }
    function n(b, c, d) {
        ...
        if (c.response && a.isFunction(c.response)) c.response(d);
            ...
            if (c.proxy)
                return (
                    C.info(c, ['Performing JSONP proxy request: ' + c.proxy, c]),
                    v({
                        global: !1,
                        url: c.proxy,
                        type: c.proxyType,
    ...
    function p(a, c, d) {
        ...
        a.data && (a.data = (a.data + '').replace(z, '=' + f + '$1')),
            (a.url = a.url.replace(z, '=' + f + '$1')),
            (b[f] =
                b[f] ||
                function() {
    ...
    function q(b, c, d) {
        b.success && b.success.call(c, d.responseText || '', 'success', {}),
            b.global && (b.context ? a(b.context) : a.event).trigger('ajaxSuccess', [{}, b]);
    }
    function r(b, c) {
        b.complete && b.complete.call(c, { statusText: 'success', status: 200 }, 'success'),
            b.global && (b.context ? a(b.context) : a.event).trigger('ajaxComplete', [{}, b]),
            b.global && !--a.active && a.event.trigger('ajaxStop');
    }
    function s(b, c) {
        var d, e, f, h;
        C.debug(null, ['Ajax call intercepted', b, c]),
            'object' == typeof b ? ((c = b), (b = void 0)) : ((c = c || {}), (c.url = b || c.url)),
            (e = a.ajaxSetup({}, c)),
        ...
        for (var i = 0; i < w.length; i++) {
            ...
            if (m) {
                if ((f = g(m, e))) {
                    if (
                        (a.mockjaxSettings.retainAjaxCalls && x.push(e),
                        C.info(f, ['MOCK ' + e.type.toUpperCase() + ': ' + e.url, a.ajaxSetup({}, e)]),
                        (301 === f.status || 302 === f.status) &&
                            ('GET' === e.type.toUpperCase() || 'HEAD' === e.type.toUpperCase()) &&
                            f.headers.Location)
                    ) {
                    ...
                    return e.dataType && 'JSONP' === e.dataType.toUpperCase() && (d = l(e, f, c))
                        ? d
                        : ((c.crossDomain = !1),
                          (f.cache = e.cache),
                          (f.timeout = e.timeout),
                          ...
                          f.isTimeout &&
                              (f.responseTime > 1
                                  ? (c.timeout = f.responseTime - 1)
                                  : ((f.responseTime = 2), (c.timeout = 1))),
                          a.isFunction(f.onAfterSuccess) && (c.success = h('Success', f)),
                          a.isFunction(f.onAfterError) && (c.error = h('Error', f)),
                          a.isFunction(f.onAfterComplete) && (c.complete = h('Complete', f)),
                          t(f, c),
                          (function(b, c, e, f) {
                              d = v.call(
                                  a,
        ...
        if (
            (C.log(null, ['No mock matched to request', b, c]),
            a.mockjaxSettings.retainAjaxCalls && y.push(c),
            !0 === a.mockjaxSettings.throwUnmocked)
        )
    ...
    function u(a) {
        ...
        for (b = 0, c = w.length; b < c; b++)
            (d = w[b]), f(d.url) ? C.log(d, ['Clearing mock: ' + (d && d.url), d]) : e.push(d);
        return e;
    }
    var v = a.ajax,
        w = [],
    ...
    var C = {
            _log: function(b, c, d) {
                ...
                if (
                    (b && void 0 !== b.logging && (e = b.logging),
                    (d = 0 === d ? d : d || D.LOG),
                    (c = c.splice ? c : [c]),
                    !(!1 === e || e < d))
                )
                    return a.mockjaxSettings.log
                        ? a.mockjaxSettings.log(b, c[1] || c[0])
                        : a.mockjaxSettings.logger && a.mockjaxSettings.logger[a.mockjaxSettings.logLevelMethods[d]]
                        ? a.mockjaxSettings.logger[a.mockjaxSettings.logLevelMethods[d]].apply(
                              a.mockjaxSettings.logger,
                              c
                          )
                        : void 0;
            },
    ...
    return (
        ...
        (a.mockjax.clear = function(a) {
            'string' == typeof a || a instanceof RegExp
                ? (w = u(a))
                : a || 0 === a
                ? (C.log(w[a], ['Clearing mock: ' + (w[a] && w[a].url), w[a]]), (w[a] = null))
                : (C.log(null, 'Clearing all mocks'), (w = [])),
                (x = []),
                (y = []);
        }),
