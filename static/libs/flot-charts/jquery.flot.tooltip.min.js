...
!(function(a) {
    ...
    (c.prototype.init = function(b) {
        ...
        function d(c, d, g) {
            f.clickmode
                ? (a(b.getPlaceholder()).bind('plothover', e), b.hideTooltip(), (f.clickmode = !1))
                : (e(c, d, g),
            ...
            if (e) b.showTooltip(e, f.tooltipOptions.snap ? e : d);
                ...
                a.each(b.getData(), function(a, c) {
                    ...
                    if (o < j.distance) {
                        ...
                        (j = { distance: o, item: r }),
                            f.tooltipOptions.snap && (k = { pageX: c.xaxis.p2c(q[0]), pageY: c.yaxis.p2c(q[1]) });
                    }
                }),
        ...
        if (((this.plotPlugins = []), g)) for (var h = 0; g > h; h++) this.plotPlugins.push(a.plot.plugins[h].name);
        b.hooks.bindEvents.push(function(b, g) {
            ...
            (b.setTooltipPosition = function(b) {
                ...
                b.x - a(window).scrollLeft() > a(window)[f.wfunc]() - d && ((b.x -= d), (b.x = Math.max(b.x, 0))),
        ...
        (c.prototype.stringFormat = function(a, b) {
            ...
            if (
                ...
                'undefined' != typeof b.series.percent
                    ? (f = b.series.percent)
                    : 'undefined' != typeof b.series.percents && (f = b.series.percents[b.dataIndex]),
                ...
                this.isTimeMode('xaxis', b) &&
                    ...
                    (a = a.replace(
                        m,
                        this.timestampToDate(c, this.tooltipOptions.xDateFormat, b.series.xaxis.options)
                    )),
                this.isTimeMode('yaxis', b) &&
                    this.isYDateFormat(b) &&
                    (a = a.replace(
                        n,
                        this.timestampToDate(d, this.tooltipOptions.yDateFormat, b.series.yaxis.options)
                    )),
            ...
            return (
                'undefined' != typeof b.series.xaxis.tickFormatter &&
                    (a = a.replace(o, b.series.xaxis.tickFormatter(c, b.series.xaxis).replace(/\$/g, '$$'))),
                'undefined' != typeof b.series.yaxis.tickFormatter &&
                    (a = a.replace(p, b.series.yaxis.tickFormatter(d, b.series.yaxis).replace(/\$/g, '$$'))),
                a
            );
        }),
