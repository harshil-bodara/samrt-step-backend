...
!(function(t, i, e, n) {
    ...
    (h.draw = function() {
        ...
        a.register('bar', { delimiter: ',', fill: ['#4D89F9'], height: 16, min: 0, padding: 0.1, width: 32 }, function(
            t
        ) {
            for (
                var i = this.values(),
                ...
                o ? (w < 0 ? (k = d(e.min(a, 0))) : ($ = d(e.max(r, 0)))) : (v = 1),
                    0 == (v = $ - k) && ((v = 1), a > 0 && o && k--),
                    h.append(
                        s('rect', { 'data-value': w, fill: c.call(this, w, g, i), x: m, y: k, width: y, height: v })
                    );
            }
        });
