    ...
    (o.prototype = {
        ...
        dragStop: function(t) {
            ...
            this.placeEl.replaceWith(i),
                this.hasNewRoot
                    ? (!0 === this.options.fixed ? this.restoreItemAtIndex(i, s) : this.el.trigger('lostItem'),
        ...
        dragMove: function(i) {
            ...
            this.scrollTimer && clearTimeout(this.scrollTimer),
                ...
                d.dirAx &&
                    ...
                    d.distX > 0 &&
                        ...
                        this.placeEl.parents(r.listNodeName).length + this.dragDepth <= r.maxDepth &&
                            (o.length
                                ? (o = a.children(r.listNodeName).last()).append(this.placeEl)
            ...
            if (!d.dirAx || m || f) {
                ...
                (n = this.placeEl.parent()),
                    f
                        ? ((o = t(s.createElement(r.listNodeName)).addClass(r.listClass)).append(this.placeEl),
