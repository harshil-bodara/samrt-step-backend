    ...
    var a = function(a, b) {
        ...
        b = function(a, b) {
            ...
            if (Array.prototype.map && a.map === Array.prototype.map)
                ...
                for (c = 0; f > c; c++)
                    (callback_params = d), callback_params.splice(0, 0, a[c]), e.push(b.apply(this, callback_params));
            return e;
        },
        c = function(a) {
            var b,
        ...
        f = function(a, b) {
            ...
            for (c = 0; c < a.length; c++)
                a[c] instanceof google.maps.LatLng ||
                    (a[c].length > 0 && 'object' == typeof a[c][0] ? (a[c] = f(a[c], b)) : (a[c] = d(a[c], b)));
            return a;
        },
        g = function(a, b) {
            var c,
    ...
    (j.prototype.createControl = function(a) {
        ...
        (j.prototype.createMarker = function(b) {
            ...
            if (((i.fences = e), b.infoWindow)) {
                ...
                for (
                    var j = ['closeclick', 'content_changed', 'domready', 'position_changed', 'zindex_changed'], k = 0;
                    k < j.length;
                    k++
                )
                    !(function(a, c) {
            ...
            (Array.prototype.indexOf = function(a) {
                ...
                if (
                    (arguments.length > 1 &&
                        ...
                        d != d
                            ? (d = 0)
                            : 0 != d && d != 1 / 0 && d != -(1 / 0) && (d = (d > 0 || -1) * Math.floor(Math.abs(d)))),
                    d >= c)
                )
                    return -1;
