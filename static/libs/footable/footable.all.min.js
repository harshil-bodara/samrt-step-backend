        ...
        return (
            ...
            (r.init = function() {
                ...
                for (var o in l.breakpoints)
                    r.breakpoints.push({ name: o, width: l.breakpoints[o] }), (r.breakpointNames += o + ' ');
            ...
            (r.addRowToggle = function() {
                if (l.addRowToggle) {
                    ...
                    a ||
                        t
                            .find('> tbody > tr:not(.' + d.detail + ',.' + d.disabled + ') > td:first-child')
                            .add('> tbody > tr:not(.' + d.detail + ',.' + d.disabled + ') > th:first-child')
                            .not('.' + d.detailCell)
                            .prepend(e(l.toggleHTMLElement).addClass(d.toggle));
                }
            }),
            ...
            (r.getColumnData = function(t) {
                ...
                for (var m in l.breakpoints)
                    (n.hide[m] = 'all' === a.data('hide') || e.inArray(m, i) >= 0), (h = h || n.hide[m]);
                n.hasBreakpoint = h;
                ...
                if (t.is(':visible')) {
                    ...
                    if (
                        ...
                        t
                            ...
                            d !== p && (t.trigger(u.redraw), r.raise(s.breakpoint, { breakpoint: d, info: a }));
                    }
            ...
            (r.redraw = function() {
                ...
                t
                    ...
                    t
                        .find('> thead > tr > th.footable-last-column, > tbody > tr > td.footable-last-column')
                        .removeClass('footable-last-column'),
                    t
                        .find('> thead > tr > th.footable-first-column, > tbody > tr > td.footable-first-column')
                    ...
                    i.find('> td:hidden').each(function() {
                        ...
                        return (
                            a.isEditable !== !1 &&
                                ...
                                (null == o && ((o = 'bind-' + e.now() + '-' + t), e(this).attr('data-bind-name', o)),
                                (s = e(this)
                                    .contents()
                                    .detach())),
                            s ||
        ...
        options: {
            ...
            createGroupedDetail: function(e) {
                for (var t = { _none: { name: null, data: [] } }, a = 0; e.length > a; a++) {
                    var i = e[a].group;
                    null !== i
                        ? (i in t || (t[i] = { name: e[a].groupName || e[a].group, data: [] }), t[i].data.push(e[a]))
        ...
        plugins: {
            _validate: function(a) {
                ...
                return 'string' != typeof i.name
                    ...
                    : e.isFunction(i.init)
                    ? (t.footable.options.debug === !0 &&
                          console.log('Validation succeeded for plugin "' + i.name + '".', i),
                      !0)
                    : (t.footable.options.debug === !0 &&
                          console.error(
                              'Validation failed, plugin "' + i.name + '" does not implement a function called "init".',
                              i
                          ),
                      !1);
            },
...
(function(e, t, undefined) {
    ...
    function l(e, t, a) {
        0 === e.find('tr.emptyInfo').size() &&
            e.find('tbody').append('<tr class="emptyInfo"><td colspan="' + t.length + '">' + a + '</td></tr>');
    }
    function d(t, a, o, i) {
        ...
        (a.name = 'Footable Grid'),
                                    ...
                                    'click.grid': function(a) {
                                        ...
                                        return o.hasClass(s)
                                            ...
                                            : (f.multiSelect ||
                                                  ...
                                                  u.find('tbody tr.' + f.activeClass).removeClass(f.activeClass),
                                              o.toggleClass(f.activeClass),
                                              f.showCheckbox &&
                                                  o.find('input:checkbox.check').prop('checked', function(e, t) {
            ...
            (a.newItem = function(t, o, i) {
                ...
                if ((n.find('tr.emptyInfo').remove(), e.isArray(t))) {
                    ...
                    return (
                        a.footable.redraw(),
                        a.footable.raise(a.footable.options.grid.events.created, { item: t, index: o }),
                        undefined
                    );
                }
            ...
            (a.setItem = function(t, o) {
                if (e.isPlainObject(t)) {
                    ...
                    r.html(n.html()),
                        a.footable.redraw(),
                        a.footable.raise(a.footable.options.grid.events.updated, { item: t, index: o });
                }
            }),
        ...
        (e.name = 'Footable Filter'),
                                ...
                                'footable_initialized.filtering': function() {
                                    var i = t(a.table),
                                        o = {
                                            ...
                                            disableEnter:
                                                i.data('filter-disable-enter') || a.options.filter.disableEnter,
                                        };
                                    o.disableEnter &&
            ...
            (e.filter = function(a) {
                ...
                if (!((l && l.result === !1) || (l.filter && n > l.filter.length)))
                    if (l.clear) e.clearFilter();
                        ...
                        o.find('> tbody > tr')
                            .hide()
                            .addClass('footable-filtered');
                        var s = o.find('> tbody > tr:not(.footable-row-detail)');
                        t.each(d, function(t, e) {
                            e &&
                                e.length > 0 &&
                                (o.data('current-filter', e), (s = s.filter(i.options.filter.filterFunction)));
                        }),
                            s.each(function() {
            ...
            (e.showRow = function(e, a) {
                var i = t(e),
                    ...
                    n = t(a.table);
                i.is(':visible') ||
                    (n.hasClass('breakpoint') && i.hasClass('footable-detail-show') && o.hasClass('footable-row-detail')
            ...
            (t.createNavigation = function(a) {
                ...
                if (0 === i.length) {
                    if (
                        ...
                        i.parents('table:first').length > 0 && i.parents('table:first') !== e(a.table))
                    )
                        return;
                    i.length > 1 &&
                        a.options.debug === !0 &&
                ...
                if (0 !== i.length) {
                    ...
                    (o.control = i),
                        ...
                        i.off('click', 'a[data-page]').on('click', 'a[data-page]', function(n) {
                            n.preventDefault();
                ...
                for (i = t.pages.length - 1; i >= 0; i--)
                    (o = t.pages[i]),
                        i >= a &&
                            ...
                            o.length > 0 &&
                            n.after(
                                '<li class="footable-page"><a data-page="' + i + '" href="#">' + (i + 1) + '</a></li>'
                            );
        ...
        (e.name = 'Footable Sortable'),
            ...
            (e.doSort = function(a, i) {
                ...
                if (t(o.table).data('sort') !== !1) {
                    ...
                    if (
                        ((i = i === undefined ? s.hasClass(d.sorted) : 'toggle' === i ? !s.hasClass(d.sorted) : i),
                        l.sort.ignore === !0)
                    )
                        return !0;
