                ...
                l.fail(function(t, n, i) {
                    e === d.buttons['delete'].action
                        ? (o.removeClass(d.mutedClass).addClass(d.dangerClass),
                          o.find('.tabledit-toolbar button').attr('disabled', !1),
                          o.find('.tabledit-toolbar .tabledit-restore-button').hide())
        ...
        var i = this,
                    ...
                    toolbar: function() {
                        if (d.editButton || d.deleteButton) {
                            ...
                            0 === i.find('th.tabledit-toolbar-column').length &&
                                i.find('tr:first').append('<th class="tabledit-toolbar-column"></th>'),
                                d.editButton &&
                                    (t =
            ...
            u = {
                ...
                edit: function(e) {
                    c.reset(e);
                    var n = t(e).parent('tr');
                    n.find('.tabledit-input.tabledit-identifier').prop('disabled', !1),
                        t(e)
                            .find('.tabledit-span')
                            .hide();
                    ...
                    i.prop('disabled', !1).show(),
                        ...
                        d.editButton &&
                            (n.find('button.tabledit-edit-button').addClass('active'),
                ...
                submit: function(e) {
                    ...
                    t(e)
                        ...
                        i !== !1 &&
                            (t(e)
                                .parent('tr')
                                .addClass('tabledit-deleted-row'),
                            t(e)
                                .parent('tr')
                                .addClass(d.mutedClass)
                                .find('.tabledit-toolbar button:not(.tabledit-restore-button)')
                                .attr('disabled', !0),
                            t(e)
                                .find('.tabledit-restore-button')
                                .show(),
                            (o = t(e).parent('tr')));
                },
                confirm: function(e) {
                ...
                : (i.on(d.eventType, 'tr:not(.tabledit-deleted-row) td.tabledit-view-mode', function(t) {
                  ...
                  t(document).on('click', function(t) {
                      ...
                      e.is(t.target) ||
                          ...
                          b.reset(i.find('.tabledit-input:visible').parent('td'));
                  })),
