            ...
            (i = [r(2)]),
                (n = function(t) {
                            ...
                            for (var y = 0; y < c; y++) {
                                ...
                                if (C) {
                                    ...
                                    S >= 0 &&
                                        ...
                                        A >= 0 &&
                                        A <= 1.001 &&
                                        (i ? g++ : g.push({ x: C.x, y: C.y, t1: G(S, 1), t2: G(A, 1) }));
                                }
                            }
                        return g;
                    }
                    ...
                    function g(t, e, r, i, n, a) {
                        null != t
                            ? ((this.a = +t), (this.b = +e), (this.c = +r), (this.d = +i), (this.e = +n), (this.f = +a))
                            ...
                            if (h) (h.initstatus = a), (h.start = new Date() - h.ms * a);
                                ...
                                for (var C in l)
                                    if (l[A](C) && (pt[A](C) || i.paper.customAttributes[A](C)))
                                        switch (
                                            ((x[C] = i.attr(C)), null == x[C] && (x[C] = ft[C]), (m[C] = l[C]), pt[C])
                                        ) {
                                            case $:
                                                b[C] = (m[C] - x[C]) / v;
                                                break;
                    ...
                    if (
                        ...
                        (e.type =
                            T.win.SVGAngle ||
                            T.doc.implementation.hasFeature('http://www.w3.org/TR/SVG11/feature#BasicStructure', '1.1')
                                ? 'SVG'
                                : 'VML'),
                        'VML' == e.type)
                    ) {
                                ...
                                n.length ||
                                    I(t).replace(yt, function(t, e, r) {
                                        ...
                                        if (
                                            ...
                                            'm' == s &&
                                                a.length > 2 &&
                                                (n.push([e][P](a.splice(0, 2))), (s = 'l'), (e = 'm' == e ? 'l' : 'L')),
                                            'r' == s)
                                        )
                                            n.push([e][P](a));
                    ...
                    var Ot = (e.pathBBox = function(t) {
                        ...
                        Wt = (e._pathToRelative = function(t) {
                            ...
                            var i = [],
                                ...
                                l = 0;
                            'M' == t[0][0] &&
                                ((n = t[0][1]), (a = t[0][2]), (s = n), (o = a), l++, i.push(['M', n, a]));
                        ...
                        Gt = (e._pathToAbsolute = function(t) {
                            ...
                            if (((e.is(t, Q) && e.is(t && t[0], Q)) || (t = e.parsePathString(t)), !t || !t.length))
                                return [['M', 0, 0]];
                            var i = [],
                                n = 0,
                                a = 0,
                                ...
                                h = 0;
                            'M' == t[0][0] &&
                                ((n = +t[0][1]), (a = +t[0][2]), (o = n), (l = a), h++, (i[0] = ['M', n, a]));
                            for (
                                var u =
                                        3 == t.length &&
                                        'M' == t[0][0] &&
                        ...
                        Ut = function(t, e, r, i, a, s, o, l, h, u) {
                            ...
                            if (u) (S = u[0]), (A = u[1]), (B = u[2]), (C = u[3]);
                                ...
                                var _ = r * r,
                                    ...
                                    k =
                                        (s == o ? -1 : 1) *
                                        Y.sqrt(H((_ * w - _ * m * m - w * y * y) / (_ * m * m + w * y * y))),
                                    B = (k * r * m) / i + (t + l) / 2,
                                    C = (k * -i * y) / r + (e + h) / 2,
                        ...
                        ee = (e._toback = function(t, e) {
                            e.bottom !== t &&
                                (Kt(t, e), (t.next = e.bottom), (t.prev = null), (e.bottom.prev = t), (e.bottom = t));
                        }),
                                ...
                                for (var c = 0, f = i.length; c < f; c++) {
                                    ...
                                    't' == v && 3 == d
                                        ...
                                        ? 2 == d
                                            ...
                                            : 4 == d &&
                                              (x
                                                  ? ((_ = y.x(p[2], p[3])), (w = y.y(p[2], p[3])), u.rotate(p[1], _, w))
                        ...
                        le = (e._equaliseTransform = function(t, r) {
                            ...
                            for (var i = W(t.length, r.length), n = [], a = [], s = 0, o, l, h, u; s < i; s++) {
                                if (
                                    ...
                                    (u = r[s] || oe(h)),
                                    h[0] != u[0] ||
                                        ('r' == h[0].toLowerCase() && (h[2] != u[2] || h[3] != u[3])) ||
                                        ('s' == h[0].toLowerCase() && (h[3] != u[3] || h[4] != u[4])))
                                )
                                    return;
                        ...
                        (function(t) {
                            ...
                            (t.add = function(t, e, r, i, n, a) {
                                ...
                                (t.split = function() {
                                    ...
                                    return (
                                        s < 0
                                            ? ((t.rotate = e.deg(Y.acos(s))), a < 0 && (t.rotate = 360 - t.rotate))
                    ...
                    (N.getElementByPoint = function(t, e) {
                        ...
                        return (
                            n == r.canvas.parentNode && (n = i), (n = n && n.raphael ? r.getById(n.raphaelid) : null)
                        );
                    }),
                    ...
                    var we = {},
                        ke = function(t, r, i, n, a, s, o, u, c) {
                            return null == c
                                ? l(t, r, i, n, a, s, o, u)
                                : e.findDotsAtSegment(t, r, i, n, a, s, o, u, h(t, r, i, n, a, s, o, u, c));
                        },
                        Be = function(t, r) {
                            return function(i, n, a) {
                                ...
                                for (var s, o, l, h, u = '', c = {}, f, p = 0, d = 0, g = i.length; d < g; d++) {
                                    if (((l = i[d]), 'M' == l[0])) (s = +l[1]), (o = +l[2]);
                                        ...
                                        if (((h = ke(s, o, l[1], l[2], l[3], l[4], l[5], l[6])), p + h > n)) {
                                            if (r && !c.start) {
                                                if (
                                                    ((f = ke(s, o, l[1], l[2], l[3], l[4], l[5], l[6], n - p)),
                                ...
                                return (
                                    ...
                                    (f = t
                                        ...
                                        : r
                                        ? c
                                        : e.findDotsAtSegment(s, o, l[0], l[1], l[2], l[3], l[4], l[5], 1)),
                        ...
                        Ne = function() {
                            for (var r = +new Date(), i = 0; i < Ee.length; i++) {
                                ...
                                if (!n.el.removed && !n.paused) {
                                    ...
                                    if (
                                        (n.initstatus
                                            ? ((a = ((n.initstatus * n.anim.top - n.prev) / (n.percent - n.prev)) * s),
                                                        ...
                                                        case 'transform':
                                                            if (h[y].real)
                                                                for (d = [], m = 0, _ = l[y].length; m < _; m++)
                                                                    for (
                                                                        d[m] = [l[y][m][0]], w = 1, k = l[y][m].length;
                                                                        w < k;
                                                                        w++
                                                                    )
                                                                        d[m][w] = l[y][m][w] + x * s * h[y][m][w];
                    ...
                    (ye.animateWith = function(t, r, i, n, a, s) {
                        ...
                        (ye.stop = function(e) {
                            for (var r = 0; r < Ee.length; r++)
                                Ee[r].el.id != this.id ||
                                    (e && Ee[r].anim != e) ||
                                    (t('raphael.anim.stop.' + this.id, this, Ee[r].anim) !== !1 && Ee.splice(r--, 1));
                            return this;
                        }),
                    ...
                    var ze = function(t) {
                            if (((this.items = []), (this.length = 0), (this.type = 'set'), t))
                                for (var e = 0, r = t.length; e < r; e++)
                                    !t[e] ||
                                        (t[e].constructor != ye.constructor && t[e].constructor != ze) ||
                                ...
                                r = function(t, r, i) {
                                    ...
                                    return (
                                        r.replace(e, function(t, e, r, i, a) {
                                            (e = e || i),
                                                n && (e in n && (n = n[e]), 'function' == typeof n && a && (n = n()));
                                        }),
                                        (n = (null == n || n == i ? t : n) + '')
                                    );
                                };
            ...
            !(function(r) {
                ...
                (eve = function(t, e) {
                    ...
                    (eve.separator = function(t) {
                        t
                            ? ((t = y(t).replace(/(?=[\.\^\]\[\-])/g, '\\')), (t = '[' + t + ']'), (o = new RegExp(t)))
                            : (o = /[\.\/]/);
                    }),
                    (eve.on = function(t, e) {
                                ...
                                if ('path' == i.type) {
                                    ...
                                    if (
                                        ('open' == x
                                            ...
                                            : ((_ = b = k / 2), (w = { fill: u.stroke, stroke: 'none' })),
                                        i._.arrows
                                            ? a
                                        ...
                                        t._g.doc.getElementById(S)
                                            ? g[S]++
                                            : (o.defs.appendChild(
                                                  v(v('path'), { 'stroke-linecap': 'round', d: d[x], id: S })
                                              ),
                                              (g[S] = 1));
                                        ...
                                        a
                                            ? ((y = i._.arrows.startdx * f || 0), (m = t.getTotalLength(u.path) - y))
                                            : ((y = 0), (m = t.getTotalLength(u.path) - (i._.arrows.enddx * f || 0))),
                                    ...
                                    if (a[e](d)) {
                                        ...
                                        switch (((u[d] = g), d)) {
                                            ...
                                            case 'target':
                                                ...
                                                'target' == d
                                                    ? w.setAttributeNS(p, 'show', 'blank' == g ? 'new' : g)
                                            ...
                                            case 'clip-rect':
                                                ...
                                                if (4 == C.length) {
                                                    i.clip &&
                                                        i.clip.parentNode.parentNode.removeChild(i.clip.parentNode);
                                                    var A = v('clipPath'),
                                                        T = v('rect');
                                                    (A.id = t.createUUID()),
                                            ...
                                            case 'path':
                                                'path' == i.type &&
                                                    ...
                                                    (i._.dirty = 1),
                                                    i._.arrows &&
                                                        ('startString' in i._.arrows && _(i, i._.arrows.startString),
                                            ...
                                            case 'cy':
                                                ...
                                                break;
                                            case 'r':
                                                'rect' == i.type ? v(l, { rx: g, ry: g }) : l.setAttribute(d, g),
                                                    (i._.dirty = 1);
                                                break;
                                            case 'src':
                            ...
                            S = function(i, a) {
                                if (
                                    ...
                                    if (a[e]('text')) {
                                        ...
                                        for (u = o.getElementsByTagName('tspan'), p = 0, d = u.length; p < d; p++)
                        ...
                        (T.prototype = E),
                            ...
                            (E._getBBox = function() {
                                ...
                                this.paper.canvas.parentElement
                                    ...
                                    : this.paper.canvas.parentNode && (r = this.paper.canvas.parentNode.style),
                            ...
                            (E.blur = function(e) {
                                ...
                                if (0 !== +e) {
                                    ...
                                    r._blur &&
                                        (r._blur.parentNode.removeChild(r._blur), delete r._blur, delete r.attrs.blur),
                            ...
                            (t._engine.image = function(t, e, r, i, n, a) {
                                var s = v('image');
                                v(s, { x: r, y: i, width: n, height: a, preserveAspectRatio: 'none' }),
                            ...
                            (t._engine.create = function() {
                                ...
                                return (
                                    ...
                                    1 == r
                                        ? ((o.style.cssText = l + 'position:absolute;left:' + i + 'px;top:' + n + 'px'),
                            ...
                            (t.prototype.renderfix = function() {
                                ...
                                var n = -r.e % 1,
                                    a = -r.f % 1;
                                (n || a) &&
                                    (n && ((this._left = (this._left + n) % 1), (e.left = this._left + 'px')),
                                    a && ((this._top = (this._top + a) % 1), (e.top = this._top + 'px')));
                            }),
                        ...
                        var S = function(t, e, i) {
                            ...
                            A = function(n, l) {
                                ...
                                var c = n.node,
                                    ...
                                    y =
                                        w[n.type] &&
                                        (f.cx != l.cx || f.cy != l.cy || f.r != l.r || f.rx != l.rx || f.ry != l.ry),
                                    m = n;
                                            ...
                                            (j.color = t.getRGB(l.fill).hex),
                                                ...
                                                t.getRGB(l.fill).error &&
                                                    (m.type in { circle: 1, ellipse: 1 } ||
                                                        'r' != r(l.fill).charAt()) &&
                                                    T(m, l.fill, j) &&
                                                    ((f.fill = 'none'), (f.gradient = l.fill), (j.rotate = !1));
                                    }
                                        ...
                                        return (
                                            ...
                                            e &&
                                                ...
                                                l(e - 0.5, 2) + l(r - 0.5, 2) > 0.25 &&
                                                    (r = n.sqrt(0.25 - l(e - 0.5, 2)) * (2 * (r > 0.5) - 1) + 0.5),
                                                (f = e + p + r)),
                                            d
                                        );
                                    })),
