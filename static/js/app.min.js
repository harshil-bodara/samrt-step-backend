    ...
    (t.prototype.initTooltipPlugin = function() {
        ...
        (t.prototype.initFormValidation = function() {
            n('.needs-validation').on('submit', function(t) {
                return (
                    ...
                    !1 !== n(this)[0].checkValidity() || (t.preventDefault(), t.stopPropagation(), !1)
                );
            });
        }),
        (t.prototype.initCustomModalPlugin = function() {
            n('[data-plugin="custommodal"]').on('click', function(t) {
                t.preventDefault(),
                    new Custombox.modal({
                        content: { target: n(this).attr('href'), effect: n(this).attr('data-animation') },
        ...
        (t.prototype._resetSidebarScroll = function() {
                ...
                e('.button-menu-mobile').on('click', function(t) {
                    ...
                    e(document).on('click', 'body', function(t) {
                        0 < e(t.target).closest('.right-bar-toggle, .right-bar').length ||
                            ...
                            (e('body').removeClass('right-bar-enabled'), e('body').removeClass('sidebar-enable'));
                    }),
            ...
            (t.prototype.initLayout = function() {
                768 <= this.$window.width() && this.$window.width() <= 1028
                    ...
                    : 1 != this.$body.data('keep-enlarged') && this.$body.removeClass('enlarged');
            }),
            (t.prototype.init = function() {
                var i = this;
                this.initLayout(),
