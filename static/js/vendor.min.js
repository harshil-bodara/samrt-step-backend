!(function(e, t) {
        ...
        C.extend({
            ...
            isPlainObject: function(e) {
                ...
                return (
                    ...
                    (!(t = i(e)) ||
                        ('function' == typeof (n = m.call(t, 'constructor') && t.constructor) && s.call(n) === u))
                );
            },
    ...
    var p = (function(n) {
        ...
        ((_ = oe.selectors = {
            ...
            filter: {
                                  ...
                                  if (((l = [y ? c.firstChild : c.lastChild]), y && h)) {
                                      ...
                                      for (
                                          ...
                                          ((b ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) ||
                                              !++d ||
                                              (h &&
                                                  ((r = (o = s[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[
                                                      p
                                                  ] = [S, d]),
                                              s !== e));
                ...
                PSEUDO: function(e, o) {
                    var t,
                        s = _.pseudos[e] || _.setFilters[e.toLowerCase()] || oe.error('unsupported pseudo: ' + e);
                    return s[C]
                        ? s(o)
                        : 1 < s.length
                        ? ((t = [e, e, '', o]),
            ...
            pseudos: {
                ...
                focus: function(e) {
                    return (
                        e === T.activeElement && (!T.hasFocus || T.hasFocus()) && !!(e.type || e.href || ~e.tabIndex)
                    );
                },
                enabled: de(!1),
                disabled: de(!0),
                ...
                : function(e, t, n) {
                      ...
                      if (n) {
                          ...
                          for (; (e = e[l]); )
                              if (1 === e.nodeType || f)
                                  if (
                                      ((r = (o = e[C] || (e[C] = {}))[e.uniqueID] || (o[e.uniqueID] = {})),
        ...
        return (
            ...
            (p = oe.tokenize = function(e, t) {
                ...
                for (s = e, a = [], l = _.preFilter; s; ) {
                    ...
                    (n = !1),
                    (i = U.exec(s)) &&
                        ((n = i.shift()), r.push({ value: n, type: i[0].replace(F, ' ') }), (s = s.slice(n.length))),
                    _.filter))
                        !(i = K[o].exec(s)) ||
                            (l[o] && !(i = l[o](i))) ||
                            ((n = i.shift()), r.push({ value: n, type: o, matches: i }), (s = s.slice(n.length)));
                    if (!n) break;
                }
            ...
            (g = oe.select = function(e, t, n, i) {
                ...
                if (((n = n || []), 1 === c.length)) {
                    ...
                    for (r = K.needsContext.test(e) ? 0 : o.length; r-- && ((s = o[r]), !_.relative[(a = s.type)]); )
                        if (
                            (l = _.find[a]) &&
                            (i = l(s.matches[0].replace(Z, ee), (J.test(o[0].type) && ge(t.parentNode)) || t))
                        ) {
    ...
    ((C.fn.init = function(e, t, n) {
        ...
        if (((n = n || k), 'string' != typeof e))
            return e.nodeType
                ...
                : C.makeArray(e, this);
        if (
            !(i = '<' === e[0] && '>' === e[e.length - 1] && 3 <= e.length ? [null, e, null] : O.exec(e)) ||
            (!i[1] && t)
        )
            ...
            function(i, r) {
                C.fn[i] = function(e, t) {
                    ...
                    return (
                        ...
                        1 < this.length && (j[i] || C.uniqueSort(n), L.test(i) && n.reverse()),
                        this.pushStack(n)
                    );
                };
            }
    ...
    (C.Callbacks = function(i) {
        ...
        C.extend({
                        ...
                        then: function(t, n, i) {
                            ...
                            function u(r, o, s, a) {
                                return function() {
                                    ...
                                    r
                                        ? t()
                                        : (C.Deferred.getStackHook && (t.stackTrace = C.Deferred.getStackHook()),
                                          T.setTimeout(t));
                                };
                            }
            ...
            when: function(e) {
                ...
                if (
                    n <= 1 &&
                    (M(e, o.done(s(t)).resolve, o.reject, !n), 'pending' === o.state() || y(r[t] && r[t].then))
                )
                    return o.then();
    ...
    (C.fn.ready = function(e) {
        ...
        'complete' === x.readyState || ('loading' !== x.readyState && !x.documentElement.doScroll)
            ...
            : (x.addEventListener('DOMContentLoaded', B), T.addEventListener('load', B));
    ...
    var te = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        re = function(e, t) {
            return (
                ...
                ('' === e.style.display && C.contains(e.ownerDocument, e) && 'none' === C.css(e, 'display'))
            );
        },
        oe = function(e, t, n, i) {
            var r,
    ...
    function se(e, t, n, i) {
        ...
        if (c && c[3] !== u) {
            for (l /= 2, u = u || c[3], c = +l || 1; s--; )
                C.style(e, t, c + u), (1 - o) * (1 - (o = a() / l || 0.5)) <= 0 && (s = 0), (c /= o);
            ...
            if (m && (l = m.events)) {
                for (u = (t = (t || '').match(P) || ['']).length; u--; )
                    if (((d = g = (a = Ee.exec(t[u]) || [])[1]), (p = (a[2] || '').split('.').sort()), d)) {
                        ...
                        s &&
                            !h.length &&
                            ((f.teardown && !1 !== f.teardown.call(e, p, m.handle)) || C.removeEvent(e, d, m.handle),
                            delete l[d]);
                ...
                for (s = C.event.handlers.call(this, a, u), t = 0; (r = s[t++]) && !a.isPropagationStopped(); )
                    for (a.currentTarget = r.elem, n = 0; (o = r.handlers[n++]) && !a.isImmediatePropagationStopped(); )
                        (a.rnamespace && !a.rnamespace.test(o.namespace)) ||
                            ...
                            (a.data = o.data),
                            void 0 !==
                                (i = ((C.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, l)) &&
                                !1 === (a.result = i) &&
                    ...
                    if (1 === u.nodeType && ('click' !== e.type || !0 !== u.disabled)) {
                        for (o = [], s = {}, n = 0; n < l; n++)
                            void 0 === s[(r = (i = t[n]).selector + ' ')] &&
                                (s[r] = i.needsContext ? -1 < C(r, this).index(u) : C.find(r, this, null, [u]).length),
                                s[r] && o.push(i);
            ...
            e && e.type
                ? ((this.originalEvent = e),
                  ...
                  (this.isDefaultPrevented =
                      e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? Te : xe),
                    ...
                    handle: function(e) {
                        ...
                        return (
                            (n && (n === this || C.contains(this, n))) ||
                                ((e.type = i.origType), (t = i.handler.apply(this, arguments)), (e.type = r)),
                            t
                        );
                    },
                };
    ...
    function He(n, i, r, o) {
        ...
        if (
            f &&
            ((t = (e = ye(i, n[0].ownerDocument, !1, n, o)).firstChild), 1 === e.childNodes.length && (e = t), t || o)
        ) {
            for (a = (s = C.map(de(e, 'script'), Oe)).length; c < f; c++)
                (l = e), c !== h && ((l = C.clone(l, !0, !0)), a && C.merge(s, de(l, 'script'))), r.call(n[c], l, c);
            if (a)
    ...
    function Pe(e, t, n) {
        for (var i, r = t ? C.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
            n || 1 !== i.nodeType || C.cleanData(de(i)),
                i.parentNode &&
                    (n && C.contains(i.ownerDocument, i) && pe(de(i, 'script')), i.parentNode.removeChild(i));
        return e;
    }
    C.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n) for (o = o || de(e), s = s || de(c), i = 0, r = o.length; i < r; i++) je(o[i], s[i]);
                else je(e, c);
                ...
                return U(
                    ...
                    function(e) {
                        ...
                        if ('string' == typeof e && !De.test(e) && !he[(ce.exec(e) || ['', ''])[1].toLowerCase()]) {
                            ...
                            try {
                                for (; n < i; n++)
                                    1 === (t = this[n] || {}).nodeType && (C.cleanData(de(t, !1)), (t.innerHTML = e));
                                t = 0;
                            } catch (e) {}
                        }
    ...
    function Xe(e, t, n, i, r, o) {
        ...
        return (
            !i &&
                0 <= o &&
                (l += Math.max(0, Math.ceil(e['offset' + t[0].toUpperCase() + t.slice(1)] - o - l - a - 0.5))),
            l
        );
    }
    function Ge(e, t, n) {
        ...
        return (
            ...
            ('auto' === r || (!parseFloat(r) && 'inline' === C.css(e, 'display', !1, i))) &&
    ...
    C.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                'string' === (o = typeof n) && (r = ne.exec(n)) && r[1] && ((n = se(e, t, r)), (o = 'number')),
                    null != n &&
                        n == n &&
            ...
            C.cssHooks[a] = {
                ...
                set: function(e, t, n) {
                    ...
                    return (
                        ...
                        s && (i = ne.exec(t)) && 'px' !== (i[3] || 'px') && ((e.style[a] = t), (t = C.css(e, a))),
                        Ye(0, t, s)
                    );
                },
            };
        ...
        ((Je.propHooks = {
            _default: {
                ...
                set: function(e) {
                    C.fx.step[e.prop]
                        ? C.fx.step[e.prop](e)
                        : 1 !== e.elem.nodeType || (null == e.elem.style[C.cssProps[e.prop]] && !C.cssHooks[e.prop])
                        ? (e.elem[e.prop] = e.now)
    ...
    function ot() {
        et &&
            (!1 === x.hidden && T.requestAnimationFrame ? T.requestAnimationFrame(ot) : T.setTimeout(ot, C.fx.interval),
            C.fx.tick());
    }
    function st() {
        return (
        ...
        var n,
            ...
            l = function() {
                ...
                return (
                    ...
                    n < 1 && r ? t : (r || a.notifyWith(o, [u, 1, 0]), a.resolveWith(o, [u]), !1)
                );
            },
            u = a.promise({
                elem: o,
                ...
                if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(d))
                    for (i in (f &&
                        ...
                        'none' === (c = C.css(e, 'display')) &&
                            (u
                                ? (c = u)
                                : (le([e], !0), (u = e.style.display || u), (c = C.css(e, 'display')), le([e]))),
                ...
                return (
                    ...
                    this.each(function() {
                        var e,
                            ...
                            o = n ? n.length : 0;
                        for (
                            t.finish = !0, C.queue(this, s, []), i && i.stop && i.stop.call(this, !0), e = r.length;
                            e--;
            ...
            attr: function(e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return void 0 === e.getAttribute
                        ? C.prop(e, t, n)
                        : ((1 === o && C.isXMLDoc(e)) ||
                              (r = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? ct : void 0)),
                          void 0 !== n
                              ? null === n
    ...
    C.extend(C.event, {
        trigger: function(e, t, n, i) {
            ...
            if (
                ...
                if (!i && !c.noBubble && !b(n)) {
                    for (a = c.delegateType || d, yt.test(a + d) || (o = o.parentNode); o; o = o.parentNode)
                        h.push(o), (s = o);
            ...
            ajax: function(e, t) {
                ...
                m.hasContent
                    ...
                    : ((o = m.url.slice(f.length)),
                      ...
                      !1 === m.cache && ((f = f.replace(It, '$1')), (o = (Et.test(f) ? '&' : '?') + '_=' + wt++ + o)),
                      (m.url = f + o)),
                m.ifModified &&
                    (C.lastModified[f] && E.setRequestHeader('If-Modified-Since', C.lastModified[f]),
                ...
                E.setRequestHeader(
                    ...
                    m.dataTypes[0] && m.accepts[m.dataTypes[0]]
                        ? m.accepts[m.dataTypes[0]] + ('*' !== m.dataTypes[0] ? ', ' + Pt + '; q=0.01' : '')
                        : m.accepts['*']
                ),
                m.headers))
                ...
                function u(e, t, n, i) {
                    ...
                    p ||
                        ...
                        r
                            ? (m.ifModified &&
                                  ((l = E.getResponseHeader('Last-Modified')) && (C.lastModified[f] = l),
        ...
        C.each(['get', 'post'], function(e, r) {
            C[r] = function(e, t, n, i) {
                return (
                    ...
                    C.ajax(C.extend({ url: e, type: r, dataType: i, data: t, success: n }, C.isPlainObject(e) && e))
                );
            };
        }),
    ...
    C.ajaxSetup({
        ...
        (v.createHTMLDocument =
            (((Ut = x.implementation.createHTMLDocument('').body).innerHTML = '<form></form><form></form>'),
        ...
        (C.parseHTML = function(e, t, n) {
            return 'string' != typeof e
                ...
                : ('boolean' == typeof t && ((n = t), (t = !1)),
                  t ||
                      (v.createHTMLDocument
                          ? (((i = (t = x.implementation.createHTMLDocument('')).createElement('base')).href =
                                x.location.href),
                  ...
                  (r = N.exec(e))
                      ? [t.createElement(r[1])]
                      : ((r = ye([e], t, o)), o && o.length && C(o).remove(), C.merge([], r.childNodes)));
            var i, r, o;
        }),
    ...
    (function(e, t) {
        ...
        var v = 'button',
            ...
            D = '.active',
            N = '.btn',
            I = { CLICK_DATA_API: 'click' + b + _, FOCUS_BLUR_DATA_API: 'focus' + b + _ + ' blur' + b + _ },
            k = (function() {
                function n(e) {
                    this._element = e;
                }
        ...
        var O = 'carousel',
            ...
            ae = (function() {
                ...
                return (
                    ...
                    (e.pause = function(e) {
                        e || (this._isPaused = !0),
                            this._element.querySelector(ne) && (g.triggerTransitionEnd(this._element), this.cycle(!0)),
                                ...
                                this._pointerEvent
                                    ...
                                    : (p(this._element).on(U.TOUCHSTART, function(e) {
                                      ...
                                      p(this._element).on(U.TOUCHMOVE, function(e) {
                                          var t;
                                          (t = e).originalEvent.touches && 1 < t.originalEvent.touches.length
                                              ? (n.touchDeltaX = 0)
                    ...
                    (e._getItemIndex = function(e) {
                        return (
                            (this._items = e && e.parentNode ? [].slice.call(e.parentNode.querySelectorAll(ee)) : []),
                                ...
                                if (0 < i)
                                    for (var r = 0; r < i; r++) {
                                        var o = this._triggerArray[r],
                                            s = g.getSelectorFromElement(o);
                                        if (null !== s)
                                            p([].slice.call(document.querySelectorAll(s))).hasClass(ge) ||
                                                p(o)
                                                    .addClass(ye)
        ...
        function Pe(e) {
            ...
            return i && 'BODY' !== i && 'HTML' !== i
                ? -1 !== ['TH', 'TD', 'TABLE'].indexOf(n.nodeName) && 'static' === Ie(n, 'position')
                    ? Pe(n)
                    : n
                : e
        ...
        function Xe(e, t, n, i) {
            ...
            if ('viewport' === i)
                ...
                var a = void 0;
                'scrollParent' === i
                    ? 'BODY' === (a = Oe(ke(t))).nodeName && (a = e.ownerDocument.documentElement)
                            ...
                            var u = i.priority,
                                ...
                                f = {
                                    primary: function(e) {
                                        var t = c[e];
                                        return (
                                            c[e] < l[e] && !i.escapeWithReference && (t = Math.max(c[e], l[e])),
                                            ze({}, e, t)
                                        );
                                    },
                                    secondary: function(e) {
                                        ...
                                        return (
                                            c[e] > l[e] &&
                                                ...
                                                (n = Math.min(c[t], l[e] - ('right' === e ? c.width : c.height))),
                                            ze({}, t, n)
                                        );
                                    },
                                };
                    ...
                    arrow: {
                        ...
                        fn: function(e, t) {
                            ...
                            return (
                                ...
                                (e.arrowElement = i),
                                (e.offsets.arrow = (ze((n = {}), f, Math.round(b)), ze(n, h, ''), n)),
                                e
                            );
                        },
                        element: '[x-arrow]',
                ...
                return (
                    ...
                    (e._getOffset = function() {
                        ...
                        return (
                            'function' == typeof this._config.offset
                                ? (e.fn = function(e) {
                                      return (
                                          (e.offsets = l({}, e.offsets, t._config.offset(e.offsets, t._element) || {})),
                                          e
                                      );
                                  })
                    ...
                    (u._jQueryInterface = function(t) {
                        return this.each(function() {
                            ...
                            if (
                                (e || ((e = new u(this, 'object' == typeof t ? t : null)), p(this).data(Tt, e)),
                                'string' == typeof t)
                            ) {
                    ...
                    (u._clearMenus = function(e) {
                        if (!e || (3 !== e.which && ('keyup' !== e.type || 9 === e.which)))
                            for (
                                var t = [].slice.call(document.querySelectorAll(Pt)), n = 0, i = t.length;
                                n < i;
                                n++
                            ) {
                        ...
                        if (
                            (/input|textarea/i.test(e.target.tagName)
                                ? !(
                                      32 === e.which ||
                                      (27 !== e.which &&
                                          ((40 !== e.which && 38 !== e.which) || p(e.target).closest(Rt).length))
                                  )
                                : At.test(e.which)) &&
                    ...
                    i = function(e, t) {
                        ...
                        r.forEach(function(e) {
                            (function(e, t) {
                                ...
                                if (-1 !== t.indexOf(n))
                                    return (
                                        -1 === vn.indexOf(n) || Boolean(e.nodeValue.match(bn) || e.nodeValue.match(_n))
                                    );
                                for (
                ...
                return (
                    ...
                    (e.setElementContent = function(e, t) {
                        'object' != typeof t || (!t.nodeType && !t.jquery)
                            ? this.config.html
                                ? (this.config.sanitize && (t = wn(t, this.config.whiteList, this.config.sanitizeFn)),
                                  e.html(t))
                                : e.text(t)
                            : this.config.html
                            ? p(t)
                    ...
                    (e._getOffset = function() {
                        ...
                        return (
                            'function' == typeof this.config.offset
                                ? (e.fn = function(e) {
                                      return (
                                          (e.offsets = l({}, e.offsets, t.config.offset(e.offsets, t.element) || {})), e
                                      );
                                  })
                    ...
                    (e._getConfig = function(e) {
                        ...
                        return (
                            ...
                            'number' ==
                                typeof (e = l({}, this.constructor.Default, t, 'object' == typeof e && e ? e : {}))
                    ...
                    (i._jQueryInterface = function(n) {
                        return this.each(function() {
                            ...
                            if (
                                ...
                                (e || ((e = new i(this, t)), p(this).data(Tn, e)), 'string' == typeof n)
                            ) {
                                if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                                e[n]();
                            }
                ...
                return (
                    ...
                    (i._jQueryInterface = function(n) {
                        return this.each(function() {
                            ...
                            if (
                                (e || !/dispose|hide/.test(n)) &&
                                (e || ((e = new i(this, t)), p(this).data(Qn, e)), 'string' == typeof n)
                            ) {
                                if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                                e[n]();
                            }
                ...
                return (
                    ...
                    (n._jQueryInterface = function(t) {
                        return this.each(function() {
                            ...
                            if (
                                (e || ((e = new n(this, 'object' == typeof t && t)), p(this).data(oi, e)),
                                'string' == typeof t)
                            ) {
                                if (void 0 === e[t]) throw new TypeError('No method named "' + t + '"');
                                e[t]();
        ...
        var Fi = 'toast',
            ...
            Zi = (function() {
                ...
                return (
                    ...
                    (e._getConfig = function(e) {
                        return (
                            (e = l({}, Gi, p(this._element).data(), 'object' == typeof e && e ? e : {})),
                    ...
                    (i._jQueryInterface = function(n) {
                        return this.each(function() {
                            var e = p(this),
                                t = e.data(Bi);
                            if (
                                (t || ((t = new i(this, 'object' == typeof n && n)), e.data(Bi, t)),
                                'string' == typeof n)
                            ) {
                                if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                                t[n](this);
                    ...
                    this.each(function() {
                        ...
                        if (h.parent().hasClass(A.wrapperClass)) {
                            ...
                            y.css(_),
                                ...
                                h.bind('touchmove', function(e) {
                                    (f || e.originalEvent.preventDefault(), e.originalEvent.touches.length) &&
                                        (E((o - e.originalEvent.touches[0].pageY) / A.touchScrollStep, !0),
                                        (o = e.originalEvent.touches[0].pageY));
                                }),
                                T(),
                                'bottom' === A.start
                                    ? (b.css({ top: h.outerHeight() - b.outerHeight() }), E(0, !0))
                                    : 'top' !== A.start &&
                                      (E(D(A.start).position().top, null, !0), A.alwaysVisible || b.hide()),
                                (v = this),
                        ...
                        function E(e, t, n) {
                            ...
                            if (
                                (t &&
                                    ((i =
                                        parseInt(b.css('top')) + ((e * parseInt(A.wheelStep)) / 100) * b.outerHeight()),
                                    (i = Math.min(Math.max(i, 0), r)),
                                    (i = 0 < e ? Math.ceil(i) : Math.floor(i)),
                                    b.css({ top: i + 'px' })),
                                (i =
                                    (a = parseInt(b.css('top')) / (h.outerHeight() - b.outerHeight())) *
                        ...
                        function x() {
                            ...
                            (l = a),
                                s >= h.outerHeight()
                                    ? (f = !0)
                                    : (b.stop(!0, !0).fadeIn('fast'), A.railVisible && y.stop(!0, !0).fadeIn('fast'));
                        }
                        function C() {
                            A.alwaysVisible ||
                                    ...
                                    .one(c.TRANSITION_END, function() {
                                        t.config &&
                                            ...
                                            (n
                                                ...
                                                .addClass(t.config.collapseClass + ' ' + t.config.collapseInClass)
                                                .height(''),
                        ...
                        if (!this.transitioning && a(e).hasClass(this.config.collapseInClass)) {
                            ...
                            if ((n.trigger(i), !i.isDefaultPrevented())) {
                                ...
                                var r = function() {
                                    t.config &&
                                        t.element &&
                                        (t.transitioning && t.config.onTransitionEnd && t.config.onTransitionEnd(),
                                        t.setTransitioning(!1),
                                        n.trigger(u.HIDDEN),
    ...
    (function(e, t) {
        ...
        function c(e) {
            ...
            return '[object String]' === n
                ? i(e)
                : r(e) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(n) && e.hasOwnProperty('length')
                ? e
                : r((t = e)) && 0 < t.nodeType
                ? [e]
                : [];
        ...
        var d = {
                    ...
                    (s =
                        ...
                        (s =
                            'touches' in e && e.touches.length
                                ? ((o = e.touches[0].pageY - r.top), e.touches[0].pageX - r.left)
                ...
                hide: function(e, t) {
                    for (
                        var n = (t = t || this).getElementsByClassName('waves-rippling'), i = 0, r = n.length;
                        i < r;
                        i++
                    )
                        o(e, t, n[i]);
                    a && (t.removeEventListener('touchend', d.hide), t.removeEventListener('touchcancel', d.hide)),
        ...
        function n(t) {
            ...
            if (null !== n) {
                ...
                if ((u.registerEvent(t), 'touchstart' === t.type && d.delay)) {
                    ...
                    d.show(t, n),
                        a &&
                            (n.addEventListener('touchend', d.hide, !1), n.addEventListener('touchcancel', d.hide, !1)),
            ...
            (t.attach = function(e, t) {
                ...
                for (var r = 0, o = e.length; r < o; r++)
                    (i = (n = e[r]).tagName.toLowerCase()),
                        -1 !== ['input', 'img'].indexOf(i) && (l[i](n), (n = n.parentElement)),
            ...
            (t.ripple = function(e, t) {
                ...
                if ((((t = t || {}).wait = t.wait || 0), (t.position = t.position || null), n))
                    for (
                        ...
                        if (
                            ((i = e[a]),
                            (r = t.position || { x: i.clientWidth / 2, y: i.clientHeight / 2 }),
                            (o = f(i)),
                            (s.x = o.left + r.x),
                            (s.y = o.top + r.y),
                            (l.pageX = s.x),
    ...
    (function() {
        ...
        function n(e) {
            (this.element = e),
                ...
                (i += 1),
                m.windowContext || ((m.windowContext = !0), (m.windowContext = new n(window))),
